...
Rust-verified L3 graph/value Folios, scenario, and expected behavior artifact.
...
Reconciliation matches L3 operation/scoped-iteration addresses within the
...
fresh L3 rendering. All pairs of ordered subsets of three keys exercise
...
The input contract is L3 operations and operands. `for-key` is the second
