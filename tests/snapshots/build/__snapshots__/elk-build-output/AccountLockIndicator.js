...
return (_ctx: any,_cache: any) => {
  ...
  return (_openBlock(), _createElementBlock("div", {
      ...
      "text-secondary-light": ""
        ...
        _: 1 /* STABLE */
      }, 8 /* PROPS */, ["disabled"]), (__props.showLabel) ? (_openBlock(), _createElementBlock("div", { key: 0 }, _toDisplayString(_unref(t)('account.lock')), 1 /* TEXT */)) : _createCommentVNode("v-if", true) ], 2 /* CLASS */))
}
}
