...
export default {
  ...
  setup(__props, { emit: __emit }) {
    ...
    async function updateAgreeServerRules(v) {
      if (v) {
    ...
    async function updateAgreeTosAndPrivacyPolicy(v) {
      if (v) {
        const confirm = await os.confirm({
          type: "question",
          title: i18n.ts.doYouAgree,
          text: i18n.tsx.iHaveReadXCarefullyAndAgree({ x: tosPrivacyPolicyLabel.value })
        });
        if (confirm.canceled) return;
    ...
    async function updateAgreeNote(v) {
      if (v) {
        const confirm = await os.confirm({
          type: "question",
          title: i18n.ts.doYouAgree,
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock("div", null, [_createElementVNode(
        ...
        _unref(instance).disableRegistration || _unref(instance).federation !== "all" ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          class: "_gaps_s"
        ...
        _createElementVNode("div", { style: "text-align: center;" }, [_createElementVNode(
          "div",
          null,
          _toDisplayString(_unref(i18n).ts.pleaseConfirmBelowBeforeSignup),
          1
          /* TEXT */
        ), _createElementVNode(
          "div",
          _hoisted_2,
          _toDisplayString(_unref(i18n).ts.beSureToReadThisAsItIsImportant),
          1
          /* TEXT */
        )]),
        _unref(availableServerRules) ? (_openBlock(), _createBlock(MkFolder, {
          key: 0,
          defaultOpen: true
        }, {
          ...
          suffix: _withCtx(() => [agreeServerRules.value ? (_openBlock(), _createElementBlock("i", {
            key: 0,
            class: "ti ti-check",
          ...
          default: _withCtx(() => [_createElementVNode(
            ...
            default: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts.agree),
              1
              /* TEXT */
            )]),
            _: 1
        ...
        _unref(availableTos) || _unref(availablePrivacyPolicy) ? (_openBlock(), _createBlock(MkFolder, {
          key: 0,
          defaultOpen: true
        }, {
          label: _withCtx(() => [_createTextVNode(
            _toDisplayString(tosPrivacyPolicyLabel.value),
            1
            /* TEXT */
          )]),
          suffix: _withCtx(() => [agreeTosAndPrivacyPolicy.value ? (_openBlock(), _createElementBlock("i", {
            key: 0,
            class: "ti ti-check",
            style: "color: var(--MI_THEME-success)"
          })) : _createCommentVNode("v-if", true)]),
          default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_s" }, [_unref(availableTos) ? (_openBlock(), _createElementBlock("div", { key: 0 }, [_createElementVNode("a", {
            ...
            1
            /* TEXT */
          ), _hoisted_3], 8, ["href"])])) : _createCommentVNode("v-if", true), _unref(availablePrivacyPolicy) ? (_openBlock(), _createElementBlock("div", { key: 0 }, [_createElementVNode("a", {
            ...
            1
            /* TEXT */
          ), _hoisted_4], 8, ["href"])])) : _createCommentVNode("v-if", true)]), _createVNode(MkSwitch, {
        ...
        _createVNode(MkFolder, { defaultOpen: true }, {
          label: _withCtx(() => [_createTextVNode(
            _toDisplayString(_unref(i18n).ts.basicNotesBeforeCreateAccount),
            1
            /* TEXT */
          )]),
          suffix: _withCtx(() => [agreeNote.value ? (_openBlock(), _createElementBlock("i", {
            key: 0,
            class: "ti ti-check",
            style: "color: var(--MI_THEME-success)"
          })) : _createCommentVNode("v-if", true)]),
          default: _withCtx(() => [_createElementVNode("a", {
            ...
            1
            /* TEXT */
          ), _hoisted_5]), _createVNode(MkSwitch, {
        ...
        !agreed.value ? (_openBlock(), _createElementBlock(
          "div",
          {
            key: 0,
            style: "text-align: center;"
          },
          _toDisplayString(_unref(i18n).ts.pleaseAgreeAllToContinue),
          1
          /* TEXT */
        )) : _createCommentVNode("v-if", true),
