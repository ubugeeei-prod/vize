...
export default {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const url = ref(props.avatarDecoration ? props.avatarDecoration.url : "");
    const name = ref(props.avatarDecoration ? props.avatarDecoration.name : "");
    const description = ref(props.avatarDecoration ? props.avatarDecoration.description : "");
    ...
    const rolesThatCanBeUsedThisDecoration = ref([]);
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(MkWindow, {
      ...
      }, _createSlots({ _: 2 }, [__props.avatarDecoration ? {
        name: "header",
        ...
        name: "header",
        fn: _withCtx(() => [_createTextVNode("New decoration")]),
        key: "1"
      }]), 1032, [
        "initialWidth",
        "initialHeight",
