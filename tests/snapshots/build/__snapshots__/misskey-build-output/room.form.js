      ...
      return _openBlock(), _createElementBlock(
        ...
        [
          _withDirectives(_createElementVNode("textarea", {
            ...
            onKeydown,
            onPaste
          }, null, 42, ["placeholder", "readonly"]), [[_vModelText, text.value]]),
          _createElementVNode(
            "footer",
            { class: _normalizeClass(_ctx.$style.footer) },
            [file.value ? (_openBlock(), _createElementBlock(
              "div",
              {
                key: 0,
              ...
              [
                ...
                _createElementVNode("button", {
                  ...
                  onClick: send
                }, [!sending.value ? (_openBlock(), _createElementBlock(
                  _Fragment,
                  { key: 0 },
                  [_hoisted_3],
                  64
                  /* STABLE_FRAGMENT */
                )) : _createCommentVNode("v-if", true), sending.value ? (_openBlock(), _createBlock(_component_MkLoading, {
                  key: 0,
                  em: true
                }, null, 8, ["em"])) : _createCommentVNode("v-if", true)], 10, ["disabled", "title"])
              ],
              2
              /* CLASS */
            )],
