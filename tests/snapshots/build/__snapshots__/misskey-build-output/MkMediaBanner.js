import { openBlock as _openBlock, createBlock as _createBlock, createElementBlock as _createElementBlock, createElementVNode as _createElementVNode, toDisplayString as _toDisplayString, normalizeClass as _normalizeClass, unref as _unref } from "vue";
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock(
        ...
        [__props.media.type.startsWith("audio") && __props.media.type !== "audio/midi" ? (_openBlock(), _createBlock(MkMediaAudio, {
          key: 0,
          audio: __props.media
        }, null, 8, ["audio"])) : hide.value ? (_openBlock(), _createElementBlock(
          "div",
          {
            key: 1,
          ...
          [
            _createElementVNode("span", { style: "font-size: 1.6em;" }, [_hoisted_1]),
            _createElementVNode(
              "b",
              null,
        ...
        }, [_createElementVNode("span", { style: "font-size: 1.6em;" }, [_hoisted_2]), _createElementVNode(
          "b",
          null,
          _toDisplayString(__props.media.name),
          1
          /* TEXT */
        )], 10, [
          "href",
