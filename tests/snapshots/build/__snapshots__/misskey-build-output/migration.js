...
export default {
  ...
  setup(__props) {
    ...
    async function move() {
      ...
      await os.apiWithDialog("i/move", { moveToAccount: account });
      unisonReload();
    }
    function add() {
    ...
    async function save() {
      ...
      const i = await os.apiWithDialog("i/update", { alsoKnownAs });
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock("div", { class: "_gaps_m" }, [_createVNode(MkFolder, { defaultOpen: true }, {
        ...
        label: _withCtx(() => [_createTextVNode(
          _toDisplayString(_unref(i18n).ts._accountMigration.moveFrom),
          1
          /* TEXT */
        )]),
        caption: _withCtx(() => [_createTextVNode(
          _toDisplayString(_unref(i18n).ts._accountMigration.moveFromSub),
          1
          /* TEXT */
        )]),
        default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [
          _createVNode(FormInfo, null, {
            default: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts._accountMigration.moveFromDescription),
              1
              /* TEXT */
            )]),
            _: 1
          ...
          _createElementVNode("div", { class: "_gaps" }, [(_openBlock(true), _createElementBlock(
            _Fragment,
            null,
            _renderList(accountAliases.value, (_, i) => {
              return _openBlock(), _createBlock(MkInput, {
                modelValue: accountAliases.value[i],
                "onUpdate:modelValue": ($event) => accountAliases.value[i] = $event
              }, {
        ...
        _: 1
      }, 8, ["defaultOpen"]), _createVNode(MkFolder, { defaultOpen: !!_unref($i).movedTo }, {
        icon: _withCtx(() => [_hoisted_5]),
        label: _withCtx(() => [_createTextVNode(
          _toDisplayString(_unref(i18n).ts._accountMigration.moveTo),
          1
          /* TEXT */
        )]),
        default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [_createVNode(FormInfo, null, {
          default: _withCtx(() => [_createTextVNode(
            _toDisplayString(_unref(i18n).ts._accountMigration.moveAccountDescription),
            1
            /* TEXT */
          )]),
          _: 1
        }), _unref($i) && !_unref($i).movedTo ? (_openBlock(), _createElementBlock(
          _Fragment,
          { key: 0 },
          [
            _createVNode(FormInfo, null, {
              default: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._accountMigration.moveAccountHowTo),
                1
                /* TEXT */
              )]),
              _: 1
            ...
            _createVNode(FormInfo, { warn: "" }, {
              default: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._accountMigration.moveCannotBeUndone),
                1
                /* TEXT */
              )]),
              _: 1
            ...
            _createVNode(MkInput, {
              ...
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => moveToAccount.value = $event)
            }, {
              prefix: _withCtx(() => [_hoisted_6]),
              label: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._accountMigration.moveToLabel),
                1
                /* TEXT */
              )]),
              _: 1
            ...
            _createVNode(MkButton, {
              ...
              default: _withCtx(() => [
                ...
                _createTextVNode(" "),
                _createTextVNode(
                  _toDisplayString(_unref(i18n).ts._accountMigration.startMigration),
                  1
                  /* TEXT */
                )
              ]),
          ...
          64
          /* STABLE_FRAGMENT */
        )) : _unref($i) ? (_openBlock(), _createElementBlock(
          _Fragment,
          { key: 1 },
          [
            _createVNode(FormInfo, null, {
              default: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._accountMigration.postMigrationNote),
                1
                /* TEXT */
              )]),
              _: 1
            ...
            _createVNode(FormInfo, { warn: "" }, {
              default: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._accountMigration.movedAndCannotBeUndone),
                1
                /* TEXT */
              )]),
              _: 1
            ...
            _createElementVNode(
              "div",
              null,
              _toDisplayString(_unref(i18n).ts._accountMigration.movedTo),
              1
              /* TEXT */
            ),
            movedTo.value ? (_openBlock(), _createBlock(MkUserInfo, {
              key: 0,
              user: movedTo.value,
