import { Fragment as _Fragment, openBlock as _openBlock, createElementBlock as _createElementBlock, createElementVNode as _createElementVNode, renderList as _renderList, renderSlot as _renderSlot, normalizeClass as _normalizeClass, normalizeStyle as _normalizeStyle } from "vue";
    ...
    onMounted(() => {
      ...
      const add = () => {
        ...
        const particle = {
          ...
          x,
          y,
          size: .2 + sizeFactor / 10 * 3,
          dur: 1e3 + sizeFactor * 1e3,
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock(
        ...
        [_createElementVNode(
          ...
          _Fragment,
          null,
          _renderList(particles.value, (particle) => {
