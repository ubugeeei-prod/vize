...
export default {
  ...
  setup(__props) {
    ...
    async function ignore(invitation) {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock("div", { class: "_gaps" }, [
        invitations.value.length > 0 ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          class: "_gaps_s"
        }, [(_openBlock(true), _createElementBlock(
          _Fragment,
          null,
          _renderList(invitations.value, (invitation) => {
            return _openBlock(), _createBlock(MkFolder, {
              ...
              suffix: _withCtx(() => [_createVNode(_component_MkTime, { time: invitation.createdAt }, null, 8, ["time"])]),
              footer: _withCtx(() => [_createElementVNode("div", { class: "_buttons" }, [_createVNode(MkButton, {
                primary: "",
                onClick: ($event) => join(invitation)
              }, {
                default: _withCtx(() => [
                  _hoisted_2,
                  _createTextVNode(" "),
                  _createTextVNode(
                    _toDisplayString(_unref(i18n).ts._chat.join),
                    1
                    /* TEXT */
                  )
                ]),
                ...
                danger: "",
                onClick: ($event) => ignore(invitation)
              }, {
                default: _withCtx(() => [
                  _hoisted_3,
                  _createTextVNode(" "),
                  _createTextVNode(
                    _toDisplayString(_unref(i18n).ts._chat.ignore),
                    1
                    /* TEXT */
                  )
                ]),
              ...
              default: _withCtx(() => [_createElementVNode(
                ...
                [_createVNode(_component_MkAvatar, {
                  ...
                  link: ""
                }, null, 10, ["user"]), _createElementVNode("div", {
                  style: "flex: 1;",
                  class: "_gaps_s"
                }, [
                  _createVNode(_component_MkUserName, { user: invitation.room.owner }, null, 8, ["user"]),
                  _hoisted_4,
                  _createElementVNode(
                    "div",
                    null,
                    _toDisplayString(invitation.room.description === "" ? _unref(i18n).ts.noDescription : invitation.room.description),
                    1
                    /* TEXT */
                  )
                ])],
        ...
        !fetching.value && invitations.value.length == 0 ? (_openBlock(), _createBlock(_component_MkResult, {
          key: 0,
          type: "empty",
