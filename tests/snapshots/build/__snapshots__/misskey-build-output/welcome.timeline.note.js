    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock(
        ...
        [_createElementVNode(
          ...
          [
            __props.note.cw != null ? (_openBlock(), _createElementBlock(
              "div",
              {
                key: 0,
              ...
              [
                ...
                showContent.value ? (_openBlock(), _createElementBlock("div", { key: 0 }, [
                  ...
                  __props.note.text ? (_openBlock(), _createBlock(_component_Mfm, {
                    ...
                    text: __props.note.text,
                    author: __props.note.user
                  }, null, 8, ["text", "author"])) : _createCommentVNode("v-if", true),
            ...
            __props.note.files && __props.note.files.length > 0 && (__props.note.cw == null || showContent.value) ? (_openBlock(), _createElementBlock(
              "div",
              {
                key: 0,
                class: _normalizeClass(_ctx.$style.richcontent)
              },
              [_createVNode(MkMediaList, { mediaList: __props.note.files.slice(0, 4) }, null, 8, ["mediaList"])],
              2
              /* CLASS */
            )) : _createCommentVNode("v-if", true),
            __props.note.reactionCount > 0 ? (_openBlock(), _createElementBlock(
              "div",
              {
                key: 0,
