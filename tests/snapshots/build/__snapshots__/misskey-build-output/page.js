...
export default {
  ...
  setup(__props) {
    ...
    const otherPostsPaginator = markRaw(new Paginator("users/pages", {
      limit: 6,
      computedParams: computed(() => page.value ? { userId: page.value.user.id } : undefined)
    }));
    ...
    function like() {
      if (!page.value) return;
      os.apiWithDialog("pages/like", { pageId: page.value.id }).then(() => {
    ...
    async function unlike() {
      ...
      os.apiWithDialog("pages/unlike", { pageId: page.value.id }).then(() => {
    ...
    function pin(pin) {
      if (!page.value) return;
      os.apiWithDialog("i/update", { pinnedPageId: pin ? page.value.id : null });
    }
    ...
    function showMenu(ev) {
      ...
      if ($i && $i.id === page.value.userId) {
        menuItems.push({
          icon: "ti ti-pencil",
          text: i18n.ts.edit,
          action: () => router.push("/pages/edit/:initPageId", { params: { initPageId: page.value.id } })
        });
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_PageWithHeader, {
        ...
        default: _withCtx(() => [_createElementVNode("div", {
          ...
          default: _withCtx(() => [page.value ? (_openBlock(), _createElementBlock("div", {
            key: page.value.id,
            class: "_gaps"
          }, [
            _createElementVNode(
              ...
              [
                _createElementVNode(
                  ...
                  [
                    _createElementVNode(
                      ...
                      [page.value.eyeCatchingImageId ? (_openBlock(), _createBlock(MkImgWithBlurhash, {
                        key: 0,
                    ...
                    page.value.eyeCatchingImageId ? (_openBlock(), _createElementBlock(
                      "div",
                      {
                        key: 0,
                    ...
                    _createElementVNode(
                      ...
                      [_createElementVNode(
                        "h1",
                        null,
                        _toDisplayString(page.value.title || page.value.name),
                        1
                        /* TEXT */
                      ), _createElementVNode(
                        "div",
                        { class: _normalizeClass(_ctx.$style.pageBannerTitleSub) },
                        [page.value.user ? (_openBlock(), _createElementBlock(
                          "div",
                          {
                            key: 0,
                          ...
                          [page.value.userId === _unref($i)?.id ? _withDirectives((_openBlock(), _createBlock(_component_MkA, {
                            key: 0,
                ...
                _createElementVNode(
                  ...
                  [_createVNode(XPage, { page: page.value }, null, 8, ["page"])],
                  2
                  /* CLASS */
                ),
                _createElementVNode(
                  ...
                  [_createElementVNode("div", null, [page.value.isLiked ? _withDirectives((_openBlock(), _createBlock(
                    MkButton,
                    {
                      key: 0,
                      class: "button",
                    ...
                    {
                      default: _withCtx(() => [_hoisted_3, page.value.likedCount > 0 ? (_openBlock(), _createElementBlock(
                        "span",
                        {
                          key: 0,
                          class: "count"
                        },
                        _toDisplayString(page.value.likedCount),
                        1
                        /* TEXT */
                      )) : _createCommentVNode("v-if", true)]),
                      _: 2
                    ...
                    1024
                    /* DYNAMIC_SLOTS */
                  )), [[_directive_tooltip, _unref(i18n).ts._pages.unlike]]) : _withDirectives((_openBlock(), _createBlock(
                    MkButton,
                    {
                      key: 1,
                      class: "button",
                    ...
                    {
                      default: _withCtx(() => [_hoisted_4, page.value.likedCount > 0 ? (_openBlock(), _createElementBlock(
                        "span",
                        {
                          key: 0,
                          class: "count"
                    ...
                    1024
                    /* DYNAMIC_SLOTS */
                  )), [[_directive_tooltip, _unref(i18n).ts._pages.like]])]), _createElementVNode(
                    "div",
                    ...
                    [
                      ...
                      _unref($i) ? _withDirectives((_openBlock(), _createElementBlock(
                        ...
                        2
                        /* CLASS */
                      )), [[_directive_click_anime]]) : _createCommentVNode("v-if", true)
                    ],
                    2
                    /* CLASS */
                  )],
                ...
                _createElementVNode(
                  ...
                  [_createVNode(_component_MkAvatar, {
                    ...
                    link: "",
                    preview: ""
                  }, null, 10, ["user"]), _createVNode(_component_MkA, { to: `/@${__props.username}` }, {
                    default: _withCtx(() => [_createVNode(_component_MkUserName, {
                      user: page.value.user,
                ...
                _createElementVNode(
                  ...
                  ]), page.value.createdAt != page.value.updatedAt ? (_openBlock(), _createElementBlock("div", { key: 0 }, [
                    _hoisted_10,
                    _createTextVNode(
            ...
            key: 1,
            onRetry: _cache[2] || (_cache[2] = ($event) => fetchPage())
