    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_PageWithHeader, {
        ...
        default: _withCtx(() => [_createElementVNode("div", {
          ...
          _: 1
        }), scopesWithDomain.value ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          class: "_gaps_m"
        }, [(_openBlock(true), _createElementBlock(
          _Fragment,
          null,
          _renderList(scopesWithDomain.value, (domain) => {
            return _openBlock(), _createBlock(
              FormSection,
              { key: domain.domain ?? "system" },
              {
