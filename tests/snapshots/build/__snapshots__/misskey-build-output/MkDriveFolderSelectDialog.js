  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createBlock(MkModalWindow, {
        ...
        header: _withCtx(() => [
          _createTextVNode(
            _toDisplayString(__props.multiple ? _unref(i18n).ts.selectFolders : _unref(i18n).ts.selectFolder),
            1
            /* TEXT */
          ),
          _createTextVNode(" "),
          __props.multiple && selected.value.length > 0 ? (_openBlock(), _createElementBlock(
            "span",
            {
              key: 0,
