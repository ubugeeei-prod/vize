    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createBlock(MkModalWindow, {
        ...
        header: _withCtx(() => [_createTextVNode(
          _toDisplayString(_unref(i18n).ts.authentication),
          1
          /* TEXT */
        )]),
        default: _withCtx(() => [_createElementVNode("div", {
        ...
        }, [_createElementVNode("div", { style: "padding: 0 0 16px 0; text-align: center;" }, [_hoisted_1, _createElementVNode(
          "div",
          _hoisted_2,
          _toDisplayString(_unref(i18n).ts.authenticationRequiredToContinue),
          1
          /* TEXT */
        )]), _createElementVNode(
          "form",
          ...
          [_createElementVNode("div", { class: "_gaps" }, [
            ...
            _unref($i).twoFactorEnabled ? (_openBlock(), _createBlock(MkInput, {
              key: 0,
              type: "text",
              ...
              caption: _withCtx(() => [_createElementVNode(
                "button",
                {
                  class: "_textButton",
                  type: "button",
                  onClick: _cache[3] || (_cache[3] = ($event) => isBackupCode.value = !isBackupCode.value)
                },
