...
export default {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock("div", { class: "lcfyofjk" }, [_createElementVNode("svg", { viewBox: `0 0 ${viewBoxX.value} ${viewBoxY.value}` }, [
        _createElementVNode("defs", null, [_createElementVNode("linearGradient", {
          ...
          y1: "1",
          y2: "0"
        }, [_hoisted_1, _hoisted_2], 8, ["id"]), _createElementVNode("mask", {
          id: _unref(cpuMaskId),
          x: "0",
          y: "0",
        ...
        _createElementVNode("rect", {
          ...
          style: _normalizeStyle({
            stroke: "none",
            fill: `url(#${_unref(cpuGradientId)})`,
            mask: `url(#${_unref(cpuMaskId)})`
          })
        }, null, 12, ["width", "height"]),
        _createElementVNode("text", {
          x: "1",
          y: "5"
        }, [_createTextVNode("CPU "), _createElementVNode(
          "tspan",
          null,
          _toDisplayString(cpuP.value) + "%",
          1
          /* TEXT */
        )])
      ], 8, ["viewBox"]), _createElementVNode("svg", { viewBox: `0 0 ${viewBoxX.value} ${viewBoxY.value}` }, [
        _createElementVNode("defs", null, [_createElementVNode("linearGradient", {
          ...
          y1: "1",
          y2: "0"
        }, [_hoisted_3, _hoisted_4], 8, ["id"]), _createElementVNode("mask", {
          id: _unref(memMaskId),
          x: "0",
          y: "0",
          width: viewBoxX.value,
        ...
        _createElementVNode("rect", {
          ...
          style: _normalizeStyle({
            stroke: "none",
            fill: `url(#${_unref(memGradientId)})`,
            mask: `url(#${_unref(memMaskId)})`
          })
        }, null, 12, ["width", "height"]),
        _createElementVNode("text", {
          x: "1",
          y: "5"
        }, [_createTextVNode("MEM "), _createElementVNode(
          "tspan",
          null,
          _toDisplayString(memP.value) + "%",
          1
          /* TEXT */
        )])
      ], 8, ["viewBox"])]);
