  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_PageWithHeader, {
        ...
        default: _withCtx(() => [tab.value === "overview" ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          class: "_spacer",
          style: "--MI_SPACER-w: 600px; --MI_SPACER-min: 20px;"
        }, [_createVNode(XOverview)])) : tab.value === "emojis" ? (_openBlock(), _createElementBlock("div", {
          key: 1,
          class: "_spacer",
          style: "--MI_SPACER-w: 1000px; --MI_SPACER-min: 20px;"
        }, [_createVNode(XEmojis)])) : _unref(instance).federation !== "none" && tab.value === "federation" ? (_openBlock(), _createElementBlock("div", {
          key: 2,
          class: "_spacer",
          style: "--MI_SPACER-w: 1000px; --MI_SPACER-min: 20px;"
        }, [_createVNode(XFederation)])) : tab.value === "charts" ? (_openBlock(), _createElementBlock("div", {
          key: 3,
          class: "_spacer",
          style: "--MI_SPACER-w: 1000px; --MI_SPACER-min: 20px;"
        }, [_createVNode(MkInstanceStats)])) : _createCommentVNode("v-if", true)]),
        _: 2
      }, 1032, [
        "actions",
        "tabs",
