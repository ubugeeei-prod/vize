    ...
    return (_ctx, _cache) => {
      ...
      return _withDirectives((_openBlock(), _createElementBlock(
        ...
        [isThumbnailAvailable.value && _unref(prefer).s.enableHighQualityImagePlaceholders ? (_openBlock(), _createBlock(MkImgWithBlurhash, {
          ...
          "alt",
          "title"
        ])) : is.value === "image" ? (_openBlock(), _createElementBlock(
          "i",
          {
            key: 2,
          ...
          2
          /* CLASS */
        )) : is.value === "video" ? (_openBlock(), _createElementBlock(
          "i",
          {
            key: 3,
          ...
          2
          /* CLASS */
        )) : is.value === "audio" || is.value === "midi" ? (_openBlock(), _createElementBlock(
          "i",
          {
            key: 4,
          ...
          2
          /* CLASS */
        )) : is.value === "csv" ? (_openBlock(), _createElementBlock(
          "i",
          {
            key: 5,
          ...
          2
          /* CLASS */
        )) : is.value === "pdf" ? (_openBlock(), _createElementBlock(
          "i",
          {
            key: 6,
            class: _normalizeClass(["ti ti-file-text", _ctx.$style.icon])
          ...
          2
          /* CLASS */
        )) : is.value === "textfile" ? (_openBlock(), _createElementBlock(
          "i",
          {
            key: 7,
            class: _normalizeClass(["ti ti-file-text", _ctx.$style.icon])
          ...
          2
          /* CLASS */
        )) : is.value === "archive" ? (_openBlock(), _createElementBlock(
          "i",
          {
            key: 8,
          ...
          2
          /* CLASS */
        )), isThumbnailAvailable.value && is.value === "video" ? (_openBlock(), _createElementBlock(
          "i",
          {
            key: 0,
