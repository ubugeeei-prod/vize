  ...
  setup(__props) {
    const { model: state, def: stateDef } = useMkSelect({
      items: [
        ...
        {
          label: i18n.ts.unresolved,
          value: "unresolved"
        },
        {
          label: i18n.ts.resolved,
          value: "resolved"
        }
      ],
      initialValue: "unresolved"
    });
    const { model: reporterOrigin, def: reporterOriginDef } = useMkSelect({
      items: [
        {
          label: i18n.ts.all,
          value: "combined"
    ...
    const { model: targetUserOrigin, def: targetUserOriginDef } = useMkSelect({
      items: [
        {
          label: i18n.ts.all,
          value: "combined"
        ...
        default: _withCtx(() => [_createElementVNode("div", {
          ...
          [
            ...
            _createVNode(_component_MkTip, { k: "abuses" }, {
              default: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._abuseUserReport.resolveTutorial),
                1
                /* TEXT */
              )]),
              _: 1
            ...
            _createElementVNode(
              ...
              [
                ...
                _createVNode(MkSelect, {
                  ...
                  "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => targetUserOrigin.value = $event)
                }, {
                  label: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.reporteeOrigin),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                _createVNode(MkSelect, {
                  ...
                  "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => reporterOrigin.value = $event)
                }, {
                  label: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.reporterOrigin),
                    1
                    /* TEXT */
                  )]),
                  _: 1
