...
export default {
  ...
  setup(__props) {
    ...
    async function setType() {
      ...
      if (src == null) return;
      updateColumn(props.column.id, { tl: src ?? undefined });
    }
    const menu = computed(() => {
      const menuItems = [];
      menuItems.push({
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createBlock(XColumn, {
        ...
        header: _withCtx(() => [__props.column.tl != null ? (_openBlock(), _createElementBlock(
          "i",
          {
            key: 0,
          ...
          "span",
          _hoisted_1,
          _toDisplayString(__props.column.name || (__props.column.tl ? _unref(i18n).ts._timelines[__props.column.tl] : null) || _unref(i18n).ts._deck._columns.tl),
          1
          /* TEXT */
        )]),
        default: _withCtx(() => [!_unref(isAvailableBasicTimeline)(__props.column.tl) ? (_openBlock(), _createElementBlock(
          "div",
          {
            key: 0,
          ...
          2
          /* CLASS */
        )) : __props.column.tl ? (_openBlock(), _createBlock(MkStreamingNotesTimeline, {
