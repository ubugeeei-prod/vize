...
export default {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock("div", { class: "_selectable" }, [
        _createElementVNode(
          "div",
          {
        ...
        _createElementVNode(
          "div",
          {
            class: _normalizeClass({
              ...
              [_ctx.$style.focused]: focused.value,
              [_ctx.$style.tall]: __props.tall,
              [_ctx.$style.pre]: __props.pre
            }),
        ...
        __props.mfmPreview ? (_openBlock(), _createElementBlock(
          "button",
          {
            key: 0,
            ...
            class: "_textButton",
            type: "button",
            onClick: _cache[4] || (_cache[4] = ($event) => preview.value = !preview.value)
          },
          _toDisplayString(_unref(i18n).ts.preview),
          1
          /* TEXT */
        )) : _createCommentVNode("v-if", true),
        __props.mfmPreview ? _withDirectives((_openBlock(), _createElementBlock(
          "div",
          {
            key: 0,
            class: _normalizeClass(_ctx.$style.mfmPreview)
          },
          [_createVNode(_component_Mfm, { text: v.value }, null, 8, ["text"])],
          2
          /* CLASS */
        )), [[_directive_panel], [_vShow, preview.value]]) : _createCommentVNode("v-if", true),
