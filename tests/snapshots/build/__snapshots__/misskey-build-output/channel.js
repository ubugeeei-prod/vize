...
export default {
  ...
  setup(__props) {
    ...
    const featuredPaginator = markRaw(new Paginator("notes/featured", {
      limit: 10,
      computedParams: computed(() => ({ channelId: props.channelId }))
    }));
    useInterval(() => {
    ...
    watch(() => props.channelId, async () => {
      ...
      if ((favorited.value || _channel.isFollowing) && _channel.lastNotedAt) {
        const lastReadedAt = miLocalStorage.getItemAsJson(`channelLastReadedAt:${_channel.id}`) ?? 0;
    ...
    function openPostForm() {
      os.post({ channel: channel.value });
    }
    function favorite() {
      if (!channel.value) return;
      os.apiWithDialog("channels/favorite", { channelId: channel.value.id }).then(() => {
    ...
    async function unfavorite() {
      ...
      os.apiWithDialog("channels/unfavorite", { channelId: channel.value.id }).then(() => {
    ...
    async function mute() {
      ...
      if (canceled) return;
      const expiresAt = period === "indefinitely" ? null : period === "tenMinutes" ? Date.now() + 1e3 * 60 * 10 : period === "oneHour" ? Date.now() + 1e3 * 60 * 60 : period === "oneDay" ? Date.now() + 1e3 * 60 * 60 * 24 : period === "oneWeek" ? Date.now() + 1e3 * 60 * 60 * 24 * 7 : null;
      ...
      return _openBlock(), _createBlock(_component_PageWithHeader, {
        ...
        footer: _withCtx(() => [_createElementVNode(
          ...
          [_createElementVNode("div", {
            ...
            primary: "",
            gradate: "",
            onClick: _cache[1] || (_cache[1] = ($event) => openPostForm())
          }, {
            default: _withCtx(() => [
              _hoisted_9,
              _createTextVNode(" "),
              _createTextVNode(
                _toDisplayString(_unref(i18n).ts.postToTheChannel),
                1
                /* TEXT */
              )
            ]),
        ...
        default: _withCtx(() => [_createElementVNode("div", {
        ...
        }, [channel.value && tab.value === "overview" ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          class: "_gaps"
        }, [_createElementVNode(
          "div",
          ...
          [
            ...
            }, null, 10, ["channel", "full"]),
            favorited.value ? _withDirectives((_openBlock(), _createBlock(
              MkButton,
              {
                key: 0,
                asLike: "",
                ...
                onClick: _cache[2] || (_cache[2] = ($event) => unfavorite())
              },
              {
              ...
              MkButton,
              {
                ...
                rounded: "",
                class: _normalizeClass(["button", _ctx.$style.favorite]),
                onClick: _cache[3] || (_cache[3] = ($event) => favorite())
              },
              {
            ...
            _createElementVNode(
              ...
              [
                _createElementVNode(
                  ...
                  [
                    _createElementVNode("div", null, [_hoisted_3, _createVNode(_component_I18n, {
                      ...
                      n: _withCtx(() => [_createElementVNode(
                        "b",
                        null,
                        _toDisplayString(channel.value.usersCount),
                        1
                        /* TEXT */
                      )]),
                      _: 1
                    }, 8, ["src"])]),
                    _createElementVNode("div", null, [_hoisted_4, _createVNode(_component_I18n, {
                      ...
                      n: _withCtx(() => [_createElementVNode(
                        "b",
                        null,
                        _toDisplayString(channel.value.notesCount),
                        1
                        /* TEXT */
                      )]),
                      _: 1
                    }, 8, ["src"])]),
                    _unref($i) != null && channel.value != null && _unref($i).id === channel.value.userId ? (_openBlock(), _createElementBlock("div", {
                      key: 0,
                      style: "color: var(--MI_THEME-warn)"
                    }, [_hoisted_5, _createElementVNode(
                      "span",
                      _hoisted_6,
                      _toDisplayString(_unref(i18n).ts.youAreAdmin),
                      1
                      /* TEXT */
                ...
                channel.value.isSensitive ? (_openBlock(), _createElementBlock(
                  "div",
                  {
                    key: 0,
            ...
            channel.value.description ? (_openBlock(), _createElementBlock(
              "div",
              {
                key: 0,
          ...
          null,
          {
            header: _withCtx(() => [_hoisted_7, _createTextVNode(
              _toDisplayString(_unref(i18n).ts.pinnedNotes),
              1
              /* TEXT */
            )]),
            default: _withCtx(() => [channel.value.pinnedNotes && channel.value.pinnedNotes.length > 0 ? (_openBlock(), _createElementBlock("div", {
              key: 0,
              class: "_gaps"
            }, [(_openBlock(true), _createElementBlock(
              _Fragment,
              null,
              _renderList(channel.value.pinnedNotes, (note) => {
          ...
          1024
          /* DYNAMIC_SLOTS */
        )])) : _createCommentVNode("v-if", true), channel.value && tab.value === "timeline" ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          class: "_gaps"
        }, [
          channel.value.isArchived ? (_openBlock(), _createBlock(MkInfo, {
            key: 0,
            warn: ""
          }, {
            default: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts.thisChannelArchived),
              1
              /* TEXT */
            )]),
            _: 1
          })) : _createCommentVNode("v-if", true),
          _unref($i) && _unref(prefer).r.showFixedPostFormInChannel.value ? (_openBlock(), _createBlock(MkPostForm, {
            key: 0,
            channel: channel.value,
            class: "post-form _panel",
            fixed: "",
            autofocus: _unref(deviceKind) === "desktop"
          }, null, 8, ["channel", "autofocus"])) : _createCommentVNode("v-if", true),
          _createVNode(MkStreamingNotesTimeline, {
            key: __props.channelId,
            src: "channel",
            channel: __props.channelId
          }, null, 8, ["channel"])
        ])) : tab.value === "featured" ? (_openBlock(), _createElementBlock("div", { key: 1 }, [_createVNode(MkNotesTimeline, { paginator: _unref(featuredPaginator) }, null, 8, ["paginator"])])) : tab.value === "search" ? (_openBlock(), _createElementBlock("div", { key: 2 }, [_unref(notesSearchAvailable) ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          class: "_gaps"
        }, [_createElementVNode("div", null, [_createVNode(MkInput, {
          onEnter: _cache[4] || (_cache[4] = ($event) => search()),
          ...
          onClick: _cache[6] || (_cache[6] = ($event) => search())
        }, {
          default: _withCtx(() => [_createTextVNode(
          ...
          _: 1
        })]), searchPaginator.value ? (_openBlock(), _createBlock(MkNotesTimeline, {
          key: searchKey.value,
          paginator: searchPaginator.value
        }, null, 8, ["paginator"])) : _createCommentVNode("v-if", true)])) : (_openBlock(), _createElementBlock("div", { key: 1 }, [_createVNode(MkInfo, { warn: "" }, {
          default: _withCtx(() => [_createTextVNode(
            _toDisplayString(_unref(i18n).ts.notesSearchNotAvailable),
            1
            /* TEXT */
          )]),
          _: 1
