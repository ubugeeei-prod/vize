        ...
        default: _withCtx(() => [_createElementVNode("div", {
          ...
          _createVNode(MkFolder, { defaultOpen: true }, {
            label: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts.backgroundColor),
              1
              /* TEXT */
            )]),
            default: _withCtx(() => [_createElementVNode("div", { class: "cwepdizn-colors" }, [_createElementVNode("div", { class: "row" }, [(_openBlock(true), _createElementBlock(
              _Fragment,
              null,
              _renderList(_unref(bgColors).filter((x) => x.kind === "light"), (color) => {
                return _openBlock(), _createElementBlock("button", {
                  class: _normalizeClass(["color _button", { active: theme.value.props.bg === color.color }]),
                  onClick: ($event) => setBgColor(color)
                }, [_createElementVNode(
                  "div",
                  {
                    class: "preview",
              ...
              256
              /* UNKEYED_FRAGMENT */
            ))]), _createElementVNode("div", { class: "row" }, [(_openBlock(true), _createElementBlock(
              _Fragment,
              null,
              _renderList(_unref(bgColors).filter((x) => x.kind === "dark"), (color) => {
                return _openBlock(), _createElementBlock("button", {
                  class: _normalizeClass(["color _button", { active: theme.value.props.bg === color.color }]),
                  onClick: ($event) => setBgColor(color)
                }, [_createElementVNode(
          ...
          _createVNode(MkFolder, { defaultOpen: true }, {
            label: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts.accentColor),
              1
              /* TEXT */
            )]),
            default: _withCtx(() => [_createElementVNode("div", { class: "cwepdizn-colors" }, [_createElementVNode("div", { class: "row" }, [(_openBlock(true), _createElementBlock(
              _Fragment,
              null,
              _renderList(accentColors, (color) => {
                return _openBlock(), _createElementBlock("button", {
                  class: _normalizeClass(["color rounded _button", { active: theme.value.props.accent === color }]),
                  onClick: ($event) => setAccentColor(color)
                }, [_createElementVNode(
                  "div",
                  {
                    class: "preview",
          ...
          _createVNode(MkFolder, { defaultOpen: true }, {
            label: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts.textColor),
              1
              /* TEXT */
            )]),
            default: _withCtx(() => [_createElementVNode("div", { class: "cwepdizn-colors" }, [_createElementVNode("div", { class: "row" }, [(_openBlock(true), _createElementBlock(
              _Fragment,
              null,
              _renderList(fgColors, (color) => {
                return _openBlock(), _createElementBlock("button", {
                  class: _normalizeClass(["color char _button", { active: theme.value.props.fg === color.forLight || theme.value.props.fg === color.forDark }]),
                  onClick: ($event) => setFgColor(color)
                }, [_createElementVNode(
                  "div",
                  {
                    class: "preview",
          ...
          _createVNode(MkFolder, { defaultOpen: false }, {
            ...
            label: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts.editCode),
              1
              /* TEXT */
            )]),
            default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [_createVNode(MkCodeEditor, {
              lang: "json5",
              modelValue: themeCode.value,
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => themeCode.value = $event)
            }, {
              label: _withCtx(() => [_createTextVNode(
              ...
              default: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts.apply),
                1
                /* TEXT */
              )]),
              _: 1
          ...
          _createVNode(MkFolder, { defaultOpen: false }, {
            label: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts.addDescription),
              1
              /* TEXT */
            )]),
            default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [_createVNode(MkTextarea, {
              modelValue: description.value,
              "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => description.value = $event)
            }, {
              label: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._theme.description),
                1
                /* TEXT */
              )]),
              _: 1
