...
export default {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const roles = ref([]);
    const selectedRoleIds = ref(initialRoleIds.value ?? []);
    ...
    async function addRole() {
      const items = roles.value.filter((r) => r.isPublic).filter((r) => !selectedRoleIds.value.includes(r.id)).map((r) => ({
        label: r.name,
        value: r.id
      }));
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createBlock(MkModalWindow, {
        ...
        default: _withCtx(() => [_createElementVNode("div", {
        ...
        }, [fetching.value ? (_openBlock(), _createBlock(MkLoading, { key: 0 })) : (_openBlock(), _createElementBlock(
          "div",
          {
            key: 1,
          ...
          [
            ...
            selectedRoles.value.length > 0 ? (_openBlock(), _createElementBlock(
              "div",
              {
                key: 0,
              ...
              [(_openBlock(true), _createElementBlock(
                _Fragment,
                null,
                _renderList(selectedRoles.value, (role) => {
            ...
            _unref(infoMessage) ? (_openBlock(), _createBlock(MkInfo, { key: 0 }, {
              default: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(infoMessage)),
                1
                /* TEXT */
              )]),
              _: 1
