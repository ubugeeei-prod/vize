...
export default {
  ...
  setup(__props) {
    const props = __props;
    const hide = ref(true);
    const url = computed(() => props.raw || prefer.s.loadRawImages ? props.image.url : prefer.s.disableShowingAnimatedImages ? getStaticImageUrl(props.image.url) : props.image.thumbnailUrl);
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock(
        ...
        [_createVNode(
          _resolveDynamicComponent(__props.disableImageLink ? "div" : "a"),
          _mergeProps(__props.disableImageLink ? {
          ...
          {
            default: _withCtx(() => [_unref(prefer).s.enableHighQualityImagePlaceholders ? (_openBlock(), _createBlock(MkImgWithBlurhash, {
              key: 0,
              ...
              "width",
              "height"
            ])) : _unref(prefer).s.dataSaver.media || hide.value ? (_openBlock(), _createElementBlock("div", {
              key: 1,
              title: __props.image.comment || __props.image.name,
              style: _normalizeStyle(hide.value ? "background: #888;" : null),
              class: _normalizeClass(_ctx.$style.image)
            }, null, 14, ["title"])) : (_openBlock(), _createElementBlock("img", {
              key: 2,
              src: url.value,
              alt: __props.image.comment || __props.image.name,
              title: __props.image.comment || __props.image.name,
          ...
          [_createElementVNode(
            ...
            [__props.image.isSensitive ? (_openBlock(), _createElementBlock("b", {
              ...
              " " + _toDisplayString(_unref(i18n).ts.sensitive) + _toDisplayString(_unref(prefer).s.dataSaver.media ? ` (${_unref(i18n).ts.image}${__props.image.size ? " " + bytes(__props.image.size) : ""})` : ""),
              1
              /* TEXT */
              ...
              " " + _toDisplayString(_unref(prefer).s.dataSaver.media && __props.image.size ? bytes(__props.image.size) : _unref(i18n).ts.image),
              1
              /* TEXT */
            )])), __props.controls ? (_openBlock(), _createElementBlock(
              "span",
              {
                key: 0,
                style: "display: block;"
          ...
          [
            _createElementVNode(
              ...
              [
                ["image/gif", "image/apng"].includes(__props.image.type) ? (_openBlock(), _createElementBlock(
                  "div",
                  {
                    key: 0,
                ...
                __props.image.comment ? (_openBlock(), _createElementBlock(
                  "div",
                  {
                    key: 0,
                    class: _normalizeClass(_ctx.$style.indicator)
                ...
                __props.image.isSensitive ? (_openBlock(), _createElementBlock("div", {
                  key: 0,
                  class: _normalizeClass(_ctx.$style.indicator),
                  style: "color: var(--MI_THEME-warn);",
                  title: _unref(i18n).ts.sensitive
                }, [_hoisted_3], 10, ["title"])) : _createCommentVNode("v-if", true)
              ],
              2
              /* CLASS */
            ),
            ...
            _createElementVNode(
              "i",
              {
                ...
                onClick: _cache[0] || (_cache[0] = _withModifiers(($event) => hide.value = true, ["stop"]))
              },
              null,
              2
              /* CLASS */
