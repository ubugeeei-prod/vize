    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createBlock(XContainer, {
        ...
        header: _withCtx(() => [
          ...
          _createTextVNode(" "),
          _createTextVNode(
            _toDisplayString(_unref(i18n).ts._pages.blocks.note),
            1
            /* TEXT */
          )
        ]),
        default: _withCtx(() => [_createElementVNode("section", {
          style: "padding: 16px;",
          class: "_gaps_s"
        }, [
          _createVNode(MkInput, {
            modelValue: id.value,
            "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => id.value = $event)
          }, {
            label: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts._pages.blocks._note.id),
              1
              /* TEXT */
            )]),
            caption: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts._pages.blocks._note.idDescription),
              1
              /* TEXT */
            )]),
            _: 1
          ...
          _createVNode(MkSwitch, {
            ...
            "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => props.modelValue.detailed = $event)
          }, {
            default: _withCtx(() => [_createElementVNode(
              "span",
              null,
              _toDisplayString(_unref(i18n).ts._pages.blocks._note.detailed),
              1
              /* TEXT */
            )]),
            _: 1
          }, 8, ["modelValue"]),
          note.value && !props.modelValue.detailed ? (_openBlock(), _createBlock(MkNote, {
            key: note.value.id + ":normal",
            style: "margin-bottom: 16px;",
            note: note.value,
            "onUpdate:note": _cache[3] || (_cache[3] = ($event) => note.value = $event)
          }, null, 8, ["note"])) : _createCommentVNode("v-if", true),
          note.value && props.modelValue.detailed ? (_openBlock(), _createBlock(MkNoteDetailed, {
            key: note.value.id + ":detail",
            style: "margin-bottom: 16px;",
            note: note.value,
            "onUpdate:note": _cache[4] || (_cache[4] = ($event) => note.value = $event)
          }, null, 8, ["note"])) : _createCommentVNode("v-if", true)
        ])]),
        _: 1
      }, 8, ["draggable"]);
