...
export default {
  ...
  setup(__props) {
      ...
      "up": {
        ...
        callback: () => {
          if (hasFocus() && videoEl.value) {
            volume.value = Math.min(volume.value + .1, 1);
          }
        }
      },
      "down": {
        ...
        callback: () => {
          if (hasFocus() && videoEl.value) {
            volume.value = Math.max(volume.value - .1, 0);
          }
        }
      },
      "left": {
    ...
    async function toggleSensitive(file) {
    ...
    const rangePercent = computed({
      ...
      set: (to) => {
        ...
        videoEl.value.currentTime = to * durationMs.value / 1e3;
      }
    });
    const volume = ref(.25);
    const speed = ref(1);
    const loop = ref(false);
    // TODO: ドライブファイルのフラグに置き換える
    ...
    function toggleFullscreen() {
      ...
      if (isFullscreen.value) {
        exitFullscreen({ videoEl: videoEl.value });
    ...
    let onceInit = false;
    let mediaTickFrameId = null;
    let stopVideoElWatch;
    function init() {
      if (onceInit) return;
      onceInit = true;
        ...
        if (videoEl.value) {
          ...
          function updateMediaTick() {
            if (videoEl.value) {
              ...
              elapsedTimeMs.value = videoEl.value.currentTime * 1e3;
          ...
          durationMs.value = videoEl.value.duration * 1e3;
    ...
    return (_ctx, _cache) => {
      ...
      return _withDirectives((_openBlock(), _createElementBlock("div", {
      ...
      }, [hide.value ? (_openBlock(), _createElementBlock(
        "button",
        {
          key: 0,
        ...
        [_createElementVNode(
          ...
          [__props.video.isSensitive ? (_openBlock(), _createElementBlock("b", {
            ...
            " " + _toDisplayString(_unref(i18n).ts.sensitive) + _toDisplayString(_unref(prefer).s.dataSaver.media ? ` (${_unref(i18n).ts.video}${__props.video.size ? " " + bytes(__props.video.size) : ""})` : ""),
            1
            /* TEXT */
            ...
            " " + _toDisplayString(_unref(prefer).s.dataSaver.media && __props.video.size ? bytes(__props.video.size) : _unref(i18n).ts.video),
            1
            /* TEXT */
          )])), _createElementVNode(
            "span",
        ...
        2
        /* CLASS */
      )) : _unref(prefer).s.useNativeUiForVideoAudioPlayer ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 1,
        ...
        [
          ...
          }, [_createElementVNode("source", { src: __props.video.url }, null, 8, ["src"])], 42, [
            "poster",
            "title",
            "alt",
            "onKeydown"
          ...
          _createElementVNode(
            "i",
            {
              ...
              onClick: _cache[0] || (_cache[0] = ($event) => hide.value = true)
            },
            null,
            2
            /* CLASS */
          ...
          _createElementVNode(
            ...
            [__props.video.comment ? (_openBlock(), _createElementBlock(
              "div",
              {
                key: 0,
              ...
              2
              /* CLASS */
            )) : _createCommentVNode("v-if", true), __props.video.isSensitive ? (_openBlock(), _createElementBlock("div", {
              key: 0,
              class: _normalizeClass(_ctx.$style.indicator),
              style: "color: var(--MI_THEME-warn);",
              title: _unref(i18n).ts.sensitive
            }, [_hoisted_4], 10, ["title"])) : _createCommentVNode("v-if", true)],
            2
            /* CLASS */
          )
        ],
        ...
        [
          ...
          isReady.value && !isPlaying.value ? (_openBlock(), _createElementBlock(
            "button",
            {
              key: 0,
            ...
            2
            /* CLASS */
          )) : !isActuallyPlaying.value ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 1,
          ...
          _createElementVNode(
            ...
            {
              class: _normalizeClass(["ti ti-eye-off", _ctx.$style.hide]),
              onClick: _cache[1] || (_cache[1] = ($event) => hide.value = true)
            },
            null,
            2
            /* CLASS */
          ...
          _createElementVNode(
            ...
            [__props.video.comment ? (_openBlock(), _createElementBlock(
              ...
              style: "color: var(--MI_THEME-warn);",
              title: _unref(i18n).ts.sensitive
            }, [_hoisted_6], 10, ["title"])) : _createCommentVNode("v-if", true)],
            2
            /* CLASS */
          ),
          _createElementVNode(
            ...
            [
              ...
              _createElementVNode(
                ...
                _toDisplayString(_unref(hms)(elapsedTimeMs.value)),
                3
                /* TEXT, CLASS */
              ),
              _createElementVNode(
                ...
                }, null, 10, ["sliderBgWhite", "modelValue"])],
                2
                /* CLASS */
              ),
              _createVNode(MkMediaRange, {
                ...
                "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => rangePercent.value = $event)
              }, null, 10, [
                "sliderBgWhite",
                "buffer",
                "modelValue"
        ...
        2
        /* CLASS */
      ))], 42, ["onContextmenu", "onKeydown"])), [[_directive_hotkey, _unref(keymap)]]);
    };
  }
};
