...
export default {
  ...
  setup(__props) {
    ...
    function onChangeReceiveAnnouncementEmail(v) {
      misskeyApi("i/update", { receiveAnnouncementEmail: v });
    }
    ...
    const saveNotificationSettings = () => {
      misskeyApi("i/update", { emailNotificationTypes: [
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_SearchMarker, {
        ...
        default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [!_unref(instance).enableEmail ? (_openBlock(), _createBlock(MkInfo, { key: 0 }, {
          default: _withCtx(() => [_createTextVNode(
            _toDisplayString(_unref(i18n).ts.emailNotSupported),
            1
            /* TEXT */
          )]),
          _: 1
        })) : _createCommentVNode("v-if", true), _createVNode(MkDisableSection, { disabled: !_unref(instance).enableEmail }, {
          default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [
            _createVNode(_component_SearchMarker, { keywords: ["email", "address"] }, {
              default: _withCtx(() => [_createVNode(FormSection, { first: "" }, {
                ...
                default: _withCtx(() => [_createVNode(MkInput, {
                  ...
                  "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => emailAddress.value = $event)
                }, _createSlots({ _: 2 }, [{
                  name: "prefix",
            ...
            _createVNode(FormSection, null, {
              default: _withCtx(() => [_createVNode(_component_SearchMarker, { keywords: ["announcement", "email"] }, {
                default: _withCtx(() => [_createVNode(MkSwitch, {
                  ...
                  label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                    default: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts.receiveAnnouncementFromInstance),
                      1
                      /* TEXT */
                    )]),
                    _: 1
            ...
            _createVNode(_component_SearchMarker, { keywords: ["notification", "email"] }, {
              default: _withCtx(() => [_createVNode(FormSection, null, {
                label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.emailNotification),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_s" }, [
                  _createVNode(MkSwitch, {
                    ...
                    "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => emailNotification_mention.value = $event)
                  }, {
                    default: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts._notification._types.mention),
                      1
                      /* TEXT */
                    )]),
                    _: 1
                  ...
                  _createVNode(MkSwitch, {
                    ...
                    "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => emailNotification_reply.value = $event)
                  }, {
                    default: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts._notification._types.reply),
                      1
                      /* TEXT */
                    )]),
                    _: 1
                  ...
                  _createVNode(MkSwitch, {
                    ...
                    "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => emailNotification_quote.value = $event)
                  }, {
                    default: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts._notification._types.quote),
                      1
                      /* TEXT */
                    )]),
                    _: 1
                  ...
                  _createVNode(MkSwitch, {
                    ...
                    "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => emailNotification_follow.value = $event)
                  }, {
                    default: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts._notification._types.follow),
                      1
                      /* TEXT */
                    )]),
                    _: 1
                  ...
                  _createVNode(MkSwitch, {
                    ...
                    "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => emailNotification_receiveFollowRequest.value = $event)
                  }, {
                    default: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts._notification._types.receiveFollowRequest),
                      1
                      /* TEXT */
                    )]),
                    _: 1
