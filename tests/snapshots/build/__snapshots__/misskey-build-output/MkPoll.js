...
export default {
  ...
  setup(__props) {
    ...
    const remaining = computed(() => {
      ...
      return Math.floor(Math.max(expiresAtTime.value - now.value, 0) / 1e3);
    });
    ...
    const timer = computed(() => i18n.tsx._poll[remaining.value >= 86400 ? "remainingDays" : remaining.value >= 3600 ? "remainingHours" : remaining.value >= 60 ? "remainingMinutes" : "remainingSeconds"]({
      ...
      return _openBlock(), _createElementBlock(
        ...
        [_createElementVNode(
          ...
          [(_openBlock(true), _createElementBlock(
            _Fragment,
            null,
            _renderList(__props.choices, (choice, i) => {
              return _openBlock(), _createElementBlock("li", {
                key: i,
                class: _normalizeClass(_ctx.$style.choice),
                onClick: ($event) => vote(i)
              }, [_createElementVNode(
                "div",
                {
                ...
                [
                  choice.isVoted ? (_openBlock(), _createElementBlock(
                    _Fragment,
                    { key: 0 },
                    [_hoisted_1],
                    64
                  ...
                  showResult.value ? (_openBlock(), _createElementBlock(
                    "span",
                    {
                      key: 0,
                      style: "margin-left: 4px; opacity: 0.7;"
                    },
                    "(" + _toDisplayString(_unref(i18n).tsx._poll.votesCount({ n: choice.votes })) + ")",
                    1
                    /* TEXT */
                  )) : _createCommentVNode("v-if", true)
                ],
          ...
          2
          /* CLASS */
        ), !__props.readOnly ? (_openBlock(), _createElementBlock(
          "p",
          {
            key: 0,
          ...
          [
            _createElementVNode(
              "span",
              null,
              _toDisplayString(_unref(i18n).tsx._poll.totalVotes({ n: total.value })),
              1
              /* TEXT */
            ),
            _hoisted_2,
            !closed.value && !isVoted.value ? (_openBlock(), _createElementBlock(
              "a",
              {
                key: 0,
                style: "color: inherit;",
                onClick: _cache[0] || (_cache[0] = ($event) => showResult.value = !showResult.value)
              },
              _toDisplayString(showResult.value ? _unref(i18n).ts._poll.vote : _unref(i18n).ts._poll.showResult),
              1
              /* TEXT */
            )) : _createCommentVNode("v-if", true),
            isVoted.value ? (_openBlock(), _createElementBlock(
              "span",
              { key: 0 },
              _toDisplayString(_unref(i18n).ts._poll.voted),
              1
              /* TEXT */
            )) : closed.value ? (_openBlock(), _createElementBlock(
              "span",
              { key: 1 },
              _toDisplayString(_unref(i18n).ts._poll.closed),
              1
              /* TEXT */
            )) : _createCommentVNode("v-if", true),
            remaining.value > 0 ? (_openBlock(), _createElementBlock(
              "span",
              { key: 0 },
              " · " + _toDisplayString(timer.value),
              1
              /* TEXT */
            )) : _createCommentVNode("v-if", true)
          ],
