...
export default {
  ...
  setup(__props, { emit: __emit }) {
    ...
    async function tokenDone() {
      ...
      const res = await os.apiWithDialog("i/2fa/done", { token: token.value.toString() });
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(MkModalWindow, {
        ...
        header: _withCtx(() => [_createTextVNode(
          _toDisplayString(_unref(i18n).ts.setupOf2fa),
          1
          /* TEXT */
        )]),
        default: _withCtx(() => [_createElementVNode("div", { style: "overflow-x: clip;" }, [_createVNode(_Transition, {
          ...
          default: _withCtx(() => [page.value === 0 ? (_openBlock(), _createElementBlock("div", {
            key: 0,
            ...
            _createVNode(MkInfo, null, {
              default: _withCtx(() => [_createVNode(MkLink, {
                url: "https://misskey-hub.net/docs/for-users/stepped-guides/how-to-enable-2fa/",
                target: "_blank"
              }, {
                default: _withCtx(() => [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts._2fa.moreDetailedGuideHere),
                  1
                  /* TEXT */
                )]),
                _: 1
            ...
            _createVNode(_component_I18n, {
              ...
              a: _withCtx(() => [_hoisted_1]),
              b: _withCtx(() => [_hoisted_2]),
              _: 1
            }, 8, ["src"]),
            _createElementVNode(
              "div",
              null,
              _toDisplayString(_unref(i18n).ts._2fa.step2),
              1
              /* TEXT */
            ),
            _createElementVNode("div", null, [_createElementVNode("a", {
            ...
            }, null, 10, ["src"])], 10, ["href"]), _createElementVNode("div", null, [_createVNode(MkButton, {
              inline: "",
              rounded: "",
              link: "",
              ...
              default: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts.launchApp),
                1
                /* TEXT */
              )]),
              _: 1
            ...
            _createVNode(MkKeyValue, { copy: __props.twoFactorData.url }, {
              key: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._2fa.step2Uri),
                1
                /* TEXT */
              )]),
              value: _withCtx(() => [_createTextVNode(
                _toDisplayString(__props.twoFactorData.url),
                1
                /* TEXT */
              )]),
              _: 1
            ...
            _: 1
          })])])])) : page.value === 1 ? (_openBlock(), _createElementBlock("div", {
            key: 1,
            ...
            _createElementVNode(
              "div",
              null,
              _toDisplayString(_unref(i18n).ts._2fa.step3Title),
              1
              /* TEXT */
            ),
            ...
            _createElementVNode(
              "div",
              null,
              _toDisplayString(_unref(i18n).ts._2fa.step3),
              1
              /* TEXT */
            )
          ]), _createElementVNode("div", {
            ...
            default: _withCtx(() => [
              ...
              _createTextVNode(" "),
              _createTextVNode(
                _toDisplayString(_unref(i18n).ts.goBack),
                1
                /* TEXT */
              )
            ]),
            ...
            _: 1
          })])])])) : page.value === 2 ? (_openBlock(), _createElementBlock("div", {
            key: 2,
            style: "height: 100cqh; overflow: auto;"
          }, [_createElementVNode("div", {
            class: "_spacer",
            ...
            _createElementVNode(
              "div",
              _hoisted_6,
              _toDisplayString(_unref(i18n).ts._2fa.setupCompleted) + "🎉",
              1
              /* TEXT */
            ),
            _createElementVNode(
              "div",
              _hoisted_7,
              _toDisplayString(_unref(i18n).ts._2fa.step4),
              1
              /* TEXT */
            ),
            _createElementVNode(
              "div",
              _hoisted_8,
              _toDisplayString(_unref(i18n).ts._2fa.checkBackupCodesBeforeCloseThisWizard),
              1
              /* TEXT */
            ),
            _createVNode(MkFolder, { defaultOpen: true }, {
              ...
              label: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._2fa.backupCodes),
                1
                /* TEXT */
              )]),
              default: _withCtx(() => [_createElementVNode("div", { class: "_gaps" }, [
                _createVNode(MkInfo, { warn: "" }, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts._2fa.backupCodesDescription),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                (_openBlock(true), _createElementBlock(
                  _Fragment,
                  null,
                  _renderList(backupCodes.value, (code, i) => {
                ...
                _createVNode(MkButton, {
                  ...
                  default: _withCtx(() => [
                    ...
                    _createTextVNode(" "),
                    _createTextVNode(
                      _toDisplayString(_unref(i18n).ts.download),
                      1
                      /* TEXT */
                    )
                  ]),
