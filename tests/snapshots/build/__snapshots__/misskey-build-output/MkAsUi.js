...
export default {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock("div", null, [_unref(c).type === "root" ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 0,
        ...
        [(_openBlock(true), _createElementBlock(
          _Fragment,
          null,
          _renderList(_unref(c).children, (child) => {
            return _openBlock(), _createElementBlock(
              _Fragment,
              { key: child },
              [!g(child).hidden ? (_openBlock(), _createBlock(_component_MkAsUi, {
                key: 0,
                component: g(child),
        ...
        2
        /* CLASS */
      )) : _unref(c).type === "text" ? (_openBlock(), _createElementBlock(
        "span",
        {
          key: 1,
          class: _normalizeClass({
            [_ctx.$style.fontSerif]: _unref(c).font === "serif",
            [_ctx.$style.fontMonospace]: _unref(c).font === "monospace"
          }),
          style: _normalizeStyle({
            fontSize: _unref(c).size ? `${_unref(c).size * 100}%` : undefined,
            fontWeight: _unref(c).bold ? "bold" : undefined,
            color: _unref(c).color
          })
        },
        _toDisplayString(_unref(c).text),
        7
        /* TEXT, CLASS, STYLE */
      )) : _unref(c).type === "mfm" ? (_openBlock(), _createBlock(_component_Mfm, {
        key: 2,
        class: _normalizeClass({
          [_ctx.$style.fontSerif]: _unref(c).font === "serif",
          [_ctx.$style.fontMonospace]: _unref(c).font === "monospace"
        ...
        style: _normalizeStyle({
          fontSize: _unref(c).size ? `${_unref(c).size * 100}%` : null,
          fontWeight: _unref(c).bold ? "bold" : null,
          color: _unref(c).color ?? null
        }),
        text: _unref(c).text ?? "",
        onClickEv: _cache[0] || (_cache[0] = (...args) => _unref(c).onClickEv && _unref(c).onClickEv(...args))
      }, null, 14, ["text"])) : _unref(c).type === "button" ? (_openBlock(), _createBlock(MkButton, {
        key: 3,
        ...
        inline: "",
        onClick: _cache[1] || (_cache[1] = (...args) => _unref(c).onClick && _unref(c).onClick(...args))
      }, {
        ...
        "disabled",
        "small"
      ])) : _unref(c).type === "buttons" ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 4,
          class: "_buttons",
        ...
        [(_openBlock(true), _createElementBlock(
          _Fragment,
          null,
          _renderList(_unref(c).buttons, (button) => {
        ...
        4
        /* STYLE */
      )) : _unref(c).type === "switch" ? (_openBlock(), _createBlock(MkSwitch, {
        key: 5,
        modelValue: valueForSwitch.value,
        "onUpdate:modelValue": onSwitchUpdate
      }, _createSlots({ _: 2 }, [_unref(c).label ? {
        name: "label",
        ...
        key: "0"
      } : undefined]), 1032, ["modelValue"])) : _unref(c).type === "textarea" ? (_openBlock(), _createBlock(MkTextarea, {
        key: 6,
        modelValue: _unref(c).default ?? null,
        "onUpdate:modelValue": _cache[2] || (_cache[2] = (...args) => _unref(c).onInput && _unref(c).onInput(...args))
      }, _createSlots({ _: 2 }, [_unref(c).label ? {
        name: "label",
        fn: _withCtx(() => [_createTextVNode(
          _toDisplayString(_unref(c).label),
        ...
        key: "0"
      } : undefined]), 1032, ["modelValue"])) : _unref(c).type === "textInput" ? (_openBlock(), _createBlock(MkInput, {
        key: 7,
        small: __props.size === "small",
        modelValue: _unref(c).default ?? null,
        "onUpdate:modelValue": _cache[3] || (_cache[3] = (...args) => _unref(c).onInput && _unref(c).onInput(...args))
      }, _createSlots({ _: 2 }, [_unref(c).label ? {
        name: "label",
        fn: _withCtx(() => [_createTextVNode(
          _toDisplayString(_unref(c).label),
        ...
        key: "0"
      } : undefined]), 1032, ["small", "modelValue"])) : _unref(c).type === "numberInput" ? (_openBlock(), _createBlock(MkInput, {
        key: 8,
        small: __props.size === "small",
        modelValue: _unref(c).default ?? null,
        type: "number",
        "onUpdate:modelValue": _cache[4] || (_cache[4] = (...args) => _unref(c).onInput && _unref(c).onInput(...args))
      }, _createSlots({ _: 2 }, [_unref(c).label ? {
        name: "label",
        fn: _withCtx(() => [_createTextVNode(
          _toDisplayString(_unref(c).label),
        ...
        key: "0"
      } : undefined]), 1032, ["small", "modelValue"])) : _unref(c).type === "select" ? (_openBlock(), _createBlock(MkSelect, {
        key: 9,
        small: __props.size === "small",
        ...
        "rounded",
        "small"
      ])) : _unref(c).type === "postForm" ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 11,
        ...
        label: _withCtx(() => [_createTextVNode(
          _toDisplayString(_unref(c).title),
          1
          /* TEXT */
        )]),
        ...
        _: 2
      }, 1032, ["defaultOpen"])) : _unref(c).type === "container" ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 13,
