    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock(
        ...
        [_createElementVNode(
          ...
          [read.value ? (_openBlock(), _createBlock(
            MkButton,
            {
              key: 0,
              class: _normalizeClass(_ctx.$style.button),
              rounded: "",
              onClick: _cache[0] || (_cache[0] = ($event) => read.value = false)
            },
            {
              default: _withCtx(() => [
                _hoisted_1,
                _createTextVNode(" "),
                _createTextVNode(
                  _toDisplayString(_unref(i18n).ts._qr.showTabTitle),
                  1
                  /* TEXT */
                )
              ]),
            ...
            MkButton,
            {
              ...
              class: _normalizeClass(_ctx.$style.button),
              rounded: "",
              onClick: _cache[1] || (_cache[1] = ($event) => read.value = true)
            },
            {
              default: _withCtx(() => [
                _hoisted_2,
                _createTextVNode(" "),
                _createTextVNode(
                  _toDisplayString(_unref(i18n).ts._qr.readTabTitle),
                  1
                  /* TEXT */
                )
              ]),
            ...
            2
            /* CLASS */
          )), read.value ? (_openBlock(), _createBlock(MkQrRead, { key: 0 })) : (_openBlock(), _createBlock(MkQrShow, { key: 1 }))],
          2
          /* CLASS */
        ), !read.value ? (_openBlock(), _createBlock(MkPolkadots, {
          key: 0,
          accented: "",
          revered: "",
          height: 200,
          style: "position: sticky; bottom: 0; margin-top: -200px;"
        }, null, 8, ["height"])) : _createCommentVNode("v-if", true)],
        2
        /* CLASS */
      );
    };
