...
const _hoisted_1 = /* @__PURE__ */ _createElementVNode("circle", {
  cx: "64",
  cy: "64",
  r: "64",
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock(
        ...
        { class: _normalizeClass([_ctx.$style.root, {
          ...
          [_ctx.$style.colored]: __props.colored,
          [_ctx.$style.mini]: __props.mini,
          [_ctx.$style.em]: __props.em
        }]) },
        [_createElementVNode(
          "div",
          ...
          [_createElementVNode(
            ...
            [_createElementVNode("g", { transform: "matrix(1.125,0,0,1.125,12,12)" }, [_hoisted_1])],
            2
            /* CLASS */
          ), _createElementVNode(
            "svg",
            {
              class: _normalizeClass([
                _ctx.$style.spinner,
                _ctx.$style.fg,
                { [_ctx.$style.static]: __props.static }
              ]),
              viewBox: "0 0 168 168",
              xmlns: "http://www.w3.org/2000/svg"
            },
            [_createElementVNode("g", { transform: "matrix(1.125,0,0,1.125,12,12)" }, [_hoisted_2])],
            2
            /* CLASS */
          )],
          2
