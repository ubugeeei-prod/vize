...
export default {
  ...
  setup(__props) {
    const props = __props;
    return (_ctx, _cache) => {
      return __props.type === "info" ? (_openBlock(), _createElementBlock(
        "svg",
        {
          key: 0,
        ...
        2
        /* CLASS */
      )) : __props.type === "question" ? (_openBlock(), _createElementBlock(
        "svg",
        {
          key: 1,
        ...
        2
        /* CLASS */
      )) : __props.type === "success" ? (_openBlock(), _createElementBlock(
        "svg",
        {
          key: 2,
        ...
        2
        /* CLASS */
      )) : __props.type === "warn" ? (_openBlock(), _createElementBlock(
        "svg",
        {
          key: 3,
        ...
        2
        /* CLASS */
      )) : __props.type === "error" ? (_openBlock(), _createElementBlock(
        "svg",
        {
          key: 4,
        ...
        2
        /* CLASS */
      )) : __props.type === "waiting" ? (_openBlock(), _createElementBlock(
        "svg",
        {
          key: 5,
