...
export default {
  ...
  setup(__props) {
    ...
    const { model: sort, def: sortDef } = useMkSelect({
      items: [
        {
          label: `${i18n.ts.createdAt} (${i18n.ts.ascendingOrder})`,
          value: "+createdAt"
        },
        {
          label: `${i18n.ts.createdAt} (${i18n.ts.descendingOrder})`,
          value: "-createdAt"
        },
        {
        ...
        {
          label: `${i18n.ts.usedAt} (${i18n.ts.descendingOrder})`,
          value: "-usedAt"
        }
      ],
        ...
        default: _withCtx(() => [_createElementVNode("div", {
          ...
          _createVNode(MkFolder, { expanded: false }, {
            ...
            default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [
              _createVNode(MkSwitch, {
                ...
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => noExpirationDate.value = $event)
              }, {
                label: _withCtx(() => [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts.noExpirationDate),
                  1
                  /* TEXT */
                )]),
                _: 1
              }, 8, ["modelValue"]),
              !noExpirationDate.value ? (_openBlock(), _createBlock(MkInput, {
                key: 0,
                type: "datetime-local",
                modelValue: expiresAt.value,
                "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => expiresAt.value = $event)
              }, {
                label: _withCtx(() => [_createTextVNode(
              ...
              _createVNode(MkInput, {
                ...
                "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => createCount.value = $event)
              }, {
                label: _withCtx(() => [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts.createCount),
                  1
                  /* TEXT */
                )]),
                _: 1
              ...
              _createVNode(MkButton, {
                ...
                default: _withCtx(() => [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts.create),
                  1
                  /* TEXT */
                )]),
                _: 1
          ...
          _createElementVNode(
            ...
            [_createVNode(MkSelect, {
              ...
              label: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts.state),
                1
                /* TEXT */
              )]),
              _: 1
            }, 10, ["items", "modelValue"]), _createVNode(MkSelect, {
              items: _unref(sortDef),
              class: _normalizeClass(_ctx.$style.input),
              modelValue: _unref(sort),
              "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => sort.value = $event)
            }, {
              label: _withCtx(() => [_createTextVNode(
