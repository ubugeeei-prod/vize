...
export default {
  ...
  setup(__props) {
    ...
    const searchSelectedIndex = ref(null);
    const searchResult = ref([]);
    const searchIndexItemByIdComputed = computed(() => props.searchIndex && new Map(props.searchIndex.map((i) => [i.id, i])));
    ...
    watch(rawSearchQuery, (value) => {
      ...
      if (searchIndexItemById != null) {
        const addSearchResult = (item) => {
          ...
          let icon = item.icon;
          const parentLabels = [];
          for (let current = searchIndexItemById.get(item.parentId ?? ""); current != null; current = searchIndexItemById.get(current.parentId ?? "")) {
            path ??= current.path;
            icon ??= current.icon;
    ...
    function searchOnInput(ev) {
      searchSelectedIndex.value = null;
      rawSearchQuery.value = ev.target.value;
    }
    function searchOnKeyDown(ev) {
      ...
      if (ev.key === "ArrowDown" || ev.key === "ArrowUp") {
        nextTick(() => {
          ...
          const selectedEl = rootEl.value.querySelector(".searchResultItem.selected");
          if (selectedEl != null) {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock(
        ...
        [__props.searchIndex && __props.searchIndex.length > 0 ? (_openBlock(), _createBlock(MkInput, {
          ...
          _: 1
        }, 8, ["placeholder", "modelValue"])) : _createCommentVNode("v-if", true), rawSearchQuery.value == "" ? (_openBlock(), _createElementBlock(
          _Fragment,
          { key: 0 },
          [(_openBlock(true), _createElementBlock(
            _Fragment,
            null,
            _renderList(__props.def, (group) => {
              return _openBlock(), _createElementBlock("div", { class: "group" }, [group.title ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 0,
                  class: "title"
                },
                _toDisplayString(group.title),
                1
                /* TEXT */
              )) : _createCommentVNode("v-if", true), _createElementVNode("div", { class: "items" }, [(_openBlock(true), _createElementBlock(
                _Fragment,
                null,
                _renderList(group.items, (item, i) => {
                  return _openBlock(), _createElementBlock(
                    _Fragment,
                    null,
                    [item.type === "a" ? (_openBlock(), _createElementBlock("a", {
                      key: 0,
                      href: item.href,
                      target: item.target,
                      class: _normalizeClass(["_button item", {
                        danger: item.danger,
                        active: item.active
                      }])
                    }, [item.icon ? (_openBlock(), _createElementBlock("span", {
                      key: 0,
                      class: "icon"
                    }, [_createElementVNode(
                      "i",
                      ...
                      1
                      /* TEXT */
                    )], 10, ["href", "target"])) : item.type === "button" ? (_openBlock(), _createElementBlock("button", {
                      key: 1,
                      class: _normalizeClass(["_button item", {
                        danger: item.danger,
                        active: item.active
                      ...
                      1
                      /* TEXT */
                    )], 10, ["disabled", "onClick"])) : (_openBlock(), _createBlock(_component_MkA, {
                      key: 2,
                      to: item.to,
                      class: _normalizeClass(["_button item", {
                        danger: item.danger,
                      ...
                      default: _withCtx(() => [item.icon ? (_openBlock(), _createElementBlock("span", {
                        key: 0,
                        class: "icon"
                      }, [_createElementVNode(
                        "i",
          ...
          [(_openBlock(true), _createElementBlock(
            _Fragment,
            null,
            _renderList(searchResult.value, (item, index) => {
              return _openBlock(), _createElementBlock("div", null, [_createVNode(_component_MkA, {
                ...
                default: _withCtx(() => [item.icon ? (_openBlock(), _createElementBlock("span", {
                  ...
                  2
                  /* CLASS */
                )])) : _createCommentVNode("v-if", true), _createElementVNode("span", { class: "text" }, [item.isRoot ? (_openBlock(), _createElementBlock(
                  _Fragment,
                  { key: 0 },
                  [_createTextVNode(
                  ...
                  [
                    _createElementVNode(
                      "span",
                      _hoisted_5,
                      _toDisplayString(item.parentLabels.join(" > ")),
                      1
                      /* TEXT */
                    ),
                    _hoisted_6,
