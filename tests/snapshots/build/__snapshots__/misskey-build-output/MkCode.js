  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock(
        ...
        [__props.copyButton ? (_openBlock(), _createElementBlock(
          "button",
          {
            key: 0,
          ...
          null,
          {
            fallback: _withCtx(() => [_createElementVNode(
              "pre",
              { class: _normalizeClass(["_selectable", [_ctx.$style.codeBlockFallbackRoot, { [_ctx.$style.outerStyle]: __props.withOuterStyle }]]) },
              [_createElementVNode(
                "code",
            ...
            default: _withCtx(() => [show.value && __props.lang ? (_openBlock(), _createBlock(XCode, {
              key: 0,
              class: "_selectable",
              code: __props.code,
              lang: __props.lang,
              ...
              "lang",
              "withOuterStyle"
            ])) : show.value ? (_openBlock(), _createElementBlock(
              "pre",
              {
                key: 1,
                class: _normalizeClass(["_selectable", [_ctx.$style.codeBlockFallbackRoot, { [_ctx.$style.outerStyle]: __props.withOuterStyle }]])
              ...
              [_createElementVNode(
                ...
                [_createElementVNode("div", null, [_hoisted_2, _createTextVNode(
                  " " + _toDisplayString(_unref(i18n).ts.code),
                  1
                  /* TEXT */
                )]), _createElementVNode(
                  "div",
