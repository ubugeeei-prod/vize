  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_PageWithHeader, {
        ...
        tab: headerTab.value,
        "onUpdate:tab": _cache[0] || (_cache[0] = ($event) => headerTab.value = $event)
      }, {
        default: _withCtx(() => [headerTab.value === "local" ? (_openBlock(), _createBlock(
          XGridLocalComponent,
          {
            key: 0,
          ...
          2
          /* CLASS */
        )) : headerTab.value === "remote" ? (_openBlock(), _createBlock(XGridRemoteComponent, { key: 1 })) : headerTab.value === "register" ? (_openBlock(), _createBlock(XRegisterComponent, { key: 2 })) : _createCommentVNode("v-if", true)]),
        _: 2
      }, 1032, ["tabs", "tab"]);
    };
  }
