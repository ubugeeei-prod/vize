...
export default {
  ...
  setup(__props, { emit: __emit }) {
    ...
    function touchStart(event) {
      ...
      if (hasSomethingToDoWithXSwipe(event.target)) return;
    ...
    function hasSomethingToDoWithXSwipe(el) {
      ...
      if ([
        ...
        "fixed",
        "sticky"
      ].includes(style.position)) return true;
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock(
        ...
        [_createVNode(_Transition, {
          ...
          default: _withCtx(() => [_createElementVNode("div", { key: tabModel.value }, [_renderSlot(_ctx.$slots, "default")])]),
          _: 3
        }, 1038, [
          "enterActiveClass",
          "leaveActiveClass",
