...
export default {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      }, _createSlots({ _: 2 }, [_unref($i) ? {
        name: "footer",
        fn: _withCtx(() => [_createElementVNode(
          "div",
          ...
          [_createElementVNode("div", {
            ...
            MkButton,
            {
              ...
              onClick: _cache[0] || (_cache[0] = ($event) => post())
            },
            {
              default: _withCtx(() => [_hoisted_1, _createTextVNode(
                _toDisplayString(_unref(i18n).ts.postToHashtag),
                1
                /* TEXT */
              )]),
              _: 1
