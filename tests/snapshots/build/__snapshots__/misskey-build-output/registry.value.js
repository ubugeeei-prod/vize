  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_PageWithHeader, {
        ...
        }, [_createElementVNode("div", { class: "_gaps_m" }, [_createVNode(FormInfo, { warn: "" }, {
          default: _withCtx(() => [_createTextVNode(
            _toDisplayString(_unref(i18n).ts.editTheseSettingsMayBreakAccount),
            1
            /* TEXT */
          )]),
          _: 1
        }), value.value ? (_openBlock(), _createElementBlock(
          _Fragment,
          { key: 0 },
          [
              ...
              default: _withCtx(() => [
                _createVNode(MkKeyValue, null, {
                  key: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts._registry.domain),
                    1
                    /* TEXT */
                  )]),
                  value: _withCtx(() => [_createTextVNode(
                    _toDisplayString(props.domain === "@" ? _unref(i18n).ts.system : props.domain.toUpperCase()),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                _createVNode(MkKeyValue, null, {
                  key: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts._registry.scope),
                    1
                    /* TEXT */
                  )]),
                  value: _withCtx(() => [_createTextVNode(
                    _toDisplayString(scope.value.join("/")),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                _createVNode(MkKeyValue, null, {
                  key: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts._registry.key),
                    1
                    /* TEXT */
                  )]),
                  value: _withCtx(() => [_createTextVNode(
                    _toDisplayString(key.value),
                    1
                    /* TEXT */
                  )]),
                  _: 1
            ...
            _createVNode(MkCodeEditor, {
              ...
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => valueForEditor.value = $event)
            }, {
              label: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts.value) + " (JSON)",
                1
                /* TEXT */
              )]),
              _: 1
