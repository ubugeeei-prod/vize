  ...
  setup(__props) {
    ...
    async function save() {
      if (props.post != null) {
        ...
        router.push("/gallery/:postId", { params: { postId: props.post.id } });
      } else {
        ...
        router.push("/gallery/:postId", { params: { postId: created.id } });
      }
    }
    async function del() {
      ...
      if (canceled) return;
      await os.apiWithDialog("gallery/posts/delete", { postId: props.post.id });
      router.push("/gallery");
    }
        ...
        default: _withCtx(() => [_createElementVNode("div", {
          ...
          _createElementVNode("div", { class: "_gaps_s" }, [(_openBlock(true), _createElementBlock(
            ...
            default: _withCtx(() => [
              ...
              _createTextVNode(" "),
              _createTextVNode(
                _toDisplayString(_unref(i18n).ts.attachFile),
                1
                /* TEXT */
              )
            ]),
          ...
          _createVNode(MkSwitch, {
            ...
            "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => isSensitive.value = $event)
          }, {
            default: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts.markAsSensitive),
              1
              /* TEXT */
            )]),
            _: 1
          }, 8, ["modelValue"]),
          _createElementVNode("div", { class: "_buttons" }, [props.post != null ? (_openBlock(), _createBlock(MkButton, {
            key: 0,
            primary: "",
            onClick: save
          }, {
            ...
            default: _withCtx(() => [
              ...
              _createTextVNode(" "),
              _createTextVNode(
                _toDisplayString(_unref(i18n).ts.publish),
                1
                /* TEXT */
              )
            ]),
            _: 1
          })), props.post != null ? (_openBlock(), _createBlock(MkButton, {
            key: 0,
            danger: "",
            onClick: del
          }, {
