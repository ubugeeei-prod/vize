    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock(
        ...
        { class: _normalizeClass([_ctx.$style.root, {
          yellow: __props.instance.isNotResponding,
          red: __props.instance.isBlocked,
          gray: __props.instance.isSuspended,
          blue: __props.instance.isSilenced
        }]) },
        [
          ...
          _createElementVNode("div", { class: "body" }, [_createElementVNode(
            "span",
            _hoisted_1,
            _toDisplayString(__props.instance.name ?? __props.instance.host),
            1
            /* TEXT */
          ), _createElementVNode("span", { class: "sub _monospace" }, [_createElementVNode(
            "b",
            null,
            _toDisplayString(__props.instance.host),
            1
            /* TEXT */
          ), _createTextVNode(
            " / " + _toDisplayString(__props.instance.softwareName || "?") + " " + _toDisplayString(__props.instance.softwareVersion),
            1
            /* TEXT */
          )])]),
          chartValues.value ? (_openBlock(), _createBlock(MkMiniChart, {
            key: 0,
            class: "chart",
