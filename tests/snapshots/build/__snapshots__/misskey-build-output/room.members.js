    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock("div", { class: "_gaps" }, [
        isOwner.value ? (_openBlock(), _createBlock(MkButton, {
          ...
          rounded: "",
          style: "margin: 0 auto;",
          onClick: _cache[0] || (_cache[0] = ($event) => emit("inviteUser"))
        }, {
          default: _withCtx(() => [
            _hoisted_1,
            _createTextVNode(" "),
            _createTextVNode(
              _toDisplayString(_unref(i18n).ts._chat.inviteUser),
              1
              /* TEXT */
            )
          ]),
        ...
        _createVNode(_component_MkA, {
          ...
          default: _withCtx(() => [_createVNode(MkUserCardMini, { user: __props.room.owner }, null, 8, ["user"])]),
          _: 1
        }, 10, ["to"]),
        memberships.value.length > 0 ? (_openBlock(), _createElementBlock("hr", { key: 0 })) : _createCommentVNode("v-if", true),
        ...
        isOwner.value ? (_openBlock(), _createElementBlock(
          _Fragment,
          { key: 0 },
          [
            _hoisted_2,
            _createElementVNode(
              "div",
              null,
              _toDisplayString(_unref(i18n).ts._chat.sentInvitations),
              1
              /* TEXT */
            ),
            (_openBlock(true), _createElementBlock(
              ...
              _renderList(invitations.value, (invitation) => {
                return _openBlock(), _createElementBlock(
                  ...
                  [_createVNode(_component_MkA, {
                    ...
                    default: _withCtx(() => [_createVNode(MkUserCardMini, { user: invitation.user }, null, 8, ["user"])]),
                    _: 2
                  }, 10, ["to"])],
                  2
                  /* CLASS */
