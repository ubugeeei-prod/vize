...
export default {
  ...
  setup(__props) {
    ...
    const searchPaginator = shallowRef(null);
    const searchKey = ref(0);
    const featuredFlashsPaginator = markRaw(new Paginator("flash/featured", {
      limit: 5,
      offsetMode: true
    }));
    const myFlashsPaginator = markRaw(new Paginator("flash/my", { limit: 5 }));
    ...
    function search() {
      ...
      searchPaginator.value = markRaw(new Paginator("flash/search", { params: { query: searchQuery.value } }));
      searchKey.value++;
    }
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_PageWithHeader, {
        ...
        default: _withCtx(() => [_createElementVNode("div", {
        ...
        }, [tab.value === "search" ? (_openBlock(), _createElementBlock("div", { key: 0 }, [_createElementVNode("div", { class: "_gaps" }, [
          ...
          searchPaginator.value ? (_openBlock(), _createBlock(MkPagination, {
            key: searchKey.value,
        ...
        ])])) : tab.value === "featured" ? (_openBlock(), _createElementBlock("div", { key: 1 }, [_createVNode(MkPagination, { paginator: _unref(featuredFlashsPaginator) }, {
          default: _withCtx(({ items }) => [_createElementVNode("div", { class: "_gaps_s" }, [(_openBlock(true), _createElementBlock(
            _Fragment,
            null,
            _renderList(items, (flash) => {
          ...
          _: 1
        }, 8, ["paginator"])])) : tab.value === "my" ? (_openBlock(), _createElementBlock("div", { key: 2 }, [_createElementVNode("div", { class: "_gaps" }, [_createVNode(MkButton, {
          gradate: "",
          rounded: "",
          style: "margin: 0 auto;",
          ...
          _: 1
        }, 8, ["paginator"])])])) : tab.value === "liked" ? (_openBlock(), _createElementBlock("div", { key: 3 }, [_createVNode(MkPagination, {
