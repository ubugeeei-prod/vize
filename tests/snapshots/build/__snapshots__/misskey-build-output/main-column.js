  ...
  setup(__props) {
    ...
    */
    ...
    function onHeaderClick() {
      ...
      const scrollEl = rootEl.value.querySelector("._pageScrollable,._pageScrollableReversed");
      if (scrollEl) {
        scrollEl.scrollTo({
          top: 0,
          behavior: "smooth"
    ...
    return (_ctx, _cache) => {
      ...
      return _unref(prefer).s["deck.alwaysShowMainColumn"] || _unref(mainRouter).currentRoute.value.name !== "index" ? (_openBlock(), _createBlock(XColumn, {
        key: 0,
        ...
        header: _withCtx(() => [pageMetadata.value ? (_openBlock(), _createElementBlock(
          _Fragment,
          { key: 0 },
          [_createElementVNode(
            "i",
