...
export default {
  ...
  async setup(__props) {
    ...
    const backups = ([__temp, __restore] = _withAsyncContext(() => listCloudBackups()), __temp = await __temp, __restore(), __temp);
    function del(backup) {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_SearchMarker, {
        ...
        default: _withCtx(() => [_createElementVNode("div", { class: "_gaps" }, [(_openBlock(true), _createElementBlock(
          _Fragment,
          null,
          _renderList(_unref(backups), (backup) => {
