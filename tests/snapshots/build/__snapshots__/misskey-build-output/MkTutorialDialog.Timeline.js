    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock("div", { class: "_gaps" }, [
        _createElementVNode(
          "div",
          _hoisted_1,
          _toDisplayString(_unref(i18n).ts._initialTutorial._timeline.description1),
          1
          /* TEXT */
        ),
        _createElementVNode("div", { class: "_gaps_s" }, [(_openBlock(true), _createElementBlock(
          _Fragment,
          null,
          _renderList(_unref(basicTimelineTypes), (tl) => {
            return _openBlock(), _createElementBlock("div", null, [
              ...
              _createElementVNode(
                "b",
                null,
                _toDisplayString(_unref(i18n).ts._timelines[tl]),
                1
                /* TEXT */
              ),
              _createTextVNode(
                " … " + _toDisplayString(_unref(i18n).ts._initialTutorial._timeline[tl]),
                1
                /* TEXT */
              )
            ]);
        ...
        _createElementVNode("div", { class: "_gaps_s" }, [_createElementVNode(
          "div",
          null,
          _toDisplayString(_unref(i18n).ts._initialTutorial._timeline.description2),
          1
          /* TEXT */
        ), _createElementVNode(
          "img",
        ...
        _createVNode(_component_I18n, {
          ...
          link: _withCtx(() => [_createElementVNode(
            "a",
            _hoisted_2,
            _toDisplayString(_unref(i18n).ts.help),
            1
            /* TEXT */
          )]),
          _: 1
