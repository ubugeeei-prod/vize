...
export default {
  ...
  setup(__props) {
    ...
    function submit() {
      ...
      misskeyApi("verify-email", { code: props.code }).then(() => {
        ...
        default: _withCtx(() => [_createElementVNode(
          ...
          [_createElementVNode(
            "form",
            {
              ...
              onSubmit: _cache[0] || (_cache[0] = _withModifiers(($event) => submit(), ["prevent"]))
            },
            [_createElementVNode(
              "div",
              ...
              default: _withCtx(() => [!succeeded.value ? (_openBlock(), _createElementBlock("div", {
                key: "input",
                class: "_gaps_m",
                style: "padding: 32px;"
              }, [_createElementVNode(
                ...
                _toDisplayString(_unref(i18n).tsx.clickToFinishEmailVerification({ ok: _unref(i18n).ts.gotIt })),
                3
                /* TEXT, CLASS */
                ...
                default: _withCtx(() => [_createTextVNode(
                  _toDisplayString(submitting.value ? _unref(i18n).ts.processing : _unref(i18n).ts.gotIt),
                  1
                  /* TEXT */
                ), submitting.value ? (_openBlock(), _createBlock(_component_MkEllipsis, { key: 0 })) : _createCommentVNode("v-if", true)]),
                _: 2
              }, 1032, ["disabled"])])])) : (_openBlock(), _createElementBlock("div", {
                key: "success",
                class: "_gaps_m",
                style: "padding: 32px;"
              }, [_createElementVNode(
