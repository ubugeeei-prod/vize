    ...
    async function search() {
      ...
      if (query.length > 1 && !query.includes(" ")) {
        ...
        if (query.startsWith("#")) {
          ...
          if (!confirm.canceled) {
            router.push("/user-tags/:tag", { params: { tag: query.substring(1) } });
            return;
          }
        }
      }
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock("div", { class: "_gaps" }, [_createElementVNode("div", { class: "_gaps" }, [
        ...
        _unref(instance).federation !== "none" ? (_openBlock(), _createBlock(MkRadios, {
          ...
          "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => search()),
          modelValue: searchOrigin.value
        }, null, 8, ["options", "modelValue"])) : _createCommentVNode("v-if", true),
        ...
        default: _withCtx(() => [_createVNode(MkUserList, {
