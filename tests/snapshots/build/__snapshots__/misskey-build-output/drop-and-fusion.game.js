...
const _hoisted_1 = /* @__PURE__ */ _createElementVNode("img", {
  ...
  style: "width: 200px; max-width: 100%; display: block; margin: auto; margin-bottom: -5px;"
});
...
export default {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const monoDefinitions = computed(() => {
      return props.gameMode === "normal" ? NORAML_MONOS : props.gameMode === "square" ? SQUARE_MONOS : props.gameMode === "yen" ? YEN_MONOS : props.gameMode === "sweets" ? SWEETS_MONOS : props.gameMode === "space" ? NORAML_MONOS : [];
    });
    function getScoreUnit(gameMode) {
      return gameMode === "normal" ? "pt" : gameMode === "square" ? "pt" : gameMode === "yen" ? "円" : gameMode === "sweets" ? "kcal" : "";
    }
    function getMonoRenderOptions(mono) {
    ...
    const currentPick = shallowRef(null);
    const stock = shallowRef([]);
    const holdingStock = shallowRef(null);
    const score = ref(0);
    const combo = ref(0);
    ...
    const readyGo = ref("ready");
    const highScore = ref(null);
    const yenTotal = ref(null);
    ...
    function createRendererInstance(game) {
    ...
    function loadMonoTextures() {
      async function loadSingleMonoTexture(mono) {
    ...
    function getTextureImageUrl(mono) {
      const def = monoDefinitions.value.find((x) => x.id === mono.id);
    ...
    function getGameImageDriveFile() {
      return new Promise((res) => {
        ...
        Promise.all([loadImage("/client-assets/drop-and-fusion/frame-light.svg"), loadImage("/client-assets/drop-and-fusion/logo.png")]).then((images) => {
          ...
          ctx.globalAlpha = .7;
          ctx.drawImage(logo, game.GAME_WIDTH * .55, 6, game.GAME_WIDTH * .45, game.GAME_WIDTH * .45 * (logo.height / logo.width));
          ctx.globalAlpha = 1;
          dcanvas.toBlob((blob) => {
...
SCORE: ${score.value.toLocaleString()}${getScoreUnit(props.gameMode)}`,
    ...
    function attachGameEvents() {
      ...
      game.addListener("fusioned", (x, y, nextMono, scoreDelta) => {
        ...
        {
          const { dispose } = os.popup(MkPlusOneEffect, {
            x: domX,
            y: domY,
      ...
      game.addListener("collision", (energy, bodyA, bodyB) => {
        if (!props.mute && energy > minCollisionEnergyForSound) {
          ...
          const panV = bodyA.label === "_wall_" ? bodyB.position.x - game.PLAYAREA_MARGIN : bodyB.label === "_wall_" ? bodyA.position.x - game.PLAYAREA_MARGIN : (bodyA.position.x + bodyB.position.x) / 2 - game.PLAYAREA_MARGIN;
          const panW = game.GAME_WIDTH - game.PLAYAREA_MARGIN - game.PLAYAREA_MARGIN;
          const pan = (panV / panW - .5) * 2;
      ...
      game.addListener("gameOver", () => {
        if (!props.mute) {
          if (props.gameMode === "yen") {
            sound.playUrl("/client-assets/drop-and-fusion/gameover_yen.mp3", { volume: .5 * sfxVolume.value });
          } else {
            sound.playUrl("/client-assets/drop-and-fusion/gameover.mp3", { volume: sfxVolume.value });
          }
        }
        if (replaying.value) {
          endReplay();
    ...
    onMounted(async () => {
      ...
      */
      ...
      if (!bgmBuffer) return;
      bgmNodes = sound.createSourceNode(bgmBuffer, { volume: props.mute ? 0 : bgmVolume.value });
      if (!bgmNodes) return;
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock("div", {
        ...
        [!gameLoaded.value ? (_openBlock(), _createElementBlock(
          "div",
          {
            key: 0,
          ...
          [_createElementVNode("div", null, [_createTextVNode(
            _toDisplayString(_unref(i18n).ts.loading),
            1
            /* TEXT */
          ...
          { class: "_gaps_s" },
          [
            readyGo.value === "ready" ? (_openBlock(), _createElementBlock(
              "div",
              {
                key: 0,
            ...
            _createVNode(_Transition, {
              ...
              default: _withCtx(() => [readyGo.value === "ready" ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 0,
                ...
                2
                /* CLASS */
              )) : readyGo.value === "go" ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 1,
            ...
            _createElementVNode(
              ...
              [_createElementVNode(
                ...
                [_createElementVNode("div", { class: "_woodenFrameInner" }, [_createElementVNode(
                  "b",
                  null,
                  _toDisplayString(_unref(i18n).ts.bubbleGame),
                  1
                  /* TEXT */
                ), _createElementVNode(
                  "div",
                  null,
                  "- " + _toDisplayString(__props.gameMode.toUpperCase()) + " -",
                  1
                  /* TEXT */
                )])],
                2
                /* CLASS */
              ), _createElementVNode("div", { class: "_woodenFrame _woodenFrameH" }, [_createElementVNode("div", { class: "_woodenFrameInner" }, [_createVNode(MkButton, {
                inline: "",
                small: "",
                onClick: hold
              }, {
                default: _withCtx(() => [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts._bubbleGame.hold),
                  1
                  /* TEXT */
                )]),
                _: 1
              ...
              }, null, 8, ["src"])) : _createCommentVNode("v-if", true)]), _createElementVNode(
                "div",
                {
            ...
            _createElementVNode("div", {
              ...
              _unref(store).s.darkMode ? (_openBlock(), _createElementBlock(
                "img",
                {
                  key: 0,
              ...
              _createVNode(_Transition, {
                ...
                default: _withCtx(() => [_withDirectives(_createElementVNode(
                  ...
                  _toDisplayString(comboPrev.value) + " Chain!",
                  7
                  /* TEXT, CLASS, STYLE */
              ...
              !isGameOver.value && !replaying.value && readyGo.value !== "ready" ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 0,
                ...
                [_createVNode(_Transition, {
                  ...
                  default: _withCtx(() => [currentPick.value ? (_openBlock(), _createElementBlock("img", {
                    key: currentPick.value.id,
                    src: getTextureImageUrl(currentPick.value.mono),
                    class: _normalizeClass(_ctx.$style.currentMono),
                    style: _normalizeStyle({
                      marginBottom: -(currentPick.value?.mono.sizeY * _unref(viewScale) / 2) + "px",
                      left: -(currentPick.value?.mono.sizeX * _unref(viewScale) / 2) + "px",
                      width: `${currentPick.value?.mono.sizeX * _unref(viewScale)}px`
                    })
                  }, null, 14, ["src"])) : _createCommentVNode("v-if", true)]),
                  _: 2
                }, 1032, [
                  "enterActiveClass",
                  "leaveActiveClass",
                  ...
                  "leaveToClass",
                  "moveClass"
                ]), dropReady.value && currentPick.value ? (_openBlock(), _createElementBlock(
                  _Fragment,
                  { key: 0 },
                  [_createElementVNode(
                    "img",
              ...
              isGameOver.value && !replaying.value ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 0,
                ...
                [_createElementVNode("div", { class: "_gaps_s" }, [
                  ...
                  _createElementVNode("div", null, [
                    _createTextVNode(
                      _toDisplayString(_unref(i18n).ts._bubbleGame._score.score) + ": ",
                      1
                      /* TEXT */
                    ),
                    _createVNode(MkNumber, { value: score.value }, null, 8, ["value"]),
                    _createTextVNode(
                      _toDisplayString(getScoreUnit(__props.gameMode)),
                      1
                      /* TEXT */
                    )
                  ]),
                  _createElementVNode("div", null, [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts._bubbleGame._score.maxChain) + ": ",
                    1
                    /* TEXT */
                  ), _createVNode(MkNumber, { value: maxCombo.value }, null, 8, ["value"])]),
                  __props.gameMode === "yen" ? (_openBlock(), _createElementBlock("div", { key: 0 }, [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts._bubbleGame._score.scoreYen) + ":\n              ",
                    1
                    /* TEXT */
                    ...
                    yen: _withCtx(() => [_createVNode(MkNumber, { value: yenTotal.value ?? score.value }, null, 8, ["value"])]),
                    _: 1
                  }, 8, ["src"])])) : _createCommentVNode("v-if", true),
                  __props.gameMode === "sweets" ? (_openBlock(), _createBlock(_component_I18n, {
                    key: 0,
                    src: _unref(i18n).ts._bubbleGame._score.scoreSweets,
                    tag: "div"
                  }, {
                    onigiriQtyWithUnit: _withCtx(() => [_createVNode(_component_I18n, {
                      src: _unref(i18n).ts._bubbleGame._score.estimatedQty,
                      tag: "b"
                    }, {
                      qty: _withCtx(() => [_createVNode(MkNumber, { value: score.value / 130 }, null, 8, ["value"])]),
                      _: 1
                    }, 8, ["src"])]),
                    _: 1
                  }, 8, ["src"])) : _createCommentVNode("v-if", true)
              ...
              replaying.value ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 0,
                ...
                [_createElementVNode(
                  ...
                  [_hoisted_2, _createTextVNode(
                    " " + _toDisplayString(_unref(i18n).ts.replaying),
                    1
                    /* TEXT */
                  )],
                  2
            ...
            replaying.value ? (_openBlock(), _createElementBlock("div", {
              key: 0,
              class: "_woodenFrame"
            }, [_createElementVNode("div", { class: "_woodenFrameInner" }, [_createElementVNode("div", { style: "background: #0004;" }, [_createElementVNode(
              "div",
              { style: _normalizeStyle([{
                "height": "10px",
                "background": "var(--MI_THEME-accent)",
                "will-change": "width"
              }, { width: `${currentFrame.value / _unref(endedAtFrame) * 100}%` }]) },
              null,
              4
              /* STYLE */
            )])]), _createElementVNode("div", { class: "_woodenFrameInner" }, [_createElementVNode("div", { class: "_buttonsCenter" }, [
              _createVNode(MkButton, { onClick: endReplay }, {
                default: _withCtx(() => [
                  _hoisted_3,
                  _createTextVNode(" "),
                  _createTextVNode(
                    _toDisplayString(_unref(i18n).ts.endReplay),
                    1
                    /* TEXT */
                  )
                ]),
              ...
              _createVNode(MkButton, {
                ...
                onClick: _cache[0] || (_cache[0] = ($event) => replayPlaybackRate.value = replayPlaybackRate.value === 4 ? 1 : 4)
              }, {
                default: _withCtx(() => [_hoisted_4, _createTextVNode(" x4")]),
                _: 1
              }, 8, ["primary"]),
              _createVNode(MkButton, {
                primary: replayPlaybackRate.value === 16,
                onClick: _cache[1] || (_cache[1] = ($event) => replayPlaybackRate.value = replayPlaybackRate.value === 16 ? 1 : 16)
              }, {
                default: _withCtx(() => [_hoisted_5, _createTextVNode(" x16")]),
                _: 1
              }, 8, ["primary"])
            ])])])) : _createCommentVNode("v-if", true),
            isGameOver.value ? (_openBlock(), _createElementBlock("div", {
              key: 0,
              class: "_woodenFrame"
            }, [_createElementVNode("div", { class: "_woodenFrameInner" }, [_createElementVNode("div", { class: "_buttonsCenter" }, [
              _createVNode(MkButton, {
                ...
                default: _withCtx(() => [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts.backToTitle),
                  1
                  /* TEXT */
                )]),
                _: 1
              ...
              _createVNode(MkButton, {
                ...
                default: _withCtx(() => [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts.showReplay),
                  1
                  /* TEXT */
                )]),
                _: 1
              ...
              _createVNode(MkButton, {
                ...
                default: _withCtx(() => [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts.copyReplayData),
                  1
                  /* TEXT */
                )]),
                _: 1
            ...
            _createElementVNode("div", { style: "display: flex;" }, [_createElementVNode("div", {
              class: "_woodenFrame",
              ...
              _createElementVNode("div", null, [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._bubbleGame._score.highScore) + ": ",
                1
                /* TEXT */
              ), highScore.value ? (_openBlock(), _createElementBlock("b", { key: 0 }, [_createVNode(MkNumber, { value: highScore.value }, null, 8, ["value"]), _createTextVNode(
                _toDisplayString(getScoreUnit(__props.gameMode)),
                1
                /* TEXT */
              )])) : (_openBlock(), _createElementBlock("b", { key: 1 }, "-"))]),
              __props.gameMode === "yen" ? (_openBlock(), _createElementBlock("div", { key: 0 }, [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._bubbleGame._score.scoreYen) + ":\n              ",
                1
                /* TEXT */
              ...
              style: "text-align: center;"
            }, [_createElementVNode("div", { onClick: _cache[2] || (_cache[2] = ($event) => showConfig.value = !showConfig.value) }, [_hoisted_6])])])]),
            showConfig.value ? (_openBlock(), _createElementBlock("div", {
              key: 0,
              class: "_woodenFrame"
              ...
              "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => bgmVolume.value = $event)
            }, {
              label: _withCtx(() => [_createTextVNode(
                "BGM " + _toDisplayString(_unref(i18n).ts.volume),
                1
                /* TEXT */
              )]),
              _: 1
              ...
              "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => sfxVolume.value = $event)
            }, {
              label: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts.sfx) + " " + _toDisplayString(_unref(i18n).ts.volume),
                1
                /* TEXT */
              )]),
              _: 1
            ...
            _createElementVNode("div", { class: "_woodenFrame" }, [_createElementVNode("div", { class: "_woodenFrameInner" }, [_hoisted_7, _createElementVNode("div", null, [(_openBlock(true), _createElementBlock(
              _Fragment,
              null,
              _renderList(_unref(game).monoDefinitions.sort((a, b) => a.level - b.level), (mono, i) => {
                return _openBlock(), _createElementBlock("div", {
                  key: mono.id,
                  ...
                  style: "width: 32px; vertical-align: bottom;"
                }, null, 8, ["src"]), i < _unref(game).monoDefinitions.length - 1 ? (_openBlock(), _createElementBlock("div", {
                  key: 0,
            ...
            _createElementVNode("div", { class: "_woodenFrame" }, [_createElementVNode("div", { class: "_woodenFrameInner" }, [!isGameOver.value && !replaying.value ? (_openBlock(), _createBlock(MkButton, {
              key: 0,
              full: "",
              danger: "",
              onClick: surrender
              ...
              default: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts.surrender),
                1
                /* TEXT */
              )]),
              _: 1
              ...
              default: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts.gameRetry),
                1
                /* TEXT */
              )]),
              _: 1
