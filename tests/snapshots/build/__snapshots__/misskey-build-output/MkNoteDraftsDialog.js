...
export default {
  ...
  setup(__props, { emit: __emit }) {
    const emit = __emit;
    const props = __props;
    const tab = ref(props.scheduled ? "scheduled" : "drafts");
    ...
    async function cancelSchedule(draft) {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(MkModalWindow, {
        ...
        onEsc: _cache[3] || (_cache[3] = ($event) => cancel())
      }, {
        ...
        default: _withCtx(() => [_createVNode(_component_MkStickyContainer, null, {
          header: _withCtx(() => [_createVNode(MkTabs, {
            ...
            tab: tab.value,
            "onUpdate:tab": _cache[4] || (_cache[4] = ($event) => tab.value = $event)
          }, null, 10, ["tabs", "tab"])]),
          default: _withCtx(() => [_createElementVNode("div", { class: "_spacer" }, [_createVNode(MkPagination, {
            key: tab.value,
              ...
              _renderList(items, (draft) => {
                return _withDirectives((_openBlock(), _createElementBlock(
                  ...
                  [_createElementVNode(
                    ...
                    [
                      draft.scheduledAt != null && draft.isActuallyScheduled ? (_openBlock(), _createBlock(MkInfo, { key: 0 }, {
                        default: _withCtx(() => [_createVNode(_component_I18n, {
                      ...
                      _createElementVNode(
                        ...
                        [_createElementVNode(
                          ...
                          [
                            draft.reply ? (_openBlock(), _createElementBlock("div", {
                              key: 0,
                              class: "_nowrap"
                            }, [
                              _hoisted_1,
                              ...
                              _createVNode(_component_I18n, {
                                ...
                                user: _withCtx(() => [draft.reply.user.name != null ? (_openBlock(), _createBlock(_component_Mfm, {
                                  key: 0,
                            ...
                            ])) : draft.replyId ? (_openBlock(), _createElementBlock("div", {
                              key: 1,
                              class: "_nowrap"
                            }, [
                              _hoisted_2,
                              ...
                              _createVNode(_component_I18n, {
                                ...
                                user: _withCtx(() => [_createTextVNode(
                            ...
                            draft.renote && draft.text != null ? (_openBlock(), _createElementBlock("div", {
                              key: 0,
                              class: "_nowrap"
                            }, [
                              _hoisted_3,
                              ...
                              _createVNode(_component_I18n, {
                                ...
                                user: _withCtx(() => [draft.renote.user.name != null ? (_openBlock(), _createBlock(_component_Mfm, {
                                  key: 0,
                            ...
                            ])) : draft.renoteId ? (_openBlock(), _createElementBlock("div", {
                              key: 1,
                              class: "_nowrap"
                            }, [
                              _hoisted_4,
                            ...
                            draft.channel ? (_openBlock(), _createElementBlock("div", {
                              key: 0,
                              class: "_nowrap"
                      ...
                      _createElementVNode(
                        ...
                        [_createVNode(_component_Mfm, {
                          text: _unref(getNoteSummary)(draft, {
                            showRenote: false,
                            showReply: false
                          }),
                          plain: true,
                      ...
                      _createElementVNode(
                        ...
                        [_createElementVNode(
                          ...
                          [_createElementVNode("span", { title: _unref(i18n).ts._visibility[draft.visibility] }, [draft.visibility === "public" ? (_openBlock(), _createElementBlock("i", {
                            key: 0,
                            class: "ti ti-world"
                          })) : draft.visibility === "home" ? (_openBlock(), _createElementBlock("i", {
                            key: 1,
                            class: "ti ti-home"
                          })) : draft.visibility === "followers" ? (_openBlock(), _createElementBlock("i", {
                            key: 2,
                            class: "ti ti-lock"
                          })) : draft.visibility === "specified" ? (_openBlock(), _createElementBlock("i", {
                            key: 3,
                            class: "ti ti-mail"
                          })) : _createCommentVNode("v-if", true)], 8, ["title"]), draft.localOnly ? (_openBlock(), _createElementBlock("span", {
                            key: 0,
                            title: _unref(i18n).ts._visibility["disableFederation"]
                          }, [_hoisted_6], 8, ["title"])) : _createCommentVNode("v-if", true)],
                          2
                          /* CLASS */
                    ...
                    [draft.scheduledAt != null && draft.isActuallyScheduled ? (_openBlock(), _createBlock(MkButton, {
                      key: 0,
                      small: "",
                      onClick: ($event) => cancelSchedule(draft)
                    }, {
                      default: _withCtx(() => [
                        _hoisted_7,
                        _createTextVNode(" "),
                        _createTextVNode(
                          _toDisplayString(_unref(i18n).ts._drafts.cancelSchedule),
                          1
                          /* TEXT */
                        )
                      ]),
                      ...
                      key: 1,
                      small: "",
                      onClick: ($event) => restoreDraft(draft)
                    }, {
                      default: _withCtx(() => [
                        _hoisted_8,
                        _createTextVNode(" "),
                        _createTextVNode(
                          _toDisplayString(_unref(i18n).ts._drafts.restore),
                          1
                          /* TEXT */
                        )
                      ]),
                      ...
                      onClick: ($event) => deleteDraft(draft)
                    }, {
