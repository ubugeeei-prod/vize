...
export default {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    function onDriveFileCreated(file) {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(MkContainer, {
        ...
        header: _withCtx(() => [_createTextVNode(
          _toDisplayString(_unref(i18n).ts._widgets.photos),
          1
          /* TEXT */
        )]),
        default: _withCtx(() => [_createElementVNode("div", { class: "" }, [fetching.value ? (_openBlock(), _createBlock(_component_MkLoading, { key: 0 })) : (_openBlock(), _createElementBlock(
          "div",
          {
            key: 1,
          ...
          [(_openBlock(true), _createElementBlock(
            _Fragment,
            null,
            _renderList(images.value, (image, i) => {
