...
export default {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return hasDisconnected.value && _unref(prefer).s.serverDisconnectedBehavior === "quiet" ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 0,
        ...
        [_createElementVNode("div", null, [_hoisted_1, _createTextVNode(
          " " + _toDisplayString(_unref(i18n).ts.disconnectedFromServer),
          1
          /* TEXT */
        )]), _createElementVNode(
          "div",
          ...
          [_createVNode(MkButton, {
            ...
            default: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts.doNothing),
              1
              /* TEXT */
            )]),
            _: 1
