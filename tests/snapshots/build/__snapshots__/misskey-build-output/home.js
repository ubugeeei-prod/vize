  ...
  setup(__props, { emit: __emit }) {
    ...
    const style = computed(() => {
      ...
      if (prefer.s.disableShowingAnimatedImages) {
        return { backgroundImage: `url(${getStaticImageUrl(props.user.bannerUrl)})` };
      } else {
        return { backgroundImage: `url(${props.user.bannerUrl})` };
      }
      ;
    });
    const age = computed(() => {
    ...
    let bannerParallaxResizeObserver = null;
    ...
    onMounted(() => {
      narrow.value = rootEl.value.clientWidth < 1e3;
      if (isBirthday(user.value)) {
        confetti({ duration: 1e3 * 4 });
      }
      nextTick(() => {
        calcBannerParallax();
        adjustMemoTextarea();
      ...
      return _openBlock(), _createBlock(_resolveDynamicComponent(_unref(prefer).s.enablePullToRefresh ? MkPullToRefresh : "div"), { refresher: () => reload() }, {
        default: _withCtx(() => [_createElementVNode(
          ...
          [_createElementVNode(
            ...
            [_createElementVNode("div", { class: "main _gaps" }, [_createElementVNode("div", { class: "profile _gaps" }, [
              user.value.movedTo ? (_openBlock(), _createBlock(MkAccountMoved, {
                key: 0,
              ...
              _createElementVNode("div", {
                ...
                _createElementVNode(
                  ...
                  [
                    ...
                    _hoisted_1,
                    _createElementVNode("div", { class: "title" }, [_createVNode(_component_MkUserName, {
                      class: "name",
                      user: user.value,
                      nowrap: true
                    }, null, 8, ["user", "nowrap"]), _createElementVNode("div", { class: "bottom" }, [
                      _createElementVNode("span", { class: "username" }, [_createVNode(_component_MkAcct, {
                        user: user.value,
                        detail: true
                      }, null, 8, ["user", "detail"])]),
                      user.value.isLocked ? (_openBlock(), _createElementBlock("span", { key: 0 }, [_hoisted_2])) : _createCommentVNode("v-if", true),
                      user.value.isBot ? (_openBlock(), _createElementBlock("span", { key: 0 }, [_hoisted_3])) : _createCommentVNode("v-if", true),
                      _unref($i) && !isEditingMemo.value && !memoDraft.value ? (_openBlock(), _createElementBlock("button", {
                        key: 0,
                    ...
                    _unref($i) && _unref($i).id != user.value.id && user.value.isFollowed ? (_openBlock(), _createElementBlock(
                      "span",
                      {
                        key: 0,
                        class: "followed"
                    ...
                    _createElementVNode("div", { class: "actions" }, [_createElementVNode("button", {
                      class: "menu _button",
                      onClick: menu
                    }, [_hoisted_5]), _unref($i)?.id != user.value.id ? (_openBlock(), _createBlock(MkFollowButton, {
                      key: 0,
                      inline: true,
                      transparent: false,
                      full: true,
                      class: "koudoku",
                      user: user.value,
                      "onUpdate:user": _cache[0] || (_cache[0] = ($event) => user.value = $event)
                    }, null, 8, [
                      "inline",
                      "transparent",
                      "full",
                ...
                _createElementVNode("div", { class: "title" }, [_createVNode(_component_MkUserName, {
                  ...
                  user.value.isLocked ? (_openBlock(), _createElementBlock("span", { key: 0 }, [_hoisted_6])) : _createCommentVNode("v-if", true),
                  user.value.isBot ? (_openBlock(), _createElementBlock("span", { key: 0 }, [_hoisted_7])) : _createCommentVNode("v-if", true)
                ])]),
                user.value.followedMessage != null ? (_openBlock(), _createElementBlock("div", {
                  key: 0,
                  ...
                  default: _withCtx(() => [_createElementVNode(
                    "div",
                    _hoisted_8,
                    _toDisplayString(_unref(i18n).ts.messageToFollower),
                    1
                    /* TEXT */
                  ), _createElementVNode("div", null, [_createVNode(MkSparkle, null, {
                  ...
                  _: 1
                }, 8, ["tail"])])) : _createCommentVNode("v-if", true),
                user.value.roles.length > 0 ? (_openBlock(), _createElementBlock("div", {
                  key: 0,
                  class: "roles"
                }, [(_openBlock(true), _createElementBlock(
                  _Fragment,
                  null,
                  _renderList(user.value.roles, (role) => {
                ...
                _unref(iAmModerator) ? (_openBlock(), _createElementBlock("div", {
                  key: 0,
                  class: "moderationNote"
                }, [editModerationNote.value || moderationNote.value != null && moderationNote.value !== "" ? (_openBlock(), _createBlock(MkTextarea, {
                  key: 0,
                  manualSave: "",
                  ...
                  _: 1
                }, 8, ["modelValue"])) : (_openBlock(), _createElementBlock("div", { key: 1 }, [_createVNode(MkButton, {
                  small: "",
                  onClick: _cache[2] || (_cache[2] = ($event) => editModerationNote.value = true)
                }, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.addModerationNote),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                })]))])) : _createCommentVNode("v-if", true),
                isEditingMemo.value || memoDraft.value ? (_openBlock(), _createElementBlock(
                  "div",
                  {
                    key: 0,
                  ...
                  [_createElementVNode(
                    "div",
                    _hoisted_9,
                    _toDisplayString(_unref(i18n).ts.memo),
                    1
                    /* TEXT */
                  ), _withDirectives(_createElementVNode(
                    "textarea",
                    {
                      ref_key: "memoTextareaEl",
                      ref: memoTextareaEl,
                      "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => memoDraft.value = $event),
                      rows: "1",
                      onFocus: _cache[4] || (_cache[4] = ($event) => isEditingMemo.value = true),
                      onBlur: updateMemo,
                ...
                _createElementVNode("div", { class: "description" }, [_createVNode(
                  MkOmit,
                  null,
                  {
                    default: _withCtx(() => [user.value.description ? (_openBlock(), _createBlock(_component_Mfm, {
                      key: 0,
                ...
                _createElementVNode("div", { class: "fields system" }, [
                  user.value.location ? (_openBlock(), _createElementBlock("dl", {
                    key: 0,
                    class: "field"
                  }, [_createElementVNode("dt", { class: "name" }, [_hoisted_10, _createTextVNode(
                    ...
                    "dd",
                    _hoisted_11,
                    _toDisplayString(user.value.location),
                    1
                    /* TEXT */
                  )])) : _createCommentVNode("v-if", true),
                  user.value.birthday ? (_openBlock(), _createElementBlock("dl", {
                    key: 0,
                    class: "field"
                  }, [_createElementVNode("dt", { class: "name" }, [_hoisted_12, _createTextVNode(
                    ...
                    "dd",
                    _hoisted_13,
                    _toDisplayString(user.value.birthday.replace("-", "/").replace("-", "/")) + " (" + _toDisplayString(_unref(i18n).tsx.yearsOld({ age: age.value })) + ")",
                    1
                    /* TEXT */
                  )])) : _createCommentVNode("v-if", true),
                  _createElementVNode("dl", { class: "field" }, [_createElementVNode("dt", { class: "name" }, [_hoisted_14, _createTextVNode(
                    " " + _toDisplayString(_unref(i18n).ts.registeredDate),
                    1
                    /* TEXT */
                  )]), _createElementVNode("dd", { class: "value" }, [
                    _createTextVNode(
                      _toDisplayString(_unref(dateString)(user.value.createdAt)) + " (",
                      1
                      /* TEXT */
                    ),
                    _createVNode(_component_MkTime, { time: user.value.createdAt }, null, 8, ["time"]),
                    _createTextVNode(")")
                  ])])
                ]),
                user.value.fields.length > 0 ? (_openBlock(), _createElementBlock("div", {
                  key: 0,
                  class: "fields"
                }, [(_openBlock(true), _createElementBlock(
                  _Fragment,
                  null,
                  _renderList(user.value.fields, (field, i) => {
                    return _openBlock(), _createElementBlock("dl", {
                      key: i,
                      class: "field"
                    }, [_createElementVNode("dt", { class: "name" }, [_createVNode(_component_Mfm, {
                      text: field.name,
                      author: user.value,
                      plain: true,
                      colored: false,
                      ...
                      "plain",
                      "colored"
                    ])]), _createElementVNode("dd", { class: "value" }, [_createVNode(_component_Mfm, {
                      text: field.value,
                      author: user.value,
                      colored: false,
                      class: "_selectable"
                      ...
                      "author",
                      "colored"
                    ]), user.value.verifiedLinks.includes(field.value) ? _withDirectives((_openBlock(), _createElementBlock(
                      "i",
                      {
                        key: 0,
                ...
                _createElementVNode("div", { class: "status" }, [
                  _createVNode(_component_MkA, { to: _unref(userPage)(user.value, "notes") }, {
                    default: _withCtx(() => [_createElementVNode(
                      "b",
                      null,
                      _toDisplayString(number(user.value.notesCount)),
                      1
                      /* TEXT */
                    ), _createElementVNode(
                      "span",
                  ...
                  _unref(isFollowingVisibleForMe)(user.value) ? (_openBlock(), _createBlock(_component_MkA, {
                    key: 0,
                    ...
                    default: _withCtx(() => [_createElementVNode(
                      "b",
                      null,
                      _toDisplayString(number(user.value.followingCount)),
                      1
                      /* TEXT */
                    ), _createElementVNode(
                      "span",
                  ...
                  _unref(isFollowersVisibleForMe)(user.value) ? (_openBlock(), _createBlock(_component_MkA, {
                    key: 0,
                    ...
                    default: _withCtx(() => [_createElementVNode(
                      "b",
                      null,
                      _toDisplayString(number(user.value.followersCount)),
                      1
                      /* TEXT */
                    ), _createElementVNode(
                      "span",
              ...
              user.value.pinnedNotes.length > 0 ? (_openBlock(), _createElementBlock("div", {
                key: 0,
                class: "_gaps"
              }, [(_openBlock(true), _createElementBlock(
                _Fragment,
                null,
                _renderList(user.value.pinnedNotes, (note) => {
                ...
                128
                /* KEYED_FRAGMENT */
              ))])) : _unref($i) && _unref($i).id === user.value.id ? (_openBlock(), _createBlock(MkInfo, { key: 1 }, {
                default: _withCtx(() => [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts.userPagePinTip),
                  1
                  /* TEXT */
                )]),
                _: 1
              })) : _createCommentVNode("v-if", true),
              narrow.value ? (_openBlock(), _createElementBlock(
                _Fragment,
                { key: 0 },
                [_createVNode(_component_MkLazy, null, {
                  default: _withCtx(() => [_createVNode(XFiles, {
                    key: user.value.id,
                    user: user.value,
                    onShowMore: _cache[5] || (_cache[5] = ($event) => emit("showMoreFiles"))
                  }, null, 8, ["user"])]),
                  _: 1
                }), _createVNode(_component_MkLazy, null, {
                  default: _withCtx(() => [_createVNode(XActivity, {
                    key: user.value.id,
                    user: user.value
                  }, null, 8, ["user"])]),
                  _: 1
              ...
              !__props.disableNotes ? (_openBlock(), _createElementBlock("div", { key: 0 }, [_createVNode(_component_MkLazy, null, {
                default: _withCtx(() => [_createVNode(XTimeline, { user: user.value }, null, 8, ["user"])]),
                _: 1
              })])) : _createCommentVNode("v-if", true)
            ])]), !narrow.value ? (_openBlock(), _createElementBlock("div", {
              key: 0,
              class: "sub _gaps",
              style: "container-type: inline-size;"
            }, [_createVNode(XFiles, {
              key: user.value.id,
              user: user.value,
              onShowMore: _cache[6] || (_cache[6] = ($event) => emit("showMoreFiles"))
            }, null, 8, ["user"]), _createVNode(XActivity, {
              key: user.value.id,
              user: user.value
            }, null, 8, ["user"])])) : _createCommentVNode("v-if", true)],
            2
            /* CLASS */
          )],
          4
