    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(MkContainer, {
        ...
        header: _withCtx(() => [_createTextVNode(
          _toDisplayString(_unref(i18n).ts._widgets.trends),
          1
          /* TEXT */
        )]),
        default: _withCtx(() => [_createElementVNode("div", { class: "wbrkwala" }, [fetching.value ? (_openBlock(), _createBlock(_component_MkLoading, { key: 0 })) : (_openBlock(), _createBlock(_TransitionGroup, {
          key: 1,
          tag: "div",
          ...
          default: _withCtx(() => [(_openBlock(true), _createElementBlock(
            _Fragment,
            null,
            _renderList(stats.value, (stat) => {
              return _openBlock(), _createElementBlock("div", { key: stat.tag }, [_createElementVNode("div", { class: "tag" }, [_createVNode(_component_MkA, {
                class: "a",
                to: `/tags/${encodeURIComponent(stat.tag)}`,
                title: stat.tag
              }, {
                default: _withCtx(() => [_createTextVNode("#"), _createTextVNode(
                  _toDisplayString(stat.tag),
                  1
                  /* TEXT */
                )]),
                _: 2
                ...
                "p",
                null,
                _toDisplayString(_unref(i18n).tsx.nUsersMentioned({ n: stat.usersCount })),
                1
                /* TEXT */
