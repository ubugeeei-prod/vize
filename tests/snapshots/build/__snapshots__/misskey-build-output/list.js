...
export default {
  ...
  setup(__props) {
    ...
    const membershipsPaginator = markRaw(new Paginator("users/lists/get-memberships", {
      limit: 30,
      computedParams: computed(() => ({ listId: props.listId }))
    }));
    function fetchList() {
      misskeyApi("users/lists/show", { listId: props.listId }).then((_list) => {
        list.value = _list;
    ...
    async function deleteList() {
      ...
      if (canceled) return;
      await os.apiWithDialog("users/lists/delete", { listId: list.value.id });
    ...
    const headerActions = computed(() => list.value ? [{
      ...
      handler: () => {
        router.push("/timeline/list/:listId", { params: { listId: list.value.id } });
      }
    }] : []);
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_PageWithHeader, {
        ...
        default: _withCtx(() => [_createElementVNode("div", {
        ...
        }, [list.value ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          class: "_gaps"
          ...
          default: _withCtx(() => [_createElementVNode("div", { class: "_gaps" }, [
            ...
            _createVNode(MkSwitch, {
              ...
              default: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts.public),
                1
                /* TEXT */
              )]),
              _: 1
            ...
            _createElementVNode("div", { class: "_buttons" }, [_createVNode(MkButton, {
              ...
              rounded: "",
              danger: "",
              onClick: _cache[2] || (_cache[2] = ($event) => deleteList())
            }, {
              default: _withCtx(() => [_createTextVNode(
          ...
          label: _withCtx(() => [_createTextVNode(
            _toDisplayString(_unref(i18n).ts.members),
            1
            /* TEXT */
          )]),
          ...
          default: _withCtx(() => [_createElementVNode("div", { class: "_gaps" }, [_createVNode(MkButton, {
            ...
            primary: "",
            style: "margin: 0 auto;",
            onClick: _cache[3] || (_cache[3] = ($event) => addUser())
          }, {
            default: _withCtx(() => [
              _hoisted_1,
              _createTextVNode(" "),
            ...
            default: _withCtx(({ items }) => [_createElementVNode("div", { class: "_gaps_s" }, [(_openBlock(true), _createElementBlock(
              ...
              _renderList(items, (item) => {
                return _openBlock(), _createElementBlock("div", { key: item.id }, [_createElementVNode(
                  "div",
                  ...
                  [
                    ...
                    _createElementVNode("button", {
                      ...
                      onClick: ($event) => showMembershipMenu(item, $event)
