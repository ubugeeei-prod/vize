  ...
  setup(__props, { expose: __expose }) {
    ...
    async function unsubscribe() {
      ...
      if ($i && accounts.length >= 2) {
        apiWithDialog("sw/unregister", { endpoint }, $i.token);
      } else {
        pushSubscription.value.unsubscribe();
        apiWithDialog("sw/unregister", { endpoint }, null);
    ...
    */
    ...
    if (navigator.serviceWorker == null) {} else {
      navigator.serviceWorker.ready.then(async (swr) => {
        ...
        if (instance.swPublickey && "PushManager" in window && $i && $i.token) {
          ...
          if (pushSubscription.value) {
            const res = await misskeyApi("sw/show-registration", { endpoint: pushSubscription.value.endpoint });
            if (res) {
    ...
    __expose({ pushRegistrationInServer });
    return (_ctx, _cache) => {
      return supported.value && !pushRegistrationInServer.value ? (_openBlock(), _createBlock(MkButton, {
        key: 0,
        type: "button",
        primary: "",
        ...
        default: _withCtx(() => [_createTextVNode(
          _toDisplayString(_unref(i18n).ts.subscribePushNotification),
          1
          /* TEXT */
        )]),
        _: 1
        ...
        "wait",
        "full"
      ])) : !__props.showOnlyToRegister && (_unref($i) ? pushRegistrationInServer.value : pushSubscription.value) ? (_openBlock(), _createBlock(MkButton, {
        key: 1,
        type: "button",
        primary: false,
        gradate: __props.gradate,
        ...
        default: _withCtx(() => [_createTextVNode(
          _toDisplayString(_unref(i18n).ts.unsubscribePushNotification),
          1
          /* TEXT */
        )]),
        _: 1
        ...
        "wait",
        "full"
      ])) : _unref($i) && pushRegistrationInServer.value ? (_openBlock(), _createBlock(MkButton, {
        key: 2,
        disabled: "",
        rounded: __props.rounded,
        inline: __props.inline,
        ...
        default: _withCtx(() => [_createTextVNode(
          _toDisplayString(_unref(i18n).ts.pushNotificationAlreadySubscribed),
          1
          /* TEXT */
        )]),
        _: 1
        ...
        "wait",
        "full"
      ])) : !supported.value ? (_openBlock(), _createBlock(MkButton, {
        key: 3,
        disabled: "",
        rounded: __props.rounded,
        inline: __props.inline,
        ...
        default: _withCtx(() => [_createTextVNode(
          _toDisplayString(_unref(i18n).ts.pushNotificationNotSupported),
          1
          /* TEXT */
        )]),
        _: 1
