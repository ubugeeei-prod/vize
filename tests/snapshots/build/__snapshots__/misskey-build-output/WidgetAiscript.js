    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createBlock(MkContainer, {
        ...
        header: _withCtx(() => [_createTextVNode(
          _toDisplayString(_unref(i18n).ts._widgets.aiscript),
          1
          /* TEXT */
        )]),
        default: _withCtx(() => [_createElementVNode("div", { class: "uylguesu _monospace" }, [
          _withDirectives(_createElementVNode(
            "textarea",
            {
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _unref(widgetProps).script = $event),
              placeholder: "(1 + 1)"
            },
            null,
            512
          ...
          _createElementVNode("div", { class: "logs" }, [(_openBlock(true), _createElementBlock(
            _Fragment,
            null,
