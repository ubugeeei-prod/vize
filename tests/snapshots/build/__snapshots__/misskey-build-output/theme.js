...
export default {
  ...
  setup(__props) {
    ...
    function changeThemesSyncEnabled(value) {
      if (value) {
    ...
    function onThemeContextmenu(theme, ev) {
      os.contextMenu([
        {
          type: "label",
          text: theme.name
    ...
    function onThemeDragstart(ev, theme) {
          ...
          [
            _withDirectives(_createElementVNode("div", { class: "rfqxtzch _panel" }, [_createElementVNode("div", { class: "toggle" }, [_createElementVNode("div", { class: "toggleWrapper" }, [_createElementVNode(
              "div",
              {
                ...
                onClick: _cache[0] || (_cache[0] = ($event) => toggleDarkMode())
              },
              [
                _createElementVNode(
                  "span",
                  _hoisted_1,
                  _toDisplayString(_unref(i18n).ts.light),
                  1
                  /* TEXT */
                ),
                _createElementVNode(
                  "span",
                  _hoisted_2,
                  _toDisplayString(_unref(i18n).ts.dark),
                  1
                  /* TEXT */
                ),
              ...
              2
              /* CLASS */
            )])]), _createElementVNode("div", { class: "sync" }, [_createVNode(_component_SearchMarker, { keywords: [
              "sync",
              "device",
              "dark",
              "light",
              ...
              default: _withCtx(() => [_createVNode(MkSwitch, {
                ...
                "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => syncDeviceDarkMode.value = $event)
              }, {
                label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.syncDeviceDarkMode),
                    1
                    /* TEXT */
                  )]),
                  _: 1
            ...
            _unref(isSafeMode) ? (_openBlock(), _createBlock(MkInfo, {
              ...
              default: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts.themeIsDefaultBecauseSafeMode),
                1
                /* TEXT */
              )]),
              _: 1
              ...
              key: 1,
              class: "_gaps"
            }, [!_unref(store).r.darkMode.value ? (_openBlock(), _createBlock(_component_SearchMarker, {
              key: 0,
              keywords: ["light", "theme"]
            }, {
              default: _withCtx(() => [_createVNode(MkFolder, {
                defaultOpen: true,
                "max-height": 500
              }, {
                ...
                label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.themeForLightMode),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                caption: _withCtx(() => [_createTextVNode(
                  _toDisplayString(lightThemeName.value),
                  1
                  /* TEXT */
                )]),
                default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [
                  instanceLightTheme.value != null ? (_openBlock(), _createBlock(FormSection, {
                    key: 0,
                    first: ""
                  }, {
                    label: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts._theme.instanceTheme),
                      1
                      /* TEXT */
                    )]),
                    default: _withCtx(() => [_createElementVNode(
                      ...
                      [_createElementVNode(
                        ...
                        [_withDirectives(_createElementVNode("input", {
                          ...
                          "onUpdate:modelValue": [($event) => lightThemeId.value = $event, ($event) => lightThemeId.value = $event],
                          type: "radio",
                          name: "lightTheme",
                          class: _normalizeClass(_ctx.$style.themeRadio),
                          value: instanceLightTheme.value.id
                        }, null, 10, ["id", "value"]), [[_vModelRadio, lightThemeId.value]]), _createElementVNode("label", {
                          for: `themeRadio_${instanceLightTheme.value.id}`,
                          class: _normalizeClass(["_button", _ctx.$style.themeItemRoot]),
                          draggable: "true",
                          onDragstart: _cache[2] || (_cache[2] = ($event) => onThemeDragstart($event, instanceLightTheme.value)),
                          onContextmenu: _cache[3] || (_cache[3] = _withModifiers(($event) => onThemeContextmenu(instanceLightTheme.value, $event), ["prevent", "stop"]))
                        }, [_createVNode(MkThemePreview, {
                          theme: instanceLightTheme.value,
                          class: _normalizeClass(_ctx.$style.themeItemPreview)
                        }, null, 10, ["theme"]), _createElementVNode(
                          "div",
                          { class: _normalizeClass(_ctx.$style.themeItemCaption) },
                          _toDisplayString(instanceLightTheme.value.name),
                          3
                          /* TEXT, CLASS */
                        )], 42, ["for"])],
                        2
                  ...
                  installedLightThemes.value.length > 0 ? (_openBlock(), _createBlock(FormSection, {
                    key: 0,
                    first: instanceLightTheme.value == null
                  }, {
                    label: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts._theme.installedThemes),
                      1
                      /* TEXT */
                    )]),
                    default: _withCtx(() => [_createElementVNode(
                      ...
                      [(_openBlock(true), _createElementBlock(
                        _Fragment,
                        null,
                        _renderList(installedLightThemes.value, (theme) => {
                          return _openBlock(), _createElementBlock(
                            ...
                            [_withDirectives(_createElementVNode("input", {
                              ...
                              "onUpdate:modelValue",
                              "value"
                            ]), [[_vModelRadio, lightThemeId.value]]), _createElementVNode("label", {
                              for: `themeRadio_${theme.id}`,
                              class: _normalizeClass(["_button", _ctx.$style.themeItemRoot]),
                              draggable: "true",
                              onDragstart: ($event) => onThemeDragstart($event, theme),
                              onContextmenu: _withModifiers(($event) => onThemeContextmenu(theme, $event), ["prevent", "stop"])
                            }, [_createVNode(MkThemePreview, {
                              theme,
                              class: _normalizeClass(_ctx.$style.themeItemPreview)
                            }, null, 10, ["theme"]), _createElementVNode(
                  ...
                  _createVNode(FormSection, { first: installedLightThemes.value.length === 0 && instanceLightTheme.value == null }, {
                    ...
                    default: _withCtx(() => [_createElementVNode(
                      ...
                      [(_openBlock(true), _createElementBlock(
                        _Fragment,
                        null,
                        _renderList(builtinLightThemes.value, (theme) => {
                          return _openBlock(), _createElementBlock(
                            "div",
                            { class: _normalizeClass(_ctx.$style.themeItemOuter) },
                            [_withDirectives(_createElementVNode("input", {
              ...
              _: 1
            }, 8, ["keywords"])) : (_openBlock(), _createBlock(_component_SearchMarker, {
              key: 1,
              keywords: ["dark", "theme"]
            }, {
              default: _withCtx(() => [_createVNode(MkFolder, {
                ...
                icon: _withCtx(() => [_hoisted_13]),
                label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.themeForDarkMode),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                caption: _withCtx(() => [_createTextVNode(
                  _toDisplayString(darkThemeName.value),
                  1
                  /* TEXT */
                )]),
                default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [
                  instanceDarkTheme.value != null ? (_openBlock(), _createBlock(FormSection, {
                    key: 0,
                    first: ""
                  }, {
                    label: _withCtx(() => [_createTextVNode(
                    ...
                    default: _withCtx(() => [_createElementVNode(
                      ...
                      [_createElementVNode(
                        ...
                        [_withDirectives(_createElementVNode("input", {
                          ...
                          "onUpdate:modelValue": [($event) => darkThemeId.value = $event, ($event) => darkThemeId.value = $event],
                          type: "radio",
                          name: "darkTheme",
                          class: _normalizeClass(_ctx.$style.themeRadio),
                          value: instanceDarkTheme.value.id
                        }, null, 10, ["id", "value"]), [[_vModelRadio, darkThemeId.value]]), _createElementVNode("label", {
                          for: `themeRadio_${instanceDarkTheme.value.id}`,
                          class: _normalizeClass(["_button", _ctx.$style.themeItemRoot]),
                          draggable: "true",
                          onDragstart: _cache[4] || (_cache[4] = ($event) => onThemeDragstart($event, instanceDarkTheme.value)),
                          onContextmenu: _cache[5] || (_cache[5] = _withModifiers(($event) => onThemeContextmenu(instanceDarkTheme.value, $event), ["prevent", "stop"]))
                        }, [_createVNode(MkThemePreview, {
                          ...
                          "div",
                          { class: _normalizeClass(_ctx.$style.themeItemCaption) },
                          _toDisplayString(instanceDarkTheme.value.name),
                          3
                          /* TEXT, CLASS */
                        )], 42, ["for"])],
                        2
                  ...
                  installedDarkThemes.value.length > 0 ? (_openBlock(), _createBlock(FormSection, {
                    key: 0,
                    ...
                    default: _withCtx(() => [_createElementVNode(
                      ...
                      [(_openBlock(true), _createElementBlock(
                        _Fragment,
                        null,
                        _renderList(installedDarkThemes.value, (theme) => {
                          return _openBlock(), _createElementBlock(
                            "div",
                            { class: _normalizeClass(_ctx.$style.themeItemOuter) },
                            [_withDirectives(_createElementVNode("input", {
                              ...
                              "onUpdate:modelValue",
                              "value"
                            ]), [[_vModelRadio, darkThemeId.value]]), _createElementVNode("label", {
                              for: `themeRadio_${theme.id}`,
                              class: _normalizeClass(["_button", _ctx.$style.themeItemRoot]),
                              draggable: "true",
                              onDragstart: ($event) => onThemeDragstart($event, theme),
                  ...
                  _createVNode(FormSection, { first: installedDarkThemes.value.length === 0 && instanceDarkTheme.value == null }, {
                    ...
                    default: _withCtx(() => [_createElementVNode(
                      ...
                      [(_openBlock(true), _createElementBlock(
                        _Fragment,
                        null,
                        _renderList(builtinDarkThemes.value, (theme) => {
                          return _openBlock(), _createElementBlock(
                            "div",
                            { class: _normalizeClass(_ctx.$style.themeItemOuter) },
                            [_withDirectives(_createElementVNode("input", {
              ...
              default: _withCtx(() => [_createVNode(MkSwitch, {
                ...
                label: _withCtx(() => [
                  ...
                  _createVNode(_component_SearchLabel, null, {
                    default: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts._settings.enableSyncThemesBetweenDevices),
                      1
                      /* TEXT */
                    )]),
                    _: 1
            ...
            _createVNode(FormSection, null, {
              default: _withCtx(() => [_createElementVNode("div", { class: "_formLinksGrid" }, [
                _createVNode(FormLink, { to: "/settings/theme/manage" }, {
                  icon: _withCtx(() => [_hoisted_15]),
                  suffix: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(themesCount)),
                    1
                    /* TEXT */
                  )]),
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts._theme.manage),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                _createVNode(FormLink, {
                  ...
                  icon: _withCtx(() => [_hoisted_16]),
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts._theme.explore),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                _createVNode(FormLink, { to: "/settings/theme/install" }, {
                  icon: _withCtx(() => [_hoisted_17]),
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts._theme.install),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                _createVNode(FormLink, { to: "/theme-editor" }, {
                  icon: _withCtx(() => [_hoisted_18]),
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts._theme.make),
                    1
                    /* TEXT */
                  )]),
                  _: 1
