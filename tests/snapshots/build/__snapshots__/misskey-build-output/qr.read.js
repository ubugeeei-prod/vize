...
export default {
  ...
  setup(__props) {
    ...
    function updateLists() {
      const responses = uris.value.map((uri) => sources.get(uri)).filter((r) => !!r);
    ...
    async function processResult(result) {
      ...
      await misskeyApi("ap/show", { uri: trimmed }).then((data) => {
        if (data.type === "User") {
    ...
    onMounted(() => {
      ...
      scannerInstance.value.start().then(async () => {
        qrStarted.value = true;
        if (!scannerInstance.value) return;
        flashCanToggle.value = await scannerInstance.value.hasFlash();
        flash.value = scannerInstance.value.isFlashOn();
        ...
        [_createVNode(_component_MkStickyContainer, null, {
              ...
              _createElementVNode(
                ...
                [
                  ...
                  qrStarted.value ? _withDirectives((_openBlock(), _createBlock(MkButton, {
                    ...
                    _: 1
                  })), [[_directive_tooltip, _unref(i18n).ts._qr.stopQr]]) : _withDirectives((_openBlock(), _createBlock(MkButton, {
                    key: 1,
                    iconOnly: "",
                    danger: "",
                    onClick: startQr
                  ...
                  !flashCanToggle.value ? _withDirectives((_openBlock(), _createBlock(MkButton, {
                    ...
                    _: 1
                  })), [[_directive_tooltip, _unref(i18n).ts._qr.cannotToggleFlash]]) : !flash.value ? _withDirectives((_openBlock(), _createBlock(MkButton, {
                    key: 1,
                    iconOnly: "",
                    onClick: _cache[0] || (_cache[0] = ($event) => toggleFlash(true))
                  }, {
                    default: _withCtx(() => [_hoisted_6]),
                    _: 1
                  })), [[_directive_tooltip, _unref(i18n).ts._qr.turnOnFlash]]) : _withDirectives((_openBlock(), _createBlock(MkButton, {
                    key: 2,
                    iconOnly: "",
                    onClick: _cache[1] || (_cache[1] = ($event) => toggleFlash(false))
                  }, {
          ...
          default: _withCtx(() => [_createElementVNode(
            ...
            [_createVNode(
              ...
              null,
              {
                header: _withCtx(() => [_createVNode(MkTab, {
                  tabs: [
                    {
                      key: "users",
                      label: _unref(i18n).ts.users
                    },
                    {
                      key: "notes",
                      label: _unref(i18n).ts.notes
                    },
                    {
                      key: "all",
                ...
                }, null, 10, ["tabs", "modelValue"])]),
                default: _withCtx(() => [tab.value === "users" ? (_openBlock(), _createElementBlock(
                  "div",
                  {
                    key: 0,
                  ...
                  2
                  /* CLASS */
                )) : tab.value === "notes" ? (_openBlock(), _createElementBlock("div", {
                  key: 1,
                  class: "_margin _gaps",
                  style: "padding-bottom: var(--MI-margin);"
                }, [(_openBlock(true), _createElementBlock(
                  ...
                  128
                  /* KEYED_FRAGMENT */
                ))])) : tab.value === "all" ? (_openBlock(), _createElementBlock("div", {
                  key: 2,
                  class: "_margin _gaps",
                  style: "padding-bottom: var(--MI-margin);"
                }, [(_openBlock(true), _createElementBlock(
                  _Fragment,
                  null,
                  _renderList(Array.from(results.value).reverse(), (result) => {
