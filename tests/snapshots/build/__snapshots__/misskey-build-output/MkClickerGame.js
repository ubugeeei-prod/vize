...
export default {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock("div", null, [game.ready ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 0,
        ...
        [
          _createElementVNode(
            ...
            _toDisplayString(number(cps.value)) + "cps",
            3
            /* TEXT, CLASS */
          ),
          _createElementVNode(
            ...
            [_hoisted_1, _createTextVNode(
              " " + _toDisplayString(number(cookies.value)),
              1
              /* TEXT */
            )],
            2
