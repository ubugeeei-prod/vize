    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_PageWithHeader, {
        ...
        default: _withCtx(() => [_createElementVNode("div", {
          ...
          default: _withCtx(({ result: database }) => [(_openBlock(true), _createElementBlock(
            _Fragment,
            null,
            _renderList(database, (table) => {
              return _openBlock(), _createBlock(
                ...
                },
                {
                  ...
                  value: _withCtx(() => [_createTextVNode(
                    _toDisplayString(bytes(table[1].size)) + " (" + _toDisplayString(number(table[1].count)) + " recs)",
                    1
                    /* TEXT */
                  )]),
                  _: 2
