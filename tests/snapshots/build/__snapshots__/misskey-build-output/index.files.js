    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(MkContainer, null, {
        ...
        header: _withCtx(() => [_createTextVNode(
          _toDisplayString(_unref(i18n).ts.files),
          1
          /* TEXT */
        )]),
        default: _withCtx(() => [_createElementVNode(
          ...
          [
            ...
            !fetching.value && notes.value.length > 0 ? (_openBlock(), _createElementBlock("div", {
              key: 0,
              class: "_gaps_s"
            }, [_createElementVNode(
              "div",
              ...
              [(_openBlock(true), _createElementBlock(
                ...
                _renderList(notes.value, (note) => {
                  return _openBlock(), _createBlock(MkNoteMediaGrid, { note }, null, 8, ["note"]);
                }),
                256
                /* UNKEYED_FRAGMENT */
              ))],
              ...
              rounded: "",
              full: "",
              onClick: _cache[0] || (_cache[0] = ($event) => emit("showMore"))
            }, {
              default: _withCtx(() => [
                _createTextVNode(
            ...
            !fetching.value && notes.value.length == 0 ? (_openBlock(), _createElementBlock(
              "p",
              { key: 0 },
