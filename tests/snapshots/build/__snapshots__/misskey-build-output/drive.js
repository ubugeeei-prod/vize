...
export default {
  ...
  setup(__props) {
    ...
    function changeWatermarkPresetsSyncEnabled(value) {
      if (value) {
    ...
    if (prefer.s.uploadFolder) {
      misskeyApi("drive/folders/show", { folderId: prefer.s.uploadFolder }).then((response) => {
    ...
    function chooseUploadFolder() {
      selectDriveFolder(null).then(async ({ canceled, folders }) => {
        ...
        os.success();
        if (prefer.s.uploadFolder) {
          uploadFolder.value = await misskeyApi("drive/folders/show", { folderId: prefer.s.uploadFolder });
        } else {
    ...
    function onUpdateWatermarkPreset(id, preset) {
    ...
    function onDeleteWatermarkPreset(id) {
      const index = prefer.s.watermarkPresets.findIndex((p) => p.id === id);
      if (index !== -1) {
        prefer.commit("watermarkPresets", [...prefer.s.watermarkPresets.slice(0, index), ...prefer.s.watermarkPresets.slice(index + 1)]);
        if (prefer.s.defaultWatermarkPresetId === id) {
          prefer.commit("defaultWatermarkPresetId", null);
        }
      }
    }
    function onUpdateImageFramePreset(id, preset) {
    ...
    function onDeleteImageFramePreset(id) {
      const index = prefer.s.imageFramePresets.findIndex((p) => p.id === id);
      if (index !== -1) {
        prefer.commit("imageFramePresets", [...prefer.s.imageFramePresets.slice(0, index), ...prefer.s.imageFramePresets.slice(index + 1)]);
      }
    }
        ...
        default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [
          _createVNode(MkFeatureBanner, {
            ...
            default: _withCtx(() => [_createVNode(_component_SearchText, null, {
              default: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._settings.driveBanner),
                1
                /* TEXT */
              )]),
              _: 1
            ...
            default: _withCtx(() => [_createVNode(
              ...
              { first: "" },
              {
                label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.usageAmount),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                })]),
                default: _withCtx(() => [!fetching.value ? (_openBlock(), _createElementBlock("div", {
                  key: 0,
                  class: "_gaps_m"
                  ...
                  default: _withCtx(() => [_createVNode(MkKeyValue, null, {
                    key: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts.capacity),
                      1
                      /* TEXT */
                    )]),
                    value: _withCtx(() => [_createTextVNode(
                      _toDisplayString(bytes(capacity.value, 1)),
                      1
                      /* TEXT */
                    )]),
                    _: 1
                    ...
                    value: _withCtx(() => [_createTextVNode(
                      _toDisplayString(bytes(usage.value, 1)),
                      1
                      /* TEXT */
                    )]),
                    _: 1
          ...
          _createVNode(_component_SearchMarker, { keywords: ["statistics", "usage"] }, {
            default: _withCtx(() => [_createVNode(FormSection, null, {
              label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                default: _withCtx(() => [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts.statistics),
                  1
                  /* TEXT */
                )]),
                _: 1
              })]),
              default: _withCtx(() => [_createVNode(MkChart, {
                src: "per-user-drive",
                args: { user: _unref($i) },
                span: "day",
                limit: 7 * 5,
            ...
            default: _withCtx(() => [_createVNode(FormSection, null, {
              ...
              default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [
                _createVNode(_component_SearchMarker, { keywords: [
                  ...
                  default: _withCtx(() => [_createVNode(FormLink, { onClick: _cache[0] || (_cache[0] = ($event) => chooseUploadFolder()) }, {
                    suffix: _withCtx(() => [_createTextVNode(
                      _toDisplayString(uploadFolder.value ? uploadFolder.value.name : "-"),
                      1
                      /* TEXT */
                    )]),
                ...
                _createVNode(FormLink, { to: "/settings/drive/cleaner" }, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.drivecleaner),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                _createVNode(_component_SearchMarker, { keywords: [
                  ...
                  default: _withCtx(() => [_createVNode(MkPreferenceContainer, { k: "keepOriginalFilename" }, {
                    default: _withCtx(() => [_createVNode(MkSwitch, {
                      modelValue: _unref(keepOriginalFilename),
                      "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => keepOriginalFilename.value = $event)
                    }, {
                      label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                        default: _withCtx(() => [_createTextVNode(
                          _toDisplayString(_unref(i18n).ts.keepOriginalFilename),
                          1
                          /* TEXT */
                        )]),
                        _: 1
                      ...
                      caption: _withCtx(() => [_createVNode(_component_SearchText, null, {
                        default: _withCtx(() => [_createTextVNode(
                          _toDisplayString(_unref(i18n).ts.keepOriginalFilenameDescription),
                          1
                          /* TEXT */
                        )]),
                        _: 1
                ...
                _createVNode(_component_SearchMarker, { keywords: [
                  ...
                  default: _withCtx(() => [_createVNode(MkSwitch, {
                    "onUpdate:modelValue": [($event) => saveProfile(), ($event) => alwaysMarkNsfw.value = $event],
                    modelValue: alwaysMarkNsfw.value
                  }, {
                    label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                      default: _withCtx(() => [_createTextVNode(
                        _toDisplayString(_unref(i18n).ts.alwaysMarkSensitive),
                        1
                        /* TEXT */
                      )]),
                      _: 1
                ...
                _createVNode(_component_SearchMarker, { keywords: [
                  ...
                  default: _withCtx(() => [_createVNode(MkSwitch, {
                    "onUpdate:modelValue": [($event) => saveProfile(), ($event) => autoSensitive.value = $event],
                    modelValue: autoSensitive.value
                  }, {
                    label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                      default: _withCtx(() => [_createTextVNode(
                        _toDisplayString(_unref(i18n).ts.enableAutoSensitive),
                        1
                        /* TEXT */
                      )]),
                      _: 1
                    ...
                    caption: _withCtx(() => [_createVNode(_component_SearchText, null, {
                      default: _withCtx(() => [_createTextVNode(
                        _toDisplayString(_unref(i18n).ts.enableAutoSensitiveDescription),
                        1
                        /* TEXT */
                      )]),
                      _: 1
          ...
          _createVNode(_component_SearchMarker, { keywords: ["image"] }, {
            default: _withCtx(() => [_createVNode(FormSection, null, {
              label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                default: _withCtx(() => [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts.image),
                  1
                  /* TEXT */
                )]),
                _: 1
              ...
              default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [
                _createVNode(_component_SearchMarker, { keywords: ["watermark", "credit"] }, {
                  default: _withCtx(() => [_unref($i).policies.watermarkAvailable ? (_openBlock(), _createBlock(MkFolder, { key: 0 }, {
                    icon: _withCtx(() => [_hoisted_3]),
                    label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                      default: _withCtx(() => [_createTextVNode(
                        _toDisplayString(_unref(i18n).ts.watermark),
                        1
                        /* TEXT */
                      )]),
                      _: 1
                    ...
                    caption: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts._watermarkEditor.tip),
                      1
                      /* TEXT */
                    )]),
                    default: _withCtx(() => [_createElementVNode("div", { class: "_gaps" }, [
                      _createElementVNode("div", { class: "_gaps_s" }, [
                        (_openBlock(true), _createElementBlock(
                          _Fragment,
                          null,
                          _renderList(_unref(prefer).r.watermarkPresets.value, (preset, i) => {
                            return _openBlock(), _createBlock(XWatermarkItem, {
                              key: preset.id,
                              preset,
                              onUpdatePreset: ($event) => onUpdateWatermarkPreset(preset.id, $event),
                              onDel: ($event) => onDeleteWatermarkPreset(preset.id)
                            }, null, 8, [
                              "preset",
                              "onUpdatePreset",
                              "onDel"
                      ...
                      _createVNode(_component_SearchMarker, { keywords: [
                        ...
                        default: _withCtx(() => [_createVNode(MkPreferenceContainer, { k: "defaultWatermarkPresetId" }, {
                          default: _withCtx(() => [_createVNode(MkSelect, {
                            ...
                            "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => defaultWatermarkPresetId.value = $event)
                          }, {
                            label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                              default: _withCtx(() => [_createTextVNode(
                                _toDisplayString(_unref(i18n).ts.defaultPreset),
                                1
                                /* TEXT */
                              )]),
                              _: 1
                ...
                _createVNode(_component_SearchMarker, { keywords: [
                  ...
                  default: _withCtx(() => [_createVNode(MkFolder, null, {
                    ...
                    label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                      default: _withCtx(() => [_createTextVNode(
                        _toDisplayString(_unref(i18n).ts.frame),
                        1
                        /* TEXT */
                      )]),
                      _: 1
                    ...
                    caption: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts._imageFrameEditor.tip),
                      1
                      /* TEXT */
                    )]),
                    default: _withCtx(() => [_createElementVNode("div", { class: "_gaps" }, [_createElementVNode("div", { class: "_gaps_s" }, [
                      (_openBlock(true), _createElementBlock(
                        _Fragment,
                        null,
                        _renderList(_unref(prefer).r.imageFramePresets.value, (preset, i) => {
                          return _openBlock(), _createBlock(XImageFrameItem, {
                            key: preset.id,
                            preset,
                            onUpdatePreset: ($event) => onUpdateImageFramePreset(preset.id, $event),
                            onDel: ($event) => onDeleteImageFramePreset(preset.id)
                          }, null, 8, [
                            "preset",
                            "onUpdatePreset",
                            "onDel"
                ...
                _createVNode(_component_SearchMarker, { keywords: [
                  ...
                  default: _withCtx(() => [_createVNode(MkPreferenceContainer, { k: "defaultImageCompressionLevel" }, {
                    default: _withCtx(() => [_createVNode(MkSelect, {
                      items: [
                        {
                          label: _unref(i18n).ts.none,
                        ...
                        {
                          label: `${_unref(i18n).ts.low} (${_unref(i18n).ts._compression._quality.high}; ${_unref(i18n).ts._compression._size.large})`,
                          value: 1
                        },
                        {
                          label: `${_unref(i18n).ts.medium} (${_unref(i18n).ts._compression._quality.medium}; ${_unref(i18n).ts._compression._size.medium})`,
                          value: 2
                        },
                        {
                          label: `${_unref(i18n).ts.high} (${_unref(i18n).ts._compression._quality.low}; ${_unref(i18n).ts._compression._size.small})`,
                          value: 3
                        }
                      ],
                      modelValue: _unref(defaultImageCompressionLevel),
                      "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => defaultImageCompressionLevel.value = $event)
                    }, {
                      label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                        default: _withCtx(() => [_createTextVNode(
                          _toDisplayString(_unref(i18n).ts.defaultCompressionLevel),
                          1
                          /* TEXT */
                        )]),
                        _: 1
                      })]),
                      caption: _withCtx(() => [_createElementVNode("div", { innerHTML: _unref(i18n).ts.defaultCompressionLevel_description }, null, 8, ["innerHTML"])]),
                      _: 1
                    }, 8, ["items", "modelValue"])]),
                    _: 1
                  })]),
          ...
          _createVNode(_component_SearchMarker, { keywords: ["video"] }, {
            default: _withCtx(() => [_createVNode(FormSection, null, {
              label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                default: _withCtx(() => [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts.video),
                  1
                  /* TEXT */
                )]),
                _: 1
              })]),
              default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [_createVNode(_component_SearchMarker, { keywords: [
                "default",
                "video",
                "compression"
              ] }, {
                default: _withCtx(() => [_createVNode(MkPreferenceContainer, { k: "defaultVideoCompressionLevel" }, {
                  default: _withCtx(() => [_createVNode(MkSelect, {
                    items: [
                      {
                        label: _unref(i18n).ts.none,
                    ...
                    "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => defaultVideoCompressionLevel.value = $event)
                  }, {
                    label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                      default: _withCtx(() => [_createTextVNode(
                        _toDisplayString(_unref(i18n).ts.defaultCompressionLevel),
