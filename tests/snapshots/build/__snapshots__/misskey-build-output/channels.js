  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_PageWithHeader, {
        ...
        default: _withCtx(() => [_createElementVNode("div", {
        ...
        }, [tab.value === "search" ? (_openBlock(), _createElementBlock(
          "div",
          {
            key: 0,
          ...
          [_createElementVNode("div", { class: "_gaps" }, [
            ...
            _createVNode(MkRadios, {
              options: [{
                ...
                label: _unref(i18n).ts._channel.nameAndDescription
              }, {
                value: "nameOnly",
                label: _unref(i18n).ts._channel.nameOnly
              }],
              "onUpdate:modelValue": [($event) => search(), ($event) => searchType.value = $event],
          ...
          ]), channelPaginator.value ? (_openBlock(), _createBlock(MkFoldableSection, { key: 0 }, {
            header: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts.searchResult),
              1
              /* TEXT */
            )]),
            default: _withCtx(() => [_createVNode(MkChannelList, {
              key: key.value,
          ...
          2
          /* CLASS */
        )) : _createCommentVNode("v-if", true), tab.value === "featured" ? (_openBlock(), _createElementBlock("div", { key: 0 }, [_createVNode(MkPagination, { paginator: _unref(featuredPaginator) }, {
          ...
          _: 1
        }, 8, ["paginator"])])) : tab.value === "favorites" ? (_openBlock(), _createElementBlock("div", { key: 1 }, [_createVNode(MkPagination, { paginator: _unref(favoritesPaginator) }, {
          default: _withCtx(({ items }) => [_createElementVNode(
            "div",
            { class: _normalizeClass(_ctx.$style.root) },
            [(_openBlock(true), _createElementBlock(
          ...
          _: 1
        }, 8, ["paginator"])])) : tab.value === "following" ? (_openBlock(), _createElementBlock("div", { key: 2 }, [_createVNode(MkPagination, { paginator: _unref(followingPaginator) }, {
          default: _withCtx(({ items }) => [_createElementVNode(
            "div",
            { class: _normalizeClass(_ctx.$style.root) },
            [(_openBlock(true), _createElementBlock(
          ...
          _: 1
        }, 8, ["paginator"])])) : tab.value === "owned" ? (_openBlock(), _createElementBlock("div", {
          key: 3,
          class: "_gaps"
        }, [_createVNode(MkButton, {
          link: "",
