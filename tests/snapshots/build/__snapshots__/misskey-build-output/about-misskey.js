...
const _hoisted_3 = /* @__PURE__ */ _createElementVNode("img", {
  src: "/fluent-emoji/1f3c6.png",
  class: "treasureImg"
});
const _hoisted_4 = /* @__PURE__ */ _createElementVNode("br");
const _hoisted_5 = {
  href: "https://misskey-hub.net/docs/about-misskey/",
  target: "_blank",
  class: "_link"
};
...
const _hoisted_11 = /* @__PURE__ */ _createElementVNode("img", {
  style: "width: 100%;",
  src: "https://assets.misskey-hub.net/sponsors/masknetwork.png",
  alt: "Mask Network"
});
const _hoisted_12 = /* @__PURE__ */ _createElementVNode("img", {
  style: "width: 100%;",
  src: "https://assets.misskey-hub.net/sponsors/xserver.png",
  alt: "XServer"
});
const _hoisted_13 = /* @__PURE__ */ _createElementVNode("img", {
  style: "width: 100%;",
  src: "https://assets.misskey-hub.net/sponsors/skeb.svg",
  alt: "Skeb"
});
const _hoisted_14 = /* @__PURE__ */ _createElementVNode("img", {
  style: "width: 100%;",
  src: "https://assets.misskey-hub.net/sponsors/gmo_pepabo.svg",
  alt: "GMO Pepabo"
});
const _hoisted_15 = /* @__PURE__ */ _createElementVNode("img", {
  style: "width: 100%;",
  src: "https://assets.misskey-hub.net/sponsors/purple-dot-digital.jpg",
  alt: "Purple Dot Digital"
});
const _hoisted_16 = /* @__PURE__ */ _createElementVNode("img", {
  style: "width: 100%;",
  src: "https://assets.misskey-hub.net/sponsors/sads-llc.png",
  alt: "合同会社サッズ"
});
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_PageWithHeader, {
        ...
        default: _withCtx(() => [_createElementVNode("div", { style: "overflow: clip;" }, [_createElementVNode("div", {
          class: "_spacer",
          ...
          _withDirectives(_createElementVNode("div", { class: "about" }, [_createElementVNode(
            ...
            [
              ...
              _createElementVNode(
                "div",
                _hoisted_2,
                "v" + _toDisplayString(_unref(version)),
                1
                /* TEXT */
              ),
              (_openBlock(true), _createElementBlock(
                _Fragment,
                null,
                _renderList(easterEggEmojis.value, (emoji) => {
                  return _openBlock(), _createElementBlock("span", {
                  ...
                  }, [emoji.emoji[0] === ":" ? (_openBlock(), _createBlock(_component_MkCustomEmoji, {
                    key: 0,
                    class: "emoji",
                    name: emoji.emoji,
                    normal: true,
                    ...
                    "normal",
                    "noStyle"
                  ]))], 10, ["data-physics-x", "data-physics-y"]);
                }),
                128
                /* KEYED_FRAGMENT */
              ))
            ...
            2
            /* CLASS */
          ), thereIsTreasure.value ? (_openBlock(), _createElementBlock("button", {
            key: 0,
          ...
          _unref($i) != null ? (_openBlock(), _createElementBlock("div", {
            key: 0,
          ...
          _createVNode(FormSection, null, {
            default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_s" }, [
              _createVNode(FormLink, {
                ...
                suffix: _withCtx(() => [_createTextVNode("GitHub")]),
                default: _withCtx(() => [
                  _createTextVNode(" "),
                  _createTextVNode(
                    _toDisplayString(_unref(i18n).ts._aboutMisskey.source),
                    1
                    /* TEXT */
                  ),
                  _createTextVNode(" ("),
                  _createTextVNode(
                    _toDisplayString(_unref(i18n).ts._aboutMisskey.original),
                    1
                    /* TEXT */
                  ),
                  _createTextVNode(")\n              ")
              ...
              _createVNode(FormLink, {
                ...
                suffix: _withCtx(() => [_createTextVNode("Crowdin")]),
                default: _withCtx(() => [
                  _createTextVNode(" "),
                  _createTextVNode(
                    _toDisplayString(_unref(i18n).ts._aboutMisskey.translation),
                    1
                    /* TEXT */
                  ),
                  _createTextVNode(" ")
              ...
              _createVNode(FormLink, {
                ...
                suffix: _withCtx(() => [_createTextVNode("Patreon")]),
                default: _withCtx(() => [
                  _createTextVNode(" "),
                  _createTextVNode(
                    _toDisplayString(_unref(i18n).ts._aboutMisskey.donate),
                    1
                    /* TEXT */
                  ),
                  _createTextVNode(" ")
          ...
          _unref(instance).repositoryUrl !== "https://github.com/misskey-dev/misskey" ? (_openBlock(), _createBlock(FormSection, { key: 0 }, {
            default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_s" }, [
              _createVNode(MkInfo, null, {
                default: _withCtx(() => [_createTextVNode(
                  _toDisplayString(_unref(i18n).tsx._aboutMisskey.thisIsModifiedVersion({ name: _unref(instance).name ?? _unref(host) })),
                  1
                  /* TEXT */
                )]),
                _: 1
              }),
              _unref(instance).repositoryUrl ? (_openBlock(), _createBlock(FormLink, {
                key: 0,
              ...
              _unref(instance).providesTarball ? (_openBlock(), _createBlock(FormLink, {
                key: 0,
                to: `/tarball/misskey-${_unref(version)}.tar.gz`,
                external: ""
              }, {
                icon: _withCtx(() => [_hoisted_10]),
                suffix: _withCtx(() => [_createTextVNode("Tarball")]),
                default: _withCtx(() => [
                  _createTextVNode(" "),
                  _createTextVNode(
                    _toDisplayString(_unref(i18n).ts._aboutMisskey.source),
              ...
              !_unref(instance).repositoryUrl && !_unref(instance).providesTarball ? (_openBlock(), _createBlock(MkInfo, {
                key: 0,
                warn: ""
              }, {
                default: _withCtx(() => [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts.sourceCodeIsNotYetProvided),
                  1
                  /* TEXT */
                )]),
                _: 1
          ...
          _createVNode(FormSection, null, {
            label: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts._aboutMisskey.projectMembers),
              1
              /* TEXT */
            )]),
          ...
          _createVNode(FormSection, null, {
            label: _withCtx(() => [_createTextVNode("Special thanks")]),
            default: _withCtx(() => [_createElementVNode("div", { style: "display:grid;grid-template-columns:repeat(auto-fill, minmax(130px, 1fr));grid-gap:24px;align-items:center;" }, [
          ...
          _createVNode(FormSection, null, {
            label: _withCtx(() => [
              ...
              _createTextVNode(" "),
              _createTextVNode(
                _toDisplayString(_unref(i18n).ts._aboutMisskey.patrons),
                1
                /* TEXT */
              )
            ]),
            default: _withCtx(() => [
              _createElementVNode(
                ...
                [(_openBlock(true), _createElementBlock(
                  _Fragment,
                  null,
                  _renderList(patronsWithIcon, (patron) => {
                    return _openBlock(), _createElementBlock(
                      "div",
                      { class: _normalizeClass(_ctx.$style.patronWithIcon) },
              ...
              _createElementVNode("div", { style: "margin-top: 16px; display: grid; grid-template-columns: repeat(auto-fill, minmax(180px, 1fr)); grid-gap: 12px;" }, [(_openBlock(true), _createElementBlock(
                _Fragment,
                null,
                _renderList(patrons, (patron) => {
                  return _openBlock(), _createElementBlock(
                    "div",
                    { key: patron },
                    _toDisplayString(patron),
                    1
                    /* TEXT */
                  );
                }),
              ...
              _createElementVNode(
                "p",
                null,
                _toDisplayString(_unref(i18n).ts._aboutMisskey.morePatrons),
                1
                /* TEXT */
              )
            ]),
