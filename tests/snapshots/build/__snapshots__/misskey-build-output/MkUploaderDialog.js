...
export default {
  ...
  setup(__props, { emit: __emit }) {
    ...
    function showPerItemMenu(item, ev) {
      const menu = uploader.getMenu(item);
      os.popupMenu(menu, ev.currentTarget ?? ev.target);
    }
    function showPerItemMenuViaContextmenu(item, ev) {
      const menu = uploader.getMenu(item);
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(MkModalWindow, {
        ...
        header: _withCtx(() => [
          ...
          _createTextVNode(" "),
          _createTextVNode(
            _toDisplayString(_unref(i18n).tsx.uploadNFiles({ n: __props.files.length })),
            1
            /* TEXT */
          )
        ]),
        footer: _withCtx(() => [_createElementVNode("div", { class: "_buttonsCenter" }, [
          _unref(uploader).uploading.value ? (_openBlock(), _createBlock(MkButton, {
            key: 0,
            rounded: "",
            onClick: _cache[2] || (_cache[2] = ($event) => abortWithConfirm())
          }, {
            default: _withCtx(() => [
              _hoisted_3,
              _createTextVNode(" "),
              _createTextVNode(
                _toDisplayString(_unref(i18n).ts.abort),
                1
                /* TEXT */
              )
            ]),
            _: 1
          })) : !firstUploadAttempted.value ? (_openBlock(), _createBlock(MkButton, {
            key: 1,
            primary: "",
            rounded: "",
          ...
          canRetry.value ? (_openBlock(), _createBlock(MkButton, {
            key: 0,
            rounded: "",
            onClick: _cache[4] || (_cache[4] = ($event) => upload())
          }, {
            default: _withCtx(() => [
              _hoisted_5,
              _createTextVNode(" "),
              _createTextVNode(
                _toDisplayString(_unref(i18n).ts.retry),
                1
                /* TEXT */
              )
            ]),
          ...
          canDone.value ? (_openBlock(), _createBlock(MkButton, {
            key: 0,
            rounded: "",
            onClick: _cache[5] || (_cache[5] = ($event) => done())
          }, {
            default: _withCtx(() => [
              _hoisted_6,
              _createTextVNode(" "),
          ...
          [_createElementVNode(
            ...
            _createVNode(_component_MkTip, { k: "uploader" }, {
              default: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._uploader.tip),
                1
                /* TEXT */
              )]),
              _: 1
            ...
            props.multiple ? (_openBlock(), _createElementBlock("div", { key: 0 }, [_createVNode(MkButton, {
              style: "margin: auto;",
              iconOnly: true,
              rounded: "",
              onClick: _cache[8] || (_cache[8] = ($event) => chooseFile($event))
            }, {
              default: _withCtx(() => [_hoisted_2]),
              _: 1
            }, 8, ["iconOnly"])])) : _createCommentVNode("v-if", true),
            _createElementVNode(
              "div",
              null,
              _toDisplayString(_unref(i18n).tsx._uploader.maxFileSizeIsX({ x: _unref($i).policies.maxFileSizeMb + "MB" })),
              1
              /* TEXT */
            )
          ])],
