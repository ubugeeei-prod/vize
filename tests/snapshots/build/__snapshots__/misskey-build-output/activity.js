    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock("div", {
        ...
        _createVNode(MkFoldableSection, { class: "item" }, {
          header: _withCtx(() => [_hoisted_1, _createTextVNode(" Heatmap")]),
          default: _withCtx(() => [_createVNode(MkHeatmap, {
            user: __props.user,
            src: "notes"
          }, null, 8, ["user", "src"])]),
          _: 1
        ...
        _createVNode(MkFoldableSection, { class: "item" }, {
          header: _withCtx(() => [_hoisted_2, _createTextVNode(" Notes")]),
          default: _withCtx(() => [_createVNode(XNotes, { user: __props.user }, null, 8, ["user"])]),
          _: 1
        }),
        _createVNode(MkFoldableSection, { class: "item" }, {
          header: _withCtx(() => [_hoisted_3, _createTextVNode(" Following")]),
          default: _withCtx(() => [_createVNode(XFollowing, { user: __props.user }, null, 8, ["user"])]),
          _: 1
        }),
        _createVNode(MkFoldableSection, { class: "item" }, {
          header: _withCtx(() => [_hoisted_4, _createTextVNode(" PV")]),
          default: _withCtx(() => [_createVNode(XPv, { user: __props.user }, null, 8, ["user"])]),
          _: 1
        })
      ])]);
    };
