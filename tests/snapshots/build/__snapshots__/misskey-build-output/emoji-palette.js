...
export default {
  ...
  setup(__props) {
    ...
    const emojiPaletteForReactionDef = computed(() => [{
      label: `(${i18n.ts.auto})`,
      value: null
    ...
    const emojiPaletteForMainDef = computed(() => [{
      label: `(${i18n.ts.auto})`,
      value: null
    }, ...prefer.s.emojiPalettes.map((palette) => ({
      label: palette.name === "" ? `(${i18n.ts.noName})` : palette.name,
    ...
    function changePalettesSyncEnabled(value) {
      if (value) {
    ...
    function addPalette() {
      prefer.commit("emojiPalettes", [...prefer.s.emojiPalettes, {
        id: genId(),
        name: "",
        emojis: []
      }]);
    }
    function updatePaletteEmojis(id, emojis) {
    ...
    function updatePaletteName(id, name) {
      prefer.commit("emojiPalettes", prefer.s.emojiPalettes.map((palette) => {
        if (palette.id === id) {
          return {
            ...palette,
        ...
        default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [
          _createVNode(MkFeatureBanner, {
            ...
            default: _withCtx(() => [_createVNode(_component_SearchText, null, {
              default: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._settings.emojiPaletteBanner),
                1
                /* TEXT */
              )]),
              _: 1
          ...
          _createVNode(FormSection, { first: "" }, {
            label: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts._emojiPalette.palettes),
              1
              /* TEXT */
            )]),
            default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_s" }, [(_openBlock(true), _createElementBlock(
              _Fragment,
              null,
              _renderList(_unref(prefer).r.emojiPalettes.value, (palette) => {
                return _openBlock(), _createBlock(XPalette, {
                  key: palette.id,
                  palette,
                  onUpdateEmojis: (emojis) => updatePaletteEmojis(palette.id, emojis),
                  onUpdateName: (name) => updatePaletteName(palette.id, name),
                  onDel: ($event) => delPalette(palette.id)
                }, null, 8, [
                  "palette",
                  "onUpdateEmojis",
                  "onUpdateName",
              ...
              default: _withCtx(() => [_createVNode(MkSwitch, {
                ...
                label: _withCtx(() => [
                  ...
                  _createVNode(_component_SearchLabel, null, {
                    default: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts._emojiPalette.enableSyncBetweenDevicesForPalettes),
                      1
                      /* TEXT */
                    )]),
                    _: 1
          ...
          _createVNode(FormSection, null, {
            default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [_createVNode(_component_SearchMarker, { keywords: ["main", "palette"] }, {
              default: _withCtx(() => [_createVNode(MkPreferenceContainer, { k: "emojiPaletteForMain" }, {
                default: _withCtx(() => [_createVNode(MkSelect, {
                  items: emojiPaletteForMainDef.value,
                  modelValue: _unref(emojiPaletteForMain),
                  "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => emojiPaletteForMain.value = $event)
                }, {
                  label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                    default: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts._emojiPalette.paletteForMain),
                      1
                      /* TEXT */
                    )]),
                    _: 1
              ...
              _: 1
            }, 8, ["keywords"]), _createVNode(_component_SearchMarker, { keywords: ["reaction", "palette"] }, {
              default: _withCtx(() => [_createVNode(MkPreferenceContainer, { k: "emojiPaletteForReaction" }, {
                default: _withCtx(() => [_createVNode(MkSelect, {
                  items: emojiPaletteForReactionDef.value,
                  modelValue: _unref(emojiPaletteForReaction),
                  "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => emojiPaletteForReaction.value = $event)
                }, {
                  label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                    default: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts._emojiPalette.paletteForReaction),
                      1
                      /* TEXT */
                    )]),
                    _: 1
          ...
          _createVNode(_component_SearchMarker, { keywords: [
            ...
            default: _withCtx(() => [_createVNode(FormSection, null, {
              label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                default: _withCtx(() => [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts.emojiPickerDisplay),
                  1
                  /* TEXT */
                )]),
                _: 1
              ...
              default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [
                _createVNode(_component_SearchMarker, { keywords: [
                  ...
                  default: _withCtx(() => [_createVNode(MkPreferenceContainer, { k: "emojiPickerScale" }, {
                    default: _withCtx(() => [_createVNode(MkRadios, {
                      options: _unref(emojiPickerScaleDef),
                      modelValue: _unref(emojiPickerScale),
                      "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => emojiPickerScale.value = $event)
                    }, {
                      label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                        default: _withCtx(() => [_createTextVNode(
                          _toDisplayString(_unref(i18n).ts.size),
                          1
                          /* TEXT */
                        )]),
                        _: 1
                ...
                _createVNode(_component_SearchMarker, { keywords: [
                  ...
                  default: _withCtx(() => [_createVNode(MkPreferenceContainer, { k: "emojiPickerWidth" }, {
                    default: _withCtx(() => [_createVNode(MkRadios, {
                      options: _unref(emojiPickerWidthDef),
                      modelValue: _unref(emojiPickerWidth),
                      "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => emojiPickerWidth.value = $event)
                    }, {
                      label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                        default: _withCtx(() => [_createTextVNode(
                          _toDisplayString(_unref(i18n).ts.numberOfColumn),
                          1
                          /* TEXT */
                        )]),
                        _: 1
                ...
                _createVNode(_component_SearchMarker, { keywords: [
                  ...
                  default: _withCtx(() => [_createVNode(MkPreferenceContainer, { k: "emojiPickerHeight" }, {
                    default: _withCtx(() => [_createVNode(MkRadios, {
                      options: _unref(emojiPickerHeightDef),
                      modelValue: _unref(emojiPickerHeight),
                      "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => emojiPickerHeight.value = $event)
                    }, {
                      label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                        default: _withCtx(() => [_createTextVNode(
                          _toDisplayString(_unref(i18n).ts.height),
                          1
                          /* TEXT */
                        )]),
                        _: 1
                ...
                _createVNode(_component_SearchMarker, { keywords: [
                  ...
                  default: _withCtx(() => [_createVNode(MkPreferenceContainer, { k: "emojiPickerStyle" }, {
                    default: _withCtx(() => [_createVNode(MkSelect, {
                      items: [
                        {
                      ...
                      "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => emojiPickerStyle.value = $event)
                    }, {
                      label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                        default: _withCtx(() => [_createTextVNode(
                          _toDisplayString(_unref(i18n).ts.style),
                          1
                          /* TEXT */
                        )]),
                        _: 1
                      ...
                      caption: _withCtx(() => [_createTextVNode(
                        _toDisplayString(_unref(i18n).ts.needReloadToApply),
                        1
                        /* TEXT */
                      )]),
                      _: 1
