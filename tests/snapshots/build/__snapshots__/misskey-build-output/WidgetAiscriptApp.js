  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createBlock(MkContainer, {
        ...
        header: _withCtx(() => [_createTextVNode("App")]),
        default: _withCtx(() => [_createElementVNode(
          "div",
          { class: _normalizeClass(_ctx.$style.root) },
          [isSyntaxError.value ? (_openBlock(), _createElementBlock("div", { key: 0 }, "Syntax error :(")) : root.value ? (_openBlock(), _createBlock(MkAsUi, {
            key: 1,
            component: root.value,
            components: components.value,
            size: "small"
          }, null, 8, ["component", "components"])) : _createCommentVNode("v-if", true)],
          2
          /* CLASS */
        )]),
        _: 1
