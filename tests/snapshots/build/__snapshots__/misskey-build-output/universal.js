  ...
  setup(__props) {
    ...
    function onContextmenu(ev) {
      ...
      if ([
        ...
        "VIDEO",
        "CANVAS"
      ].includes(ev.target.tagName) || ev.target.attributes.getNamedItem("contenteditable") != null) return;
          ...
          _createElementVNode(
            ...
            [
              !isMobile.value ? (_openBlock(), _createBlock(XSidebar, {
                ...
                onWidgetButtonClick: _cache[0] || (_cache[0] = ($event) => widgetsShowing.value = true)
              }, null, 10, ["showWidgetButton"])) : _createCommentVNode("v-if", true),
              _createElementVNode(
                "div",
                {
                ...
                [
                  ...
                  _unref(prefer).s["experimental.stackingRouterView"] ? (_openBlock(), _createBlock(
                    _component_StackingRouterView,
                    {
                      key: 0,
                  ...
                  isMobile.value ? (_openBlock(), _createBlock(XMobileFooterMenu, {
                    ...
                    "onUpdate:drawerMenuShowing": _cache[1] || (_cache[1] = ($event) => drawerMenuShowing.value = $event),
                    widgetsShowing: widgetsShowing.value,
                    "onUpdate:widgetsShowing": _cache[2] || (_cache[2] = ($event) => widgetsShowing.value = $event)
                  }, null, 8, ["drawerMenuShowing", "widgetsShowing"])) : _createCommentVNode("v-if", true)
                ],
                34
                /* CLASS, NEED_HYDRATION */
              ),
              _unref(showWidgetsSide) && !pageMetadata.value?.needWideArea ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 0,
