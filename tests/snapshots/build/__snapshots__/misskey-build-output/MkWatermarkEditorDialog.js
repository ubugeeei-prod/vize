...
export default {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const layers = reactive(props.layers ?? []);
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createBlock(MkModalWindow, {
        ...
        header: _withCtx(() => [
          ...
          _createTextVNode(" "),
          _createTextVNode(
            _toDisplayString(_unref(i18n).ts._watermarkEditor.title),
            1
            /* TEXT */
          )
        ]),
        default: _withCtx(() => [_createVNode(MkPreviewWithControls, null, {
          ...
          controls: _withCtx(() => [_createElementVNode("div", { class: "_spacer _gaps" }, [_createElementVNode("div", { class: "_gaps_s" }, [(_openBlock(true), _createElementBlock(
            _Fragment,
            null,
            _renderList(layers, (layer, i) => {
              return _openBlock(), _createBlock(MkFolder, {
                ...
                label: _withCtx(() => [
                  layer.type === "text" ? (_openBlock(), _createElementBlock(
                    "div",
                    { key: 0 },
                  ...
                  layer.type === "image" ? (_openBlock(), _createElementBlock(
                    "div",
                    { key: 0 },
                    _toDisplayString(_unref(i18n).ts._watermarkEditor.image),
                    1
                    /* TEXT */
                  )) : _createCommentVNode("v-if", true),
                  layer.type === "qr" ? (_openBlock(), _createElementBlock(
                    "div",
                    { key: 0 },
                    _toDisplayString(_unref(i18n).ts._watermarkEditor.qr),
                    1
                    /* TEXT */
                  )) : _createCommentVNode("v-if", true),
                  layer.type === "stripe" ? (_openBlock(), _createElementBlock(
                    "div",
                    { key: 0 },
                    _toDisplayString(_unref(i18n).ts._watermarkEditor.stripe),
                    1
                    /* TEXT */
                  )) : _createCommentVNode("v-if", true),
                  layer.type === "polkadot" ? (_openBlock(), _createElementBlock(
                    "div",
                    { key: 0 },
                    _toDisplayString(_unref(i18n).ts._watermarkEditor.polkadot),
                    1
                    /* TEXT */
                  )) : _createCommentVNode("v-if", true),
                  layer.type === "checker" ? (_openBlock(), _createElementBlock(
                    "div",
                    { key: 0 },
                    _toDisplayString(_unref(i18n).ts._watermarkEditor.checker),
                    1
                    /* TEXT */
                  )) : _createCommentVNode("v-if", true)
                ]),
                footer: _withCtx(() => [_createElementVNode("div", { class: "_buttons" }, [
                  _createVNode(MkButton, {
                    iconOnly: "",
                    onClick: ($event) => removeLayer(layer)
                  }, {
                  ...
                  _createVNode(MkButton, {
                    iconOnly: "",
                    onClick: ($event) => swapUpLayer(layer)
                  }, {
                  ...
                  _createVNode(MkButton, {
                    iconOnly: "",
                    onClick: ($event) => swapDownLayer(layer)
                  }, {
                    default: _withCtx(() => [_hoisted_7]),
                    _: 2
                  }, 8, ["onClick"])
                ])]),
                default: _withCtx(() => [_createVNode(XLayer, {
                  layer: layers[i],
                  "onUpdate:layer": ($event) => layers[i] = $event
                }, null, 8, ["layer", "onUpdate:layer"])]),
                _: 2
              }, 1032, ["defaultOpen", "canPage"]);
            }),
            128
            /* KEYED_FRAGMENT */
          )), _createVNode(MkButton, {
