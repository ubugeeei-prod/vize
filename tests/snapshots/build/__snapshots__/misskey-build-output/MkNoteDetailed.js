  ...
  setup(__props) {
    ...
    if (noteViewInterruptors.length > 0) {
      ...
      for (const interruptor of noteViewInterruptors) {
        try {
          result = interruptor.handler(result);
        } catch (err) {
          console.error(err);
        }
      }
    ...
    async function react() {
      ...
      if (appearNote.reactionAcceptance === "likeOnly") {
        ...
        reactionPicker.show(reactButton.value ?? null, note, async (reaction) => {
          ...
          if (appearNote.text && appearNote.text.length > 100 && Date.now() - new Date(appearNote.createdAt).getTime() < 1e3 * 3) {
    ...
    function undoReact(targetNote) {
      const oldReaction = targetNote.myReaction;
      if (!oldReaction) return;
      misskeyApi("notes/reactions/delete", { noteId: targetNote.id }).then(() => {
    ...
    async function showRenoteMenu() {
      ...
      os.popupMenu([{
        ...
        danger: true,
        action: () => {
          misskeyApi("notes/delete", { noteId: note.id }).then(() => {
    ...
    function loadConversation() {
      ...
      misskeyApi("notes/conversation", { noteId: appearNote.replyId }).then((res) => {
    ...
    return (_ctx, _cache) => {
      ...
      return !muted.value && !hideByPlugin.value && !isDeleted.value ? _withDirectives((_openBlock(), _createElementBlock(
        "div",
        {
          key: 0,
          ref_key: "rootEl",
        ...
        [
          _unref(appearNote).reply && _unref(appearNote).reply.replyId ? (_openBlock(), _createElementBlock("div", { key: 0 }, [!conversationLoaded.value ? (_openBlock(), _createElementBlock("div", {
            ...
            default: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts.loadConversation),
              1
              /* TEXT */
            )]),
            _: 1
            ...
            _Fragment,
            null,
            _renderList(conversation.value, (note) => {
                ...
                [
                  _createElementVNode(
                    "button",
                    {
                      ...
                      onMousedown: _cache[0] || (_cache[0] = _withModifiers(($event) => showRenoteMenu(), ["prevent"]))
                    },
                    [_unref(isMyRenote) ? (_openBlock(), _createElementBlock("i", {
                      key: 0,
                      class: "ti ti-dots",
                      style: "margin-right: 4px;"
                    })) : _createCommentVNode("v-if", true), _createVNode(_component_MkTime, { time: _unref(note).createdAt }, null, 8, ["time"])],
                    34
                    /* CLASS, NEED_HYDRATION */
                  ),
                  _unref(note).visibility !== "public" ? (_openBlock(), _createElementBlock("span", {
                    key: 0,
                    ...
                    key: 1,
                    class: "ti ti-lock"
                  })) : _unref(note).visibility === "specified" ? (_openBlock(), _createElementBlock(
                    "i",
                    {
                      key: 2,
                      ref: "specified",
                    ...
                    512
                    /* NEED_PATCH */
                  )) : _createCommentVNode("v-if", true)], 8, ["title"])) : _createCommentVNode("v-if", true),
                  _unref(note).localOnly ? (_openBlock(), _createElementBlock("span", {
                    key: 0,
                    style: "margin-left: 0.5em;",
                    title: _unref(i18n).ts._visibility["disableFederation"]
                  }, [_hoisted_2], 8, ["title"])) : _createCommentVNode("v-if", true)
                ],
                2
                /* CLASS */
              )
          ...
          _unref(isRenote) && _unref(note).renote == null ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 0,
            ...
            [
              _createElementVNode(
                ...
                [
                      ...
                      [
                        _createElementVNode("div", null, [
                          ...
                          _createElementVNode(
                            ...
                            [_unref(appearNote).visibility !== "public" ? (_openBlock(), _createElementBlock("span", {
                              ...
                              key: 1,
                              class: "ti ti-lock"
                            })) : _unref(appearNote).visibility === "specified" ? (_openBlock(), _createElementBlock(
                              "i",
                              {
                                key: 2,
                                ref: "specified",
                              ...
                              512
                              /* NEED_PATCH */
                            )) : _createCommentVNode("v-if", true)], 8, ["title"])) : _createCommentVNode("v-if", true), _unref(appearNote).localOnly ? (_openBlock(), _createElementBlock("span", {
                              key: 0,
                              style: "margin-left: 0.5em;",
                              title: _unref(i18n).ts._visibility["disableFederation"]
                            }, [_hoisted_3], 8, ["title"])) : _createCommentVNode("v-if", true)],
                            2
                            /* CLASS */
                          )
                        ]),
                        _createElementVNode(
                          ...
                          [_createElementVNode(
                            ...
                            [_createVNode(_component_MkAcct, { user: _unref(appearNote).user }, null, 8, ["user"])],
                            2
                            /* CLASS */
                          ), _unref(appearNote).user.badgeRoles ? (_openBlock(), _createElementBlock(
                            "div",
                            {
                              key: 0,
                        ...
                        }, null, 8, ["host", "instance"])) : _createCommentVNode("v-if", true)
                      ],
                      2
                      /* CLASS */
                    )],
                  ...
                  _createElementVNode(
                    ...
                    [
                      _unref(appearNote).cw != null ? (_openBlock(), _createElementBlock(
                        "p",
                        {
                          key: 0,
                        ...
                        [_unref(appearNote).cw != "" ? (_openBlock(), _createBlock(_component_Mfm, {
                          ...
                          "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => showContent.value = $event)
                        }, null, 8, [
                          "text",
                          "renote",
                          "files",
                      ...
                      _withDirectives(_createElementVNode(
                        ...
                        null,
                        [
                          _unref(appearNote).isHidden ? (_openBlock(), _createElementBlock(
                            "span",
                            {
                              key: 0,
                              style: "opacity: 0.5"
                            },
                            "(" + _toDisplayString(_unref(i18n).ts.private) + ")",
                            1
                            /* TEXT */
                          )) : _createCommentVNode("v-if", true),
                          _unref(appearNote).replyId ? (_openBlock(), _createBlock(_component_MkA, {
                            key: 0,
                          ...
                          _unref(appearNote).text ? (_openBlock(), _createBlock(_component_Mfm, {
                            key: 0,
                          ...
                          _unref(appearNote).renote != null ? (_openBlock(), _createElementBlock(
                            "a",
                            {
                              key: 0,
                          ...
                          translating.value || translation.value ? (_openBlock(), _createElementBlock(
                            "div",
                            {
                              key: 0,
                            ...
                            [translating.value ? (_openBlock(), _createBlock(_component_MkLoading, {
                              key: 0,
                              mini: ""
                            })) : translation.value ? (_openBlock(), _createElementBlock("div", { key: 1 }, [_createElementVNode(
                              "b",
                              null,
                              _toDisplayString(_unref(i18n).tsx.translatedFrom({ x: translation.value.sourceLang })) + ": ",
                              1
                              /* TEXT */
                          ...
                          _unref(appearNote).files && _unref(appearNote).files.length > 0 ? (_openBlock(), _createElementBlock("div", { key: 0 }, [_createVNode(MkMediaList, {
                            ref_key: "galleryEl",
                            ref: galleryEl,
                            mediaList: _unref(appearNote).files
                          }, null, 8, ["mediaList"])])) : _createCommentVNode("v-if", true),
                          _unref(appearNote).poll ? (_openBlock(), _createBlock(MkPoll, {
                            key: 0,
                          ...
                          _unref(isEnabledUrlPreview) ? (_openBlock(), _createElementBlock("div", { key: 0 }, [(_openBlock(true), _createElementBlock(
                            _Fragment,
                            null,
                          ...
                          _unref(appearNote).renote ? (_openBlock(), _createElementBlock(
                            "div",
                            {
                              key: 0,
                        ...
                        512
                        /* NEED_PATCH */
                      ), [[_vShow, _unref(appearNote).cw == null || showContent.value]]),
                      _unref(appearNote).channel && !inChannel ? (_openBlock(), _createBlock(_component_MkA, {
                        key: 0,
                        ...
                        default: _withCtx(() => [
                          ...
                          _createTextVNode(" "),
                          _createTextVNode(
                            _toDisplayString(_unref(appearNote).channel.name),
                            1
                            /* TEXT */
                          )
                        ]),
                  ...
                  _createElementVNode("footer", null, [
                    _createElementVNode(
                      ...
                      [_createVNode(_component_MkA, { to: _unref(notePage)(_unref(appearNote)) }, {
                        default: _withCtx(() => [_createVNode(_component_MkTime, {
                    ...
                    _unref(appearNote).reactionAcceptance !== "likeOnly" ? (_openBlock(), _createBlock(MkReactionsViewer, {
                      key: 0,
                      style: "margin-top: 6px;",
                    ...
                    _createElementVNode(
                      "button",
                      {
                        ...
                        onClick: _cache[2] || (_cache[2] = ($event) => reply())
                      },
                      [_hoisted_6, _unref(appearNote).repliesCount > 0 ? (_openBlock(), _createElementBlock(
                        "p",
                        {
                          key: 0,
                          class: _normalizeClass(_ctx.$style.noteFooterButtonCount)
                        },
                        _toDisplayString(number(_unref(appearNote).repliesCount)),
                        3
                        /* TEXT, CLASS */
                      )) : _createCommentVNode("v-if", true)],
                      2
                    ...
                    canRenote.value ? (_openBlock(), _createElementBlock(
                      "button",
                      {
                        key: 0,
                        ref_key: "renoteButton",
                        ref: renoteButton,
                        class: _normalizeClass(["_button", _ctx.$style.noteFooterButton]),
                        onMousedown: _cache[3] || (_cache[3] = _withModifiers(($event) => renote(), ["prevent"]))
                      },
                      [_hoisted_7, _unref(appearNote).renoteCount > 0 ? (_openBlock(), _createElementBlock(
                        "p",
                        {
                          key: 0,
                          class: _normalizeClass(_ctx.$style.noteFooterButtonCount)
                        },
                        _toDisplayString(number(_unref(appearNote).renoteCount)),
                        3
                        /* TEXT, CLASS */
                      )) : _createCommentVNode("v-if", true)],
                      34
                    ...
                    _createElementVNode(
                      "button",
                      {
                        ...
                        ref: reactButton,
                        class: _normalizeClass(["_button", _ctx.$style.noteFooterButton]),
                        onClick: _cache[4] || (_cache[4] = ($event) => toggleReact())
                      },
                      [_unref(appearNote).reactionAcceptance === "likeOnly" && _unref($appearNote).myReaction != null ? (_openBlock(), _createElementBlock("i", {
                        ...
                        key: 3,
                        class: "ti ti-plus"
                      })), (_unref(appearNote).reactionAcceptance === "likeOnly" || _unref(prefer).s.showReactionsCount) && _unref($appearNote).reactionCount > 0 ? (_openBlock(), _createElementBlock(
                        "p",
                        {
                          key: 0,
                          class: _normalizeClass(_ctx.$style.noteFooterButtonCount)
                        },
                        _toDisplayString(number(_unref($appearNote).reactionCount)),
                        3
                        /* TEXT, CLASS */
                      )) : _createCommentVNode("v-if", true)],
                      2
                    ...
                    _unref(prefer).s.showClipButtonInNoteFooter ? (_openBlock(), _createElementBlock(
                      "button",
                      {
                        key: 0,
                        ref_key: "clipButton",
                        ref: clipButton,
                        class: _normalizeClass(["_button", _ctx.$style.noteFooterButton]),
                        onMousedown: _cache[5] || (_cache[5] = _withModifiers(($event) => clip(), ["prevent"]))
                      },
                      [_hoisted_9],
                      34
                      /* CLASS, NEED_HYDRATION */
                    ...
                    _createElementVNode(
                      "button",
                      {
                        ...
                        ref: menuButton,
                        class: _normalizeClass(["_button", _ctx.$style.noteFooterButton]),
                        onMousedown: _cache[6] || (_cache[6] = _withModifiers(($event) => showMenu(), ["prevent"]))
                      },
                      [_hoisted_10],
                      34
                      /* CLASS, NEED_HYDRATION */
                ...
                [
                  _createElementVNode(
                    "button",
                    {
                      ...
                      onClick: _cache[7] || (_cache[7] = ($event) => tab.value = "replies")
                    },
                    [_hoisted_11, _createTextVNode(
                      " " + _toDisplayString(_unref(i18n).ts.replies),
                      1
                      /* TEXT */
                    )],
                    2
                  ...
                  _createElementVNode(
                    "button",
                    {
                      ...
                      onClick: _cache[8] || (_cache[8] = ($event) => tab.value = "renotes")
                    },
                    [_hoisted_12, _createTextVNode(
                      " " + _toDisplayString(_unref(i18n).ts.renotes),
                      1
                      /* TEXT */
                    )],
                    2
                  ...
                  _createElementVNode(
                    "button",
                    {
                      ...
                      onClick: _cache[9] || (_cache[9] = ($event) => tab.value = "reactions")
                    },
                    [_hoisted_13, _createTextVNode(
                      " " + _toDisplayString(_unref(i18n).ts.reactions),
                      1
                      /* TEXT */
                    )],
                    2
              ...
              _createElementVNode("div", null, [tab.value === "replies" ? (_openBlock(), _createElementBlock("div", { key: 0 }, [!repliesLoaded.value ? (_openBlock(), _createElementBlock("div", {
                key: 0,
                style: "padding: 16px"
              }, [_createVNode(MkButton, {
                style: "margin: 0 auto;",
                ...
                default: _withCtx(() => [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts.loadReplies),
                  1
                  /* TEXT */
                )]),
                _: 1
                ...
                _Fragment,
                null,
                _renderList(replies.value, (note) => {
                  return _openBlock(), _createBlock(MkNoteSub, {
                    key: _unref(note).id,
                    note: _unref(note),
                ...
                128
                /* KEYED_FRAGMENT */
              ))])) : tab.value === "renotes" ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 1,
                ...
                [_createVNode(MkPagination, {
                  ...
                  default: _withCtx(({ items }) => [_createElementVNode("div", { style: "display: grid; grid-template-columns: repeat(auto-fill, minmax(270px, 1fr)); grid-gap: 12px;" }, [(_openBlock(true), _createElementBlock(
                    _Fragment,
                    null,
                  ...
                  _: 1
                }, 8, ["paginator", "forceDisableInfiniteScroll"])],
                2
                /* CLASS */
              )) : tab.value === "reactions" ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 2,
                ...
                [_createElementVNode(
                  ...
                  [(_openBlock(true), _createElementBlock(
                    _Fragment,
                    null,
                    _renderList(Object.keys(_unref($appearNote).reactions), (reaction) => {
                      return _openBlock(), _createElementBlock("button", {
                        key: reaction,
                        class: _normalizeClass(["_button", [_ctx.$style.reactionTab, { [_ctx.$style.reactionTabActive]: reactionTabType.value === reaction }]]),
                        onClick: ($event) => reactionTabType.value = reaction
                      }, [_createVNode(MkReactionIcon, { reaction }, null, 8, ["reaction"]), _createElementVNode(
                        "span",
                        _hoisted_14,
                        _toDisplayString(_unref($appearNote).reactions[reaction]),
                        1
                        /* TEXT */
                      )], 10, ["onClick"]);
                    }),
                  ...
                  2
                  /* CLASS */
                ), reactionTabType.value ? (_openBlock(), _createBlock(MkPagination, {
                  ...
                  _: 1
                }, 8, ["paginator", "forceDisableInfiniteScroll"])) : _createCommentVNode("v-if", true)],
                2
                /* CLASS */
              )) : _createCommentVNode("v-if", true)])
            ],
        ...
        2
        /* CLASS */
      )), [[_directive_hotkey, _unref(keymap)]]) : muted.value ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 1,
          class: _normalizeClass(["_panel", _ctx.$style.muted]),
          onClick: _cache[10] || (_cache[10] = ($event) => muted.value = false)
        },
        [_createVNode(_component_I18n, {
