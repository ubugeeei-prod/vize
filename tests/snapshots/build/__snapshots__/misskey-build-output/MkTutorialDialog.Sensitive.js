...
export default {
  ...
  setup(__props, { emit: __emit }) {
    const emit = __emit;
    const onceSucceeded = ref(false);
    function doSucceeded(fileId, to) {
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock("div", { class: "_gaps" }, [
        _createElementVNode(
          "div",
          _hoisted_1,
          _toDisplayString(_unref(i18n).ts._initialTutorial._howToMakeAttachmentsSensitive.description),
          1
          /* TEXT */
        ),
        _createElementVNode(
          "div",
          null,
          _toDisplayString(_unref(i18n).ts._initialTutorial._howToMakeAttachmentsSensitive.tryThisFile),
          1
          /* TEXT */
        ),
        _createVNode(MkInfo, null, {
          default: _withCtx(() => [_createTextVNode(
            _toDisplayString(_unref(i18n).ts._initialTutorial._howToMakeAttachmentsSensitive.method),
            1
            /* TEXT */
          )]),
          _: 1
        ...
        onceSucceeded.value ? (_openBlock(), _createElementBlock("div", { key: 0 }, [_createElementVNode("b", { style: "color: var(--MI_THEME-accent);" }, [_hoisted_2, _createTextVNode(
          " " + _toDisplayString(_unref(i18n).ts._initialTutorial.wellDone),
          1
          /* TEXT */
        )]), _createTextVNode(
          " " + _toDisplayString(_unref(i18n).ts._initialTutorial._howToMakeAttachmentsSensitive.sensitiveSucceeded),
          1
          /* TEXT */
        )])) : _createCommentVNode("v-if", true),
        _createVNode(MkFolder, null, {
          label: _withCtx(() => [_createTextVNode(
            _toDisplayString(_unref(i18n).ts.previewNoteText),
            1
            /* TEXT */
          )]),
          default: _withCtx(() => [_createVNode(MkNote, {
            mock: true,
            note: exampleNote,
            class: _normalizeClass(_ctx.$style.exampleRoot)
          }, null, 10, ["mock", "note"])]),
