  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_MkA, {
        ...
        default: _withCtx(() => [_createElementVNode("div", { class: "thumbnail" }, [_createVNode(_Transition, null, {
          default: _withCtx(() => [_createVNode(MkImgWithBlurhash, {
            class: "img layered",
          ...
          _: 1
        })]), _createElementVNode("article", null, [_createElementVNode("header", null, [_createVNode(_component_MkAvatar, {
          user: __props.post.user,
          class: "avatar",
          link: "",
          preview: ""
        }, null, 8, ["user"])]), _createElementVNode("footer", null, [_createElementVNode(
          "span",
          _hoisted_1,
          _toDisplayString(__props.post.title),
          1
          /* TEXT */
        )])])]),
        _: 1
