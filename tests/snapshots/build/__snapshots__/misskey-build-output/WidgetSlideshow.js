  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock(
        ...
        [_createElementVNode("div", { onClick: choose }, [
          _unref(widgetProps).folderId == null ? (_openBlock(), _createElementBlock(
            "p",
            { key: 0 },
          ...
          _unref(widgetProps).folderId != null && images.value.length === 0 && !fetching.value ? (_openBlock(), _createElementBlock(
            "p",
            { key: 0 },
