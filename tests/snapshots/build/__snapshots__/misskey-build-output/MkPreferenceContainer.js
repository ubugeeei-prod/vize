...
export default {
  ...
  setup(__props) {
    ...
    function showMenu(ev, contextmenu) {
      ...
      if (contextmenu) {
        ...
        os.popupMenu(prefer.getPerPrefMenu(props.k), ev.currentTarget ?? ev.target, { onClosing: () => {
          window.clearInterval(i);
        } });
      }
    }
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock(
        "div",
        {
          ...
          onContextmenu: _cache[0] || (_cache[0] = _withModifiers(($event) => showMenu($event, true), ["prevent", "stop"]))
        },
        [_createElementVNode(
          "div",
          ...
          [
            ...
            isAccountOverrided.value ? (_openBlock(), _createElementBlock("i", {
              key: 0,
            ...
            _createElementVNode(
              ...
              [_createElementVNode("button", {
                ...
                onClick: _cache[1] || (_cache[1] = ($event) => showMenu($event))
              }, [_hoisted_1])],
              2
              /* CLASS */
            )
