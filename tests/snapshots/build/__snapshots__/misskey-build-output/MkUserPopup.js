  ...
  setup(__props, { emit: __emit }) {
    ...
    async function fetchUser() {
      if (typeof props.q === "object") {
        ...
        const query = props.q.startsWith("@") ? Misskey.acct.parse(props.q.substring(1)) : { userId: props.q };
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_Transition, {
        ...
        default: _withCtx(() => [__props.showing ? (_openBlock(), _createElementBlock(
          "div",
          {
            key: 0,
          ...
          [error.value ? (_openBlock(), _createBlock(_component_MkError, {
            key: 0,
            onRetry: _cache[3] || (_cache[3] = ($event) => fetchUser())
          })) : user.value != null ? (_openBlock(), _createElementBlock("div", { key: 1 }, [
            _createElementVNode(
              "div",
              {
            ...
            _createElementVNode(
              ...
              [_createElementVNode("g", { transform: "matrix(1.6,0,0,1.6,-38.4,-51.2)" }, [_hoisted_1])],
              2
              /* CLASS */
            ),
            ...
            _createElementVNode(
              ...
              [_createVNode(_component_MkA, {
                ...
                [_createVNode(_component_MkAcct, { user: user.value }, null, 8, ["user"])],
                2
                /* CLASS */
              )],
              2
            ...
            _createElementVNode(
              ...
              [user.value.description ? (_openBlock(), _createBlock(_component_Mfm, {
                key: 0,
                class: _normalizeClass(_ctx.$style.mfm),
                text: user.value.description,
                author: user.value
              }, null, 10, ["text", "author"])) : (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 1,
                  style: "opacity: 0.7;"
            ...
            _unref($i) && user.value.id != _unref($i).id ? (_openBlock(), _createBlock(MkFollowButton, {
              key: 0,
              class: _normalizeClass(_ctx.$style.follow),
              mini: "",
              user: user.value,
              "onUpdate:user": _cache[4] || (_cache[4] = ($event) => user.value = $event)
            }, null, 10, ["user"])) : _createCommentVNode("v-if", true)
          ])) : (_openBlock(), _createElementBlock("div", { key: 2 }, [_createVNode(_component_MkLoading)]))],
          38
