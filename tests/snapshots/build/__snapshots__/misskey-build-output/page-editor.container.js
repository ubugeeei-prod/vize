...
export default {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock("div", { class: "cpjygsrt" }, [_createElementVNode("header", null, [_createElementVNode("div", { class: "title" }, [_renderSlot(_ctx.$slots, "header")]), _createElementVNode("div", { class: "buttons" }, [
        _renderSlot(_ctx.$slots, "func"),
        __props.removable ? (_openBlock(), _createElementBlock("button", {
          key: 0,
          class: "_button",
          onClick: _cache[0] || (_cache[0] = ($event) => remove())
        ...
        _createElementVNode("button", {
          class: "_button",
          onClick: _cache[1] || (_cache[1] = ($event) => toggleContent(!showBody.value))
