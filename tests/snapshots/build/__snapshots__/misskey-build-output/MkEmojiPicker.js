...
export default {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const tab = ref("index");
    const customEmojiFolderRoot = {
      value: "",
      category: "",
      children: []
    };
    function parseAndMergeCategories(input, root) {
    ...
    function canReact(emoji) {
      return !props.targetNote || checkReactionPermissions($i, props.targetNote, emoji);
    }
    function filterCategory(emoji, category) {
    ...
    function computeButtonTitle(ev) {
      const elm = ev.target;
      const emoji = elm.dataset.emoji;
      elm.title = getEmojiName(emoji);
    }
    function chosen(emoji, ev) {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock(
        "div",
        {
          class: _normalizeClass(["omfetrab", [
            "s" + size.value,
            "w" + width.value,
            "h" + height.value,
            {
              asDrawer: __props.asDrawer,
              asWindow: __props.asWindow
            }
          ]]),
        ...
        [
          _createElementVNode("input", {
            ...
            type: "search",
            autocapitalize: "off",
            onInput: _cache[0] || (_cache[0] = ($event) => input()),
          ...
          _createElementVNode(
            ...
            [
              _createElementVNode("section", { class: "result" }, [searchResultCustom.value.length > 0 ? (_openBlock(), _createElementBlock("div", {
                ...
                _Fragment,
                null,
                _renderList(searchResultCustom.value, (emoji) => {
                  return _openBlock(), _createElementBlock("button", {
                    ...
                    title: emoji.name,
                    tabindex: "0",
                    onClick: ($event) => chosen(emoji, $event)
                  }, [_createVNode(_component_MkCustomEmoji, {
                    class: "emoji",
                    name: emoji.name,
                    fallbackToImage: true
                  }, null, 8, ["name", "fallbackToImage"])], 8, [
                    "disabled",
                    "title",
                    "onClick"
                  ]);
                ...
                128
                /* KEYED_FRAGMENT */
              ))])) : _createCommentVNode("v-if", true), searchResultUnicode.value.length > 0 ? (_openBlock(), _createElementBlock("div", {
                key: 0,
                class: "body"
              }, [(_openBlock(true), _createElementBlock(
                _Fragment,
                null,
                _renderList(searchResultUnicode.value, (emoji) => {
                  return _openBlock(), _createElementBlock("button", {
                    key: emoji.name,
                    class: "_button item",
                    title: emoji.name,
                    ...
                    class: "emoji",
                    emoji: emoji.char
                  }, null, 8, ["emoji"])], 8, ["title", "onClick"]);
                }),
                128
                /* KEYED_FRAGMENT */
              ))])) : _createCommentVNode("v-if", true)]),
              tab.value === "index" ? (_openBlock(), _createElementBlock("div", {
                key: 0,
                class: "group index"
              }, [__props.showPinned && pinned.value && pinned.value.length > 0 ? (_openBlock(), _createElementBlock("section", { key: 0 }, [_createElementVNode("div", { class: "body" }, [(_openBlock(true), _createElementBlock(
                _Fragment,
                null,
                _renderList(pinnedEmojisDef.value, (emoji) => {
                  return _openBlock(), _createElementBlock("button", {
                    key: getKey(emoji),
                    ...
                    onClick: ($event) => chosen(emoji, $event)
                  }, [!emoji.hasOwnProperty("char") ? (_openBlock(), _createBlock(_component_MkCustomEmoji, {
                    key: 0,
                    class: "emoji",
                    name: getKey(emoji),
                    normal: true
                  }, null, 8, ["name", "normal"])) : (_openBlock(), _createBlock(_component_MkEmoji, {
                    key: 1,
                    class: "emoji",
                    emoji: getKey(emoji),
                    normal: true
                  }, null, 8, ["emoji", "normal"]))], 40, [
                    "data-emoji",
                    "disabled",
                    "onClick"
                  ]);
                ...
                1
                /* TEXT */
              )]), _createElementVNode("div", { class: "body" }, [(_openBlock(true), _createElementBlock(
                _Fragment,
                null,
                _renderList(recentlyUsedEmojisDef.value, (emoji) => {
                  return _openBlock(), _createElementBlock("button", {
                    key: getKey(emoji),
                    class: "_button item",
                    disabled: !canReact(emoji),
              ...
              _cache[1] || (_setBlockTracking(-1, true), (_cache[1] = _createElementVNode("div", { class: "group" }, [_createElementVNode(
                "header",
                _hoisted_3,
                _toDisplayString(_unref(i18n).ts.customEmojis),
                1
                /* TEXT */
              ), (_openBlock(true), _createElementBlock(
                _Fragment,
                null,
                _renderList(customEmojiFolderRoot.children, (child) => {
                ...
                128
                /* KEYED_FRAGMENT */
              ))])).cacheIndex = 1, _setBlockTracking(1), _cache[1]),
              _cache[2] || (_setBlockTracking(-1, true), (_cache[2] = _createElementVNode("div", { class: "group" }, [_createElementVNode(
                "header",
                _hoisted_4,
                _toDisplayString(_unref(i18n).ts.emoji),
                1
                /* TEXT */
              ), (_openBlock(true), _createElementBlock(
                _Fragment,
                null,
                _renderList(_unref(categories), (category) => {
                  return _openBlock(), _createBlock(XSection, {
                    key: category,
                    ...
                    default: _withCtx(() => [_createTextVNode(
                      _toDisplayString(category),
                      1
                      /* TEXT */
                    )]),
                    _: 2
                  }, 1032, ["emojis", "hasChildSection"]);
                }),
                128
                /* KEYED_FRAGMENT */
              ))])).cacheIndex = 2, _setBlockTracking(1), _cache[2])
            ],
            512
            /* NEED_PATCH */
          ),
          _createElementVNode("div", { class: "tabs" }, [
            _createElementVNode(
              "button",
              {
                class: _normalizeClass(["_button tab", { active: tab.value === "index" }]),
                onClick: _cache[3] || (_cache[3] = ($event) => tab.value = "index")
              },
              [_hoisted_5],
              2
              /* CLASS */
            ...
            _createElementVNode(
              "button",
              {
                ...
                onClick: _cache[4] || (_cache[4] = ($event) => tab.value = "custom")
              },
              [_hoisted_6],
              2
              /* CLASS */
            ...
            _createElementVNode(
              "button",
              {
                ...
                onClick: _cache[5] || (_cache[5] = ($event) => tab.value = "unicode")
              },
              [_hoisted_7],
              2
              /* CLASS */
            ...
            _createElementVNode(
              "button",
              {
                ...
                onClick: _cache[6] || (_cache[6] = ($event) => tab.value = "tags")
              },
              [_hoisted_8],
              2
              /* CLASS */
