...
export default {
  ...
  setup(__props, { emit: __emit }) {
    ...
    if (props.user.isFollowing == null && $i) {
      misskeyApi("users/show", { userId: props.user.id }).then(onFollowChange);
    }
    function onFollowChange(user) {
    ...
    async function onClick() {
      const isLoggedIn = await pleaseLogin({ openOnRemote: {
        type: "web",
      ...
      try {
        if (isFollowing.value) {
          ...
          await misskeyApi("following/delete", { userId: props.user.id });
          ...
          await misskeyApi("following/requests/cancel", { userId: props.user.id });
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock("button", {
        class: _normalizeClass(["_button", [_ctx.$style.root, {
          [_ctx.$style.wait]: wait.value,
          [_ctx.$style.active]: isFollowing.value || hasPendingFollowRequestFromYou.value,
          [_ctx.$style.full]: __props.full,
          [_ctx.$style.large]: __props.large
        }]]),
        disabled: wait.value,
        onClick
      }, [!wait.value ? (_openBlock(), _createElementBlock(
        _Fragment,
        { key: 0 },
        [hasPendingFollowRequestFromYou.value && __props.user.isLocked ? (_openBlock(), _createElementBlock(
          _Fragment,
          { key: 0 },
          [__props.full ? (_openBlock(), _createElementBlock(
            "span",
            {
              key: 0,
              class: _normalizeClass(_ctx.$style.text)
            },
            _toDisplayString(_unref(i18n).ts.followRequestPending),
            3
            /* TEXT, CLASS */
          ...
          [__props.full ? (_openBlock(), _createElementBlock(
            ...
            _toDisplayString(_unref(i18n).ts.processing),
            3
            /* TEXT, CLASS */
          )) : _createCommentVNode("v-if", true), _createVNode(_component_MkLoading, {
            em: true,
            colored: false
          }, null, 8, ["em", "colored"])],
          64
          /* STABLE_FRAGMENT */
        )) : isFollowing.value ? (_openBlock(), _createElementBlock(
          _Fragment,
          { key: 2 },
          [__props.full ? (_openBlock(), _createElementBlock(
            "span",
          ...
          64
          /* STABLE_FRAGMENT */
        )) : !isFollowing.value && __props.user.isLocked ? (_openBlock(), _createElementBlock(
          _Fragment,
          { key: 3 },
          [__props.full ? (_openBlock(), _createElementBlock(
            "span",
            ...
            _toDisplayString(_unref(i18n).ts.followRequest),
            3
            /* TEXT, CLASS */
          )) : _createCommentVNode("v-if", true), _hoisted_3],
          64
          /* STABLE_FRAGMENT */
        )) : !isFollowing.value && !__props.user.isLocked ? (_openBlock(), _createElementBlock(
          _Fragment,
          ...
          [__props.full ? (_openBlock(), _createElementBlock(
            ...
            3
            /* TEXT, CLASS */
          )) : _createCommentVNode("v-if", true), _hoisted_4],
          64
          /* STABLE_FRAGMENT */
