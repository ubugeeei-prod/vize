...
export default {
  ...
  setup(__props) {
    ...
    const federationPubActiveDiff = ref(null);
    const federationSubActive = ref(null);
    const federationSubActiveDiff = ref(null);
    ...
    onMounted(async () => {
      ...
      magicGrid.listen();
      */
      misskeyApiGet("charts/federation", {
        limit: 2,
        span: "day"
      }).then((chart) => {
      ...
      return _openBlock(), _createElementBlock("div", {
        ...
        [
          _createVNode(MkFoldableSection, { class: "item" }, {
            header: _withCtx(() => [_createTextVNode("Stats")]),
            default: _withCtx(() => [_createVNode(XStats)]),
            _: 1
          }),
          _createVNode(MkFoldableSection, { class: "item" }, {
            header: _withCtx(() => [_createTextVNode("Active users")]),
            default: _withCtx(() => [_createVNode(XActiveUsers)]),
            _: 1
          }),
          _createVNode(MkFoldableSection, { class: "item" }, {
            header: _withCtx(() => [_createTextVNode("Heatmap")]),
            default: _withCtx(() => [_createVNode(XHeatmap)]),
            _: 1
          }),
          _createVNode(MkFoldableSection, { class: "item" }, {
            header: _withCtx(() => [_createTextVNode("Retention rate")]),
            default: _withCtx(() => [_createVNode(XRetention)]),
            _: 1
          }),
          _createVNode(MkFoldableSection, { class: "item" }, {
            header: _withCtx(() => [_createTextVNode("Moderators")]),
            default: _withCtx(() => [_createVNode(XModerators)]),
            _: 1
          }),
          _createVNode(MkFoldableSection, { class: "item" }, {
            header: _withCtx(() => [_createTextVNode("Federation")]),
            default: _withCtx(() => [_createVNode(XFederation)]),
            _: 1
          }),
          _createVNode(MkFoldableSection, { class: "item" }, {
            header: _withCtx(() => [_createTextVNode("Instances")]),
            default: _withCtx(() => [_createVNode(XInstances)]),
            _: 1
          }),
          _createVNode(MkFoldableSection, { class: "item" }, {
            header: _withCtx(() => [_createTextVNode("Ap requests")]),
            default: _withCtx(() => [_createVNode(XApRequests)]),
            _: 1
          }),
          _createVNode(MkFoldableSection, { class: "item" }, {
            header: _withCtx(() => [_createTextVNode("New users")]),
            default: _withCtx(() => [_createVNode(XUsers)]),
            _: 1
          }),
          _createVNode(MkFoldableSection, { class: "item" }, {
            header: _withCtx(() => [_createTextVNode("Deliver queue")]),
            default: _withCtx(() => [_createVNode(XQueue, { domain: "deliver" })]),
            _: 1
          }),
          _createVNode(MkFoldableSection, { class: "item" }, {
            header: _withCtx(() => [_createTextVNode("Inbox queue")]),
            default: _withCtx(() => [_createVNode(XQueue, { domain: "inbox" })]),
            _: 1
          })
        ],
        2
