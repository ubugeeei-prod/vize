  ...
  setup(__props, { emit: __emit }) {
    ...
    const methodIcon = computed(() => {
      switch (entity.value.method) {
        ...
        case "webhook": return "ti-webhook";
        default: return "ti-help";
      }
    });
    const methodName = computed(() => {
      switch (entity.value.method) {
        case "email": return i18n.ts._abuseReport._notificationRecipient._recipientType.mail;
        case "webhook": return i18n.ts._abuseReport._notificationRecipient._recipientType.webhook;
        default: return "不明";
      }
    });
        ...
        [
          _createElementVNode(
            ...
            [_createElementVNode(
              ...
              " " + _toDisplayString(methodName.value),
              1
              /* TEXT */
            )],
            2
          ...
          _createElementVNode(
            ...
            _toDisplayString(_unref(entity).name),
            3
            /* TEXT, CLASS */
          ),
          _createElementVNode(
            ...
            [method.value === "email" && user.value ? (_openBlock(), _createElementBlock(
              "div",
              { key: 0 },
              ...
              1
              /* TEXT */
            )) : _createCommentVNode("v-if", true), method.value === "webhook" && systemWebhook.value ? (_openBlock(), _createElementBlock(
              "div",
              { key: 0 },
          ...
          _createElementVNode(
            ...
            [_createElementVNode(
              "button",
              {
                ...
                onClick: _cache[0] || (_cache[0] = ($event) => onEditButtonClicked())
              },
              [_hoisted_1],
              2
              /* CLASS */
              ...
              {
                class: _normalizeClass(_ctx.$style.recipientButton),
                onClick: _cache[1] || (_cache[1] = ($event) => onDeleteButtonClicked())
              },
              [_hoisted_2],
              2
              /* CLASS */
