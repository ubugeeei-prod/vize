...
export default {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock("span", null, [_createElementVNode(
        "span",
        null,
        "@" + _toDisplayString(__props.user.username),
        1
        /* TEXT */
      ), __props.user.host || __props.detail ? (_openBlock(), _createElementBlock(
        "span",
        {
          key: 0,
          style: "opacity: 0.5;"
        },
        "@" + _toDisplayString(__props.user.host || _unref(host)),
        1
        /* TEXT */
