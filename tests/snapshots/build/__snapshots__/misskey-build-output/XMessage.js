...
export default {
  ...
  setup(__props) {
    ...
    function onReactionClick(record) {
      if ($i.policies.chatAvailability !== "available") return;
    ...
    function showMenu(ev, contextmenu = false) {
      const menu = [];
      ...
      if (isMe.value && $i.policies.chatAvailability === "available") {
        menu.push({
          ...
          danger: true,
          action: () => {
            misskeyApi("chat/messages/delete", { messageId: props.message.id });
          }
        });
      }
        ...
        [_createVNode(_component_MkAvatar, {
          ...
          [
            ...
            _createVNode(MkFukidashi, {
              ...
              default: _withCtx(() => [__props.message.text ? (_openBlock(), _createBlock(_component_Mfm, {
                key: 0,
                ref: "text",
                class: "_selectable",
              ...
              ])) : _createCommentVNode("v-if", true), __props.message.file ? (_openBlock(), _createBlock(MkMediaList, {
                key: 0,
              ...
              [
                ...
                __props.isSearchResult && "toRoom" in __props.message && __props.message.toRoom != null ? (_openBlock(), _createBlock(_component_MkA, {
                  ...
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(__props.message.toRoom.name),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                }, 8, ["to"])) : _createCommentVNode("v-if", true),
                __props.isSearchResult && "toUser" in __props.message && __props.message.toUser != null && isMe.value ? (_openBlock(), _createBlock(_component_MkA, {
                  key: 0,
                  to: `/chat/user/${__props.message.toUserId}`
                }, {
                  default: _withCtx(() => [_createTextVNode("@"), _createTextVNode(
                    _toDisplayString(__props.message.toUser.username),
                    1
                    /* TEXT */
                  )]),
                  _: 1
            ...
            _createVNode(_TransitionGroup, {
              ...
              default: _withCtx(() => [(_openBlock(true), _createElementBlock(
                _Fragment,
                null,
                _renderList(__props.message.reactions, (record) => {
                  return _openBlock(), _createElementBlock("div", {
                    ...
                    onClick: ($event) => onReactionClick(record)
                  }, [_createVNode(_component_MkAvatar, {
                    user: record.user,
                    link: false,
                    class: _normalizeClass(_ctx.$style.reactionAvatar)
                  }, null, 10, ["user", "link"]), _createVNode(MkReactionIcon, {
                    withTooltip: true,
