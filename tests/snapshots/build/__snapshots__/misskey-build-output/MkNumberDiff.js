  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock(
        "span",
        { class: _normalizeClass(["ceaaebcd", {
          [_ctx.$style.isPlus]: isPlus.value,
          [_ctx.$style.isMinus]: isMinus.value,
          [_ctx.$style.isZero]: isZero.value
        }]) },
        [
          _renderSlot(_ctx.$slots, "before"),
          _createTextVNode(
            _toDisplayString(isPlus.value ? "+" : "") + _toDisplayString(number(__props.value)),
            1
            /* TEXT */
          ),
