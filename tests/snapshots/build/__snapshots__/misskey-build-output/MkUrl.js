  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createBlock(_resolveDynamicComponent(_unref(self) ? "MkA" : "a"), _normalizeProps({
        ...
        default: _withCtx(() => [
          !_unref(self) ? (_openBlock(), _createElementBlock(
            _Fragment,
            { key: 0 },
            [
              _createElementVNode(
                ...
                _toDisplayString(_unref(schema)) + "//",
                3
                /* TEXT, CLASS */
              ),
              _createElementVNode(
                ...
                _toDisplayString(_unref(hostname)),
                3
                /* TEXT, CLASS */
              ),
              _unref(port) != "" ? (_openBlock(), _createElementBlock(
                "span",
                { key: 0 },
                ":" + _toDisplayString(_unref(port)),
                1
                /* TEXT */
          ...
          _unref(pathname) === "/" && _unref(self) ? (_openBlock(), _createElementBlock(
            "span",
            {
              key: 0,
          ...
          _unref(pathname) != "" ? (_openBlock(), _createElementBlock(
            "span",
            {
              key: 0,
              class: _normalizeClass(_ctx.$style.pathname)
            },
            _toDisplayString(_unref(self) ? _unref(pathname).substring(1) : _unref(pathname)),
            3
            /* TEXT, CLASS */
          )) : _createCommentVNode("v-if", true),
          _createElementVNode(
          ...
          _createElementVNode(
            ...
            _toDisplayString(_unref(hash)),
            3
            /* TEXT, CLASS */
          ),
          _unref(target) === "_blank" ? (_openBlock(), _createElementBlock(
            "i",
            {
              key: 0,
