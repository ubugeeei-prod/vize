...
const _hoisted_2 = /* @__PURE__ */ _createElementVNode("stop", {
  offset: "100%",
  "stop-color": "#4ab300"
});
const _hoisted_3 = /* @__PURE__ */ _createElementVNode("animate", {
  attributeName: "d",
  dur: "20s",
...
const _hoisted_4 = /* @__PURE__ */ _createElementVNode("animate", {
  attributeName: "d",
  dur: "20s",
  repeatCount: "indefinite",
  keyTimes: "0;0.333;0.667;1",
          ...
          [_createElementVNode(
            ...
            [
              _createElementVNode("svg", {
                ...
                x2: "100%",
                y2: "0%"
              }, [_hoisted_1, _hoisted_2])]), _createElementVNode("g", { transform: "translate(427, 150) scale(1, 1) translate(-427, -150)" }, [_createElementVNode("path", {
                d: "",
                fill: "url(#linear)",
                opacity: "0.4"
              }, [_hoisted_3]), _createElementVNode("path", {
                d: "",
                fill: "url(#linear)",
                opacity: "0.4"
              }, [_hoisted_4])])]),
              ...
              _createElementVNode("div", { style: "padding: 16px 32px 32px 32px;" }, [!accountCreated.value ? (_openBlock(), _createElementBlock(
                "form",
                {
                  key: 0,
                  class: "_gaps_m",
                  onSubmit: _cache[0] || (_cache[0] = _withModifiers(($event) => createAccount(), ["prevent"]))
                },
                [
                  _createElementVNode("div", {
                    ...
                    "b",
                    null,
                    _toDisplayString(_unref(i18n).ts._serverSetupWizard.installCompleted),
                    1
                    /* TEXT */
                  )]), _createElementVNode(
                    "div",
                    null,
                    _toDisplayString(_unref(i18n).ts._serverSetupWizard.firstCreateAccount),
                    1
                    /* TEXT */
                  )]),
                  _createVNode(MkInput, {
                    ...
                    "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => setupPassword.value = $event)
                  }, {
                    label: _withCtx(() => [
                      _createTextVNode(
                        _toDisplayString(_unref(i18n).ts.initialPasswordForSetup),
                        1
                        /* TEXT */
                      ),
                      _createTextVNode(" "),
                  ...
                  _createElementVNode("div", null, [_createVNode(MkButton, {
                    ...
                    default: _withCtx(() => [_createTextVNode(
                      _toDisplayString(accountCreating.value ? _unref(i18n).ts.processing : _unref(i18n).ts.next),
                      1
                      /* TEXT */
                    ), accountCreating.value ? (_openBlock(), _createBlock(_component_MkEllipsis, { key: 0 })) : _createCommentVNode("v-if", true)]),
                    _: 2
                  }, 1032, ["disabled"])])
                ],
                32
                /* NEED_HYDRATION */
              )) : step.value === 0 ? (_openBlock(), _createElementBlock("div", {
                key: 1,
                class: "_gaps_m"
              }, [_createElementVNode("div", {
                style: "text-align: center;",
                ...
                "b",
                null,
                _toDisplayString(_unref(i18n).ts._serverSetupWizard.accountCreated),
                1
                /* TEXT */
                ...
                default: _withCtx(() => [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts.next),
                  1
                  /* TEXT */
                )]),
                _: 1
              })])) : step.value === 1 ? (_openBlock(), _createElementBlock("div", {
                key: 2,
                class: "_gaps_m"
              }, [
                _createElementVNode("div", {
                  ...
                  _createElementVNode("div", { style: "font-size: 120%;" }, [_createElementVNode(
                    "b",
                    null,
                    _toDisplayString(_unref(i18n).ts._serverSetupWizard.serverSetting),
                    1
                    /* TEXT */
                  )]),
                  _createElementVNode(
                    "div",
                    null,
                    _toDisplayString(_unref(i18n).ts._serverSetupWizard.youCanEasilyConfigureOptimalServerSettingsWithThisWizard),
                    1
                    /* TEXT */
                  ),
                  _createElementVNode(
                    "div",
                    null,
                    _toDisplayString(_unref(i18n).ts._serverSetupWizard.settingsYouMakeHereCanBeChangedLater),
                    1
                    /* TEXT */
                  )
                ]),
                ...
                _createVNode(MkButton, {
                  ...
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts._serverSetupWizard.skipSettings),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                })
              ])) : step.value === 2 ? (_openBlock(), _createElementBlock("div", {
                key: 3,
                class: "_gaps_m"
              }, [
                _createElementVNode("div", {
                  ...
                  _createElementVNode("div", null, [_createElementVNode(
                    "b",
                    null,
                    _toDisplayString(_unref(i18n).ts._serverSetupWizard.settingsCompleted),
                    1
                    /* TEXT */
                  )]),
                  _createElementVNode(
                    "div",
                    null,
                    _toDisplayString(_unref(i18n).ts._serverSetupWizard.settingsCompleted_description),
                    1
                    /* TEXT */
                  ),
                  _createElementVNode(
                    "div",
                    null,
                    _toDisplayString(_unref(i18n).ts._serverSetupWizard.settingsCompleted_description2),
                    1
                    /* TEXT */
                  )
                ]),
                _createElementVNode(
                  ...
                  [
                    _createElementVNode("div", null, [_createElementVNode(
                      "b",
                      null,
                      _toDisplayString(_unref(i18n).ts._serverSetupWizard.donationRequest),
                      1
                      /* TEXT */
                    )]),
                    _createElementVNode("div", null, [
                      _createTextVNode(
                        _toDisplayString(_unref(i18n).ts._serverSetupWizard._donationRequest.text1),
                        1
                        /* TEXT */
                      ),
                      _hoisted_10,
                      _createTextVNode(
                        _toDisplayString(_unref(i18n).ts._serverSetupWizard._donationRequest.text2),
                        1
                        /* TEXT */
                      ),
                      _hoisted_11,
                      _createTextVNode(
                        _toDisplayString(_unref(i18n).ts._serverSetupWizard._donationRequest.text3),
                        1
                        /* TEXT */
                      )
                    ]),
