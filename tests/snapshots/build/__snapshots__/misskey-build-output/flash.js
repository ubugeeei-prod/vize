...
export default {
  ...
  setup(__props) {
    ...
    function fetchFlash() {
      flash.value = null;
      misskeyApi("flash/show", { flashId: props.id }).then((_flash) => {
        flash.value = _flash;
      }).catch((err) => {
        error.value = err;
      });
    ...
    async function like() {
      ...
      os.apiWithDialog("flash/like", { flashId: flash.value.id }).then(() => {
    ...
    async function unlike() {
      ...
      os.apiWithDialog("flash/unlike", { flashId: flash.value.id }).then(() => {
    ...
    const aiscript = shallowRef(null);
    const root = ref();
    ...
    async function run() {
      ...
      const interpreter = new Interpreter({
        ...createAiScriptEnv({ storageKey: "flash:" + flash.value.id }),
    ...
    function showMenu(ev) {
      if (!flash.value) return;
      const menu = [...$i && $i.id !== flash.value.userId ? [{
        icon: "ti ti-exclamation-circle",
        text: i18n.ts.reportAbuse,
        action: reportAbuse
      }, ...$i.isModerator || $i.isAdmin ? [{ type: "divider" }, {
        icon: "ti ti-trash",
        text: i18n.ts.delete,
        danger: true,
        action: () => os.confirm({
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_PageWithHeader, {
        ...
        default: _withCtx(() => [_createElementVNode("div", {
          ...
          default: _withCtx(() => [flash.value ? (_openBlock(), _createElementBlock("div", { key: flash.value.id }, [
            _createVNode(_Transition, {
              name: _unref(prefer).s.animation ? "zoom" : "",
              mode: "out-in"
            }, {
              default: _withCtx(() => [started.value ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 0,
                  class: _normalizeClass(_ctx.$style.started)
                },
                [_createElementVNode("div", { class: "main _panel" }, [root.value ? (_openBlock(), _createBlock(MkAsUi, {
                  key: 0,
                  ...
                  flash.value.isLiked ? _withDirectives((_openBlock(), _createBlock(
                    ...
                    {
                      default: _withCtx(() => [_hoisted_2, flash.value?.likedCount && flash.value.likedCount > 0 ? (_openBlock(), _createElementBlock(
                        "span",
                        {
                          key: 0,
                    ...
                    1024
                    /* DYNAMIC_SLOTS */
                  )), [[_directive_tooltip, _unref(i18n).ts.unlike]]) : _withDirectives((_openBlock(), _createBlock(
                    MkButton,
                    {
                      key: 1,
                      asLike: "",
                    ...
                    {
                      default: _withCtx(() => [_hoisted_3, flash.value?.likedCount && flash.value.likedCount > 0 ? (_openBlock(), _createElementBlock(
                        "span",
                        {
                          key: 0,
                          style: "margin-left: 6px;"
                ...
                [_createElementVNode("div", { class: "_panel main" }, [
                  _createElementVNode(
                    "div",
                    _hoisted_7,
                    _toDisplayString(flash.value.title),
                    1
                    /* TEXT */
                  ),
                  _createElementVNode("div", { class: "summary" }, [_createVNode(_component_Mfm, { text: flash.value.summary }, null, 8, ["text"])]),
            ...
            _createVNode(MkFolder, {
              ...
              label: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._play.viewSource),
                1
                /* TEXT */
              )]),
            ...
            _createElementVNode(
              ...
              [_createVNode(_component_Mfm, { text: `By @${flash.value.user.username}` }, null, 8, ["text"]), _createElementVNode("div", { class: "date" }, [flash.value.createdAt != flash.value.updatedAt ? (_openBlock(), _createElementBlock("div", { key: 0 }, [
                _hoisted_10,
                _createTextVNode(
              ...
              ])) : _createCommentVNode("v-if", true), _createElementVNode("div", null, [
                _hoisted_11,
                _createTextVNode(
            ...
            _unref($i) && _unref($i).id === flash.value.userId ? (_openBlock(), _createBlock(_component_MkA, {
              key: 0,
              to: `/play/${flash.value.id}/edit`,
              style: "color: var(--MI_THEME-accent);"
            }, {
              default: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._play.editThisPage),
                1
                /* TEXT */
              )]),
              _: 1
            ...
            key: 1,
            onRetry: _cache[2] || (_cache[2] = ($event) => fetchFlash())
