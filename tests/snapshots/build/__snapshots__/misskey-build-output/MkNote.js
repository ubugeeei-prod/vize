...
export default {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const currentClip = inject("currentClip", null);
    ...
    const renoteCollapsed = ref(prefer.s.collapseRenotes && isRenote && ($i && ($i.id === note.userId || $i.id === appearNote.userId) || $appearNote.myReaction != null));
    const pleaseLoginContext = computed(() => ({
      type: "lookup",
      url: `https://${host}/notes/${appearNote.id}`
    }));
    function checkMute(noteToCheck, mutedWords, checkOnly = false) {
      if (mutedWords != null) {
    ...
    function readPromo() {
      misskeyApi("promo/read", { noteId: appearNote.id });
    }
    function emitUpdReaction(emoji, delta) {
      if (delta < 0) {
    ...
    return (_ctx, _cache) => {
      ...
      return !hardMuted.value && !hideByPlugin.value && muted.value === false ? _withDirectives((_openBlock(), _createElementBlock(
        "div",
        {
          key: 0,
          ref_key: "rootEl",
          ...
          class: _normalizeClass([_ctx.$style.root, {
            [_ctx.$style.showActionsOnlyHover]: _unref(prefer).s.showNoteActionsOnlyHover,
            [_ctx.$style.skipRender]: _unref(prefer).s.skipNoteRender
          }]),
          tabindex: "0"
        },
        [
          ...
          __props.pinned ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 0,
            ...
            [_hoisted_1, _createTextVNode(
              " " + _toDisplayString(_unref(i18n).ts.pinnedNote),
              1
              /* TEXT */
            )],
            2
          ...
          _unref(isRenote) ? (_openBlock(), _createElementBlock(
            ...
            [
              _unref(note).channel ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 0,
                ...
                [
                  _createElementVNode(
                    ...
                    [_createElementVNode(
                      ...
                      2
                      /* CLASS */
                    ), _createVNode(_component_MkTime, { time: _unref(note).createdAt }, null, 8, ["time"])],
                    34
                  ...
                  _unref(note).channel ? (_openBlock(), _createElementBlock("span", {
                    key: 0,
                    style: "margin-left: 0.5em;",
                    title: _unref(note).channel.name
                  }, [_hoisted_4], 8, ["title"])) : _createCommentVNode("v-if", true)
                ],
                2
                /* CLASS */
              )
          ...
          _unref(isRenote) && _unref(note).renote == null ? (_openBlock(), _createElementBlock(
            ...
            3
            /* TEXT, CLASS */
          )) : renoteCollapsed.value ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: 1,
            ...
            [_createVNode(_component_MkAvatar, {
              ...
              link: "",
              preview: ""
            }, null, 10, ["user"]), _createVNode(_component_Mfm, {
              ...
              onClick: _cache[1] || (_cache[1] = ($event) => renoteCollapsed.value = false)
            }, null, 10, [
              "text",
              "plain",
              "nowrap",
            ...
            [
              _unref(appearNote).channel ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 0,
                  class: _normalizeClass(_ctx.$style.colorBar),
              ...
              _createElementVNode(
                ...
                [
                  ...
                  _createElementVNode("div", { style: "container-type: inline-size;" }, [
                    _unref(appearNote).cw != null ? (_openBlock(), _createElementBlock(
                      ...
                      [_unref(appearNote).cw != "" ? (_openBlock(), _createBlock(_component_Mfm, {
                        ...
                        "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => showContent.value = $event)
                      }, null, 8, [
                        "text",
                        "renote",
                        "files",
                    ...
                    _withDirectives(_createElementVNode(
                      ...
                      [
                        ...
                        _unref(appearNote).files && _unref(appearNote).files.length > 0 ? (_openBlock(), _createElementBlock("div", {
                          key: 0,
                        ...
                        _unref(appearNote).renoteId ? (_openBlock(), _createElementBlock(
                          "div",
                          {
                            key: 0,
                        ...
                        _unref(isLong) && collapsed.value ? (_openBlock(), _createElementBlock(
                          "button",
                          {
                            key: 0,
                            class: _normalizeClass(["_button", _ctx.$style.collapsed]),
                            onClick: _cache[3] || (_cache[3] = ($event) => collapsed.value = false)
                          },
                          [_createElementVNode(
                            "span",
                          ...
                          "button",
                          {
                            ...
                            onClick: _cache[4] || (_cache[4] = ($event) => collapsed.value = true)
                          },
                          [_createElementVNode(
                            "span",
                            { class: _normalizeClass(_ctx.$style.showLessLabel) },
                            _toDisplayString(_unref(i18n).ts.showLess),
                            3
                            /* TEXT, CLASS */
                          )],
                          2
                  ...
                  _unref(appearNote).reactionAcceptance !== "likeOnly" ? (_openBlock(), _createBlock(MkReactionsViewer, {
                    ...
                    more: _withCtx(() => [_createVNode(_component_MkA, {
                    ...
                    [
                      _createElementVNode(
                        "button",
                        {
                          ...
                          onClick: _cache[5] || (_cache[5] = ($event) => reply())
                        },
                        [_hoisted_7, _unref(appearNote).repliesCount > 0 ? (_openBlock(), _createElementBlock(
                          "p",
                          {
                            key: 0,
                      ...
                      canRenote.value ? (_openBlock(), _createElementBlock(
                        "button",
                        {
                          ...
                          ref: renoteButton,
                          class: _normalizeClass(["_button", _ctx.$style.footerButton]),
                          onMousedown: _cache[6] || (_cache[6] = _withModifiers(($event) => renote(), ["prevent"]))
                        },
                        [_hoisted_8, _unref(appearNote).renoteCount > 0 ? (_openBlock(), _createElementBlock(
                          "p",
                          {
                            key: 0,
                            class: _normalizeClass(_ctx.$style.footerButtonCount)
                      ...
                      _createElementVNode(
                        "button",
                        {
                          ...
                          ref: reactButton,
                          class: _normalizeClass(["_button", _ctx.$style.footerButton]),
                          onClick: _cache[7] || (_cache[7] = ($event) => toggleReact())
                        },
                      ...
                      _unref(prefer).s.showClipButtonInNoteFooter ? (_openBlock(), _createElementBlock(
                        "button",
                        {
                          ...
                          ref: clipButton,
                          class: _normalizeClass(["_button", _ctx.$style.footerButton]),
                          onMousedown: _cache[8] || (_cache[8] = _withModifiers(($event) => clip(), ["prevent"]))
                        },
                        [_hoisted_10],
                        34
                        /* CLASS, NEED_HYDRATION */
                      ...
                      _createElementVNode(
                        "button",
                        {
                          ...
                          ref: menuButton,
                          class: _normalizeClass(["_button", _ctx.$style.footerButton]),
                          onMousedown: _cache[9] || (_cache[9] = _withModifiers(($event) => showMenu(), ["prevent"]))
                        },
                        [_hoisted_11],
                        34
                        /* CLASS, NEED_HYDRATION */
        ...
        2
        /* CLASS */
      )), [[_directive_hotkey, _unref(keymap)]]) : !hardMuted.value && !hideByPlugin.value ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 1,
