...
export default {
  ...
  setup(__props) {
    ...
    async function initialize() {
      ...
      if (props.userId) {
        const [u, m] = await Promise.all([misskeyApi("users/show", { userId: props.userId }), misskeyApi("chat/messages/user-timeline", {
          userId: props.userId,
          limit: LIMIT
        })]);
        user.value = u;
        ...
        const [rResult, mResult] = await Promise.allSettled([misskeyApi("chat/rooms/show", { roomId: props.roomId }), misskeyApi("chat/messages/room-timeline", {
          roomId: props.roomId,
          limit: LIMIT
        })]);
        ...
        const m = mResult.status === "fulfilled" ? mResult.value : [];
        room.value = r;
        messages.value = m.map((x) => normalizeMessage(x));
        if (messages.value.length === LIMIT) {
          canFetchMore.value = true;
    ...
    function onMessage(message) {
      ...
      if (message.fromUserId !== $i.id && !window.document.hidden && isActivated) {
        connection.value?.send("read", { id: message.id });
      }
    ...
    async function inviteUser() {
      ...
      const invitee = await os.selectUser({
        includeSelf: false,
        localOnly: true
      });
    ...
    async function leaveRoom() {
      ...
      if (canceled) return;
      misskeyApi("chat/rooms/leave", { roomId: room.value.id });
      router.push("/chat");
    }
    ...
    definePage(computed(() => {
      if (initialized.value) {
        if (user.value) {
          ...
          return { title: i18n.ts.directMessage };
        }
      } else {
        return { title: i18n.ts.directMessage };
      }
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_PageWithHeader, {
        ...
        footer: _withCtx(() => [tab.value === "chat" ? (_openBlock(), _createElementBlock(
          "div",
          {
            key: 0,
            class: _normalizeClass(_ctx.$style.footer)
          },
          [_createElementVNode("div", { class: "_gaps" }, [_createVNode(_Transition, { name: "fade" }, {
            default: _withCtx(() => [_withDirectives(_createElementVNode(
              ...
              [_createElementVNode(
                ...
                [_createElementVNode(
                  ...
                  _toDisplayString(_unref(i18n).ts._chat.newMessage),
                  1
                  /* TEXT */
                )],
                2
            ...
            _: 1
          }), initialized.value ? (_openBlock(), _createBlock(XForm, {
            key: 0,
            user: user.value,
            room: room.value,
            class: _normalizeClass(_ctx.$style.form)
          }, null, 10, ["user", "room"])) : _createCommentVNode("v-if", true)])],
          2
          /* CLASS */
        )) : _createCommentVNode("v-if", true)]),
        default: _withCtx(() => [tab.value === "chat" ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          class: "_spacer",
          style: "--MI_SPACER-w: 700px;"
        }, [_createElementVNode("div", { class: "_gaps" }, [
          initializing.value ? (_openBlock(), _createElementBlock("div", { key: 0 }, [_createVNode(_component_MkLoading)])) : messages.value.length === 0 ? (_openBlock(), _createElementBlock("div", { key: 1 }, [_createElementVNode("div", {
            class: "_gaps",
            style: "text-align: center;"
          }, [_createElementVNode(
            "div",
            null,
            _toDisplayString(_unref(i18n).ts._chat.noMessagesYet),
            1
            /* TEXT */
          ), user.value ? (_openBlock(), _createElementBlock(
            _Fragment,
            { key: 0 },
            [user.value.chatScope === "followers" ? (_openBlock(), _createElementBlock(
              "div",
              { key: 0 },
              _toDisplayString(_unref(i18n).ts._chat.thisUserAllowsChatOnlyFromFollowers),
              1
              /* TEXT */
            )) : user.value.chatScope === "following" ? (_openBlock(), _createElementBlock(
              "div",
              { key: 1 },
              _toDisplayString(_unref(i18n).ts._chat.thisUserAllowsChatOnlyFromFollowing),
              1
              /* TEXT */
            )) : user.value.chatScope === "mutual" ? (_openBlock(), _createElementBlock(
              "div",
              { key: 2 },
              _toDisplayString(_unref(i18n).ts._chat.thisUserAllowsChatOnlyFromMutualFollowing),
              1
              /* TEXT */
            )) : user.value.chatScope === "none" ? (_openBlock(), _createElementBlock(
              "div",
              { key: 3 },
              _toDisplayString(_unref(i18n).ts._chat.thisUserNotAllowedChatAnyone),
              1
              /* TEXT */
            )) : _createCommentVNode("v-if", true)],
            64
            /* STABLE_FRAGMENT */
          )) : room.value ? (_openBlock(), _createElementBlock(
            "div",
            { key: 1 },
            _toDisplayString(_unref(i18n).ts._chat.inviteUserToChat),
            1
            /* TEXT */
          )) : _createCommentVNode("v-if", true)])])) : (_openBlock(), _createElementBlock(
            "div",
            {
              key: 2,
              ref_key: "timelineEl",
            ...
            [canFetchMore.value ? (_openBlock(), _createElementBlock("div", { key: 0 }, [_createVNode(MkButton, {
              ...
              _: 1
            }, 10, ["wait"])])) : _createCommentVNode("v-if", true), _createVNode(_TransitionGroup, {
              ...
              default: _withCtx(() => [(_openBlock(true), _createElementBlock(
                _Fragment,
                null,
                _renderList(_unref(timeline).toReversed(), (item) => {
                  return _openBlock(), _createElementBlock(
                    _Fragment,
                    { key: item.id },
                    [item.type === "item" ? (_openBlock(), _createBlock(XMessage, {
                      key: 0,
                      message: item.data
                    }, null, 8, ["message"])) : item.type === "date" ? (_openBlock(), _createElementBlock(
                      "div",
                      {
                        key: 1,
                      ...
                      [
                        _createElementVNode("span", null, [_hoisted_1, _createTextVNode(
                          " " + _toDisplayString(item.nextText),
                          1
                          /* TEXT */
                        )]),
                        _hoisted_2,
          ...
          user.value && (!user.value.canChat || user.value.host !== null) ? (_openBlock(), _createElementBlock("div", { key: 0 }, [_createVNode(MkInfo, { warn: "" }, {
            default: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts._chat.chatNotAvailableInOtherAccount),
              1
              /* TEXT */
            )]),
            _: 1
          })])) : _createCommentVNode("v-if", true),
          _unref($i).policies.chatAvailability !== "available" ? (_openBlock(), _createBlock(MkInfo, {
            key: 0,
            warn: ""
          }, {
            default: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref($i).policies.chatAvailability === "readonly" ? _unref(i18n).ts._chat.chatIsReadOnlyForThisAccountOrServer : _unref(i18n).ts._chat.chatNotAvailableForThisAccountOrServer),
              1
              /* TEXT */
            )]),
            _: 1
          })) : _createCommentVNode("v-if", true)
        ])])) : tab.value === "search" ? (_openBlock(), _createElementBlock("div", {
          key: 1,
          class: "_spacer",
          style: "--MI_SPACER-w: 700px;"
        ...
        }, null, 8, ["userId", "roomId"])])) : tab.value === "members" ? (_openBlock(), _createElementBlock("div", {
          key: 2,
          class: "_spacer",
          style: "--MI_SPACER-w: 700px;"
        }, [room.value != null ? (_openBlock(), _createBlock(XMembers, {
          key: 0,
          room: room.value,
          onInviteUser: inviteUser
        }, null, 8, ["room"])) : _createCommentVNode("v-if", true)])) : tab.value === "info" ? (_openBlock(), _createElementBlock("div", {
          key: 3,
          class: "_spacer",
          style: "--MI_SPACER-w: 700px;"
        }, [room.value != null ? (_openBlock(), _createBlock(XInfo, {
          key: 0,
          room: room.value
        }, null, 8, ["room"])) : _createCommentVNode("v-if", true)])) : _createCommentVNode("v-if", true)]),
        _: 2
      }, 1032, [
        "reversed",
        "tabs",
