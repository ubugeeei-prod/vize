        ...
        default: _withCtx(() => [_createElementVNode("div", {
          ...
          _createVNode(MkButton, {
            ...
            default: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts._registry.createKey),
              1
              /* TEXT */
            )]),
            _: 1
          }),
          keys.value ? (_openBlock(), _createBlock(FormSection, { key: 0 }, {
            label: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts._registry.keys),
              1
              /* TEXT */
            )]),
            default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_s" }, [(_openBlock(true), _createElementBlock(
              _Fragment,
              null,
              _renderList(keys.value, (key) => {
                return _openBlock(), _createBlock(FormLink, {
                  to: `/registry/value/${props.domain}/${scope.value.join("/")}/${key[0]}`,
                  class: "_monospace"
                }, {
