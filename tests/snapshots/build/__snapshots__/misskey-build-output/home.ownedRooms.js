  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock("div", { class: "_gaps" }, [
        rooms.value.length > 0 ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          class: "_gaps_s"
        }, [(_openBlock(true), _createElementBlock(
          _Fragment,
          null,
          _renderList(rooms.value, (room) => {
        ...
        !fetching.value && rooms.value.length == 0 ? (_openBlock(), _createBlock(_component_MkResult, {
          key: 0,
          type: "empty",
