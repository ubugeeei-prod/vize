  ...
  setup(__props) {
    ...
    const rangePercent = computed({
      ...
      set: (to) => {
        ...
        audioEl.value.currentTime = to * durationMs.value / 1e3;
      }
    });
    const volume = ref(.25);
    const speed = ref(1);
        ...
        if (audioEl.value) {
          ...
          function updateMediaTick() {
            if (audioEl.value) {
              ...
              elapsedTimeMs.value = audioEl.value.currentTime * 1e3;
          ...
          durationMs.value = audioEl.value.duration * 1e3;
    ...
    return (_ctx, _cache) => {
      ...
      return _withDirectives((_openBlock(), _createElementBlock("div", {
        ...
        ref: playerEl,
        tabindex: "0",
        class: _normalizeClass([_ctx.$style.audioContainer, __props.audio.isSensitive && _unref(prefer).s.highlightSensitiveMedia && _ctx.$style.sensitive]),
        ...
        [_createElementVNode(
          ...
          [__props.audio.isSensitive ? (_openBlock(), _createElementBlock("b", {
            ...
            " " + _toDisplayString(_unref(i18n).ts.sensitive) + _toDisplayString(_unref(prefer).s.dataSaver.media ? ` (${_unref(i18n).ts.audio}${__props.audio.size ? " " + bytes(__props.audio.size) : ""})` : ""),
            1
            /* TEXT */
            ...
            " " + _toDisplayString(_unref(prefer).s.dataSaver.media && __props.audio.size ? bytes(__props.audio.size) : _unref(i18n).ts.audio),
            1
            /* TEXT */
          )])), _createElementVNode(
            "span",
        ...
        }, [_createElementVNode("source", { src: __props.audio.url }, null, 8, ["src"])], 42, ["onKeydown"])],
        2
        /* CLASS */
        ...
        [
          _createElementVNode(
            ...
            [_createElementVNode("source", { src: __props.audio.url }, null, 8, ["src"])],
            32
            /* NEED_HYDRATION */
          ),
          _createElementVNode(
