...
export default {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock("div", { class: "_gaps_m" }, [(_openBlock(true), _createElementBlock(
        _Fragment,
        null,
        _renderList(_unref(statusbars), (x) => {
          return _openBlock(), _createBlock(
            ...
            { key: x.id },
            {
              ...
              default: _withCtx(() => [_createVNode(XStatusbar, {
                _id: x.id,
                userLists: userLists.value
              }, null, 8, ["_id", "userLists"])]),
              _: 2
            },
            1024
            /* DYNAMIC_SLOTS */
