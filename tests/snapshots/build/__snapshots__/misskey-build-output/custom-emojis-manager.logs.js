...
export default {
  ...
  setup(__props) {
    ...
    const showingSuccessLogs = ref(false);
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock("div", null, [_unref(logs).length > 0 ? (_openBlock(), _createElementBlock("div", {
        ...
        "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => showingSuccessLogs.value = $event)
      }, {
        label: _withCtx(() => [_createTextVNode(
          _toDisplayString(_unref(i18n).ts._customEmojisManager._logs.showSuccessLogSwitch),
          1
          /* TEXT */
        )]),
        _: 1
      }, 8, ["modelValue"]), _createElementVNode("div", null, [filteredLogs.value.length > 0 ? (_openBlock(), _createElementBlock("div", { key: 0 }, [_createVNode(MkGrid, {
        data: filteredLogs.value,
        settings: setupGrid()
      }, null, 8, ["data", "settings"])])) : (_openBlock(), _createElementBlock(
        "div",
        { key: 1 },
