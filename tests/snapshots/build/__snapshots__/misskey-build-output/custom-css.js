      ...
      return _openBlock(), _createElementBlock("div", { class: "_gaps_m" }, [
        _createVNode(FormInfo, { warn: "" }, {
          default: _withCtx(() => [_createTextVNode(
            _toDisplayString(_unref(i18n).ts.customCssWarn),
            1
            /* TEXT */
          )]),
          _: 1
        ...
        _unref(isSafeMode) ? (_openBlock(), _createBlock(FormInfo, {
          ...
          default: _withCtx(() => [_createTextVNode(
            _toDisplayString(_unref(i18n).ts.customCssIsDisabledBecauseSafeMode),
            1
            /* TEXT */
          )]),
          _: 1
        ...
        _createVNode(MkCodeEditor, {
          ...
          "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => localCustomCss.value = $event)
        }, {
          label: _withCtx(() => [_createTextVNode("CSS")]),
          _: 1
        }, 8, ["modelValue"])
      ]);
    };
