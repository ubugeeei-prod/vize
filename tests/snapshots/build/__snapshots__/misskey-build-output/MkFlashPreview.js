  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_MkA, {
        ...
        default: _withCtx(() => [_createElementVNode("article", null, [
          _createElementVNode("header", null, [_createElementVNode("h1", { title: __props.flash.title }, _toDisplayString(__props.flash.title), 9, ["title"])]),
          __props.flash.summary ? (_openBlock(), _createElementBlock("p", {
            key: 0,
          ...
          _createElementVNode("footer", null, [_createElementVNode("img", {
            class: "icon",
            src: __props.flash.user.avatarUrl
          }, null, 8, ["src"]), _createElementVNode(
            "p",
            null,
            _toDisplayString(_unref(userName)(__props.flash.user)),
            1
            /* TEXT */
          )])
        ])]),
