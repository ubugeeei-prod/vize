...
export default {
  ...
  async setup(__props) {
    ...
    const proxyAccount = ([__temp, __restore] = _withAsyncContext(() => misskeyApi("users/show", { userId: meta.proxyAccountId })), __temp = await __temp, __restore(), __temp);
    ...
    const pinnedUsersForm = useForm({ pinnedUsers: meta.pinnedUsers.join("\n") }, async (state) => {
      await os.apiWithDialog("admin/update-meta", { pinnedUsers: state.pinnedUsers.split("\n") });
      fetchInstance(true);
    });
    ...
    const adForm = useForm({ notesPerOneAd: meta.notesPerOneAd }, async (state) => {
      await os.apiWithDialog("admin/update-meta", { notesPerOneAd: state.notesPerOneAd });
      fetchInstance(true);
    });
    ...
    const proxyAccountForm = useForm({ description: proxyAccount.description }, async (state) => {
      await os.apiWithDialog("admin/update-proxy-account", { description: state.description });
      fetchInstance(true);
    });
    async function openSetupWizard() {
      ...
      if (canceled) return;
      const { dispose } = await os.popupAsyncWithDialog(import("@/components/MkServerSetupWizardDialog.vue").then((x) => x.default), {}, { closed: () => dispose() });
    }
        ...
        default: _withCtx(() => [_createElementVNode("div", {
          ...
          default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [
            _createVNode(_component_SearchMarker, { keywords: ["information", "meta"] }, {
              default: _withCtx((slotProps) => [_createVNode(MkFolder, { defaultOpen: true }, _createSlots({ _: 2 }, [
                {
                  name: "icon",
                ...
                },
                {
                  ...
                  fn: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                    default: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts.info),
                      1
                      /* TEXT */
                    )]),
                    _: 1
                ...
                _unref(infoForm).modified.value ? {
                  name: "footer",
                  fn: _withCtx(() => [_createVNode(MkFormFooter, { form: _unref(infoForm) }, null, 8, ["form"])]),
                  key: "0"
                } : undefined
              ]), 1032, ["defaultOpen"])]),
              _: 1
            ...
            _createVNode(_component_SearchMarker, { keywords: ["pinned", "users"] }, {
              default: _withCtx((slotProps) => [_createVNode(MkFolder, { defaultOpen: slotProps.isParentOfTarget }, _createSlots({ _: 2 }, [
                {
                  name: "icon",
                  fn: _withCtx(() => [_createVNode(_component_SearchIcon, null, {
                ...
                _unref(pinnedUsersForm).modified.value ? {
                  name: "footer",
                  fn: _withCtx(() => [_createVNode(MkFormFooter, { form: _unref(pinnedUsersForm) }, null, 8, ["form"])]),
                  key: "0"
                } : undefined
              ]), 1032, ["defaultOpen"])]),
              _: 1
            ...
            _createVNode(_component_SearchMarker, { keywords: ["serviceWorker"] }, {
              default: _withCtx((slotProps) => [_createVNode(MkFolder, { defaultOpen: slotProps.isParentOfTarget }, _createSlots({ _: 2 }, [
                ...
                },
                {
                  name: "label",
                  fn: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                    default: _withCtx(() => [_createTextVNode("ServiceWorker")]),
                    _: 1
                  })])
                },
                _unref(serviceWorkerForm).modified.value ? {
                  name: "footer",
                  fn: _withCtx(() => [_createVNode(MkFormFooter, { form: _unref(serviceWorkerForm) }, null, 8, ["form"])]),
                  key: "0"
                } : undefined
              ]), 1032, ["defaultOpen"])]),
              _: 1
            ...
            _createVNode(_component_SearchMarker, { keywords: ["ads"] }, {
              default: _withCtx((slotProps) => [_createVNode(MkFolder, { defaultOpen: slotProps.isParentOfTarget }, _createSlots({ _: 2 }, [
                ...
                },
                {
                  ...
                  fn: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                    default: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts._ad.adsSettings),
                      1
                      /* TEXT */
                    )]),
                    _: 1
                ...
                _unref(adForm).modified.value ? {
                  name: "footer",
                  fn: _withCtx(() => [_createVNode(MkFormFooter, { form: _unref(adForm) }, null, 8, ["form"])]),
                  key: "0"
                } : undefined
              ]), 1032, ["defaultOpen"])]),
              _: 1
            ...
            _createVNode(_component_SearchMarker, { keywords: ["url", "preview"] }, {
              default: _withCtx((slotProps) => [_createVNode(MkFolder, { defaultOpen: slotProps.isParentOfTarget }, _createSlots({ _: 2 }, [
                ...
                },
                {
                  ...
                  fn: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                    default: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts._urlPreviewSetting.title),
                      1
                      /* TEXT */
                    )]),
                    _: 1
                ...
                _unref(urlPreviewForm).modified.value ? {
                  name: "footer",
                  fn: _withCtx(() => [_createVNode(MkFormFooter, { form: _unref(urlPreviewForm) }, null, 8, ["form"])]),
                  key: "0"
                } : undefined
              ]), 1032, ["defaultOpen"])]),
              _: 1
            ...
            _createVNode(_component_SearchMarker, { keywords: ["federation"] }, {
              default: _withCtx((slotProps) => [_createVNode(MkFolder, { defaultOpen: slotProps.isParentOfTarget }, _createSlots({ _: 2 }, [
                ...
                _unref(federationForm).modified.value ? {
                  name: "footer",
                  fn: _withCtx(() => [_createVNode(MkFormFooter, { form: _unref(federationForm) }, null, 8, ["form"])]),
                  key: "0"
                } : undefined
              ]), 1032, ["defaultOpen"])]),
              _: 1
            ...
            _createVNode(_component_SearchMarker, { keywords: ["proxy", "account"] }, {
              default: _withCtx((slotProps) => [_createVNode(MkFolder, { defaultOpen: slotProps.isParentOfTarget }, _createSlots({ _: 2 }, [
                ...
                },
                {
                  ...
                  fn: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                    default: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts.proxyAccount),
                      1
                      /* TEXT */
                    )]),
                    _: 1
                ...
                _unref(proxyAccountForm).modified.value ? {
                  name: "footer",
                  fn: _withCtx(() => [_createVNode(MkFormFooter, { form: _unref(proxyAccountForm) }, null, 8, ["form"])]),
                  key: "0"
                } : undefined
              ]), 1032, ["defaultOpen"])]),
              _: 1
