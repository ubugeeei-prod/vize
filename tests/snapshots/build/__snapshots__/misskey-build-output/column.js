...
export default {
  ...
  setup(__props, { emit: __emit }) {
    ...
    function toggleActive() {
      ...
      updateColumn(props.column.id, { active: props.column.active == null ? false : !props.column.active });
    }
    function getMenu() {
      const menuItems = [];
      if (props.menu) {
      ...
      watch(flexibleRef, (flexible) => {
        updateColumn(props.column.id, { flexible });
      });
      menuItems.push({
        type: "switch",
      ...
      return _openBlock(), _createElementBlock(
        "div",
        {
          class: _normalizeClass(["_forceShrinkSpacer", [_ctx.$style.root, {
            [_ctx.$style.paged]: isMainColumn.value,
            [_ctx.$style.naked]: __props.naked,
            [_ctx.$style.active]: active.value,
            [_ctx.$style.draghover]: draghover.value,
            [_ctx.$style.dragging]: dragging.value,
            [_ctx.$style.dropready]: dropready.value,
        ...
        [_createElementVNode(
          "header",
          {
            ...
            onWheelPassive: _cache[0] || (_cache[0] = ($event) => emit("headerWheel", $event))
          },
          [
            _createElementVNode(
              "svg",
              ...
              [_createElementVNode("g", { transform: "matrix(6.2431,0,0,6.2431,-677.417,-29.3839)" }, [_hoisted_1])],
              2
              /* CLASS */
            ),
            _createElementVNode(
            ...
            __props.isStacked && !isMainColumn.value ? (_openBlock(), _createElementBlock(
              "button",
              {
                key: 0,
              ...
              [active.value ? (_openBlock(), _createElementBlock(
                _Fragment,
                { key: 0 },
                [_hoisted_2],
                64
