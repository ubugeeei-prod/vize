...
export default {
  ...
  setup(__props) {
    ...
    onMounted(async () => {
      if (props.token == null) {
        const { dispose } = await os.popupAsyncWithDialog(import("@/components/MkForgotPassword.vue").then((x) => x.default), {}, { closed: () => dispose() });
        mainRouter.push("/");
      }
    });
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_PageWithHeader, {
        ...
        default: _withCtx(() => [__props.token ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          class: "_spacer",
          style: "--MI_SPACER-w: 700px; --MI_SPACER-min: 16px; --MI_SPACER-max: 32px;"
        }, [_createElementVNode("div", { class: "_gaps_m" }, [_createVNode(MkInput, {
          type: "password",
          ...
          label: _withCtx(() => [_createTextVNode(
            _toDisplayString(_unref(i18n).ts.newPassword),
            1
            /* TEXT */
          )]),
          _: 1
