          ...
          [_createElementVNode("div", null, [
              ...
              _renderList(menu.value, (item) => {
                return _openBlock(), _createElementBlock(
                  ...
                  [item === "-" ? (_openBlock(), _createElementBlock(
                    ...
                    _: 2
                  }, 1040, ["activeClass", "to"])), [[_directive_click_anime], [_directive_tooltip, _unref(navbarItemDef)[item].title]]) : _createCommentVNode("v-if", true)],
                  64
                  /* STABLE_FRAGMENT */
                );
              }),
            ...
            _withDirectives(_createElementVNode(
              ...
              [_createElementVNode(
                ...
                2
                /* CLASS */
              ), otherNavItemIndicated.value ? (_openBlock(), _createElementBlock(
                "span",
                {
                  key: 0,
                  class: _normalizeClass(["_blink", _ctx.$style.indicator])
            ...
            [
              ...
              _createElementVNode(
                "div",
                {
                  ...
                  onClick: _cache[1] || (_cache[1] = ($event) => os.post())
                },
                [_createVNode(
                  MkButton,
                  {
