...
`;
    ...
    if (props.id) {
      flash.value = await misskeyApi("flash/show", { flashId: props.id });
    }
    ...
    async function save() {
      if (flash.value != null) {
        ...
        router.push("/play/:id/edit", { params: { id: created.id } });
      }
    }
    function show() {
      if (flash.value == null) {
        os.alert({ text: "Please save" });
      } else {
    ...
    async function del() {
      ...
      if (canceled) return;
      await os.apiWithDialog("flash/delete", { flashId: flash.value.id });
      router.push("/play");
    }
    const headerActions = computed(() => []);
    const headerTabs = computed(() => []);
    definePage(() => ({ title: flash.value ? `${i18n.ts._play.edit}: ${flash.value.title}` : i18n.ts._play.new }));
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_PageWithHeader, {
        ...
        footer: _withCtx(() => [_createElementVNode(
          ...
          [_createElementVNode("div", { class: "_spacer" }, [_createElementVNode("div", { class: "_buttons" }, [
            ...
            flash.value ? (_openBlock(), _createBlock(MkButton, {
              key: 0,
              danger: "",
              onClick: del
            }, {
        ...
        default: _withCtx(() => [_createElementVNode("div", {
          ...
          _createVNode(MkInput, {
            ...
            label: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts._play.title),
              1
              /* TEXT */
            )]),
            _: 1
          ...
          _createVNode(MkSelect, {
            ...
            caption: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts._play.visibilityDescription),
              1
              /* TEXT */
            )]),
            _: 1
          ...
          _createVNode(MkTextarea, {
            ...
            label: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts._play.summary),
              1
              /* TEXT */
            )]),
            _: 1
          ...
          _createVNode(MkButton, {
            ...
            default: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts.selectFromPresets),
              1
              /* TEXT */
            ), _hoisted_1]),
            _: 1
          ...
          _createVNode(MkCodeEditor, {
            ...
            "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => script.value = $event)
          }, {
            label: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts._play.script),
              1
              /* TEXT */
            )]),
            _: 1
