...
const _hoisted_1 = /* @__PURE__ */ _createElementVNode("path", {
  d: "M190,25C195.523,25 200,29.477 200,35C200,58.415 200,116.585 200,140C200,145.523 195.523,150 190,150C155.86,150 44.14,150 10,150C4.477,150 0,145.523 0,140C0,112.727 0,37.273 0,10C0,4.477 4.477,0 10,-0C26.642,0 59.332,0 70.858,0C73.51,-0 76.054,1.054 77.929,2.929C82.74,7.74 92.26,17.26 97.071,22.071C98.946,23.946 101.49,25 104.142,25C118.808,25 168.535,25 190,25Z",
  style: "fill:var(--MI_THEME-accentedBg);"
});
...
export default {
  ...
  setup(__props, { emit: __emit }) {
    ...
    function deleteFolder() {
      misskeyApi("drive/folders/delete", { folderId: props.folder.id }).then(() => {
      ...
      menu = [
        {
          ...
          action: async () => {
            const { dispose } = await os.popupAsyncWithDialog(import("@/components/MkDriveWindow.vue").then((x) => x.default), { initialFolder: props.folder }, { closed: () => dispose() });
          }
        },
        { type: "divider" },
        {
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock("div", {
        ...
        _createElementVNode(
          ...
          _toDisplayString(__props.folder.name),
          3
          /* TEXT, CLASS */
        ),
        _unref(prefer).s.uploadFolder == __props.folder.id ? (_openBlock(), _createElementBlock(
          "div",
          {
            key: 0,
        ...
        __props.selectMode ? (_openBlock(), _createElementBlock(
          "button",
          {
            key: 0,
          ...
          [_createElementVNode(
            ...
            { class: _normalizeClass([_ctx.$style.checkbox, {
              [_ctx.$style.checked]: __props.isSelected,
              "ti ti-check": __props.isSelected
            }]) },
            null,
            2
            /* CLASS */
