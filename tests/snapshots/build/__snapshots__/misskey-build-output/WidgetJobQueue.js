...
export default {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const prev = reactive({});
    const jammedAudioBuffer = ref(null);
    const jammedSoundNodePlaying = ref(false);
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock(
        ...
        [_createElementVNode("div", { class: "inbox" }, [_createElementVNode("div", { class: "label" }, [_createTextVNode("Inbox queue"), current.inbox.waiting > 0 ? (_openBlock(), _createElementBlock("i", {
        ...
        })) : _createCommentVNode("v-if", true)]), _createElementVNode("div", { class: "values" }, [
          _createElementVNode("div", null, [_hoisted_1, _createElementVNode("div", {
            class: _normalizeClass({
              inc: current.inbox.activeSincePrevTick > prev.inbox.activeSincePrevTick,
              dec: current.inbox.activeSincePrevTick < prev.inbox.activeSincePrevTick
            }),
            title: `${current.inbox.activeSincePrevTick}`
          }, _toDisplayString(kmg(current.inbox.activeSincePrevTick, 2)), 11, ["title"])]),
          _createElementVNode("div", null, [_hoisted_2, _createElementVNode("div", {
            class: _normalizeClass({
              inc: current.inbox.active > prev.inbox.active,
              dec: current.inbox.active < prev.inbox.active
            }),
            title: `${current.inbox.active}`
          }, _toDisplayString(kmg(current.inbox.active, 2)), 11, ["title"])]),
          _createElementVNode("div", null, [_hoisted_3, _createElementVNode("div", {
            class: _normalizeClass({
              inc: current.inbox.delayed > prev.inbox.delayed,
              dec: current.inbox.delayed < prev.inbox.delayed
            }),
            title: `${current.inbox.delayed}`
          }, _toDisplayString(kmg(current.inbox.delayed, 2)), 11, ["title"])]),
          _createElementVNode("div", null, [_hoisted_4, _createElementVNode("div", {
            class: _normalizeClass({
              inc: current.inbox.waiting > prev.inbox.waiting,
              dec: current.inbox.waiting < prev.inbox.waiting
            }),
            title: `${current.inbox.waiting}`
          }, _toDisplayString(kmg(current.inbox.waiting, 2)), 11, ["title"])])
        ])]), _createElementVNode("div", { class: "deliver" }, [_createElementVNode("div", { class: "label" }, [_createTextVNode("Deliver queue"), current.deliver.waiting > 0 ? (_openBlock(), _createElementBlock("i", {
          key: 0,
          class: "ti ti-alert-triangle icon"
        })) : _createCommentVNode("v-if", true)]), _createElementVNode("div", { class: "values" }, [
          _createElementVNode("div", null, [_hoisted_5, _createElementVNode("div", {
            class: _normalizeClass({
              inc: current.deliver.activeSincePrevTick > prev.deliver.activeSincePrevTick,
              dec: current.deliver.activeSincePrevTick < prev.deliver.activeSincePrevTick
            }),
            title: `${current.deliver.activeSincePrevTick}`
          }, _toDisplayString(kmg(current.deliver.activeSincePrevTick, 2)), 11, ["title"])]),
          _createElementVNode("div", null, [_hoisted_6, _createElementVNode("div", {
            class: _normalizeClass({
              inc: current.deliver.active > prev.deliver.active,
              dec: current.deliver.active < prev.deliver.active
            }),
            title: `${current.deliver.active}`
          }, _toDisplayString(kmg(current.deliver.active, 2)), 11, ["title"])]),
          _createElementVNode("div", null, [_hoisted_7, _createElementVNode("div", {
            class: _normalizeClass({
          ...
          }, _toDisplayString(kmg(current.deliver.delayed, 2)), 11, ["title"])]),
          _createElementVNode("div", null, [_hoisted_8, _createElementVNode("div", {
            class: _normalizeClass({
          ...
          }, _toDisplayString(kmg(current.deliver.waiting, 2)), 11, ["title"])])
        ])])],
        2
        /* CLASS */
      );
