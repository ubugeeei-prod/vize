  ...
  setup(__props) {
    ...
    onMounted(async () => {
      ...
      new Chart(chartEl.value, {
        ...
        data: { datasets: [{
          ...
          borderRadius: 4,
          backgroundColor: alpha(succColor, .35),
          fill: true,
          clip: 8
        }, {
          parsing: false,
          ...
          borderJoinStyle: "round",
          borderRadius: 4,
          backgroundColor: alpha(failColor, .35),
          fill: true,
          clip: 8
        }] },
        options: {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock("div", null, [fetching.value ? (_openBlock(), _createBlock(_component_MkLoading, { key: 0 })) : _createCommentVNode("v-if", true), _withDirectives(_createElementVNode(
        ...
        [_createElementVNode("div", { class: "charts _panel" }, [_createElementVNode("div", { class: "chart" }, [_createElementVNode(
          "canvas",
          {
            ref_key: "chartEl2",
            ref: chartEl2
          ...
          512
          /* NEED_PATCH */
        )]), _createElementVNode("div", { class: "chart" }, [_createElementVNode(
          "canvas",
          {
            ref_key: "chartEl",
            ref: chartEl
