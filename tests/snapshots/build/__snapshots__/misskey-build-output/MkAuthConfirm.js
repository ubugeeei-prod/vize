  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    async function init() {
      ...
      if (accountIdsToFetch.length > 0) {
        const usersRes = await misskeyApi("users/show", { userIds: accountIdsToFetch });
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock(
        ...
        [_createVNode(_Transition, {
          ...
          default: _withCtx(() => [phase.value === "accountSelect" ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: "accountSelect",
            ...
            [
              _createElementVNode(
                ...
                [_createElementVNode(
                  ...
                  _toDisplayString(_unref(i18n).ts.pleaseSelectAccount),
                  3
                  /* TEXT, CLASS */
                )],
                2
              ...
              _createElementVNode("div", null, [_createElementVNode(
                ...
                _toDisplayString(_unref(i18n).ts.selectAccount),
                3
                /* TEXT, CLASS */
              ), _createElementVNode(
                "div",
                ...
                [(_openBlock(true), _createElementBlock(
                  _Fragment,
                  null,
                  _renderList(users.value, ([id, user]) => {
                    return _openBlock(), _createElementBlock(
                      _Fragment,
                      null,
                      [_withDirectives(_createElementVNode("input", {
                        id: "account-" + id,
                        "onUpdate:modelValue": [($event) => selectedUser.value = $event, ($event) => selectedUser.value = $event],
                        type: "radio",
                        ...
                        "onUpdate:modelValue",
                        "value"
                      ]), [[_vModelRadio, selectedUser.value]]), _createElementVNode("label", {
                        for: "account-" + id,
                  ...
                  [_createElementVNode(
                    ...
                    _toDisplayString(_unref(i18n).ts.addAccount),
                    3
                    /* TEXT, CLASS */
                  )],
                  2
            ...
            2
            /* CLASS */
          )) : phase.value === "consent" ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: "consent",
              class: _normalizeClass(["_gaps", _ctx.$style.root])
            ...
            [
              _createElementVNode(
                "div",
                { class: _normalizeClass(["_gaps_s", _ctx.$style.header]) },
                [__props.icon ? (_openBlock(), _createElementBlock("img", {
                  key: 0,
                  ...
                  "div",
                  { class: _normalizeClass(_ctx.$style.headerText) },
                  _toDisplayString(__props.name ? _unref(i18n).tsx._auth.shareAccess({ name: __props.name }) : _unref(i18n).ts._auth.shareAccessAsk),
                  3
                  /* TEXT, CLASS */
                )],
                2
              ...
              __props.permissions && __props.permissions.length > 0 ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 0,
                ...
                [_createElementVNode(
                  "div",
                  null,
                  _toDisplayString(__props.name ? _unref(i18n).tsx._auth.permission({ name: __props.name }) : _unref(i18n).ts._auth.permissionAsk),
                  1
                  /* TEXT */
                ), _createElementVNode(
                  "div",
                  ...
                  [_createElementVNode(
                    ...
                    [(_openBlock(true), _createElementBlock(
                      _Fragment,
                      null,
                      _renderList(__props.permissions, (p) => {
                        return _openBlock(), _createElementBlock(
                          "li",
                          { key: p },
                          _toDisplayString(_unref(i18n).ts._permissions[p]),
                          1
                          /* TEXT */
                        );
                      }),
              ...
              _createElementVNode("div", null, [_createElementVNode(
                ...
                { class: _normalizeClass(_ctx.$style.accountSelectorLabel) },
                [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts._auth.scopeUser) + " ",
                  1
                  /* TEXT */
                ), _createElementVNode(
                  "button",
                  ...
                  _toDisplayString(_unref(i18n).ts.switchAccount),
                  1
                  /* TEXT */
                )],
                2
            ...
            2
            /* CLASS */
          )) : phase.value === "success" ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: "success",
            ...
            [_createElementVNode(
              ...
              [
                ...
                _createElementVNode(
                  "div",
                  { class: _normalizeClass(_ctx.$style.headerText) },
                  _toDisplayString(_unref(i18n).ts._auth.accepted),
                  3
                  /* TEXT, CLASS */
                ),
                _createElementVNode(
                  ...
                  _toDisplayString(_unref(i18n).ts._auth.pleaseGoBack),
                  3
                  /* TEXT, CLASS */
                )
              ],
            ...
            2
            /* CLASS */
          )) : phase.value === "denied" ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: "denied",
              class: _normalizeClass(["_gaps_s", _ctx.$style.root])
            ...
            [_createElementVNode(
              ...
              [_createElementVNode(
                ...
                "div",
                { class: _normalizeClass(_ctx.$style.headerText) },
                _toDisplayString(_unref(i18n).ts._auth.denied),
                3
                /* TEXT, CLASS */
              )],
              2
            ...
            2
            /* CLASS */
          )) : phase.value === "failed" ? (_openBlock(), _createElementBlock(
            "div",
            {
              key: "failed",
              class: _normalizeClass(["_gaps_s", _ctx.$style.root])
          ...
          "leaveToClass",
          "inert"
        ]), _waiting.value ? (_openBlock(), _createElementBlock(
          "div",
          {
            key: 0,
