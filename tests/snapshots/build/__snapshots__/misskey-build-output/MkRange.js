...
export default {
  ...
  props: {
    ...
    textConverter: {
      type: Function,
      required: false,
      default: (v) => (Math.round(v * 1e3) / 1e3).toString()
    },
    showTicks: {
      type: Boolean,
      required: false
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock(
        "div",
        { class: _normalizeClass(["timctyfi", {
          disabled: __props.disabled,
          easing: __props.easing
        }]) },
        [
          ...
          _withDirectives(_createElementVNode(
            ...
            [
              ...
              _createElementVNode(
                ...
                [
                  _createElementVNode("div", { class: "track" }, [_createElementVNode(
                    "div",
                    {
                      class: "highlight right",
                      style: _normalizeStyle({
                        width: rightTrackWidth.value,
                        left: rightTrackPosition.value
                      })
                    },
                    [_hoisted_1],
                    4
                    ...
                    "div",
                    {
                      ...
                      style: _normalizeStyle({
                        width: leftTrackWidth.value,
                        left: leftTrackPosition.value
                      })
                    },
                    [_hoisted_2],
                    4
                  ...
                  steps.value && __props.showTicks ? (_openBlock(), _createElementBlock("div", {
                    key: 0,
                    class: "ticks"
                  }, [(_openBlock(true), _createElementBlock(
                    _Fragment,
                    null,
                    _renderList(steps.value + 1, (i) => {
                      return _openBlock(), _createElementBlock(
                        "div",
                        {
                          class: "tick",
                          style: _normalizeStyle({ left: (i - 1) / steps.value * 100 + "%" })
                        },
                        4
                        /* STYLE */
                      );
