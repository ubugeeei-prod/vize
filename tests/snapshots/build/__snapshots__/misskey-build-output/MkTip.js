...
import { hideAllTips, closeTip } from "@/tips.js";
export default {
  __name: "MkTip",
  props: {
    k: {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return !_unref(store).r.tips.value[props.k] ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 0,
        ...
        [
          _createElementVNode("div", { style: "font-weight: bold;" }, [_hoisted_1, _createTextVNode(
            " " + _toDisplayString(_unref(i18n).ts.tip) + ":",
            1
            /* TEXT */
          )]),
          ...
          _createElementVNode("div", null, [_createVNode(MkButton, {
            ...
            rounded: "",
            small: "",
            onClick: _cache[0] || (_cache[0] = ($event) => _closeTip())
          }, {
            default: _withCtx(() => [
              _hoisted_2,
              _createTextVNode(" "),
