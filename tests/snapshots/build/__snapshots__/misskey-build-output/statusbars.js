    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock(
        ...
        [(_openBlock(true), _createElementBlock(
          _Fragment,
          null,
          _renderList(_unref(prefer).r.statusbars.value, (x) => {
            return _openBlock(), _createElementBlock(
              "div",
              {
                key: x.id,
                class: _normalizeClass([_ctx.$style.item, {
                  [_ctx.$style.black]: x.black,
              ...
              [_createElementVNode(
                ...
                3
                /* TEXT, CLASS */
              ), x.type === "rss" ? (_openBlock(), _createBlock(XRss, {
                key: 0,
                ...
                "url",
                "shuffle"
              ])) : x.type === "federation" && _unref(instance).federation !== "none" ? (_openBlock(), _createBlock(XFederation, {
                key: 1,
                class: _normalizeClass(_ctx.$style.body),
                refreshIntervalSec: x.props.refreshIntervalSec,
                marqueeDuration: x.props.marqueeDuration,
                ...
                "display",
                "colored"
              ])) : x.type === "userList" ? (_openBlock(), _createBlock(XUserList, {
                key: 2,
                class: _normalizeClass(_ctx.$style.body),
                refreshIntervalSec: x.props.refreshIntervalSec,
                marqueeDuration: x.props.marqueeDuration,
