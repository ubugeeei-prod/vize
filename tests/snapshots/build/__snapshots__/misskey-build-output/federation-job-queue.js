    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_PageWithHeader, {
        ...
        default: _withCtx(() => [_createElementVNode("div", {
          ...
          tab.value === "deliver" ? (_openBlock(), _createBlock(XQueue, {
            key: 0,
            domain: "deliver"
          })) : tab.value === "inbox" ? (_openBlock(), _createBlock(XQueue, {
            key: 1,
            domain: "inbox"
          })) : _createCommentVNode("v-if", true),
          _hoisted_1,
          _createElementVNode("div", { class: "_buttons" }, [_createVNode(MkButton, { onClick: promoteAllQueues }, {
            default: _withCtx(() => [
              _hoisted_2,
              _createTextVNode(" "),
              _createTextVNode(
                _toDisplayString(_unref(i18n).ts.retryAllQueuesNow),
                1
                /* TEXT */
              )
            ]),
            ...
            default: _withCtx(() => [
              ...
              _createTextVNode(" "),
              _createTextVNode(
                _toDisplayString(_unref(i18n).ts.clearQueue),
                1
                /* TEXT */
              )
            ]),
