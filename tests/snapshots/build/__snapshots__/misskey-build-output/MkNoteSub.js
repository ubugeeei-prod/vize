...
export default {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return __props.note == null ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 0,
        ...
        3
        /* TEXT, CLASS */
      )) : !muted.value ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 1,
        ...
        [_createElementVNode(
          ...
          [
            __props.note.channel ? (_openBlock(), _createElementBlock(
              "div",
              {
                key: 0,
            ...
            _createElementVNode(
              ...
              [_createVNode(MkNoteHeader, {
                ...
                note: __props.note,
                mini: true
              }, null, 10, ["note", "mini"]), _createElementVNode("div", null, [__props.note.cw != null ? (_openBlock(), _createElementBlock(
                "p",
                {
                  key: 0,
                ...
                "div",
                null,
                [_createVNode(MkSubNoteContent, {
                  class: _normalizeClass(_ctx.$style.text),
                  note: __props.note
                }, null, 10, ["note"])],
                512
                /* NEED_PATCH */
              ), [[_vShow, __props.note.cw == null || showContent.value]])])],
              2
              /* CLASS */
            )
          ],
          2
          /* CLASS */
        ), __props.depth < 5 ? (_openBlock(), _createElementBlock(
          _Fragment,
          { key: 0 },
          [(_openBlock(true), _createElementBlock(
            _Fragment,
            null,
            _renderList(replies.value, (reply) => {
          ...
          [_createVNode(_component_MkA, {
            ...
            default: _withCtx(() => [
              _createTextVNode(
                _toDisplayString(_unref(i18n).ts.continueThread),
                1
                /* TEXT */
              ),
              _createTextVNode(" "),
        ...
        "div",
        {
          ...
          onClick: _cache[1] || (_cache[1] = ($event) => muted.value = false)
        },
