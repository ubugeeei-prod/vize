        ...
        default: _withCtx(({ items }) => [_createElementVNode("div", { class: "_gaps" }, [(_openBlock(true), _createElementBlock(
          ...
          _renderList(items, (token) => {
            return _openBlock(), _createBlock(MkFolder, {
              ...
              {
                name: "icon",
                fn: _withCtx(() => [token.iconUrl ? (_openBlock(), _createElementBlock("img", {
                  key: 0,
                  class: _normalizeClass(_ctx.$style.appIcon),
                  src: token.iconUrl,
                  alt: ""
                }, null, 10, ["src"])) : (_openBlock(), _createElementBlock("i", {
                  key: 1,
                  class: "ti ti-plug"
                }))])
              },
              ...
              token.lastUsedAt != null ? {
                name: "suffix",
                fn: _withCtx(() => [_createVNode(_component_MkTime, { time: token.lastUsedAt }, null, 8, ["time"])]),
                key: "0"
              } : undefined,
              {
                name: "footer",
                fn: _withCtx(() => [_createVNode(MkButton, {
                  danger: "",
                  onClick: ($event) => revoke(token)
                }, {
                  default: _withCtx(() => [
                    _hoisted_1,
                    _createTextVNode(" "),
