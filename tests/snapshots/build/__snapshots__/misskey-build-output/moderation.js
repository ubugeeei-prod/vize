...
export default {
  ...
  async setup(__props) {
    ...
    async function onChange_enableRegistration(value) {
      if (value) {
      ...
      os.apiWithDialog("admin/update-meta", { disableRegistration: !value }).then(() => {
        fetchInstance(true);
      });
    }
    function onChange_emailRequiredForSignup(value) {
      os.apiWithDialog("admin/update-meta", { emailRequiredForSignup: value }).then(() => {
        fetchInstance(true);
      });
    }
    function onChange_ugcVisibilityForVisitor(value) {
      os.apiWithDialog("admin/update-meta", { ugcVisibilityForVisitor: value }).then(() => {
        fetchInstance(true);
      });
    }
    function save_preservedUsernames() {
      os.apiWithDialog("admin/update-meta", { preservedUsernames: preservedUsernames.value.split("\n") }).then(() => {
        fetchInstance(true);
      });
    }
    function save_sensitiveWords() {
      os.apiWithDialog("admin/update-meta", { sensitiveWords: sensitiveWords.value.split("\n") }).then(() => {
        fetchInstance(true);
      });
    }
    function save_prohibitedWords() {
      os.apiWithDialog("admin/update-meta", { prohibitedWords: prohibitedWords.value.split("\n") }).then(() => {
        fetchInstance(true);
      });
    }
    ...
    function save_hiddenTags() {
      os.apiWithDialog("admin/update-meta", { hiddenTags: hiddenTags.value.split("\n") }).then(() => {
        fetchInstance(true);
      });
    }
    function save_blockedHosts() {
      os.apiWithDialog("admin/update-meta", { blockedHosts: blockedHosts.value.split("\n") || [] }).then(() => {
        fetchInstance(true);
      });
    }
    function save_silencedHosts() {
      os.apiWithDialog("admin/update-meta", { silencedHosts: silencedHosts.value.split("\n") || [] }).then(() => {
        fetchInstance(true);
      });
    }
    function save_mediaSilencedHosts() {
      os.apiWithDialog("admin/update-meta", { mediaSilencedHosts: mediaSilencedHosts.value.split("\n") || [] }).then(() => {
        fetchInstance(true);
      });
    }
          ...
          default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [
            _createVNode(_component_SearchMarker, { keywords: ["open", "registration"] }, {
              default: _withCtx(() => [_createVNode(MkSwitch, {
                ...
                caption: _withCtx(() => [_createElementVNode("div", null, [_createVNode(_component_SearchText, null, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts._serverSettings.thisSettingWillAutomaticallyOffWhenModeratorsInactive),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                  ...
                  _createVNode(_component_SearchText, null, {
                    default: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts._serverSettings.openRegistrationWarning),
                      1
                      /* TEXT */
                    )]),
                    _: 1
            ...
            _createVNode(_component_SearchMarker, { keywords: [
              ...
              default: _withCtx(() => [_createVNode(MkSwitch, {
                ...
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => emailRequiredForSignup.value = $event)
              }, {
                label: _withCtx(() => [
            ...
            _createVNode(_component_SearchMarker, { keywords: [
              ...
              default: _withCtx(() => [_createVNode(MkSelect, {
                ...
                "onUpdate:modelValue": [onChange_ugcVisibilityForVisitor, ($event) => ugcVisibilityForVisitor.value = $event],
                modelValue: _unref(ugcVisibilityForVisitor)
              }, {
                label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts._serverSettings.userGeneratedContentsVisibilityForVisitor),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                caption: _withCtx(() => [_createElementVNode("div", null, [_createVNode(_component_SearchText, null, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts._serverSettings.userGeneratedContentsVisibilityForVisitor_description),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                  ...
                  _createVNode(_component_SearchText, null, {
                    default: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts._serverSettings.userGeneratedContentsVisibilityForVisitor_description2),
                      1
                      /* TEXT */
                    )]),
                    _: 1
            ...
            _createVNode(_component_SearchMarker, { keywords: ["preserved", "usernames"] }, {
              default: _withCtx(() => [_createVNode(MkFolder, null, {
                ...
                label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.preservedUsernames),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                })]),
                default: _withCtx(() => [_createElementVNode("div", { class: "_gaps" }, [_createVNode(MkTextarea, {
                  modelValue: preservedUsernames.value,
                  "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => preservedUsernames.value = $event)
                }, {
                  caption: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.preservedUsernamesDescription),
                    1
                    /* TEXT */
                  )]),
                  _: 1
            ...
            _createVNode(_component_SearchMarker, { keywords: ["sensitive", "words"] }, {
              default: _withCtx(() => [_createVNode(MkFolder, null, {
                ...
                label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.sensitiveWords),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                default: _withCtx(() => [_createElementVNode("div", { class: "_gaps" }, [_createVNode(MkTextarea, {
                  ...
                  "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => sensitiveWords.value = $event)
                }, {
                  caption: _withCtx(() => [
                    _createTextVNode(
                      _toDisplayString(_unref(i18n).ts.sensitiveWordsDescription),
                      1
                      /* TEXT */
                    ),
                    _hoisted_5,
                    _createTextVNode(
                      _toDisplayString(_unref(i18n).ts.sensitiveWordsDescription2),
                      1
                      /* TEXT */
                    )
                  ]),
            ...
            _createVNode(_component_SearchMarker, { keywords: ["prohibited", "words"] }, {
              default: _withCtx(() => [_createVNode(MkFolder, null, {
                ...
                label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.prohibitedWords),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                default: _withCtx(() => [_createElementVNode("div", { class: "_gaps" }, [_createVNode(MkTextarea, {
                  ...
                  "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => prohibitedWords.value = $event)
                }, {
                  caption: _withCtx(() => [
                    _createTextVNode(
                      _toDisplayString(_unref(i18n).ts.prohibitedWordsDescription),
                      1
                      /* TEXT */
                    ),
                    _hoisted_7,
                    _createTextVNode(
                      _toDisplayString(_unref(i18n).ts.prohibitedWordsDescription2),
                      1
                      /* TEXT */
                    )
                  ]),
            ...
            _createVNode(_component_SearchMarker, { keywords: [
              ...
              default: _withCtx(() => [_createVNode(MkFolder, null, {
                ...
                label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.prohibitedWordsForNameOfUser),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                default: _withCtx(() => [_createElementVNode("div", { class: "_gaps" }, [_createVNode(MkTextarea, {
                  ...
                  "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => prohibitedWordsForNameOfUser.value = $event)
                }, {
                  caption: _withCtx(() => [
                    _createTextVNode(
                      _toDisplayString(_unref(i18n).ts.prohibitedWordsForNameOfUserDescription),
                      1
                      /* TEXT */
                    ),
                    _hoisted_9,
            ...
            _createVNode(_component_SearchMarker, { keywords: [
              ...
              default: _withCtx(() => [_createVNode(MkFolder, null, {
                ...
                label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.hiddenTags),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                default: _withCtx(() => [_createElementVNode("div", { class: "_gaps" }, [_createVNode(MkTextarea, {
                  ...
                  "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => hiddenTags.value = $event)
                }, {
                  caption: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.hiddenTagsDescription),
                    1
                    /* TEXT */
                  )]),
                  _: 1
            ...
            _createVNode(_component_SearchMarker, { keywords: [
              ...
              default: _withCtx(() => [_createVNode(MkFolder, null, {
                ...
                label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.silencedInstances),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                default: _withCtx(() => [_createElementVNode("div", { class: "_gaps" }, [_createVNode(MkTextarea, {
                  ...
                  "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => silencedHosts.value = $event)
                }, {
                  caption: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.silencedInstancesDescription),
                    1
                    /* TEXT */
                  )]),
                  _: 1
            ...
            _createVNode(_component_SearchMarker, { keywords: [
              ...
              default: _withCtx(() => [_createVNode(MkFolder, null, {
                ...
                label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.mediaSilencedInstances),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                default: _withCtx(() => [_createElementVNode("div", { class: "_gaps" }, [_createVNode(MkTextarea, {
                  ...
                  "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => mediaSilencedHosts.value = $event)
                }, {
                  caption: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.mediaSilencedInstancesDescription),
                    1
                    /* TEXT */
                  )]),
                  _: 1
            ...
            _createVNode(_component_SearchMarker, { keywords: [
              ...
              default: _withCtx(() => [_createVNode(MkFolder, null, {
                ...
                label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.blockedInstances),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                default: _withCtx(() => [_createElementVNode("div", { class: "_gaps" }, [_createVNode(MkTextarea, {
                  ...
                  "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => blockedHosts.value = $event)
                }, {
                  caption: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.blockedInstancesDescription),
                    1
                    /* TEXT */
                  )]),
                  _: 1
