...
export default {
  __name: "users",
  setup(__props) {
    const storedQuery = JSON.parse(defaultMemoryStorage.getItem("admin-users-query") ?? "{}");
    const { model: sort, def: sortDef } = useMkSelect({
      items: [
        {
          label: `${i18n.ts.registeredDate} (${i18n.ts.ascendingOrder})`,
          value: "-createdAt"
        },
        {
          label: `${i18n.ts.registeredDate} (${i18n.ts.descendingOrder})`,
          value: "+createdAt"
        },
        {
        ...
        {
          label: `${i18n.ts.lastUsed} (${i18n.ts.descendingOrder})`,
          value: "+updatedAt"
        }
      ],
    ...
    async function addUser() {
      const { canceled: canceled1, result: username } = await os.inputText({ title: i18n.ts.username });
        ...
        default: _withCtx(() => [_createElementVNode("div", {
          ...
          _createElementVNode(
            ...
            [
              ...
              _createVNode(MkSelect, {
                ...
                "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => origin.value = $event)
              }, {
                label: _withCtx(() => [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts.instance),
                  1
                  /* TEXT */
                )]),
                _: 1
          ...
          _createElementVNode(
            ...
            [_createVNode(MkInput, {
              ...
              "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => searchUsername.value = $event)
            }, {
              ...
              _: 1
            }, 8, ["spellcheck", "modelValue"]), _createVNode(MkInput, {
              style: "flex: 1;",
              type: "text",
              spellcheck: false,
              disabled: _unref(paginator).computedParams?.value?.origin === "local",
              modelValue: searchHost.value,
              "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => searchHost.value = $event)
            }, {
              prefix: _withCtx(() => [_createTextVNode("@")]),
              label: _withCtx(() => [_createTextVNode(
