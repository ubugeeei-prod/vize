        ...
        default: _withCtx(() => [_createElementVNode(
          ...
          [
            _createElementVNode(
              "b",
              null,
              _toDisplayString(__props.clip.name),
              1
              /* TEXT */
            ),
            _createElementVNode(
              ...
              [
                __props.clip.description ? (_openBlock(), _createElementBlock("div", { key: 0 }, [_createVNode(_component_Mfm, {
                ...
                __props.clip.lastClippedAt ? (_openBlock(), _createElementBlock("div", { key: 0 }, [_createTextVNode(
                ...
                __props.clip.notesCount != null ? (_openBlock(), _createElementBlock(
                  "div",
                  { key: 0 },
                  _toDisplayString(_unref(i18n).ts.notesCount) + ": " + _toDisplayString(number(__props.clip.notesCount)) + " / " + _toDisplayString(_unref($i)?.policies.noteEachClipsLimit) + " (" + _toDisplayString(_unref(i18n).tsx.remainingN({ n: remaining.value })) + ")",
                  1
                  /* TEXT */
                )) : _createCommentVNode("v-if", true)
              ],
            ...
            !props.noUserInfo ? (_openBlock(), _createElementBlock(
              _Fragment,
              { key: 0 },
              [_createElementVNode(
                "div",
