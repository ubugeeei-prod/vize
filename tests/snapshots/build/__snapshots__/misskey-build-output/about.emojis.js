...
export default {
  ...
  setup(__props) {
    ...
    function search() {
      ...
      if (queryarry) {
        searchEmojis.value = customEmojis.value.filter((emoji) => queryarry.includes(`:${emoji.name}:`));
      } else {
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock("div", { class: "_gaps" }, [
        _unref($i) && (_unref($i).isModerator || _unref($i).policies.canManageCustomEmojis) ? (_openBlock(), _createBlock(MkButton, {
          key: 0,
          primary: "",
          link: "",
          ...
          default: _withCtx(() => [_createTextVNode(
            _toDisplayString(_unref(i18n).ts.manageCustomEmojis),
            1
            /* TEXT */
          )]),
          _: 1
        })) : _createCommentVNode("v-if", true),
        _createElementVNode("div", { class: "query" }, [_createVNode(MkInput, {
          class: "",
        ...
        searchEmojis.value ? (_openBlock(), _createBlock(MkFoldableSection, { key: 0 }, {
          ...
          default: _withCtx(() => [_createElementVNode(
            ...
            [(_openBlock(true), _createElementBlock(
              _Fragment,
              null,
              _renderList(searchEmojis.value, (emoji) => {
        ...
        (_openBlock(true), _createElementBlock(
          _Fragment,
          null,
          _renderList(_unref(customEmojiCategories), (category) => {
            return _openBlock(), _createBlock(MkFoldableSection, {
              ...
              default: _withCtx(() => [_createElementVNode(
                ...
                [(_openBlock(true), _createElementBlock(
                  _Fragment,
                  null,
                  _renderList(_unref(customEmojis).filter((e) => e.category === category), (emoji) => {
                    return _openBlock(), _createBlock(XEmoji, {
                      key: emoji.name,
                      emoji
                    }, null, 8, ["emoji"]);
