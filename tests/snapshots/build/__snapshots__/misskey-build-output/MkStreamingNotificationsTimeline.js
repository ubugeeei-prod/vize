...
export default {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const paginator = prefer.s.useGroupedNotifications ? markRaw(new Paginator("i/notifications-grouped", {
      limit: 20,
      computedParams: computed(() => ({ excludeTypes: props.excludeTypes ?? undefined }))
        ...
        default: _withCtx(() => [_unref(paginator).fetching.value ? (_openBlock(), _createBlock(_component_MkLoading, { key: 0 })) : _unref(paginator).error.value ? (_openBlock(), _createBlock(_component_MkError, {
          ...
          [_createVNode(_resolveDynamicComponent(_unref(prefer).s.animation ? _unref(TransitionGroup) : "div"), {
            ...
            default: _withCtx(() => [(_openBlock(true), _createElementBlock(
              _Fragment,
              null,
              _renderList(_unref(paginator).items.value, (notification, i) => {
                return _openBlock(), _createElementBlock("div", {
                  key: notification.id,
                  "data-scroll-anchor": notification.id,
                  class: _normalizeClass(_ctx.$style.item)
                }, [i > 0 && _unref(isSeparatorNeeded)(_unref(paginator).items.value[i - 1].createdAt, notification.createdAt) ? (_openBlock(), _createElementBlock(
                  "div",
                  {
                    key: 0,
                  ...
                  [
                    _createElementVNode("span", null, [_hoisted_1, _createTextVNode(
                      " " + _toDisplayString(_unref(getSeparatorInfo)(_unref(paginator).items.value[i - 1].createdAt, notification.createdAt)?.prevText),
                      1
                      /* TEXT */
                    )]),
                    _hoisted_2,
                    _createElementVNode("span", null, [_createTextVNode(
                      _toDisplayString(_unref(getSeparatorInfo)(_unref(paginator).items.value[i - 1].createdAt, notification.createdAt)?.nextText) + " ",
                      1
                      /* TEXT */
                    ), _hoisted_3])
                  ],
                  ...
                  "quote",
                  "mention"
                ].includes(notification.type) && "note" in notification ? (_openBlock(), _createBlock(MkNote, {
                  key: 0,
                  class: _normalizeClass(_ctx.$style.content),
                  note: notification.note,
                  withHardMute: true
                }, null, 10, ["note", "withHardMute"])) : (_openBlock(), _createBlock(XNotification, {
                  key: 1,
                  class: _normalizeClass(_ctx.$style.content),
                  notification,
                  withTime: true,
            ...
            onClick: _cache[1] || (_cache[1] = (...args) => _unref(paginator).fetchOlder && _unref(paginator).fetchOlder(...args))
