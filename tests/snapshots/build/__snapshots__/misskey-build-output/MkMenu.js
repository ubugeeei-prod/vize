...
export default {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const isNestingMenu = inject("isNestingMenu", false);
    ...
    async function showRadioOptions(item, ev) {
      const children = Object.keys(item.options).map((key) => {
    ...
    async function showChildren(item, ev) {
      ev.stopPropagation();
    ...
    function clicked(fn, ev, doClose = true) {
      fn(ev);
      if (!doClose) return;
      close(true);
    }
      ...
      return _openBlock(), _createElementBlock(
        ...
        [_withDirectives(_createElementVNode(
          ...
          [(_openBlock(true), _createElementBlock(
            ...
            _renderList(items2.value ?? [], (item) => {
              return _openBlock(), _createElementBlock(
                ...
                [item.type === "divider" ? (_openBlock(), _createElementBlock(
                  ...
                  2
                  /* CLASS */
                )) : item.type === "label" ? (_openBlock(), _createElementBlock(
                  "div",
                  {
                    key: 1,
                    role: "menuitem",
                  ...
                  2
                  /* CLASS */
                )) : item.type === "pending" ? (_openBlock(), _createElementBlock(
                  "span",
                  {
                    key: 2,
                    role: "menuitem",
                  ...
                  [_createElementVNode("span", null, [_createVNode(_component_MkEllipsis)])],
                  2
                  /* CLASS */
                )) : item.type === "component" ? (_openBlock(), _createElementBlock("div", {
                  key: 3,
                  role: "menuitem",
                  tabindex: "-1"
                }, [_createVNode(
                  _resolveDynamicComponent(item.component),
                  _mergeProps(item.props, {}),
                  null,
                  16
                  /* FULL_PROPS */
                )])) : item.type === "link" ? (_openBlock(), _createBlock(_component_MkA, {
                  key: 4,
                  role: "menuitem",
                  tabindex: "0",
                  class: _normalizeClass(["_button", _ctx.$style.item]),
                  to: item.to,
                  onClickPassive: ($event) => close(true),
                  ...
                  default: _withCtx(() => [
                    ...
                    item.avatar ? (_openBlock(), _createBlock(_component_MkAvatar, {
                      key: 0,
                      user: item.avatar,
                    ...
                    _createElementVNode(
                      ...
                      [_createElementVNode(
                        ...
                        [_createElementVNode(
                          ...
                          3
                          /* TEXT, CLASS */
                        ), item.caption ? (_openBlock(), _createElementBlock(
                          "div",
                          {
                            key: 0,
                            class: _normalizeClass(_ctx.$style.item_content_text_caption)
                          },
                          _toDisplayString(item.caption),
                          3
                          /* TEXT, CLASS */
                        )) : _createCommentVNode("v-if", true)],
                        2
                        /* CLASS */
                      ), item.indicate ? (_openBlock(), _createElementBlock(
                        "span",
                        {
                          key: 0,
                  ...
                  _: 2
                }, 1034, ["to", "onClickPassive"])) : item.type === "a" ? (_openBlock(), _createElementBlock("a", {
                  key: 5,
                  role: "menuitem",
                  tabindex: "0",
                  class: _normalizeClass(["_button", _ctx.$style.item]),
                  ...
                  "download",
                  "onClickPassive"
                ])) : item.type === "user" ? (_openBlock(), _createElementBlock("button", {
                  key: 6,
                  role: "menuitem",
                  tabindex: "0",
                  class: _normalizeClass([
                    "_button",
                    _ctx.$style.item,
                    { [_ctx.$style.active]: item.active }
                  ]),
                  onClick: _withModifiers(($event) => item.active ? close(false) : clicked(item.action, $event), ["prevent"]),
                  onMouseenterPassive: onItemMouseEnter,
                  onMouseleavePassive: onItemMouseLeave
                }, [
                  ...
                  _createVNode(_component_MkUserName, { user: item.user }, null, 8, ["user"]),
                  item.indicate ? (_openBlock(), _createElementBlock(
                    "div",
                    {
                      key: 0,
                ...
                ], 42, ["onClick"])) : item.type === "switch" ? (_openBlock(), _createElementBlock("button", {
                  key: 7,
                  role: "menuitemcheckbox",
                  tabindex: "0",
                  class: _normalizeClass(["_button", _ctx.$style.item]),
                  disabled: unref(item.disabled),
                  onClick: _withModifiers(($event) => switchItem(item), ["prevent"]),
                  onMouseenterPassive: onItemMouseEnter,
                  onMouseleavePassive: onItemMouseLeave
                }, [item.icon ? (_openBlock(), _createElementBlock(
                  "i",
                  ...
                  onToggle: ($event) => switchItem(item)
                }, null, 10, [
                  "checked",
                  "disabled",
                  "onToggle"
                  ...
                  [_createElementVNode(
                    ...
                    2
                    /* CLASS */
                  ), item.icon ? (_openBlock(), _createBlock(MkSwitchButton, {
                    key: 0,
                  ...
                  2
                  /* CLASS */
                )], 42, ["disabled", "onClick"])) : item.type === "radio" ? (_openBlock(), _createElementBlock("button", {
                  key: 8,
                  role: "menuitem",
                  tabindex: "0",
                  class: _normalizeClass([
                    ...
                    _ctx.$style.item,
                    _ctx.$style.parent,
                    { [_ctx.$style.active]: childShowingItem.value === item }
                  ]),
                  disabled: unref(item.disabled),
                  onMouseenter: _withModifiers(($event) => _unref(preferClick) ? null : showRadioOptions(item, $event), ["prevent"]),
                  onKeydown: _withKeys(_withModifiers(($event) => _unref(preferClick) ? null : showRadioOptions(item, $event), ["prevent"]), ["enter"]),
                  onClick: _withModifiers(($event) => !_unref(preferClick) ? null : showRadioOptions(item, $event), ["prevent"])
                }, [item.icon ? (_openBlock(), _createElementBlock(
                  "i",
                  {
                    key: 0,
                  ...
                  "onKeydown",
                  "onClick"
                ])) : item.type === "radioOption" ? (_openBlock(), _createElementBlock("button", {
                  key: 9,
                  role: "menuitemradio",
                  tabindex: "0",
                  class: _normalizeClass([
                    ...
                    _ctx.$style.item,
                    _ctx.$style.radio,
                    { [_ctx.$style.active]: unref(item.active) }
                  ]),
                  onClick: _withModifiers(($event) => unref(item.active) ? null : clicked(item.action, $event, false), ["prevent"]),
                  onMouseenterPassive: onItemMouseEnter,
                  onMouseleavePassive: onItemMouseLeave
                }, [_createElementVNode(
                  "div",
                  ...
                  2
                  /* CLASS */
                )], 42, ["onClick"])) : item.type === "parent" ? (_openBlock(), _createElementBlock("button", {
                  key: 10,
                  role: "menuitem",
                  tabindex: "0",
                  class: _normalizeClass([
                  ...
                  onMouseenter: _withModifiers(($event) => _unref(preferClick) ? null : showChildren(item, $event), ["prevent"]),
                  onKeydown: _withKeys(_withModifiers(($event) => _unref(preferClick) ? null : showChildren(item, $event), ["prevent"]), ["enter"]),
                  onClick: _withModifiers(($event) => !_unref(preferClick) ? null : showChildren(item, $event), ["prevent"])
                }, [item.icon ? (_openBlock(), _createElementBlock(
                  "i",
                  {
                    key: 0,
                  ...
                  class: _normalizeClass([
                    ...
                    _ctx.$style.item,
                    {
                      [_ctx.$style.danger]: item.danger,
                      [_ctx.$style.active]: unref(item.active)
                    }
                  ]),
                  onClick: _withModifiers(($event) => unref(item.active) ? close(false) : clicked(item.action, $event), ["prevent"]),
                  onMouseenterPassive: onItemMouseEnter,
                  onMouseleavePassive: onItemMouseLeave
                }, [
                  item.icon ? (_openBlock(), _createElementBlock(
            ...
            256
            /* UNKEYED_FRAGMENT */
          )), items2.value == null || items2.value.length === 0 ? (_openBlock(), _createElementBlock(
            "span",
            {
              key: 0,
              tabindex: "-1",
