...
import { defineAsyncComponent, onMounted, onUnmounted, useTemplateRef, watch } from "vue";
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createBlock(MkFolder, {
        ...
        label: _withCtx(() => [_createTextVNode(
          _toDisplayString(_unref(i18n).ts.preset) + ": " + _toDisplayString(__props.preset.name === "" ? "(" + _unref(i18n).ts.noName + ")" : __props.preset.name),
          1
          /* TEXT */
        )]),
        footer: _withCtx(() => [_createElementVNode("div", { class: "_buttons" }, [_createVNode(MkButton, { onClick: edit }, {
          default: _withCtx(() => [
            _hoisted_2,
            _createTextVNode(" "),
            _createTextVNode(
        ...
        default: _withCtx(() => [_createElementVNode("div", null, [_createElementVNode(
          "canvas",
          {
            ref_key: "canvasEl",
            ref: canvasEl,
