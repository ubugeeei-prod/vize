...
export default {
  ...
  setup(__props, { emit: __emit }) {
    ...
    function moveStartByMouse(event) {
    ...
    function moveStartByTouch(event) {
      if (isRefreshing.value) return;
      const scrollPos = scrollEl.scrollTop;
      if (scrollPos !== 0) {
        unlockDownScroll();
    ...
    */
    ...
    onMounted(() => {
      ...
      lockDownScroll();
      rootEl.value.addEventListener("mousedown", moveStartByMouse, { passive: false });
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock(
        ...
        [isPulling.value ? (_openBlock(), _createElementBlock(
          "div",
          {
            key: 0,
          ...
          [_createElementVNode(
            ...
            [isRefreshing.value ? (_openBlock(), _createBlock(_component_MkLoading, {
              ...
              em: true
            }, null, 10, ["em"])) : (_openBlock(), _createElementBlock(
              "i",
              {
                key: 1,
              ...
              [isPulledEnough.value ? (_openBlock(), _createElementBlock(
                _Fragment,
                { key: 0 },
                [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts.releaseToRefresh),
                  1
                  /* TEXT */
                )],
                64
                /* STABLE_FRAGMENT */
              )) : isRefreshing.value ? (_openBlock(), _createElementBlock(
                _Fragment,
                { key: 1 },
                [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts.refreshing),
                  1
                  /* TEXT */
                )],
                64
                ...
                { key: 2 },
                [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts.pullDownToRefresh),
                  1
                  /* TEXT */
                )],
                64
