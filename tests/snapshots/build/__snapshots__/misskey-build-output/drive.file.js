  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_MkStickyContainer, null, {
        ...
        default: _withCtx(() => [_createVNode(MkSwiper, {
          tabs: headerTabs.value,
          tab: tab.value,
          ...
          }, [_createVNode(XFileInfo, { fileId: __props.fileId }, null, 8, ["fileId"])])) : tab.value === "notes" ? (_openBlock(), _createElementBlock("div", {
            key: 1,
            class: "_spacer",
            style: "--MI_SPACER-w: 800px;"
          }, [_createVNode(XNotes, { fileId: __props.fileId }, null, 8, ["fileId"])])) : _createCommentVNode("v-if", true)]),
          _: 2
        }, 1032, ["tabs", "tab"])]),
        _: 1
      });
