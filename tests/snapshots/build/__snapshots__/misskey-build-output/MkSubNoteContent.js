      ...
      return _openBlock(), _createElementBlock(
        ...
        [
          _createElementVNode("div", null, [
            __props.note.isHidden ? (_openBlock(), _createElementBlock(
              "span",
              {
                key: 0,
                style: "opacity: 0.5"
            ...
            __props.note.deletedAt ? (_openBlock(), _createElementBlock(
              "span",
              {
                key: 0,
                style: "opacity: 0.5"
            ...
            __props.note.text ? (_openBlock(), _createBlock(_component_Mfm, {
              key: 0,
            ...
            __props.note.renoteId ? (_openBlock(), _createBlock(_component_MkA, {
              key: 0,
              class: _normalizeClass(_ctx.$style.rp),
              to: `/notes/${__props.note.renoteId}`
            }, {
              default: _withCtx(() => [_createTextVNode("RN: ...")]),
              _: 1
            }, 10, ["to"])) : _createCommentVNode("v-if", true)
          ]),
          __props.note.files && __props.note.files.length > 0 ? (_openBlock(), _createElementBlock("details", { key: 0 }, [_createElementVNode(
            "summary",
            null,
            "(" + _toDisplayString(_unref(i18n).tsx.withNFiles({ n: __props.note.files.length })) + ")",
            1
            /* TEXT */
          ), _createVNode(MkMediaList, { mediaList: __props.note.files }, null, 8, ["mediaList"])])) : _createCommentVNode("v-if", true),
          __props.note.poll ? (_openBlock(), _createElementBlock("details", { key: 0 }, [_createElementVNode(
            "summary",
            null,
            _toDisplayString(_unref(i18n).ts.poll),
            1
            /* TEXT */
          ), _createVNode(MkPoll, {
          ...
          __props.note.hasPoll && __props.note.poll == null ? (_openBlock(), _createBlock(_component_MkA, {
            key: 0,
          ...
          _unref(isLong) && collapsed.value ? (_openBlock(), _createElementBlock(
            ...
            "button",
            {
              ...
              onClick: _cache[1] || (_cache[1] = ($event) => collapsed.value = true)
            },
            [_createElementVNode(
              "span",
