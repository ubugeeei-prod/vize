        ...
        _createVNode(FormSection, null, {
          ...
          default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_s" }, [
            ...
            _createVNode(MkSwitch, {
              ...
              "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => event_followed.value = $event)
            }, {
              default: _withCtx(() => [_createTextVNode(
            ...
            _createVNode(MkSwitch, {
              ...
              "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => event_note.value = $event)
            }, {
              default: _withCtx(() => [_createTextVNode(
            ...
            _createVNode(MkSwitch, {
              ...
              "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => event_reply.value = $event)
            }, {
              default: _withCtx(() => [_createTextVNode(
            ...
            _createVNode(MkSwitch, {
              ...
              "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => event_renote.value = $event)
            }, {
              default: _withCtx(() => [_createTextVNode(
            ...
            _createVNode(MkSwitch, {
              ...
              "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => event_reaction.value = $event)
            }, {
              default: _withCtx(() => [_createTextVNode(
            ...
            _createVNode(MkSwitch, {
              ...
              "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => event_mention.value = $event)
            }, {
              default: _withCtx(() => [_createTextVNode(
