    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock("div", { class: "_gaps" }, [
        _createElementVNode(
          "div",
          _hoisted_1,
          _toDisplayString(_unref(i18n).ts._initialTutorial._postNote.description1),
          1
          /* TEXT */
        ),
        ...
        _createVNode(MkFormSection, null, {
          ...
          default: _withCtx(() => [_createElementVNode("div", { class: "_gaps" }, [
            _createElementVNode(
              "div",
              null,
              _toDisplayString(_unref(i18n).ts._initialTutorial._postNote._visibility.description),
              1
              /* TEXT */
            ),
            _createElementVNode("div", null, [
              ...
              _createTextVNode(
                " … " + _toDisplayString(_unref(i18n).ts._initialTutorial._postNote._visibility.public),
                1
                /* TEXT */
              )
            ]),
            _createElementVNode("div", null, [
              ...
              _createTextVNode(
                " … " + _toDisplayString(_unref(i18n).ts._initialTutorial._postNote._visibility.home),
                1
                /* TEXT */
              )
            ]),
            _createElementVNode("div", null, [
              ...
              _createTextVNode(
                " … " + _toDisplayString(_unref(i18n).ts._initialTutorial._postNote._visibility.followers),
                1
                /* TEXT */
              )
            ]),
            _createElementVNode("div", { class: "_gaps_s" }, [_createElementVNode("div", null, [
              _hoisted_5,
              _createTextVNode(),
              _createElementVNode(
                "b",
              ...
              _createTextVNode(
                " … " + _toDisplayString(_unref(i18n).ts._initialTutorial._postNote._visibility.direct),
                1
                /* TEXT */
              )
              ...
              default: _withCtx(() => [
                _createElementVNode(
                  "b",
                  null,
                  _toDisplayString(_unref(i18n).ts._initialTutorial._postNote._visibility.doNotSendConfidencialOnDirect1),
                  1
                  /* TEXT */
                ),
                _createTextVNode(" "),
                _createTextVNode(
                  _toDisplayString(_unref(i18n).ts._initialTutorial._postNote._visibility.doNotSendConfidencialOnDirect2),
                  1
                  /* TEXT */
                )
              ]),
            ...
            _createElementVNode("div", null, [
              ...
              _createElementVNode(
                "b",
                null,
                _toDisplayString(_unref(i18n).ts._visibility.disableFederation),
                1
                /* TEXT */
              ),
              _createTextVNode(
                " … " + _toDisplayString(_unref(i18n).ts._initialTutorial._postNote._visibility.localOnly),
                1
                /* TEXT */
              )
            ])
        ...
        _createVNode(MkFormSection, null, {
          label: _withCtx(() => [_createTextVNode(
            _toDisplayString(_unref(i18n).ts._initialTutorial._postNote._cw.title),
            1
            /* TEXT */
          )]),
          default: _withCtx(() => [_createElementVNode("div", { class: "_gaps" }, [
            _createElementVNode(
              "div",
              null,
              _toDisplayString(_unref(i18n).ts._initialTutorial._postNote._cw.description),
              1
              /* TEXT */
            ),
            _createVNode(MkNote, {
            ...
            _createElementVNode(
              "div",
              null,
              _toDisplayString(_unref(i18n).ts._initialTutorial._postNote._cw.useCases),
              1
              /* TEXT */
            )
          ])]),
