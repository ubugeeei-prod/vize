...
export default {
  ...
  setup(__props, { expose: __expose }) {
    ...
    function scrollToTop() {
      if (rootEl.value) scrollInContainer(rootEl.value, {
        top: 0,
        behavior: "smooth"
      });
    }
    __expose({ scrollToTop });
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock(
        ...
        [_createVNode(
          ...
          null,
          {
            header: _withCtx(() => [_unref(prefer).s.showPageTabBarBottom && (props.tabs?.length ?? 0) > 0 ? (_openBlock(), _createBlock(
              _component_MkPageHeader,
              _mergeProps(pageHeaderPropsWithoutTabs.value, { key: 0 }),
              null,
              16
              /* FULL_PROPS */
            ...
            footer: _withCtx(() => [_renderSlot(_ctx.$slots, "footer"), _unref(prefer).s.showPageTabBarBottom && (props.tabs?.length ?? 0) > 0 ? (_openBlock(), _createElementBlock(
              "div",
              {
                key: 0,
              ...
              [_createVNode(MkTabs, {
                ...
                tab: tab.value,
                "onUpdate:tab": _cache[1] || (_cache[1] = ($event) => tab.value = $event)
              }, null, 8, [
                "tabs",
                "centered",
                "tabHighlightUpper",
            ...
            default: _withCtx(() => [_createElementVNode(
              ...
              [_unref(prefer).s.enableHorizontalSwipe && __props.swipable && (props.tabs?.length ?? 1) > 1 ? (_openBlock(), _createBlock(MkSwiper, {
                key: 0,
                class: _normalizeClass(_ctx.$style.swiper),
                tabs: props.tabs ?? [],
                tab: tab.value,
                "onUpdate:tab": _cache[2] || (_cache[2] = ($event) => tab.value = $event)
              }, {
                default: _withCtx(() => [_renderSlot(_ctx.$slots, "default")]),
                _: 3
              }, 1034, ["tabs", "tab"])) : _renderSlot(_ctx.$slots, "default", { key: 1 })],
              2
              /* CLASS */
            )]),
            _: 3
