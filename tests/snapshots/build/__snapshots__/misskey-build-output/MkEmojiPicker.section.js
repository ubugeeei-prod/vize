...
export default {
  ...
  setup(__props, { emit: __emit }) {
    ...
    function nestedChosen(emoji, ev) {
    ...
    return (_ctx, _cache) => {
      ...
      return !__props.hasChildSection ? _withDirectives((_openBlock(), _createElementBlock("section", {
        key: 0,
        style: "border-radius: 6px; border-bottom: 0.5px solid var(--MI_THEME-divider);"
      }, [_createElementVNode("header", {
        class: "_acrylic",
        onClick: _cache[0] || (_cache[0] = ($event) => shown.value = !shown.value)
      }, [
        _createElementVNode(
          "i",
        ...
        _hoisted_1,
        _createTextVNode(
          ":" + _toDisplayString(emojis.value.length) + ")\n  ",
          1
          /* TEXT */
        )
        ...
        _renderList(emojis.value, (emoji) => {
          return _openBlock(), _createElementBlock("button", {
            ...
            onClick: ($event) => emit("chosen", emoji, $event)
          }, [emoji[0] === ":" ? (_openBlock(), _createBlock(_component_MkCustomEmoji, {
            key: 0,
            class: "emoji",
            name: emoji,
            normal: true,
        ...
        128
        /* KEYED_FRAGMENT */
      ))])) : _createCommentVNode("v-if", true)])), [[_directive_panel]]) : _withDirectives((_openBlock(), _createElementBlock("section", {
        key: 1,
        style: "border-radius: 6px; border-bottom: 0.5px solid var(--MI_THEME-divider);"
      }, [
        _createElementVNode("header", {
          class: "_acrylic",
          onClick: _cache[1] || (_cache[1] = ($event) => shown.value = !shown.value)
        }, [
          _createElementVNode(
            "i",
            { class: _normalizeClass(["toggle ti-fw", shown.value ? "ti ti-chevron-down" : "ti ti-chevron-up"]) },
          ...
          _hoisted_2,
          _createTextVNode(
            ":" + _toDisplayString(__props.customEmojiTree?.length) + " ",
            1
            /* TEXT */
          ),
          _hoisted_3,
        ...
        shown.value ? (_openBlock(), _createElementBlock("div", {
          ...
          _Fragment,
          null,
          _renderList(__props.customEmojiTree, (child) => {
