...
export default {
  ...
  setup(__props) {
    ...
    function onNotification(notification, isClient = false) {
      ...
      return _openBlock(), _createElementBlock(
        ...
        [
          _createVNode(_Transition, {
            ...
            default: _withCtx(() => [drawerMenuShowing.value ? (_openBlock(), _createElementBlock(
              "div",
              {
                key: 0,
                class: _normalizeClass(["_modalBg", _ctx.$style.menuDrawerBg]),
                onClick: _cache[0] || (_cache[0] = ($event) => drawerMenuShowing.value = false),
                onTouchstartPassive: _cache[1] || (_cache[1] = ($event) => drawerMenuShowing.value = false)
              },
              null,
              34
          ...
          _createVNode(_Transition, {
            ...
            default: _withCtx(() => [drawerMenuShowing.value ? (_openBlock(), _createElementBlock(
              ...
              }, null, 8, ["asDrawer", "showWidgetButton"])],
              2
              /* CLASS */
            )) : _createCommentVNode("v-if", true)]),
            _: 2
          ...
          _createVNode(_Transition, {
            ...
            default: _withCtx(() => [widgetsShowing.value ? (_openBlock(), _createElementBlock(
              "div",
              {
                key: 0,
                class: _normalizeClass(["_modalBg", _ctx.$style.widgetsDrawerBg]),
                onClick: _cache[2] || (_cache[2] = ($event) => widgetsShowing.value = false),
                onTouchstartPassive: _cache[3] || (_cache[3] = ($event) => widgetsShowing.value = false)
              },
              null,
              34
              /* CLASS, NEED_HYDRATION */
            ...
            default: _withCtx(() => [widgetsShowing.value ? (_openBlock(), _createElementBlock(
              ...
              [_createElementVNode(
                "button",
                {
                  ...
                  onClick: _cache[4] || (_cache[4] = ($event) => widgetsShowing.value = false)
                },
                [_hoisted_1],
                2
                /* CLASS */
          ...
          (_openBlock(true), _createElementBlock(
            _Fragment,
            null,
            _renderList(_unref(popups), (popup) => {
              return _openBlock(), _createBlock(
                _resolveDynamicComponent(popup.component),
                _mergeProps(popup.props, _toHandlers(popup.events, true), { key: popup.id }),
                null,
                16
                /* FULL_PROPS */
              );
          ...
          _createVNode(_resolveDynamicComponent(_unref(prefer).s.animation ? _unref(TransitionGroup) : "div"), {
            ...
            default: _withCtx(() => [(_openBlock(true), _createElementBlock(
              _Fragment,
              null,
              _renderList(notifications.value, (notification) => {
                return _openBlock(), _createElementBlock(
                  "div",
                  {
                    key: notification.id,
                  ...
                  [_createVNode(XNotification, { notification }, null, 8, ["notification"])],
                  2
                  /* CLASS */
                );
              }),
          ...
          _createVNode(XStreamIndicator),
          _unref(pendingApiRequestsCount) > 0 ? (_openBlock(), _createElementBlock("div", {
            key: 0,
            id: "wait"
          })) : _createCommentVNode("v-if", true),
          _unref(dev) ? (_openBlock(), _createElementBlock("div", {
            key: 0,
            id: "devTicker"
          }, [_hoisted_2])) : _createCommentVNode("v-if", true),
          _unref($i) && _unref($i).isBot ? (_openBlock(), _createElementBlock("div", {
            key: 0,
            id: "botWarn"
          }, [_createElementVNode(
            "span",
            _hoisted_3,
            _toDisplayString(_unref(i18n).ts.loggedInAsBot),
            1
            /* TEXT */
          )])) : _createCommentVNode("v-if", true),
          _unref(isSafeMode) ? (_openBlock(), _createElementBlock("div", {
            key: 0,
            id: "safemodeWarn"
          }, [_createElementVNode(
            "span",
            _hoisted_4,
            _toDisplayString(_unref(i18n).ts.safeModeEnabled),
            1
            /* TEXT */
          ), _createElementVNode(
            "button",
            ...
            _toDisplayString(_unref(i18n).ts.turnItOff),
            1
            /* TEXT */
          )])) : _createCommentVNode("v-if", true)
        ],
