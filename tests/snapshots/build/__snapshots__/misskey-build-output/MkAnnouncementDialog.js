...
export default {
  ...
  setup(__props, { emit: __emit }) {
    ...
    async function ok() {
      ...
      updateCurrentAccountPartial({ unreadAnnouncements: $i.unreadAnnouncements.filter((a) => a.id !== props.announcement.id) });
    }
    function onBgClick() {
    ...
    onMounted(() => {
      if (bottomEl.value && rootEl.value) {
        ...
        if (bottomElRect.top >= rootElRect.top && bottomElRect.top <= rootElRect.bottom - 66) {
          ...
          [
            _createElementVNode(
              ...
              [_createElementVNode(
                ...
                [__props.announcement.icon === "info" ? (_openBlock(), _createElementBlock("i", {
                  key: 0,
                  class: "ti ti-info-circle"
                })) : __props.announcement.icon === "warning" ? (_openBlock(), _createElementBlock("i", {
                  key: 1,
                  class: "ti ti-alert-triangle",
                  style: "color: var(--MI_THEME-warn);"
                })) : __props.announcement.icon === "error" ? (_openBlock(), _createElementBlock("i", {
                  key: 2,
                  class: "ti ti-circle-x",
                  style: "color: var(--MI_THEME-error);"
                })) : __props.announcement.icon === "success" ? (_openBlock(), _createElementBlock("i", {
                  key: 3,
                  class: "ti ti-check",
            ...
            _createElementVNode(
              ...
              [_createVNode(_component_Mfm, { text: __props.announcement.text }, null, 8, ["text"])],
              2
              /* CLASS */
            ),
            _createElementVNode(
            ...
            _createElementVNode(
              ...
              [_createVNode(MkButton, {
                ...
                default: _withCtx(() => [_createTextVNode(
                  _toDisplayString(hasReachedBottom.value ? _unref(i18n).ts.close : _unref(i18n).ts.scrollToClose),
                  1
                  /* TEXT */
                )]),
                _: 1
