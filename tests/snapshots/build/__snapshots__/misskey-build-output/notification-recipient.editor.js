...
export default {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const loading = ref(0);
    const title = ref("");
    const { model: method, def: methodDef } = useMkSelect({
      items: [{
    ...
    const { model: userId, def: userIdDef } = useMkSelect({ items: computed(() => moderators.value.map((u) => ({
      label: u.name ? `${u.name}(${u.username})` : u.username,
      value: u.id
    }))) });
    const { model: systemWebhookId, def: systemWebhookIdDef } = useMkSelect({ items: computed(() => systemWebhooks.value.map((w) => ({
      label: w.name,
      value: w.id
    }))) });
    ...
    async function onEditSystemWebhookClicked() {
      ...
      if (systemWebhookId.value === null) {
        result = await showSystemWebhookEditorDialog({ mode: "create" });
      } else {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(MkModalWindow, {
        ...
        default: _withCtx(() => [loading.value === 0 ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          ...
          [
            _createVNode(MkInput, {
              ...
              label: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts.title),
                1
                /* TEXT */
              )]),
              _: 1
            ...
            _createVNode(MkSelect, {
              ...
              "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => method.value = $event)
            }, {
              label: _withCtx(() => [_createTextVNode(
            ...
            _createElementVNode("div", null, [_unref(method) === "email" ? (_openBlock(), _createBlock(MkSelect, {
              key: 0,
              ...
              label: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._abuseReport._notificationRecipient.notifiedUser),
                1
                /* TEXT */
              )]),
              _: 1
            }, 8, ["items", "modelValue"])) : _unref(method) === "webhook" ? (_openBlock(), _createElementBlock(
              "div",
              {
                key: 1,
              ...
              [_createVNode(MkSelect, {
                ...
                "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => systemWebhookId.value = $event)
              }, {
                label: _withCtx(() => [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts._abuseReport._notificationRecipient.notifiedWebhook),
                  1
                  /* TEXT */
                )]),
                _: 1
              }, 8, ["items", "modelValue"]), _createVNode(
                MkButton,
                {
                  rounded: "",
                ...
                {
                  default: _withCtx(() => [_unref(systemWebhookId) === null ? (_openBlock(), _createElementBlock("span", {
                    key: 0,
                    class: "ti ti-plus",
            ...
            _createVNode(MkSwitch, {
              ...
              "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => isActive.value = $event)
            }, {
              label: _withCtx(() => [_createTextVNode(
