  ...
  setup(__props, { expose: __expose }) {
    ...
    onMounted(() => {
      ...
      lightbox = new PhotoSwipeLightbox({
        dataSource: props.mediaList.filter((media) => {
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock(
        ...
        [(_openBlock(true), _createElementBlock(
          _Fragment,
          null,
          _renderList(__props.mediaList.filter((media) => !previewable(media)), (media) => {
          ...
          128
          /* KEYED_FRAGMENT */
        )), __props.mediaList.filter((media) => previewable(media)).length > 0 ? (_openBlock(), _createElementBlock(
          "div",
          {
            key: 0,
            ...
            [(_openBlock(true), _createElementBlock(
              ...
              _renderList(__props.mediaList.filter((media) => previewable(media)), (media) => {
                return _openBlock(), _createElementBlock(
                  _Fragment,
                  null,
                  [media.type.startsWith("video") ? (_openBlock(), _createBlock(XVideo, {
                    key: `video:${media.id}`,
                    class: _normalizeClass(_ctx.$style.media),
                    video: media
                  }, null, 10, ["video"])) : media.type.startsWith("image") ? (_openBlock(), _createBlock(XImage, {
                    key: `image:${media.id}`,
