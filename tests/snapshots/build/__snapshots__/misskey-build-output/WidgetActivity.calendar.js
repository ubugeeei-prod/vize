...
export default {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock("svg", { viewBox: "0 0 21 7" }, [
        (_openBlock(true), _createElementBlock(
          _Fragment,
          null,
          _renderList(_unref(activity), (record) => {
            return _openBlock(), _createElementBlock("rect", {
              ...
              "title",
              null,
              _toDisplayString(record.date.year) + "/" + _toDisplayString(record.date.month + 1) + "/" + _toDisplayString(record.date.day),
              1
              /* TEXT */
            )], 8, ["x", "y"]);
          }),
