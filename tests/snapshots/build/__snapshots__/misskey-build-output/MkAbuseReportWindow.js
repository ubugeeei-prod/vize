  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(MkWindow, {
        ...
        header: _withCtx(() => [_hoisted_1, _createVNode(_component_I18n, {
          src: _unref(i18n).ts.reportAbuseOf,
          tag: "span"
        }, {
          name: _withCtx(() => [_createElementVNode("b", null, [_createVNode(_component_MkAcct, { user: __props.user }, null, 8, ["user"])])]),
          _: 1
        }, 8, ["src"])]),
        default: _withCtx(() => [_createElementVNode("div", {
          ...
          [_createElementVNode("div", { class: "" }, [_createVNode(MkTextarea, {
            modelValue: comment.value,
            "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => comment.value = $event)
          }, {
            ...
            caption: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts.fillAbuseReportDescription),
              1
              /* TEXT */
            )]),
            _: 1
          }, 8, ["modelValue"])]), _createElementVNode("div", { class: "" }, [_createVNode(MkButton, {
            primary: "",
            full: "",
            ...
            default: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts.send),
              1
              /* TEXT */
            )]),
            _: 1
