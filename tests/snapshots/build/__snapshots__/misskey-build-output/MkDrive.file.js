  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock("div", {
        ...
        onDragstart,
        onDragend
      }, [_createElementVNode("div", { style: "pointer-events: none;" }, [
        _unref($i)?.avatarId == __props.file.id ? (_openBlock(), _createElementBlock(
          "div",
          {
            key: 0,
          ...
          [_createElementVNode(
            ...
            _toDisplayString(_unref(i18n).ts.avatar),
            3
            /* TEXT, CLASS */
          )],
          2
        ...
        _unref($i)?.bannerId == __props.file.id ? (_openBlock(), _createElementBlock(
          "div",
          {
            key: 0,
            class: _normalizeClass([_ctx.$style.label])
          ...
          [_createElementVNode(
            ...
            "p",
            { class: _normalizeClass(_ctx.$style.labelText) },
            _toDisplayString(_unref(i18n).ts.banner),
            3
            /* TEXT, CLASS */
          )],
          2
        ...
        __props.file.isSensitive ? (_openBlock(), _createElementBlock(
          "div",
          {
            key: 0,
        ...
        _createElementVNode(
          ...
          [_createElementVNode(
            "span",
            null,
            _toDisplayString(__props.file.name.lastIndexOf(".") != -1 ? __props.file.name.substring(0, __props.file.name.lastIndexOf(".")) : __props.file.name),
            1
            /* TEXT */
          ), __props.file.name.lastIndexOf(".") != -1 ? (_openBlock(), _createElementBlock(
            "span",
            {
              key: 0,
              style: "opacity: 0.5;"
            },
            _toDisplayString(__props.file.name.substring(__props.file.name.lastIndexOf("."))),
            1
            /* TEXT */
          )) : _createCommentVNode("v-if", true)],
          2
