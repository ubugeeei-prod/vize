...
...meta },
    ...
    async function install() {
      ...
      switch (data.value.type) {
        case "plugin":
          ...
          try {
            await installPlugin(data.value.raw, data.value.meta);
            os.success();
            window.setTimeout(() => {
              close_();
            }, 3e3);
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_PageWithAnimBg, null, {
        default: _withCtx(() => [_createElementVNode("div", {
        ...
        }, [uiPhase.value === "fetching" ? (_openBlock(), _createBlock(MkLoading, { key: 0 })) : uiPhase.value === "confirm" && data.value ? (_openBlock(), _createBlock(MkExtensionInstaller, {
          key: 1,
          extension: data.value,
          onConfirm: _cache[0] || (_cache[0] = ($event) => install()),
          onCancel: _cache[1] || (_cache[1] = ($event) => close_())
        }, {
          additionalInfo: _withCtx(() => [_createVNode(FormSection, null, {
            default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_s" }, [_createVNode(MkKeyValue, null, {
              key: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._externalResourceInstaller._vendorInfo.endpoint),
                1
                /* TEXT */
              )]),
              value: _withCtx(() => [url.value ? (_openBlock(), _createBlock(MkUrl, {
                key: 0,
                url: url.value,
                showUrlPreview: false
              }, null, 8, ["url", "showUrlPreview"])) : _createCommentVNode("v-if", true)]),
              _: 1
            }), _createVNode(MkKeyValue, null, {
              key: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._externalResourceInstaller._vendorInfo.hashVerify),
                1
                /* TEXT */
              )]),
              value: _withCtx(() => [_hoisted_1]),
              _: 1
            })])]),
            _: 1
          })]),
          _: 1
        }, 8, ["extension"])) : uiPhase.value === "error" ? (_openBlock(), _createElementBlock(
          "div",
          {
            key: 2,
          ...
          [
            ...
            _createElementVNode(
              ...
              _toDisplayString(errorKV.value?.title),
              3
              /* TEXT, CLASS */
            ),
            _createElementVNode(
              ...
              _toDisplayString(errorKV.value?.description),
              3
              /* TEXT, CLASS */
            ),
            _createElementVNode("div", { class: "_buttonsCenter" }, [_createVNode(MkButton, { onClick: _cache[2] || (_cache[2] = ($event) => close_()) }, {
