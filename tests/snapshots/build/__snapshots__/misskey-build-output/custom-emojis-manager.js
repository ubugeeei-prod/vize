...
export default {
  ...
  setup(__props) {
    ...
    const paginator = markRaw(new Paginator("admin/emoji/list", {
      limit: 30,
      computedParams: computed(() => ({ query: query.value && query.value !== "" ? query.value : null }))
    }));
    ...
    const edit = async (emoji) => {
      const { dispose } = await os.popupAsyncWithDialog(import("./emoji-edit-dialog.vue").then((x) => x.default), { emoji }, {
        done: (result) => {
          if (result.updated) {
    ...
    const importEmoji = (emojiId) => {
      os.apiWithDialog("admin/emoji/copy", { emojiId });
    };
    const remoteMenu = (emoji, ev) => {
      os.popupMenu([
        {
          type: "label",
          text: ":" + emoji.name + ":"
    ...
    const menu = (ev) => {
      os.popupMenu([{
        ...
        text: i18n.ts.export,
        action: async () => {
          misskeyApi("export-custom-emojis", {}).then(() => {
            os.alert({
              type: "info",
        ...
        action: async () => {
          ...
          misskeyApi("admin/emoji/import-zip", { fileId: file.id }).then(() => {
            os.alert({
              type: "info",
    ...
    const setLicenseBulk = async () => {
      const { canceled, result } = await os.inputText({ title: "License" });
      if (canceled) return;
    ...
    const delBulk = async () => {
      ...
      if (canceled) return;
      await os.apiWithDialog("admin/emoji/delete-bulk", { ids: selectedEmojis.value });
      paginator.reload();
    };
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_PageWithHeader, {
        ...
        default: _withCtx(() => [_createElementVNode("div", {
        ...
        }, [_createElementVNode("div", { class: "ogwlenmc" }, [tab.value === "local" ? (_openBlock(), _createElementBlock("div", {
          key: 0,
          class: "local"
        }, [
          _createVNode(MkInput, {
            ...
            _: 1
          }, 8, ["debounce", "modelValue"]),
          _createVNode(MkSwitch, {
            style: "margin: 8px 0;",
            modelValue: selectMode.value,
            "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => selectMode.value = $event)
          }, {
            label: _withCtx(() => [_createTextVNode("Select mode")]),
            _: 1
          }, 8, ["modelValue"]),
          selectMode.value ? (_openBlock(), _createElementBlock("div", {
            key: 0,
            class: "_buttons"
          }, [
            ...
            _createVNode(MkButton, {
              ...
              default: _withCtx(() => [_createTextVNode("Set category")]),
              _: 1
            }),
            _createVNode(MkButton, {
              inline: "",
              ...
              default: _withCtx(() => [_createTextVNode("Set tag")]),
              _: 1
            }),
            _createVNode(MkButton, {
              inline: "",
              ...
              default: _withCtx(() => [_createTextVNode("Add tag")]),
              _: 1
            }),
            _createVNode(MkButton, {
              inline: "",
              ...
              default: _withCtx(() => [_createTextVNode("Remove tag")]),
              _: 1
            }),
            _createVNode(MkButton, {
              inline: "",
              ...
              default: _withCtx(() => [_createTextVNode("Set License")]),
              _: 1
            }),
            _createVNode(MkButton, {
              inline: "",
          ...
          _createVNode(MkPagination, {
            ...
            empty: _withCtx(() => [_createElementVNode(
              "span",
              null,
              _toDisplayString(_unref(i18n).ts.noCustomEmojis),
              1
              /* TEXT */
            )]),
            default: _withCtx(({ items }) => [_createElementVNode("div", { class: "ldhfsamy" }, [(_openBlock(true), _createElementBlock(
              _Fragment,
              null,
              _renderList(items, (emoji) => {
                return _openBlock(), _createElementBlock("button", {
                  key: emoji.id,
                  class: _normalizeClass(["emoji _panel _button", { selected: selectedEmojis.value.includes(emoji.id) }]),
                  onClick: ($event) => selectMode.value ? toggleSelect(emoji) : edit(emoji)
                }, [_createElementVNode("img", {
                  src: emoji.url,
                  class: "img",
                  alt: emoji.name
                }, null, 8, ["src", "alt"]), _createElementVNode("div", { class: "body" }, [_createElementVNode(
                  "div",
                  _hoisted_2,
                  _toDisplayString(emoji.name),
                  1
                  /* TEXT */
                ), _createElementVNode(
                  "div",
                  _hoisted_3,
                  _toDisplayString(emoji.category),
                  1
                  /* TEXT */
                )])], 10, ["onClick"]);
              }),
        ...
        ])) : tab.value === "remote" ? (_openBlock(), _createElementBlock("div", {
          key: 1,
          class: "remote"
          ...
          default: _withCtx(() => [_createVNode(MkInput, {
            ...
            "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => queryRemote.value = $event)
          }, {
            ...
            _: 1
          }, 8, ["debounce", "modelValue"]), _createVNode(MkInput, {
            debounce: true,
          ...
          default: _withCtx(({ items }) => [_createElementVNode("div", { class: "ldhfsamy" }, [(_openBlock(true), _createElementBlock(
            ...
            _renderList(items, (emoji) => {
              return _openBlock(), _createElementBlock("div", {
                ...
                onClick: ($event) => remoteMenu(emoji, $event)
              }, [_createElementVNode("img", {
          ...
          _: 1
        }, 8, ["paginator"])])) : _createCommentVNode("v-if", true)])])]),
        _: 1
      }, 8, [
        "actions",
        "tabs",
