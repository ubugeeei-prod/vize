...
export default {
  ...
  setup(__props, { emit: __emit }) {
    ...
    async function queryKey() {
      ...
      await webAuthnRequest(props.credentialRequest).catch(() => {
        ...
        [_createElementVNode(
          ...
          [
            _createElementVNode("div", { class: "_gaps_s" }, [_createElementVNode(
              ...
              _toDisplayString(_unref(i18n).ts.useSecurityKey),
              3
              /* TEXT, CLASS */
            )]),
            ...
            __props.isPerformingPasswordlessLogin !== true ? (_openBlock(), _createBlock(MkButton, {
              ...
              disabled: queryingKey.value,
              style: "margin: 0 auto;",
              onClick: _cache[0] || (_cache[0] = ($event) => emit("useTotp"))
            }, {
              default: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts.useTotp),
                1
                /* TEXT */
              )]),
              _: 1
