...
contextMenuFactory(col, row, value, context) {
    ...
    async function onUpdateButtonClicked() {
      ...
      const action = () => {
        return updatedItems.map((item) => misskeyApi("admin/emoji/update", {
    ...
    const headerActions = computed(() => [
      {
        ...
        handler: async () => {
          ...
          const { dispose } = await os.popupAsyncWithDialog(import("./custom-emojis-manager.local.list.search.vue").then((x) => x.default), { query: searchQuery.value }, {
            queryUpdated: (query) => {
              searchQuery.value = query;
            },
            sortOrderUpdated: (orders) => {
      ...
      },
      {
        ...
        handler: (ev) => {
          async function changeSearchLimit(to) {
            if (updatedItemsCount.value > 0) {
              const { canceled } = await os.confirm({
                type: "warning",
      ...
      },
      {
        ...
        handler: async () => {
          const { dispose } = await os.popupAsyncWithDialog(import("./custom-emojis-manager.local.list.logs.vue").then((x) => x.default), { logs: requestLogs.value }, { closed: () => {
            dispose();
          } });
        }
      }
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_MkStickyContainer, null, {
        header: _withCtx(() => [_createVNode(_component_MkPageHeader, {
          overridePageMetadata: headerPageMetadata.value,
          actions: headerActions.value
        }, null, 8, ["overridePageMetadata", "actions"])]),
        ...
        footer: _withCtx(() => [gridItems.value.length > 0 ? (_openBlock(), _createElementBlock(
          "div",
          {
            key: 0,
            ...
            _createElementVNode(
              ...
              [_createVNode(MkButton, {
                ...
                default: _withCtx(() => [
                  ...
                  _createTextVNode(" ("),
                  _createTextVNode(
                    _toDisplayString(deleteItemsCount.value),
                    1
                    /* TEXT */
                  ),
                  _createTextVNode(")\n        ")
            ...
            _createElementVNode(
              ...
              [_createVNode(MkButton, {
                ...
                default: _withCtx(() => [
                  ...
                  _createTextVNode(" ("),
                  _createTextVNode(
                    _toDisplayString(updatedItemsCount.value),
                    1
                    /* TEXT */
                  ),
                  _createTextVNode(")\n        ")
                ...
                _: 1
              }, 8, ["disabled"]), _createVNode(MkButton, { onClick: onGridResetButtonClicked }, {
