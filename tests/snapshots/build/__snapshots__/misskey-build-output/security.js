...
export default {
  __name: "security",
  setup(__props) {
    const paginator = markRaw(new Paginator("i/signin-history", { limit: 5 }));
        ...
        default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [
          _createVNode(MkFeatureBanner, {
            ...
            default: _withCtx(() => [_createVNode(_component_SearchText, null, {
              default: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._settings.securityBanner),
                1
                /* TEXT */
              )]),
              _: 1
              ...
              default: _withCtx(() => [_createVNode(_component_SearchMarker, null, {
                default: _withCtx(() => [_createVNode(MkButton, {
                  ...
                  default: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                    default: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts.changePassword),
                      1
                      /* TEXT */
                    )]),
                    _: 1
          ...
          _createVNode(_component_SearchMarker, { keywords: [
            ...
            default: _withCtx(() => [_createVNode(FormSection, null, {
              label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                default: _withCtx(() => [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts.signinHistory),
                  1
                  /* TEXT */
                )]),
                _: 1
                ...
                default: _withCtx(({ items }) => [_createElementVNode("div", null, [(_openBlock(true), _createElementBlock(
                  ...
                  _renderList(items, (item) => {
                    return _withDirectives((_openBlock(), _createElementBlock("div", {
                      ...
                      item.success ? (_openBlock(), _createElementBlock("i", {
                        key: 0,
            ...
            default: _withCtx(() => [_createVNode(FormSection, null, {
              default: _withCtx(() => [_createVNode(FormSlot, null, {
                caption: _withCtx(() => [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts.regenerateLoginTokenDescription),
                  1
                  /* TEXT */
                )]),
                default: _withCtx(() => [_createVNode(MkButton, {
                  ...
                  default: _withCtx(() => [
                    ...
                    _createVNode(_component_SearchLabel, null, {
                      default: _withCtx(() => [_createTextVNode(
                        _toDisplayString(_unref(i18n).ts.regenerateLoginToken),
                        1
                        /* TEXT */
                      )]),
                      _: 1
