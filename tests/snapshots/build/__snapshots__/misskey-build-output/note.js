...
export default {
  ...
  setup(__props) {
    ...
    const prevChannelPaginator = markRaw(new Paginator("channels/timeline", {
      limit: 10,
      initialId: props.noteId,
      computedParams: computed(() => note.value && note.value.channelId != null ? { channelId: note.value.channelId } : undefined)
    }));
    ...
    function fetchNote() {
      ...
      misskeyApi("notes/show", { noteId: props.noteId }).then((res) => {
        note.value = res;
        ...
        if ((appearNote.clippedCount ?? 0) > 0 || new Date(appearNote.createdAt).getTime() < new Date("2023-10-01").getTime()) {
          misskeyApi("notes/clips", { noteId: appearNote.id }).then((_clips) => {
            clips.value = _clips;
          });
        }
      }).catch((err) => {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_PageWithHeader, {
        ...
        default: _withCtx(() => [_createElementVNode("div", {
          ...
          default: _withCtx(() => [note.value ? (_openBlock(), _createElementBlock("div", { key: 0 }, [
            showNext.value ? (_openBlock(), _createElementBlock("div", {
              key: 0,
              class: "_margin"
            ...
            _createElementVNode("div", { class: "_margin" }, [
              !showNext.value ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 0,
                  class: _normalizeClass(["_buttons", _ctx.$style.loadNext])
                },
                [note.value.channelId ? (_openBlock(), _createBlock(
                  MkButton,
                  {
                    key: 0,
                    rounded: "",
                    class: _normalizeClass(_ctx.$style.loadButton),
                    onClick: _cache[0] || (_cache[0] = ($event) => showNext.value = "channel")
                  },
                  {
                    default: _withCtx(() => [
                      _hoisted_1,
                  ...
                  2
                  /* CLASS */
                )) : _createCommentVNode("v-if", true), _createVNode(
                  MkButton,
                  {
                    rounded: "",
                    class: _normalizeClass(_ctx.$style.loadButton),
                    onClick: _cache[1] || (_cache[1] = ($event) => showNext.value = "user")
                  },
                  {
                    default: _withCtx(() => [
                      _hoisted_3,
              ...
              _createElementVNode("div", { class: "_margin _gaps_s" }, [note.value.user.host != null ? (_openBlock(), _createBlock(MkRemoteCaution, {
                key: 0,
                href: note.value.url ?? note.value.uri
              }, null, 8, ["href"])) : _createCommentVNode("v-if", true), _createVNode(MkNoteDetailed, {
                key: note.value.id,
                initialTab: __props.initialTab,
                class: _normalizeClass(_ctx.$style.note),
                note: note.value,
                "onUpdate:note": _cache[2] || (_cache[2] = ($event) => note.value = $event)
              }, null, 10, ["initialTab", "note"])]),
              clips.value && clips.value.length > 0 ? (_openBlock(), _createElementBlock("div", {
                key: 0,
                class: "_margin"
              }, [_createElementVNode(
                "div",
                _hoisted_5,
                _toDisplayString(_unref(i18n).ts.clip),
                1
                /* TEXT */
              ), _createElementVNode("div", { class: "_gaps" }, [(_openBlock(true), _createElementBlock(
                _Fragment,
                null,
                _renderList(clips.value, (item) => {
              ...
              !showPrev.value ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 0,
                ...
                [note.value.channelId ? (_openBlock(), _createBlock(
                  MkButton,
                  {
                    ...
                    rounded: "",
                    class: _normalizeClass(_ctx.$style.loadButton),
                    onClick: _cache[3] || (_cache[3] = ($event) => showPrev.value = "channel")
                  },
                  {
                    default: _withCtx(() => [
                      _hoisted_6,
                  ...
                  MkButton,
                  {
                    rounded: "",
                    class: _normalizeClass(_ctx.$style.loadButton),
                    onClick: _cache[4] || (_cache[4] = ($event) => showPrev.value = "user")
                  },
                  {
                    default: _withCtx(() => [
                      _hoisted_8,
            ...
            showPrev.value ? (_openBlock(), _createElementBlock("div", {
              key: 0,
              class: "_margin"
            }, [_createVNode(MkNotesTimeline, {
              withControl: false,
            ...
            key: 1,
            onRetry: _cache[5] || (_cache[5] = ($event) => fetchNote())
