...
export default {
  ...
  setup(__props) {
    ...
    const _permissions = computed(() => {
      return props.permission ? props.permission.split(",").filter((p) => Misskey.permissions.includes(p)) : [];
    });
    const authRoot = useTemplateRef("authRoot");
    async function onAccept(token) {
      await misskeyApi("miauth/gen-token", {
        ...
        if (props.callback && props.callback !== "") {
          ...
          if ([
            ...
            "tel:",
            "vbscript:"
          ].includes(cbUrl.protocol)) throw new Error("invalid url");
        ...
        default: _withCtx(() => [_createElementVNode(
          ...
          [_createElementVNode(
            ...
            [_createVNode(MkAuthConfirm, {
              ...
              consentAdditionalInfo: _withCtx(() => [__props.callback != null ? (_openBlock(), _createElementBlock(
                "div",
                {
                  key: 0,
                ...
                [_createElementVNode(
                  "div",
                  null,
                  _toDisplayString(_unref(i18n).ts._auth.byClickingYouWillBeRedirectedToThisUrl),
                  1
                  /* TEXT */
                ), _createElementVNode(
                  "div",
                  { class: _normalizeClass(["_monospace", _ctx.$style.redirectUrl]) },
                  _toDisplayString(__props.callback),
                  3
                  /* TEXT, CLASS */
                )],
                2
