...
export default {
  ...
  setup(__props) {
    ...
    const uiKey = ref(0);
    const uiInspectorOpenedComponents = ref(new WeakMap());
    ...
    function stringifyUiProps(uiProps) {
      return JSON.stringify({
        ...
        type: undefined,
        id: undefined
      }, (k, v) => typeof v === "function" ? "<function>" : v, 2);
    }
    async function run() {
    ...
    const showns = computed(() => {
      ...
      (function addChildrenToResult(c) {
        result.add(c.id);
      ...
      return _openBlock(), _createBlock(_component_PageWithHeader, null, {
        default: _withCtx(() => [_createElementVNode("div", {
          ...
          _createElementVNode("div", { class: "_gaps_s" }, [_createElementVNode(
            ...
            primary: "",
            onClick: _cache[1] || (_cache[1] = ($event) => run())
          }, {
            default: _withCtx(() => [_hoisted_1]),
            _: 1
          })]),
          root.value && components.value.length > 1 ? (_openBlock(), _createBlock(MkContainer, {
            key: uiKey.value,
            foldable: true
          }, {
            header: _withCtx(() => [_createTextVNode("UI")]),
            default: _withCtx(() => [_createElementVNode(
              ...
              [_createVNode(MkAsUi, {
                ...
                size: "small"
              }, null, 8, ["component", "components"])],
              2
              /* CLASS */
            )]),
            _: 1
          }, 8, ["foldable"])) : _createCommentVNode("v-if", true),
          _createVNode(MkContainer, {
            foldable: true,
            class: ""
          }, {
            header: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts.output),
              1
              /* TEXT */
            )]),
            default: _withCtx(() => [_createElementVNode(
          ...
          _createVNode(MkContainer, {
            ...
            header: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts.uiInspector),
              1
              /* TEXT */
            )]),
            default: _withCtx(() => [_createElementVNode(
              ...
              [(_openBlock(true), _createElementBlock(
                _Fragment,
                null,
                _renderList(components.value, (c) => {
                  return _openBlock(), _createElementBlock(
                    "div",
                    {
                      key: c.value.id,
                    ...
                    [
                      ...
                      _createElementVNode(
                        ...
                        _toDisplayString(c.value.id),
                        3
                        /* TEXT, CLASS */
                      ),
                      _createElementVNode("button", {
                        class: _normalizeClass(_ctx.$style.uiInspectorPropsToggle),
                        onClick: () => uiInspectorOpenedComponents.value.set(c, !uiInspectorOpenedComponents.value.get(c))
                      }, [uiInspectorOpenedComponents.value.get(c) ? (_openBlock(), _createElementBlock("i", {
                        key: 0,
                      ...
                      uiInspectorOpenedComponents.value.get(c) ? (_openBlock(), _createElementBlock("div", { key: 0 }, [_createVNode(MkTextarea, {
                ...
                _toDisplayString(_unref(i18n).ts.uiInspectorDescription),
                3
                /* TEXT, CLASS */
              )],
              2
