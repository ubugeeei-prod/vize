      ...
      return _openBlock(), _createElementBlock(
        ...
        [_createElementVNode(
          ...
          [__props.buffer !== undefined ? (_openBlock(), _createElementBlock("progress", {
            ...
            min: "0",
            max: "1"
          }, _toDisplayString(Math.round(__props.buffer * 100)) + "% buffered", 11, ["value"])) : _createCommentVNode("v-if", true), _withDirectives(_createElementVNode(
            "input",
            {
              ...
              max: "1",
              step: "any",
              onChange: _cache[1] || (_cache[1] = ($event) => emit("dragEnded", modelValue.value))
            },
            null,
            38
