...
export default {
  ...
  setup(__props) {
    ...
    async function _fetch_() {
      fetching.value = true;
      file.value = await misskeyApi("drive/files/show", { fileId: props.fileId }).catch((err) => {
        console.error(err);
        return undefined;
      });
    ...
    function postThis() {
      ...
      os.post({ initialFiles: [file.value] });
    }
    function move() {
      if (file.value == null) return;
      const f = file.value;
    ...
    async function deleteFile() {
      ...
      if (canceled) return;
      await os.apiWithDialog("drive/files/delete", { fileId: file.value.id });
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createElementBlock("div", { class: "_gaps" }, [_createVNode(MkInfo, null, {
        ...
        _createElementVNode(
          ...
          [_createVNode(MkMediaList, { mediaList: [file.value] }, null, 8, ["mediaList"])],
          2
          /* CLASS */
        ),
        _createElementVNode(
          ...
          [_createElementVNode(
            "button",
            {
              ...
              onClick: _cache[0] || (_cache[0] = ($event) => rename())
            },
            [_createElementVNode(
              "h2",
              { class: _normalizeClass(["_nowrap", _ctx.$style.fileName]) },
              _toDisplayString(file.value.name),
              3
              /* TEXT, CLASS */
            ), _createElementVNode(
              "i",
            ...
            [
              _withDirectives(_createElementVNode(
                "button",
                {
                  ...
                  onClick: _cache[1] || (_cache[1] = ($event) => postThis())
                },
                [_hoisted_1],
                2
                /* CLASS */
              ...
              file.value.isSensitive ? _withDirectives((_openBlock(), _createElementBlock(
                "button",
                {
                  key: 0,
                  class: _normalizeClass(["_button", _ctx.$style.fileQuickActionsOthersButton]),
                  onClick: _cache[2] || (_cache[2] = ($event) => toggleSensitive())
                },
                [_hoisted_2],
                2
                /* CLASS */
              )), [[_directive_tooltip, _unref(i18n).ts.unmarkAsSensitive]]) : _withDirectives((_openBlock(), _createElementBlock(
                "button",
                {
                  key: 1,
                  class: _normalizeClass(["_button", _ctx.$style.fileQuickActionsOthersButton]),
                  onClick: _cache[3] || (_cache[3] = ($event) => toggleSensitive())
                },
                [_hoisted_3],
                2
                /* CLASS */
              ...
              _withDirectives(_createElementVNode(
                "button",
                {
                  ...
                  onClick: _cache[4] || (_cache[4] = ($event) => deleteFile())
                },
                [_hoisted_5],
                2
                /* CLASS */
        ...
        _createElementVNode("div", { class: "_gaps_s" }, [
          _createElementVNode(
            "button",
            {
              ...
              onClick: _cache[5] || (_cache[5] = ($event) => move())
            },
            [_createVNode(MkKeyValue, null, {
              ...
              value: _withCtx(() => [_createTextVNode(
                _toDisplayString(folderHierarchy.value.join(" > ")),
                1
                /* TEXT */
              ), _createElementVNode(
                "i",
          ...
          _createElementVNode(
            ...
            {
              class: _normalizeClass(["_button", _ctx.$style.kvEditBtn]),
              onClick: _cache[6] || (_cache[6] = ($event) => describe())
            },
            [_createVNode(
              MkKeyValue,
              { class: _normalizeClass(_ctx.$style.multiline) },
              {
                ...
                value: _withCtx(() => [_createTextVNode(
                  _toDisplayString(file.value.comment ? file.value.comment : `(${_unref(i18n).ts.none})`),
                  1
                  /* TEXT */
                ), _createElementVNode(
                  "i",
          ...
          _createVNode(
            ...
            {
              key: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._fileViewer.uploadedAt),
                1
                /* TEXT */
              )]),
          ...
          _createVNode(
            ...
            {
              key: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._fileViewer.type),
                1
                /* TEXT */
              )]),
              value: _withCtx(() => [_createTextVNode(
                _toDisplayString(file.value.type),
                1
                /* TEXT */
              )]),
              _: 1
          ...
          _createVNode(
            ...
            {
              key: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._fileViewer.size),
                1
                /* TEXT */
              )]),
              value: _withCtx(() => [_createTextVNode(
                _toDisplayString(bytes(file.value.size)),
                1
                /* TEXT */
              )]),
              _: 1
          ...
          _createVNode(MkKeyValue, {
            ...
            key: _withCtx(() => [_createTextVNode("URL")]),
            value: _withCtx(() => [_createTextVNode(
              _toDisplayString(file.value.url),
              1
              /* TEXT */
            )]),
            _: 1
