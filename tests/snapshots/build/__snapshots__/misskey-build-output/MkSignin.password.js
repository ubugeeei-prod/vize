...
export default {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const captchaFailed = computed(() => {
      return instance.enableHcaptcha && !hCaptchaResponse.value || instance.enableMcaptcha && !mCaptchaResponse.value || instance.enableRecaptcha && !reCaptchaResponse.value || instance.enableTurnstile && !turnstileResponse.value || instance.enableTestcaptcha && !testcaptchaResponse.value;
    });
    function resetPassword() {
      const { dispose } = os.popup(defineAsyncComponent(() => import("@/components/MkForgotPassword.vue")), {}, { closed: () => dispose() });
    }
    function onSubmit() {
          ...
          [
            ...
            _createElementVNode(
              ...
              [_createVNode(_component_I18n, {
                ...
                name: _withCtx(() => [_createVNode(_component_Mfm, {
              ...
              [
                ...
                _createVNode(MkInput, {
                  ...
                  caption: _withCtx(() => [_createElementVNode(
                    ...
                    _toDisplayString(_unref(i18n).ts.forgotPassword),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                __props.needCaptcha ? (_openBlock(), _createElementBlock("div", { key: 0 }, [
                  ...
                  }, null, 8, ["sitekey", "modelValue"])) : _createCommentVNode("v-if", true),
