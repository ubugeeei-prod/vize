...
export default {
  ...
  setup(__props) {
    ...
    async function deleteAccount() {
      ...
      await os.alert({ title: i18n.ts._accountDelete.started });
      await signout();
    }
    function migrate() {
      migrateOldSettings();
      ...
      return _openBlock(), _createBlock(_component_SearchMarker, {
        ...
        default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [
          _createElementVNode("div", { class: "_gaps_s" }, [
              ...
              default: _withCtx(() => [_createVNode(MkFolder, null, {
                ...
                label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.accountInfo),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                  ...
                  _createVNode(_component_SearchMarker, { keywords: ["role", "policy"] }, {
                    default: _withCtx(() => [_createVNode(MkFolder, null, {
                      ...
                      default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_s" }, [(_openBlock(true), _createElementBlock(
                        _Fragment,
                        null,
                        _renderList(Object.keys(_unref($i).policies), (policy) => {
            ...
            _createVNode(_component_SearchMarker, { keywords: ["roles"] }, {
              default: _withCtx(() => [_createVNode(MkFolder, null, {
                ...
                label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.rolesAssignedToMe),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_s" }, [(_openBlock(true), _createElementBlock(
                  _Fragment,
                  null,
                  _renderList(_unref($i).roles, (role) => {
            ...
            _createVNode(_component_SearchMarker, { keywords: [
              ...
              default: _withCtx(() => [_createVNode(MkFolder, null, {
                ...
                label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.accountMigration),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                })]),
                default: _withCtx(() => [_createVNode(XMigration)]),
                _: 1
              })]),
              _: 1
            }, 8, ["keywords"]),
            _createVNode(_component_SearchMarker, { keywords: [
              ...
              default: _withCtx(() => [_createVNode(MkFolder, null, {
                ...
                label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.closeAccount),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [
                  _createVNode(FormInfo, { warn: "" }, {
                    default: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts._accountDelete.mayTakeTime),
                      1
                      /* TEXT */
                    )]),
                    _: 1
                  ...
                  _createVNode(FormInfo, null, {
                    default: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts._accountDelete.sendEmail),
                      1
                      /* TEXT */
                    )]),
                    _: 1
                  }),
                  !_unref($i).isDeleted ? (_openBlock(), _createBlock(MkButton, {
                    key: 0,
                    danger: "",
                    ...
                    default: _withCtx(() => [_createVNode(_component_SearchText, null, {
                      default: _withCtx(() => [_createTextVNode(
                        _toDisplayString(_unref(i18n).ts._accountDelete.requestAccountDelete),
                        1
                        /* TEXT */
                      )]),
                      _: 1
                    ...
                    default: _withCtx(() => [_createTextVNode(
                      _toDisplayString(_unref(i18n).ts._accountDelete.inProgress),
                      1
                      /* TEXT */
                    )]),
                    _: 1
            ...
            _createVNode(_component_SearchMarker, { keywords: [
              ...
              default: _withCtx(() => [_createVNode(MkFolder, null, {
                ...
                label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.experimentalFeatures),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                ...
                default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [
                  _createVNode(MkSwitch, {
                    ...
                    "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => enableCondensedLine.value = $event)
                  }, {
                    label: _withCtx(() => [_createTextVNode("Enable condensed line")]),
                    _: 1
                  }, 8, ["modelValue"]),
                  _createVNode(MkSwitch, {
                    modelValue: _unref(skipNoteRender),
                    "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => skipNoteRender.value = $event)
                  }, {
                    label: _withCtx(() => [_createTextVNode("Enable note render skipping")]),
                    _: 1
                  }, 8, ["modelValue"]),
                  _createVNode(MkSwitch, {
                    modelValue: _unref(stackingRouterView),
                    "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => stackingRouterView.value = $event)
                  }, {
                    label: _withCtx(() => [_createTextVNode("Enable stacking router view")]),
                    _: 1
                  }, 8, ["modelValue"]),
                  _createVNode(MkSwitch, {
                    modelValue: _unref(enableFolderPageView),
                    "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => enableFolderPageView.value = $event)
                  }, {
                    label: _withCtx(() => [_createTextVNode("Enable folder page view")]),
                    _: 1
                  }, 8, ["modelValue"]),
                  _createVNode(MkSwitch, {
                    modelValue: _unref(enableHapticFeedback),
                    "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => enableHapticFeedback.value = $event)
                  }, {
                    label: _withCtx(() => [_createTextVNode("Enable haptic feedback")]),
                    _: 1
                  }, 8, ["modelValue"]),
                  _createVNode(MkSwitch, {
                    modelValue: _unref(enableWebTranslatorApi),
                    "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => enableWebTranslatorApi.value = $event)
                  }, {
                    label: _withCtx(() => [_createTextVNode("Enable in-browser translator API")]),
                    _: 1
                  }, 8, ["modelValue"])
                ])]),
                _: 1
            ...
            _createVNode(_component_SearchMarker, { keywords: [
              ...
              default: _withCtx(() => [_createVNode(MkFolder, null, {
                ...
                label: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                  default: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.developer),
                    1
                    /* TEXT */
                  )]),
                  _: 1
                })]),
                default: _withCtx(() => [_createElementVNode("div", { class: "_gaps_m" }, [_createVNode(MkSwitch, {
                  modelValue: _unref(devMode),
                  "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => devMode.value = $event)
                }, {
                  label: _withCtx(() => [_createTextVNode(
                    _toDisplayString(_unref(i18n).ts.devMode),
                    1
                    /* TEXT */
                  )]),
                  _: 1
          ...
          _createVNode(FormLink, { to: "/registry" }, {
            ...
            default: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts.registry),
              1
              /* TEXT */
            )]),
            _: 1
          ...
          _createVNode(MkButton, { onClick: resetAllTips }, {
            default: _withCtx(() => [
              ...
              _createTextVNode(" "),
              _createTextVNode(
                _toDisplayString(_unref(i18n).ts.redisplayAllTips),
                1
                /* TEXT */
              )
            ]),
          ...
          _createVNode(MkButton, { onClick: hideAllTips }, {
            default: _withCtx(() => [
              ...
              _createTextVNode(" "),
              _createTextVNode(
                _toDisplayString(_unref(i18n).ts.hideAllTips),
                1
                /* TEXT */
              )
            ]),
          ...
          _hoisted_14,
          _unref($i).policies.chatAvailability !== "unavailable" ? (_openBlock(), _createElementBlock(
            _Fragment,
            { key: 0 },
            [_createVNode(MkButton, { onClick: readAllChatMessages }, {
              default: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts.readAllChatMessages),
                1
                /* TEXT */
              )]),
              _: 1
          ...
          _unref(storagePersistenceSupported) && !_unref(storagePersisted) ? (_openBlock(), _createBlock(MkButton, {
            key: 0,
            onClick: _cache[7] || (_cache[7] = (...args) => enableStoragePersistence && enableStoragePersistence(...args))
          }, {
            default: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts._settings.settingsPersistence_title),
              1
              /* TEXT */
            )]),
            _: 1
          ...
          _createVNode(MkButton, { onClick: forceCloudBackup }, {
            default: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts._preferencesBackup.forceBackup),
              1
              /* TEXT */
            )]),
            _: 1
          ...
          _createVNode(FormSlot, null, {
            caption: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts.migrateOldSettings_description),
              1
              /* TEXT */
            )]),
            default: _withCtx(() => [_createVNode(MkButton, {
              ...
              default: _withCtx(() => [
                ...
                _createTextVNode(" "),
                _createTextVNode(
                  _toDisplayString(_unref(i18n).ts.migrateOldSettings),
                  1
                  /* TEXT */
                )
              ]),
