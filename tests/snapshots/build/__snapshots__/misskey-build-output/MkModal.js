...
export default {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const transitionName = computed((() => prefer.s.animation ? useSendAnime.value ? "send" : type.value === "drawer" ? "modal-drawer" : type.value === "popup" ? "modal-popup" : "modal" : ""));
    const transitionDuration = computed((() => transitionName.value === "send" ? 400 : transitionName.value === "modal-popup" ? 100 : transitionName.value === "modal" ? 200 : transitionName.value === "modal-drawer" ? 200 : 0));
    ...
    const align = () => {
      ...
      } else if (props.anchor.x === "left") {} else if (props.anchor.x === "right") {
        left = x + props.anchorElement.offsetWidth;
      }
      if (props.anchor.y === "center") {
        top = y - height / 2;
      } else if (props.anchor.y === "top") {} else if (props.anchor.y === "bottom") {
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_Transition, {
        ...
        onEnter: _cache[0] || (_cache[0] = ($event) => emit("opening")),
        ...
        default: _withCtx(() => [_withDirectives(_createElementVNode(
          "div",
          {
            ...
            class: _normalizeClass([_ctx.$style.root, {
              [_ctx.$style.drawer]: type.value === "drawer",
              [_ctx.$style.dialog]: type.value === "dialog",
              [_ctx.$style.popup]: type.value === "popup"
            }]),
            style: _normalizeStyle({
              zIndex: _unref(zIndex),
              pointerEvents: (__props.manualShowing != null ? __props.manualShowing : showing.value) ? "auto" : "none",
          ...
          }, null, 46, ["data-cy-transparent"]), _createElementVNode(
            "div",
            {
              ref_key: "content",
              ref: content,
