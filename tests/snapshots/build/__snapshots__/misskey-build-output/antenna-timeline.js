...
export default {
  ...
  setup(__props) {
    ...
    function settings() {
      router.push("/my/antennas/:antennaId", { params: { antennaId: props.antennaId } });
    }
    watch(() => props.antennaId, async () => {
      antenna.value = await misskeyApi("antennas/show", { antennaId: props.antennaId });
    }, { immediate: true });
