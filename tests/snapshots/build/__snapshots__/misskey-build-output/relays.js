...
export default {
  ...
  setup(__props) {
    ...
    async function addRelay() {
      ...
      misskeyApi("admin/relays/add", { inbox }).then(() => {
        refresh();
      }).catch((err) => {
        os.alert({
          type: "error",
    ...
    function remove(inbox) {
      misskeyApi("admin/relays/remove", { inbox }).then(() => {
        refresh();
      }).catch((err) => {
        os.alert({
          type: "error",
      ...
      return _openBlock(), _createBlock(_component_PageWithHeader, {
        ...
        default: _withCtx(() => [_createElementVNode("div", {
          ...
          default: _withCtx(() => [_createElementVNode("div", { class: "_gaps" }, [(_openBlock(true), _createElementBlock(
            _Fragment,
            null,
            _renderList(relays.value, (relay) => {
              return _openBlock(), _createElementBlock("div", {
                ...
                _createElementVNode(
                  "div",
                  null,
                  _toDisplayString(relay.inbox),
                  1
                  /* TEXT */
                ),
                _createElementVNode("div", { style: "margin: 8px 0;" }, [relay.status === "accepted" ? (_openBlock(), _createElementBlock(
                  "i",
                  {
                    key: 0,
                  ...
                  2
                  /* CLASS */
                )) : relay.status === "rejected" ? (_openBlock(), _createElementBlock(
                  "i",
                  {
                    key: 1,
                  ...
                  "span",
                  null,
                  _toDisplayString(_unref(i18n).ts._relayStatus[relay.status]),
                  1
                  /* TEXT */
                )]),
                _createVNode(MkButton, {
                  ...
                  inline: "",
                  danger: "",
                  onClick: ($event) => remove(relay.inbox)
                }, {
                  default: _withCtx(() => [
                    _hoisted_1,
                    _createTextVNode(" "),
