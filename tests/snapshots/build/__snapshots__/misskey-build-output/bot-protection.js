...
const _hoisted_16 = /* @__PURE__ */ _createElementVNode("a", {
...
export default {
  ...
  async setup(__props) {
    ...
    const meta = ([__temp, __restore] = _withAsyncContext(() => misskeyApi("admin/captcha/current")), __temp = await __temp, __restore(), __temp);
    const botProtectionForm = useForm({
      ...
      if (provider === "none") {
        await os.apiWithDialog("admin/captcha/save", { provider }, undefined, errorHandler);
      } else {
        const sitekey = provider === "hcaptcha" ? state.hcaptchaSiteKey : provider === "mcaptcha" ? state.mcaptchaSiteKey : provider === "recaptcha" ? state.recaptchaSiteKey : provider === "turnstile" ? state.turnstileSiteKey : null;
        const secret = provider === "hcaptcha" ? state.hcaptchaSecretKey : provider === "mcaptcha" ? state.mcaptchaSecretKey : provider === "recaptcha" ? state.recaptchaSecretKey : provider === "turnstile" ? state.turnstileSecretKey : null;
        ...
        default: _withCtx(() => [_createVNode(
          ...
          _createSlots({ _: 2 }, [
            ...
            },
            {
              ...
              fn: _withCtx(() => [_createVNode(_component_SearchLabel, null, {
                default: _withCtx(() => [_createTextVNode(
                  _toDisplayString(_unref(i18n).ts.botProtection),
                  1
                  /* TEXT */
                )]),
                _: 1
            ...
            _unref(botProtectionForm).savedState.provider === "hcaptcha" ? {
              name: "suffix",
              fn: _withCtx(() => [_createTextVNode("hCaptcha")]),
              key: "0"
            } : _unref(botProtectionForm).savedState.provider === "mcaptcha" ? {
              name: "suffix",
              fn: _withCtx(() => [_createTextVNode("mCaptcha")]),
              key: "1"
            } : _unref(botProtectionForm).savedState.provider === "recaptcha" ? {
              name: "suffix",
              fn: _withCtx(() => [_createTextVNode("reCAPTCHA")]),
              key: "2"
            } : _unref(botProtectionForm).savedState.provider === "turnstile" ? {
              name: "suffix",
              fn: _withCtx(() => [_createTextVNode("Turnstile")]),
              key: "3"
            } : _unref(botProtectionForm).savedState.provider === "testcaptcha" ? {
              name: "suffix",
              fn: _withCtx(() => [_createTextVNode("testCaptcha")]),
              key: "4"
            } : {
              name: "suffix",
              fn: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts.none) + " (" + _toDisplayString(_unref(i18n).ts.notRecommended) + ")",
                1
                /* TEXT */
              )]),
              key: "5"
            ...
            _unref(botProtectionForm).modified.value ? {
              name: "footer",
              fn: _withCtx(() => [_createVNode(MkFormFooter, {
                canSaving: canSaving.value,
                form: _unref(botProtectionForm)
              }, null, 8, ["canSaving", "form"])]),
              key: "0"
            } : undefined
          ]),
          1024
