...
export default {
  ...
  async setup(__props) {
    ...
    const usersPaginator = markRaw(new Paginator("admin/roles/users", {
      limit: 20,
      computedParams: computed(() => props.id ? { roleId: props.id } : undefined)
    }));
    const expandedItemIds = ref([]);
    const role = reactive(await misskeyApi("admin/roles/show", { roleId: props.id }));
    function edit() {
      router.push("/admin/roles/:id/edit", { params: { id: role.id } });
    }
    async function del() {
      ...
      if (canceled) return;
      await os.apiWithDialog("admin/roles/delete", { roleId: role.id });
    ...
    async function unassign(userId, ev) {
      os.popupMenu([{
      ...
      return _openBlock(), _createBlock(_component_PageWithHeader, {
        ...
        default: _withCtx(() => [_createElementVNode("div", {
          ...
          _createVNode(MkFolder, null, {
            ...
            default: _withCtx(() => [_createVNode(XEditor, {
              modelValue: role,
              readonly: ""
            }, null, 8, ["modelValue"])]),
            _: 1
          }),
          role.target === "manual" ? (_openBlock(), _createBlock(MkFolder, {
            key: 0,
            defaultOpen: ""
          }, {
            ...
            suffix: _withCtx(() => [_createTextVNode(
              _toDisplayString(role.usersCount),
              1
              /* TEXT */
            )]),
                    ...
                    [_createElementVNode(
                      ...
                      [
                        _createVNode(_component_MkA, {
                          ...
                          default: _withCtx(() => [_createVNode(MkUserCardMini, { user: item.user }, null, 8, ["user"])]),
                          _: 2
                        }, 10, ["to"]),
                        _createElementVNode("button", {
                          class: _normalizeClass(["_button", _ctx.$style.userToggle]),
                          onClick: ($event) => toggleItem(item.id)
                        }, [_createElementVNode(
                          "i",
                        ...
                        _createElementVNode("button", {
                          ...
                          onClick: ($event) => unassign(item.user.id, $event)
                        }, [_hoisted_6], 10, ["onClick"])
                      ],
                      2
                      /* CLASS */
                    ), expandedItemIds.value.includes(item.id) ? (_openBlock(), _createElementBlock(
                      "div",
                      {
                        key: 0,
            ...
            default: _withCtx(() => [_createTextVNode(
              _toDisplayString(_unref(i18n).ts._role.isConditionalRole),
              1
              /* TEXT */
            )]),
            _: 1
