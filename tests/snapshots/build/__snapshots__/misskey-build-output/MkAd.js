...
export default {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return chosen.value && !shouldHide.value ? (_openBlock(), _createElementBlock("div", { key: 0 }, [!showMenu.value ? (_openBlock(), _createElementBlock(
        "div",
        {
          key: 0,
        ...
        [_createVNode(
          _resolveDynamicComponent(self.value ? "MkA" : "a"),
          _mergeProps(self.value ? { to: chosen.value.url.substring(_unref(local).length) } : {
        ...
        [
          _createElementVNode(
            "div",
            null,
            "Ads by " + _toDisplayString(_unref(host)),
            1
            /* TEXT */
          ),
          chosen.value.ratio !== 0 ? (_openBlock(), _createBlock(
            MkButton,
            {
              key: 0,
            ...
            },
            {
              default: _withCtx(() => [_createTextVNode(
                _toDisplayString(_unref(i18n).ts._ad.reduceFrequencyOfThisAd),
                1
                /* TEXT */
              )]),
              _: 1
          ...
          _createElementVNode(
            ...
            _toDisplayString(_unref(i18n).ts._ad.back),
            1
            /* TEXT */
          )
        ],
