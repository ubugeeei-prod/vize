...
`,
    ...
    diagnostics: {
      "App.vue": [
        ...
        `error:13:37 [TS2353] Object literal may only specify known properties, and '"ghost"' does not exist in type '__VizeSetupProps & VNodeProps & AllowedComponentProps & ComponentCustomProps & { abbr?: unknown; about?: unknown; ... 680 more ...; zoomAndPan?: unknown; } & __VizeComponentDataAttrs'.`,
      ],
