...
`,
    ...
    diagnostics: {
      "App.vue": [
        ...
        `error:13:37 [TS2353] Object literal may only specify known properties, and '"ghost"' does not exist in type 'Partial<Props<"ok">> & { value?: unknown; } & VNodeProps & AllowedComponentProps & ComponentCustomProps & { ...; } & __VizeComponentDataAttrs'.`,
      ],
