...
import {
  ...
  surfaceNameKind,
} from "../../tools/support/compat/davinci/lib/consumer-migration-scan.mjs";
import { renderConsumerMigrationSurfaceRows } from "../../tools/support/compat/davinci/lib/consumer-migration-render.mjs";
