...
`;
    ...
    const authoringSourceWithCursor = `<script setup lang="ts">
import { ref } from 'vue'
const count = ref(0)
</script>
<template>
...
`;
    const authoringCursor = authoringSourceWithCursor.indexOf("__CURSOR__");
    const authoringSource = authoringSourceWithCursor.replace("__CURSOR__", "");
