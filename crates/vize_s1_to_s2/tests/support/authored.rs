...
fn assert_wrapper_key(source: &str, root: SourceRoot<'_>, key: &vize_s1_to_s2::lower::WrapperKey) {
    match key {
        vize_s1_to_s2::lower::WrapperKey::Static { span, .. }
        | vize_s1_to_s2::lower::WrapperKey::Dynamic { span, .. } => {
