//! P3-15 bridge for the L3 scheduling contract.
//!
...
use vize_l3::op::{EdgeKind, EffectId, OpId, Phase, Program, StateEdge};
...
fn schedule_contract_codes_match_lean_reference() {
    ...
    for stem in STEMS {
        ...
        for scenario in SCENARIOS {
            ...
            let mut program = vize_l2_to_l3::lower(&allocator, &s2.root).program;
            assert_eq!(verify(&program), [], "{stem} must lower to valid L3");
