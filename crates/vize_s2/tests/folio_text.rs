...
use vize_s2::folio::{DisegnoFolio, FolioBinding, FolioElement, FolioExpr, FolioOp, FolioVueText};
use vize_s2::op::{BindingOp, ElementOp, Namespace, Op, Region, VueTextOp};
...
fn hand_built() -> DisegnoFolio {
    DisegnoFolio {
        ops: vec![FolioOp::Element(FolioElement {
            ...
            attributes: vec![],
            bindings: vec![FolioBinding::VueText(FolioVueText {
