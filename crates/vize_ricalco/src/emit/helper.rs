...
impl Helper {
    ...
    pub(super) const fn bit(self) -> u64 {
        match self {
            ...
            Self::VModelText => 536_870_912,
            Self::VModelCheckbox => 1_073_741_824,
            Self::VModelRadio => 2_147_483_648,
            Self::VModelSelect => 4_294_967_296,
            ...
            Self::WithCtx => 262144,
            Self::Teleport => 2_097_152,
            Self::Suspense => 4_194_304,
            Self::KeepAlive => 8_388_608,
            Self::BaseTransition => 16_777_216,
            Self::Transition => 33_554_432,
            Self::TransitionGroup => 67_108_864,
        }
    }
