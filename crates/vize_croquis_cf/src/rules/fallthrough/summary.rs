...
mod tests {
    ...
    fn summary_counts_fallthrough_risk_dimensions() {
        let infos = vec![
            FallthroughInfo {
                ...
                static_name_fallthrough_attrs: set(&["title"]),
            ...
            FallthroughInfo {
                ...
                static_name_fallthrough_attrs: set(&["class"]),
                dynamic_name_fallthrough_attrs: FxHashSet::default(),
    ...
    fn summary_distinguishes_consumed_safe_and_risky_attrs() {
        let infos = vec![
            FallthroughInfo {
                ...
                static_name_fallthrough_attrs: set(&["class", "data-testid", "onClick"]),
                dynamic_name_fallthrough_attrs: FxHashSet::default(),
                declared_props: FxHashSet::default(),
                declared_events: FxHashSet::default(),
                template_start: 0,
            ...
            FallthroughInfo {
                ...
                static_name_fallthrough_attrs: set(&["aria-label", "trackingId"]),
                dynamic_name_fallthrough_attrs: FxHashSet::default(),
                declared_props: FxHashSet::default(),
                declared_events: FxHashSet::default(),
                template_start: 0,
    ...
    fn summary_excludes_declared_event_listeners_from_fallthrough_counts() {
        let infos = vec![FallthroughInfo {
            ...
            static_name_fallthrough_attrs: set(&["onClick"]),
            dynamic_name_fallthrough_attrs: FxHashSet::default(),
            declared_props: FxHashSet::default(),
