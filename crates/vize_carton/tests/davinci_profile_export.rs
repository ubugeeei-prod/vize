...
//!    `davinci-road/plan/profile-export.schema.json`, checked by a strict
//!    JSON Schema subset validator (mirroring
//!    `benchmarks/davinci_harness/src/report.rs`): a schema keyword the
