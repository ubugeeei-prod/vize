...
pub use loader::{
    ...
    LoadedConfigExperimentalVueFlags, LoadedConfigWithFeatures, load_compiler_custom_elements,
...
pub use model::{
    ...
    LanguageServerUnstableFlags, LintRuleOptions, LintRuleSeverity, LinterConfig,
    LinterConfigEntry, LinterConfigPlan, LinterConfigPlanWithConfigRuleOptions,
