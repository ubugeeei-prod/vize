//! Emit-time options for the L2 DOM lane (P2-11).
//!
//! The shipped DOM codegen reads its emission-only settings from
//! `CodegenOptions`. The L2 emitter mirrors the subset it honours here so
...
/// Emission settings the L2 DOM emitter honours.
