...
pub enum UnsupportedReason {
    ...
    ForItemShape,
    ForSourceNotJs,
    /// A props surface the shipped `has_static_props` hoists but the L2
...
/// Why emission refused. Never a panic: unsupported L2 shapes are counted.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum EmitError {
    /// L2 carries an error diagnostic; refuse to guess a render function.
    Diagnostics,
