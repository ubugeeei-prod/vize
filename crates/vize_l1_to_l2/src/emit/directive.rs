...
fn imported_directive_binding_name(name: &str) -> vize_l0::String {
    let pascal = vize_l0::capitalize(&vize_l0::camelize(name));
    let mut binding = vize_l0::String::with_capacity(1 + pascal.len());
    binding.push('v');
