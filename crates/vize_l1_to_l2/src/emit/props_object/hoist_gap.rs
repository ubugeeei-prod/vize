...
//! globals, or helper aliases. The L2 hoist pass admits the self-bound
...
//! classifiers still disagree refuses the L2 emit, so the compile stays on
...
use vize_l2::op::{Attribute, BindingOp, DynamicName};
...
/// Refuse a props surface the shipped classifier hoists and L2's does not.
