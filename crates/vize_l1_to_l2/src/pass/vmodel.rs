...
//!   objects. The L2 contract never expands in L2 (`op/model.rs`).
...
//! contributes no name — the one-scanner rule (#4365): the L2 lane
...
//!   models from its tree — a binding op cannot leave the L2 surface
