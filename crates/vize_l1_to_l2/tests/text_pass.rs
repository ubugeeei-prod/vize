...
#[test]
fn entities_stay_undecoded_the_l1_scope() {
    // The L1 v1 no-decoding deviation, re-recorded for text parts: the
    // legacy lane decodes `&amp;` at parse; L2 carries the authored
