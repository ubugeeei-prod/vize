//! P5-10: L1 holes feed partial L2 fragments, and the fact manager computes
...
use vize_l1_to_l2::partial::{HoleFact, HoleKind, PartialFacts, ScopeRole, partial_facts};
