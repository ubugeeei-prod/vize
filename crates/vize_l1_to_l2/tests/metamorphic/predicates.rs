...
use vize_l1::{Attribute, Element, TokenStatus};
...
/// A directive-shaped attribute name (any form the L1→L2 classifier
...
pub fn wrap_skip(
    ...
    if matches!(element.close, vize_l1::ElementClose::Missing) {
...
pub fn merge_skip(
    source: &str,
    first: &vize_l1::Token<'_>,
    second: &vize_l1::Token<'_>,
    flags: Flags,
) -> Option<&'static str> {
    if flags.rawtext {
        return Some("rawtext-content");
