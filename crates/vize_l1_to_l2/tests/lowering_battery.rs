//! TS-20's deterministic half, plain lane: the L1 battery (well-formed
...
//!
//! The battery is `vize_l1`'s own committed fixture set, imported
...
fn every_truncation_of_every_fixture_lowers_soundly() {
    ...
    // L2. Deterministic, committed, and panic-free by the totality
    // contract.
    for fixture in battery::WELL_FORMED.iter().chain(battery::MALFORMED) {
