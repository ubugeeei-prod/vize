...
use vize_l1_to_l2::pass::cfg::{self, TEMPLATE_FACTS, TemplateComplexityGroup};
use vize_l1_to_l2::{lower, lower_source_block};
...
fn the_group_is_computed_once_read_under_demand_and_equals_the_pass() {
    ...
    let (tree, errors) = vize_l1::parse(&allocator, &source[start..end]);
    assert_eq!(
        placed,
