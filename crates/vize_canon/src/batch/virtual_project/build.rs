...
use super::passthrough::collect_passthrough_json_modules as collect_passthrough;
...
pub(super) fn build_vue_registered_file(
    ...
    Ok(RegisteredFile {
        ...
        passthrough_files: collect_passthrough(
            path,
            content,
            context.project_root,
            context.virtual_root,
...
pub(super) fn build_script_registered_file(
    ...
    Ok(RegisteredFile {
        ...
        original_content: content.to_compact_string(),
        passthrough_files: collect_passthrough(path, content, project_root, virtual_root),
        diagnostics: Vec::new(),
    })
}
