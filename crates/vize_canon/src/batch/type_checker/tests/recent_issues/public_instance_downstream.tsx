...
const fallthrough = <Public modelValue={1} someValue="ok" data-testid="public" aria-label="Public" onClick={(event) => { const mouse: MouseEvent = event; const notAny: false = null as unknown as IsAny<typeof event>; return mouse.preventDefault() }} onInput={(event) => { const input: InputEvent = event; return input.preventDefault() }} />
