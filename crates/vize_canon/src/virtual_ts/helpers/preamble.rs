...
pub const SHARED_PREAMBLE_DTS: &str = concat!(
    ...
    "declare function __vize_withDefaults<_T, _BKeys extends keyof _T, const _D extends __WithDefaultsArgs<_T>>(_props: __DefineProps<_T, _BKeys>, _defaults: _D): __WithDefaultsResult<_T, _D, _BKeys, __DefineProps<_T, _BKeys>>;\n",
