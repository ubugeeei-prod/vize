...
type __WithDefaultsResult<T, D, __BKeys extends keyof T = __VizeBooleanKey<T>> = T extends unknown ? Omit<__DefineProps<T, __BKeys>, keyof D> & { [K in keyof D & keyof T]-?: [D[K]] extends [undefined] ? __DefineProps<T, __BKeys>[K] : Exclude<__DefineProps<T, __BKeys>[K], undefined> } : never;
...
pub const VUE_SETUP_HELPERS: &str = r#"  // Compiler macros (only valid in setup scope, not global)
  ...
  function withDefaults<_T, _BKeys extends keyof _T, const _D extends __WithDefaultsArgs<_T>>(_props: __DefineProps<_T, _BKeys>, _defaults: _D): __WithDefaultsResult<_T, _D, _BKeys>; function withDefaults(_props: any, _defaults: any) { void _props; void _defaults; return undefined as any; }
...
pub const SHARED_PREAMBLE_DTS: &str = concat!(
    ...
    "declare function __vize_withDefaults<_T, _BKeys extends keyof _T, const _D extends __WithDefaultsArgs<_T>>(_props: __DefineProps<_T, _BKeys>, _defaults: _D): __WithDefaultsResult<_T, _D, _BKeys>;\n",
