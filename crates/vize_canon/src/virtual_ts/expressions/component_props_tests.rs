...
"#;
    ...
    assert!(
        output.code.contains(
            "type __HelloWorld_0_prop_msg = __VizePropValue<__HelloWorld_ValueProps_0, 'msg'>;"
        ),
...
"#;
    ...
    assert_eq!(
        output
            .code
            .matches("type __Child_0_prop_class = __VizePropValue<__Child_ValueProps_0, 'class'>;")
            .count(),
        1,
