...
use vize_carton::{FxHashMap, FxHashSet, String, camelize, capitalize};
...
fn emit_reference_type_directives(ts: &mut String, script_content: Option<&str>) -> bool {
...
fn emit_global_component_stubs(
    ts: &mut String,
    summary: &Croquis,
    options: &VirtualTsOptions,
