...
//! must equal `vize_atelier_core::davinci_plan::VAPOR.group_count()`, so the
...
fn vapor_walk_baseline_holds() {
    ...
    for fixture in &LADDER {
        ...
        assert_eq!(
            ...
            davinci_plan::VAPOR.group_count(),
            "vapor {}: the measured walks disagree with davinci_plan::VAPOR",
            fixture.name
        );
