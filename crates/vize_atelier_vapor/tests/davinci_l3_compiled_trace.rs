//! TS-28 compiled-runtime bridge for the L3 backend reference traces.
...
#[test]
fn compiled_backend_runtime_traces_match_l3_reference_ladder_or_known_gap() {
    for fixture in FIXTURES {
        ...
        assert_eq!(
            ...
            "{} VDOM compiled trace diverged from L3 reference:\n{}",
...
fn assert_vapor_trace_matches_reference_or_known_gap(
    ...
    // dynamic render effect, while the L3 trace currently orders prop/listen/text.
    ...
    assert_eq!(
        actual, expected,
        "{fixture_name} Vapor compiled trace diverged from L3 reference:\n{code}"
    );
}
