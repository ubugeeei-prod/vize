...
pub(in crate::l3) fn admitted_void(tag: &str) -> bool {
    matches!(tag, "input" | "img" | "br" | "hr")
}

pub(in crate::l3) fn reference(value: &str) -> bool {
    // A deliberately narrower grammar than JavaScript. The L3 producer has
