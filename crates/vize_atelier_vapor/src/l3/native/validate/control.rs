...
//! the rest of the native slice. Loop aliases must be plain identifiers: L2
...
/// Regions inside a conditional branch or loop body, by region index. L2 to
/// L3 partitions every op there as dynamic, so native payload classification
