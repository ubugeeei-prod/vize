...
//! must agree with explicit L3 edges.
...
use crate::l3::{AdmissionFailure, LegacyReason, retained::Retained, templates::TemplateLoop};

pub(in crate::l3) use ident::{admitted_void, reference};
...
pub(super) fn admit<'a>(
    ...
    // The L3 lowering mints op ids densely in op order, so ids index tables.
