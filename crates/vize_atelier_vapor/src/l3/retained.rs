...
//!
//! L2 parses each template expression once. The native route moves exactly the
...
//! Compound text parts were never parsed by L2; they take their single parse
//! here through L2's own admission rule. Anything the generator's retained
