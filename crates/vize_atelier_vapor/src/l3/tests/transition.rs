...
fn transition_payload_owns_wrapper_identity_and_checks_css_mutation() {
    ...
    let retained = crate::l3::retained::Retained::collect(&allocator, &s2.root);
    ...
    let tag = s3
        ...
        .unwrap();
    tag.value.text = "div";
    let code = super::generated(crate::l3::admit(s3, &retained), &allocator);
