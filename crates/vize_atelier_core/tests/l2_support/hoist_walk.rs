...
//! run-2 legacy children (the decisions), and the L2 folio ops (the
            ...
            *next += 1;
            ...
            for (index, branch) in if_op.branches.iter().enumerate() {
                ...
                match (&b1.children[..], &b2.children[..]) {
                    ...
                    {
                        // Wrapper branch: the L2 region is the
            ...
            *next += 1;
            match (&node1.children[..], &node2.children[..]) {
                    ...
                    if el1.tag == "template" =>
                {
                    ...
                    // legacy tree and is decided there; L2 keeps no
