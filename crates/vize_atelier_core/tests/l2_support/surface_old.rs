...
//! modifiers product rides at the stub span. Wrapper elements the L2
...
/// position by the L2 lowering's own selection rule, mirrored;
        ...
        match prop {
            ...
            PropNode::Directive(dir) => match dir.name {
                ...
                "bind" => {
                    ...
                    {
                        // The L2 selection rule mirrored: an authored
...
/// document order — the same order the L2 collector walks.
