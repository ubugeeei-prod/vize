...
use crate::{ApplicationContract, RenderingMode, Route, Target};

use super::diagnostic::ContractDiagnostic;

pub(crate) fn collect_unique_ids<'a>(
    collection: &str,
...
pub(crate) fn validate_environment_cycles(
...
pub(crate) fn validate_rendering_target(
    contract: &ApplicationContract,
    route: &Route,
    path: &str,
    diagnostics: &mut Vec<ContractDiagnostic>,
