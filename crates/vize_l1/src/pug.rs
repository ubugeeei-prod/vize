//! The lossless **pug** surface tree — charter #12's second L1 dialect
//! (Davinci P4-12c).
//!
...
//! (`vize_l1_to_l2::lower::pug`) replays pug's code generator over this
...
fn parse_pug_within<'a>(
    ...
    debug_assert!(
        ...
        "pug L1 fidelity: render(tree) != source"
    );
    (tree, errors)
}
