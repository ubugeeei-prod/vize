//! The L1 surface-tree node types.
//!
...
/// An attribute or directive. Directives stay *raw* at L1: `name` spans
/// the authored spelling (`v-on:click.stop`, `:[key]`, `#slot`) and the
/// semantic split into head/argument/modifiers is L1→L2's job (P2-8).
#[derive(Debug)]
