...
/// `vue.directive` - a Vue directive carried through L2 for a consumer
...
/// points into a style block, and its spans are still the L0
...
/// generated props rather than resolving a runtime directive, so L2 must keep
