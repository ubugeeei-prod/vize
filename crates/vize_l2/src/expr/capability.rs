...
//! designated `dyn` seam of the architecture is L4 emitters, and this is
//! not it.
//!
//! # Who answers what
//!
...
//!   Until the L2 legacy pass legalizes the chain, treat the payload as
...
//! consumers that need referenced bindings from L2 expressions. The P1-8
