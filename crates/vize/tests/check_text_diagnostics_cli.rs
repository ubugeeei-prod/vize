...
"#,
    ...
    assert_eq!(
        ...
        concat!(
            ...
            "  error:10:4 [TS2345] Argument of type '{ kind: \"num\"; s: string; }' is not assignable to parameter of type '__VizeComponentCheckProps<__Child_CheckProps_1, __VizePublicComponentAttrs & { [x: string]: unknown; } & __VizeCustomDataFallthroughAttrs & Partial<...>>'.\n",
