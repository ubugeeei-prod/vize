//! The shipped translator in one locale, as renderer vocabulary and as the
//! lookup `vize explain` pages read.
...
/// falls back to the built-in English, never to its key.
