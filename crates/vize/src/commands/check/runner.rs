...
use super::{
    ...
    tsconfig_inputs::{
        ...
        load_tsconfig_declaration_options, parse_jsonc_value, read_extends_entries,
        resolve_extended_tsconfig, resolve_tsconfig_for_files,
    },
};
...
fn resolve_checker_tsconfig_path(
    program_tsconfig_path: Option<&Path>,
    project_root: &Path,
    nuxt_path_aliases: &[super::nuxt::NuxtPathAlias],
...
fn write_nuxt_fallback_tsconfig(
    program_tsconfig_path: Option<&Path>,
    project_root: &Path,
    nuxt_path_aliases: &[super::nuxt::NuxtPathAlias],
