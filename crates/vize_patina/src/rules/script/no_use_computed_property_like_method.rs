...
mod tests {
    ...
    const CASES: &[(&str, usize)] = &[
        ...
        ("export default { computed: { c() { return 1 } }, methods: { m() { return this.c } } }", 0),
        // Valid: no Options API `computed` to resolve (Composition API).
        ("import { computed } from 'vue'\nconst d = computed(() => c.value)", 0),
        ...
        ("export default { computed: { c() { return 1 } }, methods: { m() { return this.x() } } }", 0),
        // Valid: receiver is `other`, not `this`.
        ("export default { computed: { c() { return 1 } }, methods: { m() { return other.c() } } }", 0),
        // Valid: a non-arrow nested function rebinds `this`.
        ("export default { computed: { c() { return 1 } }, methods: { m() { return [1].map(function () { return this.c() }) } } }", 0),
        // Valid: spread computed members are not statically known.
        ("export default { computed: { ...mapGetters(['c']) }, methods: { m() { return this.c() } } }", 0),
        // Invalid: computed called from a method.
        ("export default { computed: { c() { return 1 } }, methods: { m() { return this.c() } } }", 1),
        // Invalid: computed called from another computed getter.
        ("export default { computed: { a() { return 1 }, b() { return this.a() } } }", 1),
        // Invalid: string-keyed computed, static call.
        ("export default { computed: { \"c\"() { return 1 } }, methods: { m() { return this.c() } } }", 1),
        // Invalid: resolved through `defineComponent(...)`.
        ("import { defineComponent } from 'vue'\nexport default defineComponent({ computed: { c() { return 1 } }, methods: { m() { return this.c() } } })", 1),
        ...
        ("export default { computed: { c() { return 1 } }, methods: { m() { return [1].map(() => this.c()) } } }", 1),
        // Invalid: two distinct computed calls each report.
        ("export default { computed: { a() { return 1 }, b() { return 2 } }, methods: { m() { return this.a() + this.b() } } }", 2),
    ];
