...
mod no_refer_to_non_existent_id;
...
pub use crate::rules::opinionated::a11y::HeadingLevels;
pub use crate::rules::opinionated::a11y::LandmarkRoles;
pub use crate::rules::opinionated::a11y::PlaceholderLabelOption;
pub use crate::rules::opinionated::a11y::UseList;
...
pub use no_i_for_icon::NoIForIcon;
pub use no_redundant_roles::NoRedundantRoles;
pub use no_refer_to_non_existent_id::NoReferToNonExistentId;
