...
use super::names::{
    ...
    RULE_NO_REACTIVE_DESTRUCTURE, RULE_NO_REQUIRED_PROP_WITH_DEFAULT, RULE_NO_RESERVED_IDENTIFIERS,
    RULE_NO_RESERVED_KEYS, RULE_NO_RESERVED_PROPS, RULE_NO_SIDE_EFFECTS_IN_COMPUTED,
    RULE_NO_TOP_LEVEL_REF_IN_SCRIPT, RULE_NO_UNUSED_EMIT_DECLARATIONS,
    ...
    RULE_PREFER_USE_SLOTS, RULE_PREFER_USE_TEMPLATE_REF, RULE_REQUIRE_DEFAULT_PROP,
    RULE_REQUIRE_FUNCTION_RETURN_TYPE, RULE_REQUIRE_PROP_TYPES, RULE_REQUIRE_PROP_TYPE_CONSTRUCTOR,
    RULE_REQUIRE_SYMBOL_PROVIDE, RULE_RETURN_IN_COMPUTED_PROPERTY, RULE_RETURN_IN_EMITS_VALIDATOR,
...
use crate::rules::script::{
    ...
    NoReservedIdentifiers, NoReservedKeys, NoReservedProps, NoSideEffectsInComputed,
    NoTopLevelRefInScript, NoUnusedEmitDeclarations, NoUseComputedPropertyLikeMethod, NoWithDefaults,
    ...
    ReturnInComputedProperty, ReturnInEmitsValidator, VueRouterPreferNamedPush,
...
pub(in crate::linter::script_rules) static BUILTIN_SCRIPT_RULES: &[BuiltinScriptRuleEntry] = &[
    ...
    BuiltinScriptRuleEntry { rule_name: RULE_REQUIRE_DEFAULT_PROP, profile_name: "patina.script_rule.require_default_prop", category: "Script", fixable: false, presets: OPINIONATED_SCRIPT_PRESETS, rule: &RequireDefaultProp },
    BuiltinScriptRuleEntry { rule_name: RULE_REQUIRE_PROP_TYPES, profile_name: "patina.script_rule.require_prop_types", category: "Script", fixable: false, presets: OPINIONATED_SCRIPT_PRESETS, rule: &RequirePropTypes },
