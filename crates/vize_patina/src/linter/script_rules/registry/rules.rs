...
use super::names::{
    RULE_COMPONENT_OPTIONS_NAME_CASING, RULE_DEFINE_PROPS_DECLARATION,
...
use crate::rules::script::{
    ComponentOptionsNameCasing, DefinePropsDeclaration, NoArrowFunctionsInWatch, NoAsyncInComputed,
