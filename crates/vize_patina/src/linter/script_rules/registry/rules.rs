...
use super::names::{
    ...
    RULE_NO_DEPRECATED_PROPS_DEFAULT_THIS, RULE_NO_DUPE_KEYS, RULE_NO_DUPLICATE_ATTR_INHERITANCE,
    RULE_NO_EXPORT_IN_SCRIPT_SETUP, RULE_NO_GET_CURRENT_INSTANCE, RULE_NO_IMPORT_COMPILER_MACROS,
    RULE_NO_INTERNAL_IMPORTS, RULE_NO_MULTIPLE_SLOT_ARGS, RULE_NO_NEXT_TICK, RULE_NO_OPTIONS_API,
...
use crate::rules::script::{
    ...
    NoDeprecatedPropsDefaultThis, NoDupeKeys, NoDuplicateAttrInheritance, NoExportInScriptSetup,
    NoGetCurrentInstance, NoImportCompilerMacros, NoInternalImports, NoMultipleSlotArgs,
    NoNextTick, NoNuxtConfigTestKey, NoOptionsApi, NoPageMetaRuntimeValues,
    NoPotentialComponentOptionTypo, NoReactiveDestructure, NoRefAsOperand,
    NoRequiredPropWithDefault, NoReservedIdentifiers, NoReservedKeys, NoReservedProps,
    NoRestrictedGlobals, NoRestrictedMembers, NoSideEffectsInComputed, NoTopLevelRefInScript,
    NoUnstableNestedComponents, NoUnusedEmitDeclarations, NoUseComputedPropertyLikeMethod,
    NoWithDefaults, NuxtConfigKeysOrder, PiniaPreferStoreToRefs, PreferComputed,
