...
use super::names::{
    ...
    RULE_REQUIRE_DEFAULT_PROP, RULE_REQUIRE_EXPLICIT_SLOTS, RULE_REQUIRE_FUNCTION_RETURN_TYPE,
...
use crate::rules::script::{
    ...
    PreferUseSlots, PreferUseTemplateRef, RequireDefaultProp, RequireExplicitSlots,
