...
use super::names::{
    ...
    RULE_NO_DEPRECATED_DOLLAR_LISTENERS_API, RULE_NO_DEPRECATED_EVENTS_API, RULE_NO_DUPE_KEYS,
...
use crate::rules::script::{
    ...
    NoDeprecatedDollarListenersApi, NoDeprecatedEventsApi, NoDupeKeys, NoExportInScriptSetup,
