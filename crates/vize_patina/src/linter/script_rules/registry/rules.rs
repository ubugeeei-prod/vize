...
use super::names::{
    ...
    RULE_NO_DEPRECATED_EVENTS_API, RULE_NO_DUPE_KEYS, RULE_NO_GET_CURRENT_INSTANCE,
    RULE_NO_IMPORT_COMPILER_MACROS, RULE_NO_INTERNAL_IMPORTS, RULE_NO_NEXT_TICK,
    RULE_NO_OPTIONS_API, RULE_NO_REACTIVE_DESTRUCTURE, RULE_NO_RESERVED_IDENTIFIERS,
    RULE_NO_SIDE_EFFECTS_IN_COMPUTED, RULE_NO_TOP_LEVEL_REF_IN_SCRIPT, RULE_NO_WITH_DEFAULTS,
    ...
    RULE_REQUIRE_SYMBOL_PROVIDE, RULE_VUE_ROUTER_PREFER_NAMED_PUSH,
...
use crate::rules::script::{
    NoArrowFunctionsInWatch, NoAsyncInComputed, NoDeepDestructureInProps, NoDeprecatedEventsApi,
    NoDupeKeys, NoGetCurrentInstance, NoImportCompilerMacros, NoInternalImports, NoNextTick,
    NoOptionsApi, NoReactiveDestructure, NoReservedIdentifiers, NoSideEffectsInComputed,
    ...
    PreferUseTemplateRef, RequireFunctionReturnType, RequireSymbolProvide,
