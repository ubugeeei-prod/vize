...
use super::names::{
    ...
    RULE_NO_RESERVED_PROPS, RULE_NO_RESTRICTED_GLOBALS, RULE_NO_SIDE_EFFECTS_IN_COMPUTED,
    RULE_NO_TOP_LEVEL_REF_IN_SCRIPT, RULE_NO_UNSTABLE_NESTED_COMPONENTS,
...
use crate::rules::script::{
    ...
    NoReservedProps, NoRestrictedGlobals, NoSideEffectsInComputed, NoTopLevelRefInScript,
...
pub(in crate::linter::script_rules) static BUILTIN_SCRIPT_RULES: &[BuiltinScriptRuleEntry] = &[
    ...
    BuiltinScriptRuleEntry { rule_name: RULE_NO_RESTRICTED_GLOBALS, profile_name: "patina.script_rule.no_restricted_globals", category: "Script", fixable: false, presets: OPT_IN_SCRIPT_PRESETS, rule: &NoRestrictedGlobals },
