...
pub(in crate::linter::script_rules) static BUILTIN_SCRIPT_RULES: &[BuiltinScriptRuleEntry] = &[
    ...
    BuiltinScriptRuleEntry { rule_name: RULE_VALID_DEFINE_PROPS, profile_name: "patina.script_rule.valid_define_props", category: "Script", fixable: false, presets: OPINIONATED_SCRIPT_PRESETS, rule: &ValidDefineProps },
    BuiltinScriptRuleEntry { rule_name: RULE_VALID_DEFINE_EMITS, profile_name: "patina.script_rule.valid_define_emits", category: "Script", fixable: false, presets: OPINIONATED_SCRIPT_PRESETS, rule: &ValidDefineEmits },
    ...
    BuiltinScriptRuleEntry { rule_name: RULE_CUSTOM_EVENT_NAME_CASING, profile_name: "patina.script_rule.custom_event_name_casing", category: "Script", fixable: false, presets: OPINIONATED_SCRIPT_PRESETS, rule: &CustomEventNameCasing },
    BuiltinScriptRuleEntry { rule_name: RULE_NO_REF_AS_OPERAND, profile_name: "patina.script_rule.no_ref_as_operand", category: "Script", fixable: false, presets: OPINIONATED_SCRIPT_PRESETS, rule: &NoRefAsOperand },
    BuiltinScriptRuleEntry { rule_name: RULE_REQUIRE_EXPLICIT_SLOTS, profile_name: "patina.script_rule.require_explicit_slots", category: "Script", fixable: false, presets: OPINIONATED_SCRIPT_PRESETS, rule: &RequireExplicitSlots },
    BuiltinScriptRuleEntry { rule_name: RULE_NO_DUPLICATE_ATTR_INHERITANCE, profile_name: "patina.script_rule.no_duplicate_attr_inheritance", category: "Script", fixable: false, presets: OPINIONATED_SCRIPT_PRESETS, rule: &NoDuplicateAttrInheritance },
    BuiltinScriptRuleEntry { rule_name: RULE_NO_MULTIPLE_SLOT_ARGS, profile_name: "patina.script_rule.no_multiple_slot_args", category: "Script", fixable: false, presets: OPINIONATED_SCRIPT_PRESETS, rule: &NoMultipleSlotArgs },
    ...
    BuiltinScriptRuleEntry { rule_name: RULE_NO_UNSTABLE_NESTED_COMPONENTS, profile_name: "patina.script_rule.no_unstable_nested_components", category: "Script", fixable: false, presets: OPINIONATED_SCRIPT_PRESETS, rule: &NoUnstableNestedComponents },
];
