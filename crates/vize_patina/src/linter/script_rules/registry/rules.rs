...
pub(in crate::linter::script_rules) static BUILTIN_SCRIPT_RULES: &[BuiltinScriptRuleEntry] = &[
    ...
    BuiltinScriptRuleEntry { rule_name: RULE_NO_RESERVED_KEYS, profile_name: "patina.script_rule.no_reserved_keys", category: "Script", fixable: false, presets: OPT_IN_SCRIPT_PRESETS, rule: &NoReservedKeys },
    ...
    BuiltinScriptRuleEntry { rule_name: RULE_NO_ARROW_FUNCTIONS_IN_WATCH, profile_name: "patina.script_rule.no_arrow_functions_in_watch", category: "Script", fixable: false, presets: OPT_IN_SCRIPT_PRESETS, rule: &NoArrowFunctionsInWatch },
    ...
    BuiltinScriptRuleEntry { rule_name: RULE_NO_POTENTIAL_COMPONENT_OPTION_TYPO, profile_name: "patina.script_rule.no_potential_component_option_typo", category: "Script", fixable: false, presets: OPT_IN_SCRIPT_PRESETS, rule: &NoPotentialComponentOptionTypo },
    BuiltinScriptRuleEntry { rule_name: RULE_RETURN_IN_COMPUTED_PROPERTY, profile_name: "patina.script_rule.return_in_computed_property", category: "Script", fixable: false, presets: OPT_IN_SCRIPT_PRESETS, rule: &ReturnInComputedProperty },
    ...
    BuiltinScriptRuleEntry { rule_name: RULE_REQUIRE_PROP_TYPE_CONSTRUCTOR, profile_name: "patina.script_rule.require_prop_type_constructor", category: "Script", fixable: false, presets: OPT_IN_SCRIPT_PRESETS, rule: &RequirePropTypeConstructor },
    ...
    BuiltinScriptRuleEntry { rule_name: RULE_NO_USE_COMPUTED_PROPERTY_LIKE_METHOD, profile_name: "patina.script_rule.no_use_computed_property_like_method", category: "Script", fixable: false, presets: OPT_IN_SCRIPT_PRESETS, rule: &NoUseComputedPropertyLikeMethod },
    ...
    BuiltinScriptRuleEntry { rule_name: RULE_NO_REQUIRED_PROP_WITH_DEFAULT, profile_name: "patina.script_rule.no_required_prop_with_default", category: "Script", fixable: false, presets: OPT_IN_SCRIPT_PRESETS, rule: &NoRequiredPropWithDefault },
    ...
    BuiltinScriptRuleEntry { rule_name: RULE_VALID_NEXT_TICK, profile_name: "patina.script_rule.valid_next_tick", category: "Script", fixable: false, presets: OPT_IN_SCRIPT_PRESETS, rule: &ValidNextTick },
    BuiltinScriptRuleEntry { rule_name: RULE_VALID_DEFINE_OPTIONS, profile_name: "patina.script_rule.valid_define_options", category: "Script", fixable: false, presets: OPT_IN_SCRIPT_PRESETS, rule: &ValidDefineOptions },
    ...
    BuiltinScriptRuleEntry { rule_name: RULE_NO_RESERVED_PROPS, profile_name: "patina.script_rule.no_reserved_props", category: "Script", fixable: false, presets: OPT_IN_SCRIPT_PRESETS, rule: &NoReservedProps },
    ...
    BuiltinScriptRuleEntry { rule_name: RULE_RETURN_IN_EMITS_VALIDATOR, profile_name: "patina.script_rule.return_in_emits_validator", category: "Script", fixable: false, presets: OPT_IN_SCRIPT_PRESETS, rule: &ReturnInEmitsValidator },
    BuiltinScriptRuleEntry { rule_name: RULE_VALID_DEFINE_PROPS, profile_name: "patina.script_rule.valid_define_props", category: "Script", fixable: false, presets: OPT_IN_SCRIPT_PRESETS, rule: &ValidDefineProps },
    BuiltinScriptRuleEntry { rule_name: RULE_VALID_DEFINE_EMITS, profile_name: "patina.script_rule.valid_define_emits", category: "Script", fixable: false, presets: OPT_IN_SCRIPT_PRESETS, rule: &ValidDefineEmits },
    BuiltinScriptRuleEntry { rule_name: RULE_REQUIRE_VALID_DEFAULT_PROP, profile_name: "patina.script_rule.require_valid_default_prop", category: "Script", fixable: false, presets: OPT_IN_SCRIPT_PRESETS, rule: &RequireValidDefaultProp },
    ...
    BuiltinScriptRuleEntry { rule_name: RULE_NO_REF_AS_OPERAND, profile_name: "patina.script_rule.no_ref_as_operand", category: "Script", fixable: false, presets: OPT_IN_SCRIPT_PRESETS, rule: &NoRefAsOperand },
    ...
    BuiltinScriptRuleEntry { rule_name: RULE_NO_DUPLICATE_ATTR_INHERITANCE, profile_name: "patina.script_rule.no_duplicate_attr_inheritance", category: "Script", fixable: false, presets: OPT_IN_SCRIPT_PRESETS, rule: &NoDuplicateAttrInheritance },
    BuiltinScriptRuleEntry { rule_name: RULE_NO_MULTIPLE_SLOT_ARGS, profile_name: "patina.script_rule.no_multiple_slot_args", category: "Script", fixable: false, presets: OPT_IN_SCRIPT_PRESETS, rule: &NoMultipleSlotArgs },
    ...
    BuiltinScriptRuleEntry { rule_name: RULE_NO_UNSTABLE_NESTED_COMPONENTS, profile_name: "patina.script_rule.no_unstable_nested_components", category: "Script", fixable: false, presets: OPT_IN_SCRIPT_PRESETS, rule: &NoUnstableNestedComponents },
];
