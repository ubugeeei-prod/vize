...
use super::names::{
    ...
    RULE_NO_USE_COMPUTED_PROPERTY_LIKE_METHOD, RULE_NO_WITH_DEFAULTS, RULE_NUXT_NO_CONFIG_TEST_KEY,
...
use crate::rules::script::{
    ...
    NoWithDefaults, PiniaPreferStoreToRefs, PreferComputed, PreferDefineOptions,
    PreferImportFromVue, PreferImportMeta, PreferRefOverReactive, PreferUseAttrs, PreferUseId,
