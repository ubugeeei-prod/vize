...
use super::names::{
    ...
    RULE_VALID_DEFINE_OPTIONS, RULE_VALID_DEFINE_PROPS, RULE_VALID_NEXT_TICK,
...
use crate::rules::script::{
    ...
    ReturnInComputedProperty, ReturnInEmitsValidator, ValidDefineOptions, ValidDefineProps,
