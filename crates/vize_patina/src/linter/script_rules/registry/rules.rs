...
use super::names::{
    ...
    RULE_DEFINE_PROPS_DECLARATION, RULE_DEFINE_PROPS_DESTRUCTURING, RULE_NO_ARROW_FUNCTIONS_IN_WATCH,
    ...
    RULE_NO_USE_COMPUTED_PROPERTY_LIKE_METHOD, RULE_NO_WITH_DEFAULTS, RULE_PINIA_PREFER_STORE_TO_REFS,
    RULE_PREFER_COMPUTED, RULE_PREFER_DEFINE_OPTIONS, RULE_PREFER_IMPORT_FROM_VUE,
    RULE_PREFER_REF_OVER_REACTIVE, RULE_PREFER_USE_ATTRS, RULE_PREFER_USE_ID, RULE_PREFER_USE_SLOTS,
    RULE_PREFER_USE_TEMPLATE_REF, RULE_REQUIRE_FUNCTION_RETURN_TYPE,
    RULE_REQUIRE_PROP_TYPE_CONSTRUCTOR, RULE_REQUIRE_SYMBOL_PROVIDE, RULE_REQUIRE_TYPED_REF,
    RULE_RETURN_IN_COMPUTED_PROPERTY, RULE_VALID_DEFINE_OPTIONS, RULE_VALID_NEXT_TICK,
...
use crate::rules::script::{
    ...
    DefinePropsDestructuring, NoArrowFunctionsInWatch, NoAsyncInComputed, NoDeepDestructureInProps,
    ...
    RequireSymbolProvide, RequireTypedRef, ReturnInComputedProperty, ValidDefineOptions,
...
pub(in crate::linter::script_rules) static BUILTIN_SCRIPT_RULES: &[BuiltinScriptRuleEntry] = &[
    ...
    BuiltinScriptRuleEntry { rule_name: RULE_VALID_NEXT_TICK, profile_name: "patina.script_rule.valid_next_tick", category: "Script", fixable: false, presets: OPINIONATED_SCRIPT_PRESETS, rule: &ValidNextTick },
    BuiltinScriptRuleEntry { rule_name: RULE_VALID_DEFINE_OPTIONS, profile_name: "patina.script_rule.valid_define_options", category: "Script", fixable: false, presets: OPINIONATED_SCRIPT_PRESETS, rule: &ValidDefineOptions },
    BuiltinScriptRuleEntry { rule_name: RULE_DEFINE_PROPS_DESTRUCTURING, profile_name: "patina.script_rule.define_props_destructuring", category: "Script", fixable: false, presets: OPINIONATED_SCRIPT_PRESETS, rule: &DefinePropsDestructuring },
    BuiltinScriptRuleEntry { rule_name: RULE_REQUIRE_TYPED_REF, profile_name: "patina.script_rule.require_typed_ref", category: "Script", fixable: false, presets: OPINIONATED_SCRIPT_PRESETS, rule: &RequireTypedRef },
    BuiltinScriptRuleEntry { rule_name: RULE_PREFER_DEFINE_OPTIONS, profile_name: "patina.script_rule.prefer_define_options", category: "Script", fixable: false, presets: OPINIONATED_SCRIPT_PRESETS, rule: &PreferDefineOptions },
];
