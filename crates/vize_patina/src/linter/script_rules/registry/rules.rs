...
use super::names::{
    RULE_COMPONENT_OPTIONS_NAME_CASING, RULE_DEFINE_EMITS_DECLARATION,
...
use crate::rules::script::{
    ComponentOptionsNameCasing, DefineEmitsDeclaration, NoArrowFunctionsInWatch, NoAsyncInComputed,
