//! L2 production selector coverage for disabled static hoists.
...
#[test]
fn disabled_static_hoists_use_l2_codegen() {
    ...
    for (label, source) in [
        ...
        assert_eq!(
            ...
            Some(1),
            "{label}: disabled static hoists are a supported L2 production option"
        );
    }
}
