//! P2-11 witness: DOM-irrelevant codegen options keep the L2 production lane
...
#[test]
fn optimize_imports_uses_l2_after_legacy_noop_audit() {
    ...
    assert_eq!(
        ...
        Some(1),
        "DOM-irrelevant optimize_imports must not disarm the L2 production selector"
    );
}
