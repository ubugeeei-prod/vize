...
//! through L2 while retaining exact authored comment output.
...
#[test]
fn comment_preserving_sfc_sections_use_l2_when_profiled() {
  ...
  return (_openBlock(), _createElementBlock("div", null, [
    ...
    assert_eq!(
        ...
        Some(1),
        "comment-preserving SFC sections must use L2 once L2 preserves comments"
    );
}
