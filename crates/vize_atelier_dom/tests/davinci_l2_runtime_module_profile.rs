//! P2-11 witness: custom runtime module names stay on the profiled L2 DOM
...
#[test]
fn source_map_disabled_runtime_module_name_stays_on_l2_codegen() {
    ...
    assert_eq!(
        ...
        1,
        "custom runtime-module compiles are covered by the L2 production option surface"
    );
}
