//! P2-11 legacy patch-flag witness for L2 DOM parity.
#![cfg(feature = "legacy")]
#![expect(
...
use vize_l1_to_l2::{LegacyCaps, emit_dom_source_with_caps};
...
#[test]
fn l2_vue2_filter_patch_flags_match_the_shipped_dom_lane_per_node() {
    ...
    support::assert_l2_matches_prefixed_shipped_literals_with_dialect(
        &FILTER_CASES
            .iter()
