...
#[test]
fn l2_vue2_literal_filters_match_the_shipped_dom_lane_byte_for_byte() {
...
#[test]
fn l2_vue3_keeps_pipe_expressions_out_of_filter_mode() {
    support::assert_l2_matches_shipped_with_dialect(V3_BATTERY, VueVersion::V3);
}
