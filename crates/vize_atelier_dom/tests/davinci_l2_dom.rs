...
//!
//! L2 owns the shipped DOM renderer. The comparison battery stays as a
...
#[test]
fn l2_native_html_and_interpolations_match_the_shipped_dom_lane_byte_for_byte() {
    support::assert_l2_matches_shipped(support::battery::dom::DOM_BATTERY);
}
