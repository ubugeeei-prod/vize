...
) -> Result<FlowGraph, TemplateGraphAdapterError> {
    FlowProjector::new(snapshot, None)?.project()
}

#[doc(hidden)]
pub fn project_relief_snapshot_to_flow_with_anchor(
    snapshot: &ReliefSnapshot,
    anchor: SourceAnchor,
) -> Result<FlowGraph, TemplateGraphAdapterError> {
...
impl<'a> FlowProjector<'a> {
    ...
    ) -> Result<Self, TemplateGraphAdapterError> {
    ...
    fn project(mut self) -> Result<FlowGraph, TemplateGraphAdapterError> {
    ...
    ) -> Result<BlockId, TemplateGraphAdapterError> {
        for id in nodes {
    ...
    ) -> Result<(), TemplateGraphAdapterError> {
    ...
    ) -> Result<vize_flow::NodeId, TemplateGraphAdapterError> {
