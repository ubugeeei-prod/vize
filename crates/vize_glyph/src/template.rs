...
></div>"#
  ...
  {{
    ...
    fn test_multiline_template_literal_in_interpolation_is_idempotent() {
        ...
        // again, is not a fixed point. Quasi lines must be preserved
        // verbatim. (#3247)
        let source = concat!(
            "<div>\n",
            "  {{\n",
    ...
    #[test]
    fn test_plain_multiline_interpolation_still_indents() {
        ...
        assert_eq!(
            format_template_content(&first, &options).unwrap(),
            first,
