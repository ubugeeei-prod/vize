...
impl<'r, 'a> Emitter<'_, 'r, 'a, '_, '_, '_> {
    pub(super) fn element(
        ...
        let void = vize_l0::is_void_tag(tag);
        if void {
...
fn open_tag_anchor(source: &str, element: &l2::ElementOp<'_>, tag: &str) -> u32 {
