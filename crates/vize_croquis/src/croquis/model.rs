//! `Croquis` method implementations and croquis statistics.
//!
...
impl Croquis {
    ...
    /// Get croquis statistics for debugging.
    pub fn stats(&self) -> CroquisStats {
        CroquisStats {
...
/// Backwards-compatible name for croquis statistics.
pub type AnalysisStats = CroquisStats;
