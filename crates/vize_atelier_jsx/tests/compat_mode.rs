...
#[test]
fn babel_compat_resolves_non_html_non_svg_lowercase_tags_only_when_opted_in() {
...
#[test]
fn babel_compat_classifies_dashed_lowercase_before_lowering_slots() {
...
#[test]
fn babel_compat_keeps_html_svg_and_known_namespaces_intrinsic() {
