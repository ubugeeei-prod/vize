...
#[test]
fn plain_input_v_model_emits_from_l2() {
    let source = "const A = () => <input v-model={value} />;";
    let component = compile_native_model_from_l2(source);
    assert_eq!(
...
#[test]
fn text_input_v_model_emits_from_l2() {
...
#[test]
fn input_v_model_modifiers_emit_from_l2() {
...
#[test]
fn checkbox_input_v_model_emits_from_l2() {
...
#[test]
fn radio_input_v_model_emits_from_l2() {
...
#[test]
fn textarea_v_model_emits_from_l2() {
...
#[test]
fn select_v_model_emits_from_l2() {
...
fn compile_native_model_from_l2(source: &str) -> VdomComponent {
