...
use vize_l2::op::{BindingOp, ComponentOp, DynamicName, ElementOp, Namespace, Op, Region};
...
use super::{L2Refusal, ProjectCx, lower_children, lower_props};
...
pub(super) fn lower_element<'a>(
    ...
    match element.tag_type {
        ...
        ElementType::Slot | ElementType::Template => Err(L2Refusal::UnsupportedElement),
    }
}
