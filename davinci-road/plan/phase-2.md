...
- **Active and blocked: 2 of 22 — P2-9 and P2-11.** P2-9 still needs a
  hydrated full-corpus residual remeasurement; P2-11 has 36 landed
  installments through
  [#5207](https://github.com/ubugeeei-prod/vize/pull/5207), including
  `v-show` runtime directives, `v-html` raw HTML props, and `v-text`
  text-content props, plus `v-cloak` DOM cloak markers, but the
  slot outlet `v-on` prop surface and spread-order shape are now covered
  by S2-vs-shipped witnesses. The
