...
smoke 764 of 779, vendor 1,279 of 1,279). Projectable Croquis now emits
([record](./phase-3-records/p3-8-croquis.md)); the matrix and walker deletion remain.
...
_Slices 1-7 (2026-09-13..22), see the [P3-9 record](./phase-3-records/p3-9.md):_
TS-31 budgets pinned ([report](./ts31-sourcemap-coverage.json)). DOM, SSR and
both Vapor lanes write one `EmitDocument`; links are v3 segments and P4-5a
