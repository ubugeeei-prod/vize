...
fixtures. _Projection slice 2026-09-22:_ Croquis reactivity facts ride the
shared `BindingTable`; under the projection 290/342 fixture and 3,461/4,492
smoke-corpus templates emit byte-identically through S2, but that lane
measured 16–32% slower than legacy, so the refusal and the emit-speed,
module-hoisting and backend-option work remain open.
