...
# Croquis consumption: `vize_s2`

One shard of the [Croquis consumption matrix](../croquis-consumption.md): every fact the matrix records about `crates/vize_s2/src`. The method and the product set live on that page.
