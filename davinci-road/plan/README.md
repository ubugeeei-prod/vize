...
| [phase-2.md](./phase-2.md) + [phase-2-tasks.md](./phase-2-tasks.md) + [phase-2-records.md](./phase-2-records.md) | Disegno and the pass manager                                                                    | **Executing since 2026-08-19** — re-cut 2026-08-17 at the P1 exit with all 20 IDs expanded to the full contract (P2-5 and P2-12 split into a/b, 22 tasks); 4 of 22 landed (P2-12a the phase-start pin, P2-1 the core types, P2-2 the pass manager, P2-3 the observer). The phase file carries the re-cut record, the linked TODO index and the exit gate; the records index links one file per landed task |
