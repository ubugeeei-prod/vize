...
## Post-P1-7 floors (2026-08-15, retained-AST consumers landed)
...
in `phase-1.md` P1-7): dom 16 = 8 slot-pattern parses (`extract_slot_prop_names`,
synthesized `let <pattern> = __slotProps`) + 8 slot-default arrows
