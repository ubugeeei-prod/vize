...
The four library trees in the reviewed inventory contain 76 production files,
88 direct `alloc::vec::Vec` paths, and 304 bound `Vec`/`StdVec` uses. "Direct"
...
| s1_to_s2 | `alloc::vec::Vec`       |    56 |           56 |        222 |
| s1_to_s2 | `alloc::string::String` |     0 |            0 |          0 |
| s1_to_s2 | `vize_s0::String`       |    82 |           86 |        410 |
