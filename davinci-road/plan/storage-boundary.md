...
The five library trees in the reviewed inventory contain 98 production files,
110 direct `alloc::vec::Vec` paths, and 389 bound `Vec`/`StdVec` uses. "Direct"
...
| analysis |    16 |           17 |         56 | Diagnostics, side tables, fact tables, filters, and verifier results grow with the input; no inline bound is established. |
