...
85 direct `alloc::vec::Vec` paths, and 290 bound `Vec`/`StdVec` uses. "Direct"
...
| emit     |    28 |           28 |        111 | Ordered output buffers and collected emission inputs grow with the document.                                       |
...
| s1_to_s2 | `alloc::vec::Vec`       |    53 |           53 |        208 |
| s1_to_s2 | `alloc::string::String` |     0 |            0 |          0 |
| s1_to_s2 | `vize_s0::String`       |    76 |           80 |        368 |
| s1_to_s2 | `vize_s0::Vec`          |    15 |           16 |         67 |
| s1_to_s2 | `vize_s0::SmallVec`     |     3 |            3 |          6 |
