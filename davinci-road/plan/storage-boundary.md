...
The five library trees in the reviewed inventory contain 95 production files,
107 direct `alloc::vec::Vec` paths, and 385 bound `Vec`/`StdVec` uses. "Direct"
...
| analysis |    17 |           18 |         74 | Diagnostics, side tables, filters, and verifier results grow with the input; no inline bound is established.       |
...
| -------- | ----------------------- | ----: | -----------: | ---------: |
| infra    | `alloc::vec::Vec`       |    19 |           19 |         82 |
| infra    | `alloc::string::String` |     0 |            0 |          0 |
| infra    | `vize_s0::String`       |    24 |           24 |        149 |
