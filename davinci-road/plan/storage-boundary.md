...
104 direct `alloc::vec::Vec` paths, and 358 bound `Vec`/`StdVec` uses. "Direct"
...
| analysis |    14 |           15 |         47 | Diagnostics, side tables, filters, and verifier results grow with the input; no inline bound is established.       |
...
| -------- | ----------------------- | ----: | -----------: | ---------: |
| infra    | `alloc::vec::Vec`       |    16 |           16 |         55 |
| infra    | `alloc::string::String` |     0 |            0 |          0 |
| infra    | `vize_s0::String`       |    18 |           18 |        124 |
