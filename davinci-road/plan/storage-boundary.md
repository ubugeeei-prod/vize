...
87 direct `alloc::vec::Vec` paths, and 299 bound `Vec`/`StdVec` uses. "Direct"
...
| emit     |    30 |           30 |        120 | Ordered output buffers and collected emission inputs grow with the document.                                       |
...
| s1_to_s2 | `alloc::vec::Vec`       |    55 |           55 |        217 |
| s1_to_s2 | `alloc::string::String` |     0 |            0 |          0 |
| s1_to_s2 | `vize_s0::String`       |    84 |           89 |        417 |
