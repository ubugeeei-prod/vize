...
P3-7 still needs DOM corpus TS-11 over the materialized table. Once S3 has
typed binding payloads, this fact surface can move from S2 to the explicit S3
decision stream without changing the VNode writer again.
