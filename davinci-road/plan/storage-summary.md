...
The library trees in the reviewed inventory contain 114 production files,
126 direct `alloc::vec::Vec` paths, and 460 bound `Vec`/`StdVec` uses.
...
| s1_to_s2 | `vize_s0::String`       |    92 |           96 |        467 |
