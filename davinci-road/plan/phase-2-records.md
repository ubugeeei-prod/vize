...
| P2-10  | [#4642](https://github.com/ubugeeei-prod/vize/pull/4642) | [`css_bind_lowering`](../../crates/vize_ricalco/tests/css_bind_lowering.rs) and [`css_bind_sfc`](../../crates/vize_ricalco/tests/css_bind_sfc/main.rs)                                 |
...
| [P2-11](./phase-2-records/p2-11.md)   | series, in progress | through installment 21 ([#4860](https://github.com/ubugeeei-prod/vize/pull/4860), 2026-08-25): S2 DOM emit includes Vue 2 pipe filters, dynamic `v-bind` keys, and `.camel` / `.prop` / `.attr` modifiers. Local slot/outlet guards, the production-lane switch and the task-level corpus/budget gates remain |
