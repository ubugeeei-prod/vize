...
## Current completion evidence (2026-08-25)
...
| P2-5a  | [#4509](https://github.com/ubugeeei-prod/vize/pull/4509) | [`op_family`](../../crates/vize_disegno/tests/op_family.rs) and [`folio_laws`](../../crates/vize_disegno/tests/folio_laws.rs)                                                          |
| P2-5b  | [#4509](https://github.com/ubugeeei-prod/vize/pull/4509) | [`expr_family`](../../crates/vize_disegno/tests/expr_family.rs) and [`expr_replay`](../../crates/vize_disegno/tests/expr_replay.rs)                                                    |
| P2-6   | [#4509](https://github.com/ubugeeei-prod/vize/pull/4509) | [`verifier_fixtures`](../../crates/vize_disegno/tests/verifier_fixtures.rs) and [`verifier_observer`](../../crates/vize_disegno/tests/verifier_observer.rs)                            |
| P2-7   | [#4502](https://github.com/ubugeeei-prod/vize/pull/4502) | [`surface_fidelity`](../../crates/vize_sinopia/tests/surface_fidelity.rs) and [`davinci_surface_corpus`](../../crates/vize_sinopia/tests/davinci_surface_corpus.rs)                    |
| P2-8   | [#4544](https://github.com/ubugeeei-prod/vize/pull/4544) | [`lowering_battery`](../../crates/vize_ricalco/tests/lowering_battery.rs) and [`davinci_lowering_corpus`](../../crates/vize_ricalco/tests/davinci_lowering_corpus.rs)                  |
| P2-10  | [#4642](https://github.com/ubugeeei-prod/vize/pull/4642) | [`css_bind_lowering`](../../crates/vize_ricalco/tests/css_bind_lowering.rs) and [`css_bind_sfc`](../../crates/vize_ricalco/tests/css_bind_sfc.rs)                                      |
...
| [P2-11](./phase-2-records/p2-11.md)   | series, in progress | through installment 20 ([#4811](https://github.com/ubugeeei-prod/vize/pull/4811), 2026-08-24): S2 DOM emit includes dynamic `v-bind` keys and `.camel` / `.prop` / `.attr` modifiers. Filters, local slot/outlet guards, the production-lane switch and the task-level corpus/budget gates remain |
