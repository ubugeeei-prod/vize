...
| `ScopeKind`                            | type  | `scope`             | `vize_canon`        |    12 |    36 |
...
| `Croquis.scopes`                       | field | `croquis`           | `vize_canon`        |    19 |    41 |
...
| `Croquis`                              |      360 |  568 | `vize` (1/2), `vize_atelier_core` (17/23), `vize_atelier_dom` (2/6), `vize_atelier_jsx` (24/43), `vize_atelier_sfc` (17/43), `vize_atelier_ssr` (1/4), `vize_canon` (171/248), `vize_carton` (0/1), `vize_croquis_cf` (101/127), `vize_davinci` (0/2), `vize_maestro` (3/18), `vize_patina` (22/47), `vize_vitrine` (1/4)                                                                                                                                                                            |
...
| `ScopeKind`                            |      110 |  136 | `vize_atelier_core` (1/2), `vize_atelier_sfc` (2/3), `vize_canon` (36/48), `vize_croquis_cf` (21/25), `vize_maestro` (43/49), `vize_patina` (3/5)                                                                                                                                                                                                                                                                                                                                                    |
| `SlotUsage`                            |        7 |   17 | `vize_canon` (1/3), `vize_croquis_cf` (3/8), `vize_maestro` (3/6)                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `Span`                                 |        0 |  711 | `vize_atelier_core` (0/2), `vize_atelier_jsx` (0/73), `vize_atelier_sfc` (0/6), `vize_atelier_ssr` (0/8), `vize_atelier_vapor` (0/1), `vize_canon` (0/56), `vize_carton` (0/89), `vize_davinci` (0/20), `vize_impeto` (0/32), `vize_maestro` (0/4), `vize_patina` (0/154), `vize_relief` (0/8), `vize_s1_to_s2` (0/127), `vize_s2` (0/117), `vize_s2_to_s3` (0/14)                                                                                                                                   |
