...
| `ScopeKind`                            | type  | `scope`             | `vize_canon`        |    13 |    48 |
...
| `ScopeKind`                            |      124 |  151 | `vize_atelier_core` (1/2), `vize_atelier_sfc` (2/3), `vize_canon` (48/61), `vize_croquis_cf` (21/25), `vize_maestro` (43/49), `vize_patina` (3/5)                                                                                                                                                                                                                                                                                                                                                                           |
