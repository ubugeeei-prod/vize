...
| `Croquis`                              | type  | `croquis`           | `vize_canon`        |    84 |   193 |
...
| `ScopeData`                            | type  | `scope`             | `vize_canon`        |    18 |    32 |
...
| `Croquis.scopes`                       | field | `croquis`           | `vize_canon`        |    29 |    56 |
...
| `parse_program_for_analysis`                 | `vize_canon`        |     2 |     5 |
...
| `Croquis`                              |      387 |  617 | `vize` (1/2), `vize_atelier_core` (17/25), `vize_atelier_dom` (2/6), `vize_atelier_jsx` (24/43), `vize_atelier_sfc` (17/43), `vize_atelier_ssr` (1/4), `vize_canon` (193/288), `vize_carton` (0/1), `vize_croquis_cf` (101/127), `vize_davinci` (0/2), `vize_maestro` (7/23), `vize_patina` (22/47), `vize_s1_to_s2` (0/1), `vize_vitrine` (2/5)                                                                                                                                                                            |
...
| `ScopeData`                            |       50 |   72 | `vize_canon` (32/49), `vize_maestro` (8/11), `vize_patina` (2/4)                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
