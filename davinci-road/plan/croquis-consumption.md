...
| `Span`                                 |        0 |  703 | `vize_atelier_core` (0/2), `vize_atelier_jsx` (0/73), `vize_atelier_sfc` (0/6), `vize_atelier_vapor` (0/1), `vize_canon` (0/56), `vize_carton` (0/89), `vize_davinci` (0/20), `vize_impeto` (0/32), `vize_maestro` (0/4), `vize_patina` (0/154), `vize_relief` (0/8), `vize_s1_to_s2` (0/127), `vize_s2` (0/117), `vize_s2_to_s3` (0/14)                                                                                                                                                             |
...
| `Croquis.bindings`                     |       78 |  694 | `vize` (0/2), `vize_atelier_core` (2/24), `vize_atelier_dom` (0/1), `vize_atelier_jsx` (1/36), `vize_atelier_sfc` (16/225), `vize_atelier_ssr` (0/3), `vize_atelier_vapor` (0/4), `vize_canon` (45/90), `vize_croquis_cf` (2/10), `vize_curator` (0/1), `vize_davinci` (0/10), `vize_fresco` (0/6), `vize_impeto` (0/3), `vize_maestro` (9/13), `vize_musea` (0/1), `vize_patina` (1/6), `vize_relief` (0/1), `vize_s1_to_s2` (0/227), `vize_s2` (0/21), `vize_s2_to_s3` (0/3), `vize_vitrine` (2/7) |
