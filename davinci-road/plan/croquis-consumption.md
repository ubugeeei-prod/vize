...
| `Analyzer`                             | type  | `analyzer`          | `vize_canon`        |    37 |   146 |
...
| `AnalyzerOptions`                      | type  | `analyzer`          | `vize_canon`        |    37 |   142 |
...
| `Croquis`                              | type  | `croquis`           | `vize_canon`        |    68 |   167 |
...
| `Croquis.binding_spans`                | field | `croquis`           | `vize_canon`        |     4 |     7 |
...
| `Croquis.macros`                       | field | `croquis`           | `vize_canon`        |    21 |    65 |
...
| -------------------------------------- | -------: | ---: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Analyzer`                             |      190 |  281 | `vize` (1/2), `vize_canon` (146/224), `vize_croquis_cf` (40/49), `vize_doctor` (0/1), `vize_maestro` (2/3), `vize_vitrine` (1/2)                                                                                                                                                                                                                                                                                                                         |
| `AnalyzerOptions`                      |      165 |  282 | `vize` (1/2), `vize_canon` (142/220), `vize_croquis_cf` (19/56), `vize_maestro` (2/3)                                                                                                                                                                                                                                                                                                                                                                    |
...
| `Croquis`                              |      356 |  563 | `vize` (1/2), `vize_atelier_core` (17/23), `vize_atelier_dom` (2/6), `vize_atelier_jsx` (24/43), `vize_atelier_sfc` (17/43), `vize_atelier_ssr` (1/4), `vize_canon` (167/243), `vize_carton` (0/1), `vize_croquis_cf` (101/127), `vize_davinci` (0/2), `vize_maestro` (3/18), `vize_patina` (22/47), `vize_vitrine` (1/4)                                                                                                                                |
...
| `Croquis.binding_spans`                |       11 |   12 | `vize_maestro` (2/3)                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| `Croquis.macros`                       |      140 |  260 | `vize_atelier_sfc` (11/102), `vize_canon` (65/67), `vize_croquis_cf` (25/27), `vize_davinci` (0/4), `vize_maestro` (14/24), `vize_musea` (0/2), `vize_patina` (22/31)                                                                                                                                                                                                                                                                                    |
...
| `Croquis.scopes`                       |       81 |  139 | `vize` (0/1), `vize_atelier_core` (0/4), `vize_atelier_jsx` (0/11), `vize_canon` (41/43), `vize_curator` (0/1), `vize_davinci` (0/9), `vize_patina` (4/25), `vize_s1_to_s2` (0/9)                                                                                                                                                                                                                                                                        |
