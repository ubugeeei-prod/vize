...
| `Croquis`                              | type  | `croquis`           | `vize_canon`        |    74 |   177 |
| `Croquis`                              | type  | `croquis`           | `vize_croquis_cf`   |    40 |   101 |
| `Croquis`                              | type  | `croquis`           | `vize_maestro`      |     5 |     6 |
...
| `Croquis.macros`                       | field | `croquis`           | `vize_canon`        |    24 |    73 |
...
| `Croquis`                              |      370 |  585 | `vize` (1/2), `vize_atelier_core` (17/24), `vize_atelier_dom` (2/6), `vize_atelier_jsx` (24/43), `vize_atelier_sfc` (17/43), `vize_atelier_ssr` (1/4), `vize_canon` (177/259), `vize_carton` (0/1), `vize_croquis_cf` (101/127), `vize_davinci` (0/2), `vize_maestro` (6/22), `vize_patina` (22/47), `vize_vitrine` (2/5)                                                                                                                                                                                                   |
...
| `ScopeData`                            |       47 |   66 | `vize_canon` (29/43), `vize_maestro` (8/11), `vize_patina` (2/4)                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `ScopeId`                              |       39 |   59 | `vize_canon` (15/21), `vize_croquis_cf` (23/33), `vize_maestro` (1/2), `vize_patina` (0/1), `vize_vitrine` (0/2)                                                                                                                                                                                                                                                                                                                                                                                                            |
| `ScopeKind`                            |      147 |  177 | `vize_atelier_core` (1/2), `vize_atelier_sfc` (2/3), `vize_canon` (49/63), `vize_croquis_cf` (21/25), `vize_maestro` (65/73), `vize_patina` (3/5)                                                                                                                                                                                                                                                                                                                                                                           |
| `SlotUsage`                            |        7 |   17 | `vize_canon` (1/3), `vize_croquis_cf` (3/8), `vize_maestro` (3/6)                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `Span`                                 |        0 |  757 | `vize_armature` (0/24), `vize_atelier_core` (0/2), `vize_atelier_jsx` (0/73), `vize_atelier_sfc` (0/6), `vize_atelier_ssr` (0/8), `vize_atelier_vapor` (0/1), `vize_canon` (0/63), `vize_carton` (0/89), `vize_davinci` (0/20), `vize_impeto` (0/36), `vize_maestro` (0/4), `vize_patina` (0/154), `vize_relief` (0/8), `vize_s1_to_s2` (0/131), `vize_s2` (0/117), `vize_s2_to_s3` (0/21)                                                                                                                                  |
...
| `Croquis.bindings`                     |       77 |  718 | `vize` (0/2), `vize_armature` (0/9), `vize_atelier_core` (2/34), `vize_atelier_dom` (0/1), `vize_atelier_jsx` (1/36), `vize_atelier_sfc` (16/225), `vize_atelier_ssr` (0/6), `vize_atelier_vapor` (0/4), `vize_canon` (45/90), `vize_croquis_cf` (2/10), `vize_curator` (0/1), `vize_davinci` (0/10), `vize_fresco` (0/6), `vize_impeto` (0/3), `vize_maestro` (8/14), `vize_musea` (0/1), `vize_patina` (1/6), `vize_relief` (0/1), `vize_s1_to_s2` (0/228), `vize_s2` (0/21), `vize_s2_to_s3` (0/3), `vize_vitrine` (2/7) |
...
| `Croquis.scopes`                       |       97 |  157 | `vize` (0/1), `vize_atelier_core` (0/4), `vize_atelier_jsx` (0/11), `vize_canon` (47/49), `vize_curator` (0/1), `vize_davinci` (0/9), `vize_maestro` (15/16), `vize_patina` (4/25), `vize_s1_to_s2` (0/10)                                                                                                                                                                                                                                                                                                                  |
