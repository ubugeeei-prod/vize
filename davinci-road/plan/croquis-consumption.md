...
| `Croquis`                              | type  | `croquis`           | `vize_canon`        |    74 |   174 |
...
| `Croquis.types`                        | field | `croquis`           | `vize_canon`        |     6 |    10 |
...
| `Croquis`                              |      368 |  585 | `vize` (1/2), `vize_atelier_core` (17/25), `vize_atelier_dom` (2/6), `vize_atelier_jsx` (24/43), `vize_atelier_sfc` (17/43), `vize_atelier_ssr` (1/4), `vize_canon` (174/256), `vize_carton` (0/1), `vize_croquis_cf` (101/127), `vize_davinci` (0/2), `vize_maestro` (7/23), `vize_patina` (22/47), `vize_s1_to_s2` (0/1), `vize_vitrine` (2/5)                                                                                                                                                                            |
...
| `ScopeKind`                            |      148 |  178 | `vize_atelier_core` (2/3), `vize_atelier_sfc` (2/3), `vize_canon` (49/63), `vize_croquis_cf` (21/25), `vize_maestro` (65/73), `vize_patina` (3/5)                                                                                                                                                                                                                                                                                                                                                                           |
...
| `Croquis.bindings`                     |       77 |  722 | `vize` (0/2), `vize_armature` (0/9), `vize_atelier_core` (2/34), `vize_atelier_dom` (0/1), `vize_atelier_jsx` (1/36), `vize_atelier_sfc` (16/225), `vize_atelier_ssr` (0/6), `vize_atelier_vapor` (0/8), `vize_canon` (45/90), `vize_croquis_cf` (2/10), `vize_curator` (0/1), `vize_davinci` (0/10), `vize_fresco` (0/6), `vize_impeto` (0/3), `vize_maestro` (8/14), `vize_musea` (0/1), `vize_patina` (1/6), `vize_relief` (0/1), `vize_s1_to_s2` (0/228), `vize_s2` (0/21), `vize_s2_to_s3` (0/3), `vize_vitrine` (2/7) |
...
| `Croquis.types`                        |       10 |   37 | `vize` (0/1), `vize_atelier_sfc` (0/13), `vize_canon` (10/18), `vize_davinci` (0/3), `vize_maestro` (0/1), `vize_patina` (0/1)                                                                                                                                                                                                                                                                                                                                                                                              |
