...
| `Span`                                 |        0 |  817 | `vize` (0/4), `vize_armature` (0/24), `vize_atelier_core` (0/2), `vize_atelier_jsx` (0/75), `vize_atelier_sfc` (0/6), `vize_atelier_ssr` (0/8), `vize_atelier_vapor` (0/1), `vize_canon` (0/63), `vize_carton` (0/89), `vize_davinci` (0/35), `vize_impeto` (0/42), `vize_maestro` (0/9), `vize_patina` (0/171), `vize_relief` (0/17), `vize_s1_to_s2` (0/133), `vize_s2` (0/117), `vize_s2_to_s3` (0/21)                                                                                                                   |
| `SpreadProp`                           |        6 |   10 | `vize_canon` (6/10)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `Symbol`                               |        0 |   72 | `vize_atelier_core` (0/5), `vize_atelier_sfc` (0/4), `vize_atelier_ssr` (0/2), `vize_canon` (0/4), `vize_carton` (0/3), `vize_croquis_cf` (0/27), `vize_fresco` (0/2), `vize_maestro` (0/1), `vize_patina` (0/15), `vize_relief` (0/5), `vize_s1_to_s2` (0/1), `vize_vitrine` (0/3)                                                                                                                                                                                                                                         |
