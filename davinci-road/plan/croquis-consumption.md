...
| -------------------------------------- | ----- | ------------------- | ------------------- | ----: | ----: |
| `Analyzer`                             | type  | `analyzer`          | `vize_canon`        |    31 |   132 |
...
| `AnalyzerOptions`                      | type  | `analyzer`          | `vize_canon`        |    31 |   128 |
...
| `Croquis`                              | type  | `croquis`           | `vize_canon`        |    62 |   148 |
...
| -------------------------------------- | -------: | ---: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Analyzer`                             |      174 |  258 | `vize_canon` (132/205), `vize_croquis_cf` (40/49), `vize_doctor` (0/1), `vize_vitrine` (1/2)                                                                                                                                                                                                                                                             |
| `AnalyzerOptions`                      |      149 |  259 | `vize_canon` (128/201), `vize_croquis_cf` (19/56)                                                                                                                                                                                                                                                                                                        |
...
| `Croquis`                              |      319 |  510 | `vize` (1/2), `vize_atelier_core` (17/23), `vize_atelier_dom` (2/6), `vize_atelier_jsx` (9/21), `vize_atelier_sfc` (17/43), `vize_atelier_ssr` (1/4), `vize_canon` (148/217), `vize_carton` (0/1), `vize_croquis_cf` (101/127), `vize_davinci` (0/2), `vize_maestro` (3/17), `vize_patina` (19/43), `vize_vitrine` (1/4)                                 |
