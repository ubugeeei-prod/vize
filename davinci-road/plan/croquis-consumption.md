...
| `Analyzer`                             | type  | `analyzer`          | `vize_canon`        |    40 |   157 |
...
| `AnalyzerOptions`                      | type  | `analyzer`          | `vize_canon`        |    40 |   153 |
...
| `ComponentUsage`                       | type  | `croquis::template` | `vize_canon`        |    15 |    38 |
...
| `Croquis`                              | type  | `croquis`           | `vize_canon`        |    72 |   174 |
| `Croquis`                              | type  | `croquis`           | `vize_croquis_cf`   |    40 |   101 |
| `Croquis`                              | type  | `croquis`           | `vize_maestro`      |     4 |     5 |
...
| `Scope`                                | type  | `scope`             | `vize_canon`        |    12 |    22 |
...
| `ScopeData`                            | type  | `scope`             | `vize_canon`        |    15 |    29 |
| `ScopeData`                            | type  | `scope`             | `vize_croquis_cf`   |     8 |     8 |
| `ScopeData`                            | type  | `scope`             | `vize_maestro`      |     2 |     4 |
...
| `ScopeKind`                            | type  | `scope`             | `vize_canon`        |    14 |    49 |
| `ScopeKind`                            | type  | `scope`             | `vize_croquis_cf`   |    10 |    21 |
| `ScopeKind`                            | type  | `scope`             | `vize_maestro`      |     8 |    58 |
...
| `Croquis.pattern_diagnostics`          | field | `croquis`           | `vize_maestro`      |     1 |     2 |
...
| `Croquis.scopes`                       | field | `croquis`           | `vize_canon`        |    24 |    47 |
| `Croquis.scopes`                       | field | `croquis`           | `vize_croquis_cf`   |    17 |    27 |
| `Croquis.scopes`                       | field | `croquis`           | `vize_maestro`      |     7 |    10 |
...
| `Croquis.template_expressions`         | field | `croquis`           | `vize_canon`        |    10 |    13 |
...
| -------------------------------------- | -------: | ---: | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Analyzer`                             |      201 |  294 | `vize` (1/2), `vize_canon` (157/237), `vize_croquis_cf` (40/49), `vize_doctor` (0/1), `vize_maestro` (2/3), `vize_vitrine` (1/2)                                                                                                                                                                                                                                                                                                                                                                                            |
| `AnalyzerOptions`                      |      176 |  295 | `vize` (1/2), `vize_canon` (153/233), `vize_croquis_cf` (19/56), `vize_maestro` (2/3)                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `BindingMetadata`                      |       37 |  133 | `vize_atelier_core` (0/24), `vize_atelier_dom` (0/20), `vize_atelier_jsx` (1/2), `vize_atelier_sfc` (31/49), `vize_atelier_ssr` (0/2), `vize_atelier_vapor` (0/15), `vize_canon` (5/8), `vize_relief` (0/6), `vize_s1_to_s2` (0/1), `vize_vitrine` (0/6)                                                                                                                                                                                                                                                                    |
...
| `Croquis`                              |      366 |  577 | `vize` (1/2), `vize_atelier_core` (17/23), `vize_atelier_dom` (2/6), `vize_atelier_jsx` (24/43), `vize_atelier_sfc` (17/43), `vize_atelier_ssr` (1/4), `vize_canon` (174/254), `vize_carton` (0/1), `vize_croquis_cf` (101/127), `vize_davinci` (0/2), `vize_maestro` (5/20), `vize_patina` (22/47), `vize_vitrine` (2/5)                                                                                                                                                                                                   |
...
| `Scope`                                |       24 |   92 | `vize` (0/1), `vize_atelier_core` (0/3), `vize_atelier_dom` (0/1), `vize_atelier_jsx` (0/1), `vize_atelier_sfc` (0/5), `vize_atelier_ssr` (0/3), `vize_canon` (22/53), `vize_davinci` (0/1), `vize_maestro` (0/7), `vize_patina` (2/10), `vize_relief` (0/2), `vize_s1_to_s2` (0/2), `vize_s2` (0/1), `vize_vitrine` (0/2)                                                                                                                                                                                                  |
...
| `ScopeData`                            |       43 |   61 | `vize_canon` (29/43), `vize_maestro` (4/6), `vize_patina` (2/4)                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `ScopeId`                              |       39 |   59 | `vize_canon` (15/21), `vize_croquis_cf` (23/33), `vize_maestro` (1/2), `vize_patina` (0/1), `vize_vitrine` (0/2)                                                                                                                                                                                                                                                                                                                                                                                                            |
| `ScopeKind`                            |      140 |  169 | `vize_atelier_core` (1/2), `vize_atelier_sfc` (2/3), `vize_canon` (49/63), `vize_croquis_cf` (21/25), `vize_maestro` (58/65), `vize_patina` (3/5)                                                                                                                                                                                                                                                                                                                                                                           |
| `SlotUsage`                            |        7 |   17 | `vize_canon` (1/3), `vize_croquis_cf` (3/8), `vize_maestro` (3/6)                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `Span`                                 |        0 |  746 | `vize_armature` (0/24), `vize_atelier_core` (0/2), `vize_atelier_jsx` (0/73), `vize_atelier_sfc` (0/6), `vize_atelier_ssr` (0/8), `vize_atelier_vapor` (0/1), `vize_canon` (0/52), `vize_carton` (0/89), `vize_davinci` (0/20), `vize_impeto` (0/36), `vize_maestro` (0/4), `vize_patina` (0/154), `vize_relief` (0/8), `vize_s1_to_s2` (0/131), `vize_s2` (0/117), `vize_s2_to_s3` (0/21)                                                                                                                                  |
...
| `SymbolId`                             |        0 |    6 | `vize_canon` (0/3), `vize_patina` (0/3)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| `Croquis.bindings`                     |       77 |  707 | `vize` (0/2), `vize_armature` (0/9), `vize_atelier_core` (2/24), `vize_atelier_dom` (0/1), `vize_atelier_jsx` (1/36), `vize_atelier_sfc` (16/225), `vize_atelier_ssr` (0/6), `vize_atelier_vapor` (0/4), `vize_canon` (45/90), `vize_croquis_cf` (2/10), `vize_curator` (0/1), `vize_davinci` (0/10), `vize_fresco` (0/6), `vize_impeto` (0/3), `vize_maestro` (8/13), `vize_musea` (0/1), `vize_patina` (1/6), `vize_relief` (0/1), `vize_s1_to_s2` (0/228), `vize_s2` (0/21), `vize_s2_to_s3` (0/3), `vize_vitrine` (2/7) |
...
| `Croquis.pattern_diagnostics`          |        9 |   10 | `vize_maestro` (2/3)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `Croquis.scopes`                       |       92 |  152 | `vize` (0/1), `vize_atelier_core` (0/4), `vize_atelier_jsx` (0/11), `vize_canon` (47/49), `vize_curator` (0/1), `vize_davinci` (0/9), `vize_maestro` (10/11), `vize_patina` (4/25), `vize_s1_to_s2` (0/10)                                                                                                                                                                                                                                                                                                                  |
| `Croquis.setup_context`                |        2 |    5 | `vize_croquis_cf` (1/4)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `Croquis.template_info`                |       18 |   20 | `vize_croquis_cf` (14/15), `vize_patina` (0/1)                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `Croquis.types`                        |        9 |   35 | `vize` (0/1), `vize_atelier_sfc` (0/13), `vize_canon` (9/17), `vize_davinci` (0/3), `vize_maestro` (0/1)                                                                                                                                                                                                                                                                                                                                                                                                                    |
