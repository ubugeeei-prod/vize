...
| `Croquis`                              | type  | `croquis`           | `vize_canon`        |    82 |   187 |
...
| `Croquis.scopes`                       | field | `croquis`           | `vize_canon`        |    28 |    55 |
...
| `Croquis`                              |      381 |  609 | `vize` (1/2), `vize_atelier_core` (17/25), `vize_atelier_dom` (2/6), `vize_atelier_jsx` (24/43), `vize_atelier_sfc` (17/43), `vize_atelier_ssr` (1/4), `vize_canon` (187/280), `vize_carton` (0/1), `vize_croquis_cf` (101/127), `vize_davinci` (0/2), `vize_maestro` (7/23), `vize_patina` (22/47), `vize_s1_to_s2` (0/1), `vize_vitrine` (2/5)                                                                                                                                                                            |
...
| `Croquis.scopes`                       |      105 |  165 | `vize` (0/1), `vize_atelier_core` (0/4), `vize_atelier_jsx` (0/11), `vize_canon` (55/57), `vize_curator` (0/1), `vize_davinci` (0/9), `vize_maestro` (15/16), `vize_patina` (4/25), `vize_s1_to_s2` (0/10)                                                                                                                                                                                                                                                                                                                  |
