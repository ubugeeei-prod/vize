...
| `Drawer`                               | type  | `drawer`            | `vize_maestro`      |    18 |    22 |
| `Drawer`                               | type  | `drawer`            | `vize_patina`       |     1 |     1 |
| `DrawerOptions`                        | type  | `drawer`            | `vize_atelier_sfc`  |     1 |     5 |
| `DrawerOptions`                        | type  | `drawer`            | `vize_maestro`      |    18 |    22 |
...
| `SfcParseOptions`                            | `vize_atelier_sfc`   |    12 |   104 |
...
| `Drawer`                               |       31 |   52 | `vize_atelier_jsx` (1/2), `vize_atelier_sfc` (7/9), `vize_canon` (0/1), `vize_maestro` (22/38), `vize_patina` (1/2)                                                                                                                                                                                                                                                                                     |
| `DrawerOptions`                        |       27 |   45 | `vize_atelier_sfc` (5/6), `vize_maestro` (22/39)                                                                                                                                                                                                                                                                                                                                                        |
...
| `Scope`                                |       17 |   84 | `vize` (0/1), `vize_atelier_core` (0/3), `vize_atelier_dom` (0/1), `vize_atelier_jsx` (0/1), `vize_atelier_sfc` (0/5), `vize_atelier_ssr` (0/3), `vize_canon` (17/48), `vize_davinci` (0/1), `vize_disegno` (0/1), `vize_maestro` (0/7), `vize_patina` (0/6), `vize_relief` (0/2), `vize_ricalco` (0/3), `vize_vitrine` (0/2)                                                                           |
| `ScopeBinding`                         |        1 |   23 | `vize_atelier_core` (1/2), `vize_disegno` (0/9), `vize_ricalco` (0/12)                                                                                                                                                                                                                                                                                                                                  |
...
| `Span`                                 |        0 |  537 | `vize_atelier_core` (0/2), `vize_atelier_jsx` (0/63), `vize_atelier_sfc` (0/6), `vize_atelier_vapor` (0/1), `vize_canon` (0/56), `vize_carton` (0/71), `vize_davinci` (0/20), `vize_disegno` (0/108), `vize_maestro` (0/4), `vize_patina` (0/143), `vize_relief` (0/8), `vize_ricalco` (0/55)                                                                                                           |
...
| `Croquis.bindings`                     |       76 |  531 | `vize` (0/2), `vize_atelier_core` (2/24), `vize_atelier_sfc` (16/224), `vize_atelier_ssr` (0/3), `vize_atelier_vapor` (0/4), `vize_canon` (43/88), `vize_croquis_cf` (2/10), `vize_curator` (0/1), `vize_davinci` (0/10), `vize_disegno` (0/21), `vize_fresco` (0/6), `vize_maestro` (9/13), `vize_musea` (0/1), `vize_patina` (1/6), `vize_relief` (0/1), `vize_ricalco` (0/109), `vize_vitrine` (2/7) |
...
| `Croquis.scopes`                       |       79 |  122 | `vize` (0/1), `vize_atelier_core` (0/4), `vize_atelier_jsx` (0/6), `vize_canon` (41/43), `vize_curator` (0/1), `vize_davinci` (0/9), `vize_patina` (2/15), `vize_ricalco` (0/7)                                                                                                                                                                                                                         |
