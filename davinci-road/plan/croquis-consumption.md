...
| `ScopeData`                            | type  | `scope`             | `vize_croquis_cf`   |     9 |     9 |
...
| `Croquis.scopes`                       | field | `croquis`           | `vize_croquis_cf`   |    18 |    28 |
...
| `Croquis`                              |      405 |  645 | `vize` (1/3), `vize_atelier_core` (17/25), `vize_atelier_dom` (2/6), `vize_atelier_jsx` (24/43), `vize_atelier_sfc` (17/43), `vize_atelier_ssr` (1/5), `vize_canon` (211/314), `vize_carton` (0/1), `vize_croquis_cf` (101/127), `vize_davinci` (0/2), `vize_maestro` (7/23), `vize_patina` (22/47), `vize_s1_to_s2` (0/1), `vize_vitrine` (2/5)                                                                                                                                                                            |
...
| `ScopeData`                            |       54 |   77 | `vize_canon` (35/53), `vize_maestro` (8/11), `vize_patina` (2/4)                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| `Span`                                 |        0 |  804 | `vize_armature` (0/24), `vize_atelier_core` (0/2), `vize_atelier_jsx` (0/75), `vize_atelier_sfc` (0/6), `vize_atelier_ssr` (0/10), `vize_atelier_vapor` (0/1), `vize_canon` (0/63), `vize_carton` (0/89), `vize_davinci` (0/32), `vize_impeto` (0/42), `vize_maestro` (0/9), `vize_patina` (0/172), `vize_relief` (0/8), `vize_s1_to_s2` (0/133), `vize_s2` (0/117), `vize_s2_to_s3` (0/21)                                                                                                                                 |
...
| `Croquis.scopes`                       |      110 |  170 | `vize` (0/1), `vize_atelier_core` (0/4), `vize_atelier_jsx` (0/11), `vize_canon` (59/61), `vize_curator` (0/1), `vize_davinci` (0/9), `vize_maestro` (15/16), `vize_patina` (4/25), `vize_s1_to_s2` (0/10)                                                                                                                                                                                                                                                                                                                  |
