...
| `ScopeKind`                            | type  | `scope`             | `vize_canon`        |    16 |    54 |
...
| `Croquis.scopes`                       | field | `croquis`           | `vize_canon`        |    27 |    52 |
...
| `ScopeKind`                            |      153 |  185 | `vize_atelier_core` (2/3), `vize_atelier_sfc` (2/3), `vize_canon` (54/70), `vize_croquis_cf` (21/25), `vize_maestro` (65/73), `vize_patina` (3/5)                                                                                                                                                                                                                                                                                                                                                                           |
...
| `Croquis.scopes`                       |      102 |  162 | `vize` (0/1), `vize_atelier_core` (0/4), `vize_atelier_jsx` (0/11), `vize_canon` (52/54), `vize_curator` (0/1), `vize_davinci` (0/9), `vize_maestro` (15/16), `vize_patina` (4/25), `vize_s1_to_s2` (0/10)                                                                                                                                                                                                                                                                                                                  |
