...
| `Croquis`                              |      364 |  575 | `vize` (1/2), `vize_atelier_core` (17/23), `vize_atelier_dom` (2/6), `vize_atelier_jsx` (24/43), `vize_atelier_sfc` (17/43), `vize_atelier_ssr` (1/4), `vize_canon` (174/254), `vize_carton` (0/1), `vize_croquis_cf` (101/127), `vize_davinci` (0/2), `vize_maestro` (3/18), `vize_patina` (22/47), `vize_vitrine` (2/5)                                                                                                                                                                                                   |
...
| `ScopeKind`                            |      125 |  153 | `vize_atelier_core` (1/2), `vize_atelier_sfc` (2/3), `vize_canon` (49/63), `vize_croquis_cf` (21/25), `vize_maestro` (43/49), `vize_patina` (3/5)                                                                                                                                                                                                                                                                                                                                                                           |
...
| `Croquis.scopes`                       |       89 |  148 | `vize` (0/1), `vize_atelier_core` (0/4), `vize_atelier_jsx` (0/11), `vize_canon` (47/49), `vize_curator` (0/1), `vize_davinci` (0/9), `vize_patina` (4/25), `vize_s1_to_s2` (0/10)                                                                                                                                                                                                                                                                                                                                          |
