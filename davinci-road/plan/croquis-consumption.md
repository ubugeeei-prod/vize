...
| `Croquis`                              | type  | `croquis`           | `vize_canon`        |    71 |   173 |
...
| `ScopeKind`                            | type  | `scope`             | `vize_canon`        |    13 |    50 |
...
| `Croquis.scopes`                       | field | `croquis`           | `vize_canon`        |    23 |    46 |
...
| `Croquis`                              |      363 |  573 | `vize` (1/2), `vize_atelier_core` (17/23), `vize_atelier_dom` (2/6), `vize_atelier_jsx` (24/43), `vize_atelier_sfc` (17/43), `vize_atelier_ssr` (1/4), `vize_canon` (173/252), `vize_carton` (0/1), `vize_croquis_cf` (101/127), `vize_davinci` (0/2), `vize_maestro` (3/18), `vize_patina` (22/47), `vize_vitrine` (2/5)                                                                                                                                                                                                   |
...
| `ScopeData`                            |       39 |   55 | `vize_canon` (29/43), `vize_patina` (2/4)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `ScopeId`                              |       39 |   59 | `vize_canon` (15/21), `vize_croquis_cf` (23/33), `vize_maestro` (1/2), `vize_patina` (0/1), `vize_vitrine` (0/2)                                                                                                                                                                                                                                                                                                                                                                                                            |
| `ScopeKind`                            |      126 |  153 | `vize_atelier_core` (1/2), `vize_atelier_sfc` (2/3), `vize_canon` (50/63), `vize_croquis_cf` (21/25), `vize_maestro` (43/49), `vize_patina` (3/5)                                                                                                                                                                                                                                                                                                                                                                           |
...
| `Croquis.bindings`                     |       78 |  707 | `vize` (0/2), `vize_armature` (0/9), `vize_atelier_core` (2/24), `vize_atelier_dom` (0/1), `vize_atelier_jsx` (1/36), `vize_atelier_sfc` (16/225), `vize_atelier_ssr` (0/6), `vize_atelier_vapor` (0/4), `vize_canon` (45/90), `vize_croquis_cf` (2/10), `vize_curator` (0/1), `vize_davinci` (0/10), `vize_fresco` (0/6), `vize_impeto` (0/3), `vize_maestro` (9/13), `vize_musea` (0/1), `vize_patina` (1/6), `vize_relief` (0/1), `vize_s1_to_s2` (0/228), `vize_s2` (0/21), `vize_s2_to_s3` (0/3), `vize_vitrine` (2/7) |
...
| `Croquis.scopes`                       |       88 |  147 | `vize` (0/1), `vize_atelier_core` (0/4), `vize_atelier_jsx` (0/11), `vize_canon` (46/48), `vize_curator` (0/1), `vize_davinci` (0/9), `vize_patina` (4/25), `vize_s1_to_s2` (0/10)                                                                                                                                                                                                                                                                                                                                          |
