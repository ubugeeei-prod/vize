...
| `Symbol`                               |        0 |   78 | `vize_atelier_core` (0/5), `vize_atelier_sfc` (0/4), `vize_atelier_ssr` (0/2), `vize_canon` (0/4), `vize_carton` (0/9), `vize_croquis_cf` (0/27), `vize_fresco` (0/2), `vize_maestro` (0/1), `vize_patina` (0/15), `vize_relief` (0/5), `vize_s1_to_s2` (0/1), `vize_vitrine` (0/3)                                                                                                                                                                                                                                         |
