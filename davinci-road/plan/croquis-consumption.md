...
| `Croquis`                              | type  | `croquis`           | `vize_canon`        |    77 |   176 |
...
| `ScopeData`                            | type  | `scope`             | `vize_canon`        |    16 |    30 |
...
| `TemplateExpression`                   | type  | `croquis`           | `vize_canon`        |    10 |    22 |
...
| `Croquis.bindings`                     | field | `croquis`           | `vize_canon`        |    25 |    43 |
...
| `Croquis.macros`                       | field | `croquis`           | `vize_canon`        |    26 |    72 |
...
| `Croquis.scopes`                       | field | `croquis`           | `vize_canon`        |    25 |    49 |
...
| `Croquis`                              |      370 |  588 | `vize` (1/2), `vize_atelier_core` (17/24), `vize_atelier_dom` (2/6), `vize_atelier_jsx` (24/43), `vize_atelier_sfc` (17/43), `vize_atelier_ssr` (1/4), `vize_canon` (176/261), `vize_carton` (0/1), `vize_croquis_cf` (101/127), `vize_davinci` (0/2), `vize_maestro` (7/23), `vize_patina` (22/47), `vize_vitrine` (2/5)                                                                                                                                                                                                   |
...
| `TemplateExpression`                   |       25 |   50 | `vize_canon` (22/31), `vize_croquis_cf` (3/5), `vize_maestro` (0/14)                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `Croquis.bindings`                     |       75 |  710 | `vize` (0/2), `vize_armature` (0/9), `vize_atelier_core` (2/34), `vize_atelier_dom` (0/1), `vize_atelier_jsx` (1/36), `vize_atelier_sfc` (16/225), `vize_atelier_ssr` (0/6), `vize_atelier_vapor` (0/4), `vize_canon` (43/82), `vize_croquis_cf` (2/10), `vize_curator` (0/1), `vize_davinci` (0/10), `vize_fresco` (0/6), `vize_impeto` (0/3), `vize_maestro` (8/14), `vize_musea` (0/1), `vize_patina` (1/6), `vize_relief` (0/1), `vize_s1_to_s2` (0/228), `vize_s2` (0/21), `vize_s2_to_s3` (0/3), `vize_vitrine` (2/7) |
...
| `Croquis.macros`                       |      147 |  266 | `vize_atelier_sfc` (11/102), `vize_canon` (72/73), `vize_croquis_cf` (25/27), `vize_davinci` (0/4), `vize_maestro` (14/24), `vize_musea` (0/2), `vize_patina` (22/31)                                                                                                                                                                                                                                                                                                                                                       |
...
| `Croquis.scopes`                       |       99 |  159 | `vize` (0/1), `vize_atelier_core` (0/4), `vize_atelier_jsx` (0/11), `vize_canon` (49/51), `vize_curator` (0/1), `vize_davinci` (0/9), `vize_maestro` (15/16), `vize_patina` (4/25), `vize_s1_to_s2` (0/10)                                                                                                                                                                                                                                                                                                                  |
