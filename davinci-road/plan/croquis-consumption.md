...
| `Croquis`                              |      302 |  482 | `vize` (1/2), `vize_atelier_core` (15/21), `vize_atelier_dom` (2/7), `vize_atelier_jsx` (9/21), `vize_atelier_sfc` (16/42), `vize_atelier_ssr` (1/4), `vize_canon` (134/193), `vize_croquis_cf` (101/127), `vize_davinci` (0/2), `vize_maestro` (3/17), `vize_patina` (19/42), `vize_vitrine` (1/4)                                                      |
...
| `Span`                                 |        0 |  341 | `vize_atelier_jsx` (0/62), `vize_atelier_sfc` (0/5), `vize_canon` (0/56), `vize_carton` (0/71), `vize_davinci` (0/4), `vize_maestro` (0/2), `vize_patina` (0/141)                                                                                                                                                                                        |
