...
# Croquis consumption: `vize_l2_to_l3`

One shard of the [Croquis consumption matrix](../croquis-consumption.md): every fact the matrix records about `crates/vize_l2_to_l3/src`. The method and the product set live on that page.
