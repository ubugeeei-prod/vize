...
- [`folio_text.rs`](../../../../../crates/vize_l2/tests/folio_text.rs)
  - exact Folio parse/print and owned-mirror coverage for value-bearing and
    value-less `vue.text`.
- [`lowering_vtext.rs`](../../../../../crates/vize_l1_to_l2/tests/lowering_vtext.rs)
...
- [`davinci_s2_text.rs`](../../../../../crates/vize_atelier_dom/tests/davinci_l2_text.rs)
...
- [`emit_unsupported_census.rs`](../../../../../crates/vize_l1_to_l2/tests/emit_unsupported_census.rs)
  and [`emit_unsupported_catalogue.rs`](../../../../../crates/vize_l1_to_l2/tests/emit_unsupported_catalogue.rs)
