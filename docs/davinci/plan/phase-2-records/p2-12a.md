...
These are the original phase baseline. The 2026-09-16 source-order correction
ratchets Vapor visits downward in [walk-baseline.md](../walk-baseline.md) and
`budgets.toml`; the phase-start improvement targets remain unchanged.
