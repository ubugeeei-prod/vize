...
| `renderToString`                                                | `renderToString`                      | Partial     | Plain-text projection (no ANSI styling, no flex layout beyond column stacking); intended for tests until the M0 harness lands. |
...
| Testing: `ink-testing-library`                                  | —                                     | Planned     | `renderTui`, `lastFrame`, input injection, layout inspection (M0).                                                             |
