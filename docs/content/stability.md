...
| `vize_atlas`            | Compatibility preview | Vize tool and compiler infrastructure      | `vize_atlas::{Compilation, Product, Provider}`       | One minor with `#[deprecated]`         |
...
| `vize_module`           | Compatibility preview | JS/TS compiler and tooling authors         | `vize_module::{ModuleSyntaxProduct, ModuleDocument}` | One minor with `#[deprecated]`         |
| `vize_flow`             | Compatibility preview | Control-flow and data-flow tooling authors | `vize_flow::{FlowGraph, FlowProduct}`                | One minor with `#[deprecated]`         |
| `vize_rendu`            | Compatibility preview | Compiler frontend and backend authors      | `vize_rendu::{RenduModule, RenduProduct}`            | One minor with `#[deprecated]`         |
...
| `vize_atelier_template` | Alpha-supported       | Standalone template compiler hosts         | `vize_atelier_template::TemplateCompileProduct`      | One minor with `#[deprecated]`         |
