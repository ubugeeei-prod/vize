...
description: "Single-shot timer host used by the debounced and throttled state utilities. Implement this interface to integrate a deterministic test clock, a native runtime timer, or an application-owned scheduler. Handles are opaque: the utilities only hand them back to `TimeoutScheduler.clearTimeout`. This module declares types only and contributes no runtime code."
---
