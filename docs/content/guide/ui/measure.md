---
title: "Measure"
description: "Headless Measure; covers ResizeObserver, IntersectionObserver."
---
...
Headless Measure; covers ResizeObserver, IntersectionObserver.

|  |  |
| --- | --- |
| Package | `@vizejs/ui/measure` |
| Maturity | stable |
| Own the source | `vize lib pull measure` |
| Requires | — |
| Aliases | resize observer, intersection observer, element size, visibility |
| Covers | ResizeObserver, IntersectionObserver |
...
```ts
function createSizeObserver(options: SizeObserverOptions): SizeObserverController
```
...
```ts
function createVisibilityObserver( options: VisibilityObserverOptions, ): VisibilityObserverController
```
...
```ts
function useSizeObserver(options: SizeObserverOptions): SizeObserverController
```
...
```ts
function useVisibilityObserver( options: VisibilityObserverOptions, ): VisibilityObserverController
```
