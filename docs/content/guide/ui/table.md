---
title: "Table"
description: "Native semantic table component family for accessible tabular data composition."
---
...
|  |  |
| --- | --- |
| Package | `@vizejs/ui/table` |
| Maturity | stable |
| Own the source | `vize lib pull table` |
| Requires | — |
| Aliases | semantic table, data table shell, table primitive, tabular data |
| Covers | HTML table element, HTML caption element, HTML table section elements, HTML th scope attribute, shadcn/ui Table, Reka UI Primitive |

## Usage

```ts
import { Table, TableBody, TableCaption, TableCell, TableHead, TableHeader, TableRow } from "@vizejs/ui/table";
```

Or copy the source into your project with `vize lib pull table` (see [Source Distribution](../lib-pull.md)).

## API

### `Table`

Source: `src/families/data/table/table.vue`

#### Props

| Prop | Type | Default | Description |
| --- | --- | --- | --- |
| `layout` | `TableLayout` | `"auto"` | Native CSS `table-layout` mode. |
| `density` | `TableDensity` | `"normal"` | Consumer density token mirrored to `data-density`; no spacing CSS is emitted. |

#### Slots

| Slot | Slot props | Description |
| --- | --- | --- |
| `default` | `TableSlotState` | Renders caption, section, row, and cell children with table hook state. |

#### Exposed

| Member | Type | Description |
| --- | --- | --- |
| `layout` | `TableLayout` | Native CSS `table-layout` mode. |
| `density` | `TableDensity` | Consumer density token. |
| `style` | `TableStyle` | Inline native table style object applied to the host. |
| `element` | `HTMLTableElement \| null` | Rendered native table element. |

### `TableBody`

Source: `src/families/data/table/table-body.vue`

#### Slots

| Slot | Slot props | Description |
| --- | --- | --- |
| `default` | `TableBodySlotState` | Renders one or more native table rows inside the body section. |

#### Exposed

| Member | Type | Description |
| --- | --- | --- |
| `section` | `"body"` | Stable semantic section token. |
| `element` | `HTMLTableSectionElement \| null` | Rendered native table body element. |

### `TableCaption`

Source: `src/families/data/table/table-caption.vue`

#### Props

| Prop | Type | Default | Description |
| --- | --- | --- | --- |
| `side` | `TableCaptionSide` | `"top"` | Native CSS `caption-side` placement. |

#### Slots

| Slot | Slot props | Description |
| --- | --- | --- |
| `default` | `TableCaptionSlotState` | Renders the native caption content with caption placement state. |

#### Exposed

| Member | Type | Description |
| --- | --- | --- |
| `side` | `TableCaptionSide` | Native CSS `caption-side` placement. |
| `style` | `TableCaptionStyle` | Inline caption style object applied to the host. |
| `element` | `HTMLTableCaptionElement \| null` | Rendered native caption element. |

### `TableCell`

Source: `src/families/data/table/table-cell.vue`

#### Props

| Prop | Type | Default | Description |
| --- | --- | --- | --- |
| `headers` | `string` | `undefined` | Space-separated ids of native header cells that describe this data cell. |
| `colspan` | `number` | `undefined` | Native column span. |
| `rowspan` | `number` | `undefined` | Native row span. |
| `align` | `TableCellAlign` | `"start"` | Logical text alignment mirrored to `data-align` and `--vize-ui-table-cell-align`. |

#### Slots

| Slot | Slot props | Description |
| --- | --- | --- |
| `default` | `TableCellSlotState` | Renders native data cell content with headers and alignment state. |

#### Exposed

| Member | Type | Description |
| --- | --- | --- |
| `headers` | `string \| undefined` | Native header id references. |
| `colspan` | `number \| undefined` | Native column span. |
| `rowspan` | `number \| undefined` | Native row span. |
| `align` | `TableCellAlign` | Logical text alignment hook. |
| `style` | `TableCellStyle` | Inline cell style object applied to the host. |
| `element` | `HTMLTableCellElement \| null` | Rendered native table data cell element. |

### `TableHead`

Source: `src/families/data/table/table-head.vue`

#### Slots

| Slot | Slot props | Description |
| --- | --- | --- |
| `default` | `TableHeadSlotState` | Renders one or more native table rows inside the head section. |

#### Exposed

| Member | Type | Description |
| --- | --- | --- |
| `section` | `"head"` | Stable semantic section token. |
| `element` | `HTMLTableSectionElement \| null` | Rendered native table head element. |

### `TableHeader`

Source: `src/families/data/table/table-header.vue`

#### Props

| Prop | Type | Default | Description |
| --- | --- | --- | --- |
| `scope` | `TableHeaderScope` | `"col"` | Native header scope for assistive technology. |
| `abbr` | `string` | `undefined` | Native abbreviated header text for compact assistive output. |
| `colspan` | `number` | `undefined` | Native column span. |
| `rowspan` | `number` | `undefined` | Native row span. |
| `align` | `TableCellAlign` | `"start"` | Logical text alignment mirrored to `data-align` and `--vize-ui-table-cell-align`. |
...
| Slot | Slot props | Description |
| --- | --- | --- |
| `default` | `TableHeaderSlotState` | Renders native header cell content with scope and alignment state. |

#### Exposed

| Member | Type | Description |
| --- | --- | --- |
| `scope` | `TableHeaderScope` | Native header scope. |
| `abbr` | `string \| undefined` | Native abbreviated header text. |
| `colspan` | `number \| undefined` | Native column span. |
| `rowspan` | `number \| undefined` | Native row span. |
| `align` | `TableCellAlign` | Logical text alignment hook. |
| `style` | `TableCellStyle` | Inline cell style object applied to the host. |
| `element` | `HTMLTableCellElement \| null` | Rendered native table header cell element. |

### `TableRow`

Source: `src/families/data/table/table-row.vue`

#### Props

| Prop | Type | Default | Description |
| --- | --- | --- | --- |
| `state` | `TableRowState` | `"default"` | Consumer-owned row state mirrored to data attributes. |

#### Slots

| Slot | Slot props | Description |
| --- | --- | --- |
| `default` | `TableRowSlotState` | Renders native header and data cells with row state. |

#### Exposed

| Member | Type | Description |
| --- | --- | --- |
| `state` | `TableRowState` | Consumer-owned row state hook. |
| `selected` | `boolean` | Whether this row is marked selected for consumer styling. |
| `element` | `HTMLTableRowElement \| null` | Rendered native table row element. |
