---
title: "Hover"
description: "Headless Hover; covers React Aria useHover, Pointer Events hover."
---
...
Headless Hover; covers React Aria useHover, Pointer Events hover.

|  |  |
| --- | --- |
| Package | `@vizejs/ui/hover` |
| Maturity | stable |
| Own the source | `vize lib pull hover` |
| Requires | — |
| Aliases | hover, pointer, pen |
| Covers | React Aria useHover, Pointer Events hover |
...
```ts
function createHover(options: HoverOptions = {}): HoverController
```
...
```ts
function useHover(options: HoverOptions = {}): HoverController
```
