---
title: "Surface"
description: "Accessible, unstyled polymorphic surface for section-like composition."
---
...
Accessible, unstyled polymorphic surface for section-like composition.

|  |  |
| --- | --- |
| Package | `@vizejs/ui/surface` |
| Maturity | stable |
| Own the source | `vize lib pull surface` |
| Requires | — |
| Aliases | surface, semantic surface, section wrapper, panel wrapper |
| Covers | HTML section element, HTML article element, HTML aside element, ARIA labelledby and describedby IDREFs, shadcn/ui Card, Reka UI Primitive |

## Usage

```ts
import { Surface } from "@vizejs/ui/surface";
```

Or copy the source into your project with `vize lib pull surface` (see [Source Distribution](../lib-pull.md)).

## API

### `Surface`

Source: `src/families/layout/surface/surface.vue`

#### Props

| Prop | Type | Default | Description |
| --- | --- | --- | --- |
| `as` | `SurfaceAs` | `"section"` | Native semantic host rendered by the primitive. |
| `ariaLabelledby` | `string` | `undefined` | Space-separated ids that label the surface. |
| `ariaDescribedby` | `string` | `undefined` | Space-separated ids that describe the surface. |
| `tone` | `SurfaceTone` | `undefined` | Optional consumer tone hook mirrored to `data-tone`; no CSS is emitted. |
| `elevation` | `SurfaceElevation` | `undefined` | Optional consumer elevation hook mirrored to `data-elevation`; no CSS is emitted. |

#### Slots

| Slot | Slot props | Description |
| --- | --- | --- |
| `default` | `SurfaceSlotState` | Renders surface content with current semantic and data-hook state. |
...
| `as` | `SurfaceAs` | Rendered semantic host. |
| `tone` | `SurfaceTone \| undefined` | Optional consumer tone hook. |
| `elevation` | `SurfaceElevation \| undefined` | Optional consumer elevation hook. |
| `labelled` | `boolean` | Whether the surface has an accessible labeling reference. |
| `described` | `boolean` | Whether the surface has an accessible description reference. |
| `element` | `SurfaceElement \| null` | Rendered host element. |
