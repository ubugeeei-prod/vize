...
| --------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| Compilation     | [`vize_atlas`](https://github.com/ubugeeei-prod/vize/tree/main/crates/vize_atlas) executes source-shaped [`vize_atelier_sfc`](https://github.com/ubugeeei-prod/vize/tree/main/crates/vize_atelier_sfc), [`vize_atelier_template`](https://github.com/ubugeeei-prod/vize/tree/main/crates/vize_atelier_template), [`vize_atelier_jsx`](https://github.com/ubugeeei-prod/vize/tree/main/crates/vize_atelier_jsx), and [`vize_module`](https://github.com/ubugeeei-prod/vize/tree/main/crates/vize_module) frontends; peer [`vize_relief`](https://github.com/ubugeeei-prod/vize/tree/main/crates/vize_relief), [`vize_croquis`](https://github.com/ubugeeei-prod/vize/tree/main/crates/vize_croquis), [`vize_flow`](https://github.com/ubugeeei-prod/vize/tree/main/crates/vize_flow), and [`vize_rendu`](https://github.com/ubugeeei-prod/vize/tree/main/crates/vize_rendu) products feed DOM/SSR/Vapor outputs. [`vize_atelier_core`](https://github.com/ubugeeei-prod/vize/tree/main/crates/vize_atelier_core) remains a legacy-compatible direct API, not the shared foundation. | `@vizejs/vite-plugin`, npm `vize:build` script |
...
| ----------------- | ---------------------------------------- | -------------------------------------------------------------------------------------------- |
| Compile           | `@vizejs/vite-plugin`, `vize:build`      | Rust-native SFC and JSX/TSX compilation, raw-template APIs, DOM/SSR/Vapor output, scoped CSS |
...
Authoring components in JSX/TSX instead of `.vue` SFCs? Their [own frontend](./guide/jsx.md) shares only requested graph products and target backends.
