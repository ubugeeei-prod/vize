...
<div class="blog-grid">
  <a class="blog-card" href="./releases/">
    <span class="blog-card-kicker">轨道</span>
    <strong>发行说明</strong>
    <p>已发布更改、发布亮点、迁移说明和部署指南。</p>
  </a>

<a class="blog-card" href="./notes/">
    <span class="blog-card-kicker">轨道</span>
    <strong>注释</strong>
    <p>不定期发布开发日志、设计文章、架构说明和幕后更新。</p>
  </a>
</div>

## 如何发布

- 在 `docs/content/blog/releases/` 中实时发布帖子。
- `docs/content/blog/notes/` 中存在不规则帖子。
- 使用 `YYYY-MM-DD-slug.md` 作为文件名，以便帖子保持可排序。
- 从 `docs/templates/blog-release.md` 或 `docs/templates/blog-note.md` 开始。
- 新帖子显示在文档树中的匹配部分下。
