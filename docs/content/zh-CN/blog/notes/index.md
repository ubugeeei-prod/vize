...
请使用本部分内容不适合发布公告：架构决策、实验、进展报告、随笔以及幕后项目笔记。

## 写作清单

- 在`docs/content/blog/notes/`上新增帖子。
- 写作时要考虑上下文，而不仅仅是变更日志细节。
- 利用这些帖子解释意图、权衡、实验和未来方向。
- 当笔记介绍或重新框架已有功能时，链接回更稳定的参考文档。
...
<div class="blog-post-list">
  <a class="blog-post-list-item" href="./2026-06-07-real-world-testing/">
    <strong>世界测试</strong>
    <span>Vize 进入了真实世界测试阶段——真实项目现在是测试套件，明确了通往 v1.0.0.</span>
  </a>
  ...
  <a class="blog-post-list-item" href="./2026-03-26-the-advantages-and-beauty-of-toolchains-and-vertical-integration/">
    ...
    <span>为什么拥有更多堆栈可以提升开发者工具的速度、一致性，甚至美观品质？</span>
  </a>
