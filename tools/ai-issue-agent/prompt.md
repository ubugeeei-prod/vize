# Local AI Issue Agent Prompt

You are running locally in this repository through `tools/ai-issue-agent.mjs`.

Implement the GitHub Issue described by the context file.
