 ...
 * measure cache hits instead of compilation. `bench/generate.mjs` documents the
...
import { formatScore, makeRows } from '@bench/ui'
...
import { clampWeight } from '@bench/ui'
import icon from '${iconSpecifier}'
...
import { listEntries } from '@bench/ui'
import icon from '${iconSpecifier}'
${childImports(children)}
...
<script setup lang="ts">
import { computed, ref } from 'vue'
import { escapeMarkup } from '@bench/ui'
import icon from '${iconSpecifier}'
${childImports(children)}
