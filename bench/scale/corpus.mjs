 ...
 *   generated as a local `node_modules/@bench/ui` package instead of a real npm
...
export function generateApp({ appDir, componentCount, clean = true }) {
  ...
  paths.forEach(({ dir, file }, index) => {
    ...
    writeFileSync(target, renderComponent(index, id, children, `@bench/ui/icons/i${index}.js`));
  });
