 ...
 * This module supplies the same facts to bench/compare-tools.mjs, whose
...
export const UNRECORDED_PROVENANCE_LINE =
  "Versions and backend readiness: not recorded — this artifact predates bench/benchmark-provenance.mjs and cannot be reproduced from itself.";
