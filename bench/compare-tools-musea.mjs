 ...
 *
 * The other surfaces in `bench/compare-tools.mjs` rank Vize against an
 ...
 *
 * Kept out of `bench/compare-tools.mjs` so that file, which is long past the
 ...
 *
 * Carries an M tier that the shared formatter in `bench/compare-tools.mjs`
