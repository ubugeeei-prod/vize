...
/* eslint-disable */
export declare function applyViteDefineReplacements(code: string, defines: Array<DefineReplacementNapi>): string
...
export declare function artToCsf(source: string, options?: ArtParseOptionsNapi | undefined | null): CsfOutputNapi
...
export declare function buildInspectorGraph(files: Array<InspectorSourceFileNapi>): InspectorGraphNapi
...
export declare function chunkVitePrecompileFiles(files: Array<string>, batchSize?: number | undefined | null, options?: VitePrecompileChunkOptionsNapi | undefined | null): Array<Array<string>>

export declare function classifyVitePluginRequest(id: string): VitePluginRequestNapi

export declare function collectSfcTemplateAssetUrls(source: string, rules?: Array<TemplateAssetTagRuleNapi> | undefined | null, filename?: string | undefined | null): Array<TemplateAssetUrlNapi>
...
export declare function compileCss(source: string, options?: CssCompileOptionsNapi | undefined | null): CssCompileResultNapi

export declare function compileJsx(source: string, options?: JsxCompileOptionsNapi | undefined | null): JsxCompileResultNapi
...
export declare function compileSfcBatchWithResults(files: Array<BatchFileInputNapi>, options?: BatchCompileOptionsNapi | undefined | null): BatchCompileResultWithFilesNapi
...
export declare function createViteBareImportBases(root: string, importer?: string | undefined | null): Array<string>

export declare function createViteBareImportCandidates(id: string, aliasRules: Array<CssAliasRuleNapi>, resolvedId?: string | undefined | null): Array<string>

export declare function createViteVirtualId(realPath: string, ssr?: boolean | undefined | null): string
...
export declare function detectViteHmrUpdateType(prev: HmrHashesNapi | undefined | null, next: HmrHashesNapi): string

export declare function diffVitePrecompileFiles(files: Array<string>, currentMetadata: Array<VitePrecompileFileMetadataEntryNapi>, previousMetadata: Array<VitePrecompileFileMetadataEntryNapi>): VitePrecompileDiffNapi
...
export declare function extractSfcCustomBlocks(source: string, filename?: string | undefined | null): Array<CustomBlockNapi>

export declare function extractSfcSrcInfo(source: string, filename?: string | undefined | null): SfcSrcInfoNapi

export declare function extractSfcStyleBlocks(source: string, filename?: string | undefined | null): Array<StyleBlockNapi>

export declare function findDependentDesignTokens(tokenMap: string, targetPath: string): Array<string>
...
export declare function formatSfc(source: string, options?: FormatOptionsNapi | undefined | null): FormatResultNapi
...
export declare function generateArtCatalog(sources: Array<string>, docOptions?: DocOptionsNapi | undefined | null): CatalogOutputNapi

/** Generate component documentation from Art source */
export declare function generateArtDoc(source: string, artOptions?: ArtParseOptionsNapi | undefined | null, docOptions?: DocOptionsNapi | undefined | null): DocOutputNapi

/** Batch generate docs with parallel processing */
export declare function generateArtDocsBatch(sources: Array<string>, docOptions?: DocOptionsNapi | undefined | null): Array<DocOutputNapi>

/** Generate props palette from Art source */
export declare function generateArtPalette(source: string, artOptions?: ArtParseOptionsNapi | undefined | null, paletteOptions?: PaletteOptionsNapi | undefined | null): PaletteOutputNapi

export declare function generateDeclaration(source: string, options?: DeclarationOptionsNapi | undefined | null): DeclarationResultNapi

export declare function generateDesignTokensMarkdown(categories: string, generatedAt?: string | undefined | null): string
...
export declare function generateSfcScopeId(filename: string, root?: string | undefined | null, isProduction?: boolean | undefined | null, source?: string | undefined | null): string

/** Generate .art.vue variants from component prop definitions */
export declare function generateVariants(componentPath: string, props: Array<PropDefinitionNapi>, config?: AutogenConfigNapi | undefined | null): AutogenOutputNapi
...
export declare function hasSfcScopedStyle(source: string, filename?: string | undefined | null): boolean

export declare function hasViteHmrChanges(prev: HmrHashesNapi | undefined | null, next: HmrHashesNapi): boolean

export declare function hasVitePrecompileFileMetadataChanged(previous: VitePrecompileFileMetadataNapi | undefined | null, next: VitePrecompileFileMetadataNapi): boolean
...
export declare function lint(patterns: Array<string>, options?: LintOptionsNapi | undefined | null): LintResultNapi
...
export declare function lintPatinaSfc(source: string, options?: PatinaLintOptionsNapi | undefined | null): any
...
export declare function normalizeViteDevMiddlewareUrl(reqUrl: string): ViteDevMiddlewareRewriteNapi | null
...
export declare function normalizeViteRequireBase(importer?: string | undefined | null): string | null
...
export declare function parseArt(source: string, options?: ArtParseOptionsNapi | undefined | null): ArtDescriptorNapi

export declare function parseCssAst(source: string, options?: CssCompileOptionsNapi | undefined | null): CssAstResultNapi
...
export declare function parseSfc(source: string, options?: SfcParseOptionsNapi | undefined | null): any
...
export declare function printCssAst(ast: any, options?: CssCompileOptionsNapi | undefined | null): CssCompileResultNapi
...
export declare function resolveViteAliasRequest(id: string, aliasRules: Array<CssAliasRuleNapi>): string | null

export declare function resolveViteCssImports(css: string, importer: string, aliasRules: Array<CssAliasRuleNapi>, isDev?: boolean | undefined | null, devUrlBase?: string | undefined | null): string

export declare function resolveViteRelativeImport(id: string, importer: string): string | null

export declare function resolveViteVuePath(root: string, id: string, importer?: string | undefined | null): string

export declare function rewriteSfcTemplateAssetReferences(code: string, assets: Array<TemplateAssetUrlNapi>): string

export declare function rewriteViteDynamicTemplateImports(code: string, aliasRules: Array<DynamicImportAliasRuleNapi>): string

export declare function rewriteViteImportMetaGlobBase(code: string, importer: string, root: string): string

export declare function rewriteViteStaticAssetUrls(code: string, aliasRules: Array<DynamicImportAliasRuleNapi>): string
 ...
 */
export declare function typeCheck(source: string, options?: TypeCheckOptionsNapi | undefined | null): TypeCheckResultNapi

/** Batch type check SFC files matching a glob pattern (native multithreading) */
export declare function typeCheckBatch(pattern: string, options?: TypeCheckOptionsNapi | undefined | null): BatchTypeCheckResultNapi
...
export declare function validateDesignTokenReference(tokenMap: string, reference: string, selfPath?: string | undefined | null): string
...
export declare function wrapSfcScopedPreprocessorStyle(content: string, scoped?: string | undefined | null, lang?: string | undefined | null): string
