...
const rendererGate = [
  ...
  await readFile(path.resolve("scripts/renderer-fixtures-a11y-prefs.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-landmark.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-a11y-i18n.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-overlay-3a.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-command-palette.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-overlay-3c.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-overlay-3b.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-data.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-data-views.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-editor.ts"), "utf8"),
  ...
  await readFile(path.resolve("scripts/renderer-fixtures-mobile.ts"), "utf8"),
  ...
  await readFile(path.resolve("scripts/renderer-fixtures-qr-code.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-color-picker.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-file-upload.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-tour.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-audio-player.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-avatar-group.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-image-cropper.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-lightbox.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-marquee.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-media-player.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-signature-pad.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-video-player.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-audio-visualizer.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-hotspot.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-image-compare.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-pan-zoom.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-scrubber-preview.ts"), "utf8"),
  await readFile(path.resolve("scripts/renderer-fixtures-webcam-capture.ts"), "utf8"),
  ...
  await readFile(path.resolve("scripts/renderer-fixtures-charts.ts"), "utf8"),
...
test("public family subpaths compile from family directories directly", () => {
  for (const entry of stableEntries) {
    assert.match(
      entry.entryFile,
      /^src\/families\//u,
      `${entry.canonicalName} must compile from its family directory`,
    );
    assert.notEqual(
      entry.entryFile,
      `src/${entry.canonicalName}.ts`,
      `${entry.canonicalName} must not keep its entry file at src root`,
    );
  }
});
