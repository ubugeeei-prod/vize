...
export const uiFamilyRoots = new Map<string, string>([
  ...
  ["dashboard-grid", "src/families/layout/dashboard-grid/"],
  ...
  ["masonry", "src/families/layout/masonry/"],
  ["master-detail", "src/families/layout/master-detail/"],
  ...
  ["sticky-stack", "src/families/layout/sticky-stack/"],
  ...
  ["window-manager", "src/families/layout/window-manager/"],
