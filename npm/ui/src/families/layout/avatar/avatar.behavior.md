...
| A10 | SSR/hydration      | hydrate           | server avatar markup hydrates without warnings, node replacement, or accessibility drift                 | `src/conformance/runtime-conformance.test.ts`                                 |
