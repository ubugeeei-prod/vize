...
const disabled = computed(() => !context.canScrollNext.value);
...
type CarouselNextSetupExpose = Omit<CarouselButtonExpose, "disabled" | "element"> & {
  readonly disabled: ComputedRef<boolean>;
  readonly element: typeof element;
};

const exposed = { disabled, element } satisfies CarouselNextSetupExpose;
