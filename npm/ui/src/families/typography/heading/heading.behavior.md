...
| H8  | SSR/hydration | hydrate           | server heading markup hydrates without warnings, node replacement, or accessibility drift                | `src/conformance/runtime-conformance.test.ts`                                 |
