...
| K8  | SSR/hydration | hydrate           | server kbd markup hydrates without warnings, node replacement, or accessibility drift            | `src/conformance/runtime-conformance.test.ts`                                  |
