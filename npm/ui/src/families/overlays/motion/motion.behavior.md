...
`src/families/overlays/motion/motion.css` to the declared browser floor; see
`style-pipeline.behavior.md`) in `src/families/overlays/motion/motion-stylesheet.test.ts`; runtime rows
are proven by the named test in `src/families/overlays/motion/motion.test.ts` or
`src/families/overlays/motion/motion-ssr.test.ts`; compile-only assertions live in
`src/families/overlays/motion/motion.types.test-d.ts`.
...
| M17 | public types        | invalid token names or mutated records          | compilation rejects misuse                                                                                                  | `src/families/overlays/motion/motion.types.test-d.ts`               |
