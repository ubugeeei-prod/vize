...
import {
  ...
  BreadcrumbList,
  BreadcrumbSeparator,
} from "./families/navigation/breadcrumb/breadcrumb.ts";
</script>
...
`,
  },
  {
    ...
    source: String.raw`<script setup lang="ts">
import { TabsContent, TabsList, TabsRoot, TabsTrigger } from "./families/navigation/tabs/tabs.ts";
</script>
...
`,
  },
  {
    ...
    source: String.raw`<script setup lang="ts">
import { StepperContent, StepperItem, StepperList, StepperRoot, StepperTrigger } from "./families/navigation/stepper/stepper.ts";
</script>
...
import {
  ...
  PaginationPage,
  PaginationPrevious,
} from "./families/navigation/pagination/pagination.ts";
</script>
