...
The UI source-quality scripts publish schema version 1 of the source install
dry-run planner from `scripts/source-quality/source-install-planner.ts`. The
planner is a pure TypeScript primitive for repository tooling; it does not read
