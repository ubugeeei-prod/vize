...
import { createCollectionRegistry } from "./families/foundations/collection/collection.ts";
import { useSpatialNavigation } from "./families/interaction/spatial-navigation/spatial-navigation.ts";
...
`,
  },
  {
    ...
    source: String.raw`<script setup lang="ts">
import { createCollectionRegistry } from "./families/foundations/collection/collection.ts";
import { useCompositeNavigation } from "./families/foundations/composite-navigation/composite-navigation.ts";
...
`,
  },
  {
    ...
    source: String.raw`<script setup lang="ts">
import { createCollectionRegistry } from "./families/foundations/collection/collection.ts";
import { useTypeahead } from "./families/interaction/typeahead/typeahead.ts";
...
`,
  },
  {
    ...
    source: String.raw`<script setup lang="ts">
import { useFocusRing } from "./families/accessibility/focus/focus.ts";
...
`,
  },
  {
    ...
    source: String.raw`<script setup lang="ts">
import { useMove } from "./families/interaction/move/move.ts";
...
`,
  },
  {
    ...
    source: String.raw`<script setup lang="ts">
import { useHover } from "./families/interaction/hover/hover.ts";
...
`,
  },
  {
    ...
    source: String.raw`<script setup lang="ts">
import { useLongPress } from "./families/interaction/long-press/long-press.ts";
...
`,
  },
  {
    ...
    source: String.raw`<script setup lang="ts">
import { usePress } from "./families/interaction/press/press.ts";
