...
| public types and consumer bundle | TypeScript rejects a custom role, while root and subpath imports emit equivalent zero-CSS bundles.   | `src/alert-dialog.types.test-d.ts`, `scripts/check-tree-shaking.mjs` |
