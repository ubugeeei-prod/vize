...
type RootCompatibilityBarrelGroup = {
  readonly testName: string;
  readonly barrels: readonly (readonly [filename: string, target: string])[];
};
...
export const rootCompatibilityBarrelGroups: readonly RootCompatibilityBarrelGroup[] = [
  {
    testName: "root foundation utilities stay compatibility-only barrels",
    barrels: [
      ["collection.ts", "./families/foundations/collection/collection.ts"],
      ["command.ts", "./families/foundations/command/command.ts"],
      [
        "composite-navigation.ts",
        "./families/foundations/composite-navigation/composite-navigation.ts",
      ],
      ...
      ["primitive.ts", "./families/foundations/primitive/primitive.ts"],
    ],
  },
  {
    testName: "root focus utilities stay compatibility-only barrels",
    barrels: [
      ["dismissable-layer.ts", "./families/overlays/dismissable-layer/dismissable-layer.ts"],
      ["drag-and-drop.ts", "./families/interaction/drag-and-drop/drag-and-drop.ts"],
    ],
  },
  {
    testName: "root form utilities stay compatibility-only barrels",
    barrels: [["error-summary.ts", "./families/form/error-summary/error-summary.ts"]],
  },
  {
    testName: "root overlay utilities stay compatibility-only barrels",
    barrels: [["motion.ts", "./families/overlays/motion/motion.ts"]],
  },
  {
    testName: "root interaction utilities stay compatibility-only barrels",
    barrels: [
      ["history.ts", "./families/interaction/history/history.ts"],
      ["measure.ts", "./families/interaction/measure/measure.ts"],
      ["shortcut.ts", "./families/interaction/shortcut/shortcut.ts"],
      ["sortable.ts", "./families/interaction/sortable/sortable.ts"],
      ["spatial-navigation.ts", "./families/interaction/spatial-navigation/spatial-navigation.ts"],
      ["typeahead.ts", "./families/interaction/typeahead/typeahead.ts"],
      ["virtualizer.ts", "./families/interaction/virtualizer/virtualizer.ts"],
    ],
  },
];
