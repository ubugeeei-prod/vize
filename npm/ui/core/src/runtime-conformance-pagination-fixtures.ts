...
export const paginationRuntimeFixtures: readonly RuntimeFixture[] = [
  ...
  },
  {
    ...
    sourceFile: "pagination-ellipsis.vue",
    render: renderPaginationFixture,
    assertServerMarkup: assertPaginationServerMarkup,
    assertHydratedDom: assertPaginationHydratedDom,
  },
  {
    ...
    sourceFile: "pagination-item.vue",
    render: renderPaginationFixture,
    assertServerMarkup: assertPaginationServerMarkup,
    assertHydratedDom: assertPaginationHydratedDom,
  },
  {
    ...
    sourceFile: "pagination-list.vue",
    render: renderPaginationFixture,
    assertServerMarkup: assertPaginationServerMarkup,
    assertHydratedDom: assertPaginationHydratedDom,
  },
  {
    ...
    sourceFile: "pagination-next.vue",
    render: renderPaginationFixture,
    assertServerMarkup: assertPaginationServerMarkup,
    assertHydratedDom: assertPaginationHydratedDom,
  },
  {
    ...
    sourceFile: "pagination-page.vue",
    render: renderPaginationFixture,
    assertServerMarkup: assertPaginationServerMarkup,
    assertHydratedDom: assertPaginationHydratedDom,
  },
  {
    ...
    sourceFile: "pagination-previous.vue",
    render: renderPaginationFixture,
    assertServerMarkup: assertPaginationServerMarkup,
    assertHydratedDom: assertPaginationHydratedDom,
  },
