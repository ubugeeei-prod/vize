...
| S11 | public types       | invalid contract  | TypeScript rejects unsupported roles, state tokens, value types, and malformed slot state         | `src/families/feedback/spinner/spinner.types.test-d.ts`                 |
