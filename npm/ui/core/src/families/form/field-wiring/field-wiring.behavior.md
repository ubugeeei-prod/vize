...
`src/families/form/field-wiring/field-wiring.test.ts` or
`src/families/form/field-wiring/field-wiring-ssr.test.ts`; compile-only
assertions live in `src/families/form/field-wiring/field-wiring.types.test-d.ts`.
...
| W11 | public types | mutation or invalid options | compilation rejects misuse                                           | `src/families/form/field-wiring/field-wiring.types.test-d.ts` |
