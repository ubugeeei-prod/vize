...
Lint output supports `text`, `json`, `stylish`, `markdown`, `html`, and `agent`. The human and
agent-friendly formats include local rule documentation paths such as `docs/content/rules/vue.md`.
