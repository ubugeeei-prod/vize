...
interface SfcBlockAttributeNapi {
  name: string;
  value?: string;
}
interface CustomBlockNapi {
  blockType: string;
  content: string;
  src?: string;
...
export {
  LoaderEntry as a,
  SfcCompileResultNapi as c,
  VizeLoaderOptions as d,
  VizeRspackPluginOptions as f,
  JsxCompileResultNapi as i,
  SfcSrcInfo as l,
  CustomBlockInfo as n,
  MacroArtifact as o,
  VizeStyleLoaderOptions as p,
  JsxCompileOptionsNapi as r,
  SfcCompileOptionsNapi as s,
  CompiledModule as t,
  StyleBlockInfo as u,
};
