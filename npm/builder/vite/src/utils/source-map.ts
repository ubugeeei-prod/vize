...
import { countNewlines, shiftMappedLines, type SourceMapV3 } from "../../../shared/source-map.ts";
export { parseSourceMap, shiftMappedLines, type SourceMapV3 } from "../../../shared/source-map.ts";
