...
export function resolveVitePlus() {
  ...
  try {
    ...
    throw new Error(
      "withVize requires vite-plus installed in this project. Install your preferred version first.",
    );
  }
...
export function availableVueRules(): Set<string> {
  ...
  try {
    // A standalone project prevents recursive loading of withVize while
